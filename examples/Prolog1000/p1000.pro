['<Program>' = ['3TAP'],'<Number>' = [454],
    '<Domain>' = ['Hardware Verification, Natural Language Processing. '],
    '<Purpose>' =
        [   'Tableau-Based Automated Theorem Prover for arbitrary finitely-valued first-order logics including the handling of equality and sorts.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Reiner Haehnle, Wolfgang Wernecke.'],
    '<Organization>' = ['IBM Germany, University of Karlsruhe, DFG.'],
    '<Country>' = ['Germany.'],
    '<Prolog system>' =
        ['Quintus Prolog, runs on versions  2.4 and later. '],
    '<Other languages>' = ['C / 5%'],'<Lines>' = ['17,500 incl comments.'],
    '<Predicates>' = ['910'],
    '<Platform>' =
        ['Sun 3, Sun Sparcstations, IBM PS/2, IBM RS/6000 all Unix.'],
    '<Type of Use>' = [''],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['May 1992'],'<No. of Users>' = ['7 - 10'],
    '<Information Date>' = ['Oct 1992'],
    '<References>' =
        ['@TECHREPORT{Beckert92a, ','AUTHOR = {Bernhard Beckert}, ',
            'INSTITUTION = {IBM Germany, Institute for ',
            'Knowledge Based Systems}, ','MONTH = {jan}, ',
            'NUMBER = {208}, ',
            'TITLE = {Konzeption und {I}mplementierung von ',
            '{G}leichheit f\\"{u}r einen ','tableau--basierten ',
            '{T}heorembeweiser}, ','TYPE = {{IWBS} {R}eport}, ',
            'YEAR = {1992}} ',' ','@INPROCEEDINGS{BeckertHaehnle91, ',
            'AUTHOR = {Bernhard Beckert and Reiner ','H\\"{a}hnle}, ',
            'BOOKTITLE = {Proc.~$11^{th}$ Conference on ',
            'Automated Deduction {CADE}, Al ','bany/NY}, ',
            'EDITOR = {D.~Kapur}, ','PAGES = {507 -- 521}, ',
            'PUBLISHER = {Springer Verlag}, ','SERIES = {{LNCS}}, ',
            'TITLE = {An Improved Method for Adding ',
            'Equality to Free Variable Semantic ','Tableau}, ',
            'VOLUME = {607}, ','YEAR = {1992}} ',' ',
            '@TECHREPORT{Haehnle89, ','AUTHOR = {Reiner H\\"{a}hnle}, ',
            'INSTITUTION = {Wissenschaftliches {Z}entrum, ',
            '{IWBS}, {IBM} {D}eutschland} ',', ','NUMBER = {136}, ',
            'TITLE = {Spezifikation eines ',
            '{T}heorembeweisers f\\"{u}r dreiwertige {F}ir ',
            'st--{O}rder {L}ogik}, ','TYPE = {{IWBS} Report}, ',
            'YEAR = {1990}} ',' ','@INPROCEEDINGS{Haehnle90, ',
            'AUTHOR = {Reiner H\\"{a}hnle}, ',
            'BOOKTITLE = {Proceedings Workshop on Computer ',
            'Science Logic, Heidelberg}, ','PAGES = {248 -- 260}, ',
            'PUBLISHER = {Springer, {LNCS} 533}, ',
            'TITLE = {Towards an Efficient Tableau Proof ',
            'Procedure for Multiple--Value ','d Logics}, ',' ',
            '@INPROCEEDINGS{Haehnle91, ','AUTHOR = {Reiner H\\"{a}hnle}, ',
            'BOOKTITLE = {Proc. International Symposium on ',
            'Multiple--Valued Logic, Vic ','toria}, ',
            'PAGES = {238 -- 245}, ','PUBLISHER = {{IEEE} Press}, ',
            'TITLE = {Uniform Notation of Tableaux Rules ',
            'for Multiple--Valued Logics}, ',' ','@BOOK{Haehnle92f, ',
            'AUTHOR = {Reiner H\\"{a}hnle}, ','MONTH = {To appear}, ',
            ...
            'free variable semantic tableau ','x}, ','YEAR = {1993}} ',' ',
            '@TECHREPORT{Schoepke91, ','AUTHOR = {Gisela Sch\\"{o}pke}, ',
            'INSTITUTION = {Wissenschaftliches {Z}entrum, ',
            '{IWBS}, {IBM} {D}eutschland} ',', ','MONTH = {October}, ',
            'NUMBER = {188}, ',
            'TITLE = {{M}\\"{o}glichkeiten des {E}insatzes ',
            'eines dreiwertigen {T}heorem ','beweisers}, ',
            'TYPE = {{IWBS} Report}, ','YEAR = {1991}} ','YEAR = {1993}} ',
            'YEAR = {1991}} ','YEAR = {1990}} ','@TECHREPORT{TAP92, ',
            'AUTHOR = {Reiner H\\"{a}hnle and Bernhard ',
            'Beckert and Stefan Gerberding an ','d Werner Kernig}, ',
            'INSTITUTION = {Wissenschaftliches {Z}entrum ',
            '{H}eidelberg, {IWBS}, {IBM} { ','D}eutschland}, ',
            'MONTH = {July}, ','NUMBER = {227}, ',
            'TITLE = {{T}he {M}any--{V}alued {T}ableau-- ',
            '{B}ased {T}heorem {P}rover {\\T ','AP}}, ',
            'TYPE = {{IWBS} {R}eport}, ','YEAR = {1992}} ']].
['<Program>' = ['A Code Generator for Database Applications in Prolog.'],
    '<Number>' = [297],'<Domain>' = ['CASE Tools '],
    '<Purpose>' =
        [   'Use of Prolog as a specification language for transactional systems and as a tool for automating software cycle.'],
    '<Description>' =
    ...
    '<Developed by>' = ['S. Dulli - R. Sprugnoli - L. Veronese.'],
    '<Organization>' = ['University of Padova'],'<Country>' = ['Italy'],
    '<Prolog system>' = ['Prolog - 2         E.S.I. '],
    '<Lines>' = ['1,000  (130K memory)'],'<Predicates>' = ['300'],
    '<Platform>' = ['P.C. MSDOS'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['Dec. 1990'],'<No. of Users>' = ['4'],
    '<Information Date>' = ['25/11/91'],
    '<References>' =
...
['<Program>' = ['AALPS'],'<Number>' = [198],
    '<Domain>' = ['Aircraft planning '],
    '<Purpose>' = ['A load planning system for aircraft cargo'],
    '<Description>' =
        ['The Automated Air Load Planning System provides a ',
            ...
            'data. '],
    '<Organization>' =
        [   'SRI International, XVII Airborne Corps, Military Aircraft Command'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Quintus '],
    '<Other languages>' = ['C'],'<Platform>' = ['SUN workstation']].
['<Program>' = ['ACACIA'],'<Number>' = [243],'<Domain>' = ['Nuclear power '],
    '<Purpose>' =
        [   'a knowledge-based framework for the on-line dynamic synthesis of emergency operating procedures in a nuclear power plant'],
    '<Description>' = ['It\'s hard to see the status of this '],
    '<Organization>' = ['CEA, Electricite de France'],
    '<Country>' = ['France'],
    '<Prolog system>' =
        ['SPIRAL ',
            '\307IF*** The text replacing this argument is too long ***\310<References>\tA. ',
...
['<Program>' = ['ACAPS Loan Printing System'],'<Number>' = [458],
    '<Domain>' = ['loan paperwork production. '],
    '<Purpose>' =
        [   'Expert system to create loan documentation from ACAPS main frame loan system.'],
    '<Description>' =
    ...
    '<Developed by>' = ['John Grant.'],
    '<Organization>' = ['Security Pacific National Bank.'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Arity Prolog '],
    '<Other languages>' = ['C - 5 lines'],'<Lines>' = ['10000'],
    '<Predicates>' = ['200'],'<Platform>' = ['IBM PC - OS/2 v 1.3'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['March 1990'],'<No. of Users>' = ['100'],
    '<Information Date>' = ['1991']].
['<Program>' = ['ADAM'],'<Number>' = [437],
    '<Domain>' =
    ...
    '<Purpose>' = ['Object-Oriented Database.'],
    '<Description>' =
        ['Adds the ability to structure prolog programs and data ',
            'using the object-oriented paradigm. '],
    '<Developed by>' = ['Norman Paton.'],
    '<Organization>' = ['Heriot-Watt University.'],'<Country>' = ['UK'],
    '<Prolog system>' = ['SICStus + Sepia (Quintus,MegaLog). '],
    '<Other languages>' = ['C (1000 lines)'],'<Lines>' = ['4000'],
    '<Platform>' = ['Sun + UNIX'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Prototype'],'<When Deployed>' = ['March 1989'],
    '<No. of Users>' = ['Sites = 4; People = 50'],
    '<Information Date>' = ['April 1992'],
    '<References>' =
...
['<Program>' = ['ADAN'],'<Number>' = [375],
    '<Domain>' = ['Aquisition of knowledge from data analysis. '],
    '<Purpose>' = ['Conceptual clustering of data bases.'],
    '<Description>' =
        ['A generic product for the conceptual clustering of ','relevant ',
            'database through a non supervised learning technique. '],
    '<Developed by>' = ['Antoni Trias, Xavier Fustero.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain.'],
    '<Prolog system>' = ['PDC Prolog 3.3 for Windows. '],
    '<Other languages>' = ['Turbo C, Microsoft C.'],'<Lines>' = ['6235'],
    '<Predicates>' = ['534'],
    '<Platform>' =
        [   'Developed PC 386 / MS DOS,Delivery PC 386 or 486 / MS DOS and Windows.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['August 1992.'],'<Information Date>' = ['07/1992.'],
    '<References>' = ['AIA/ Software product description. ']].
['<Program>' = ['ADAS'],'<Number>' = "j",'<Domain>' = ['Digital design '],
    '<Purpose>' =
        ['Application-driven Design Automation for Microprocessor Design'],
    '<Description>' = ['Submitted to PAC. Paper 194 '],
    '<Developed by>' = ['Iksoo Pyo et al'],'<Country>' = ['USA'],
    '<Prolog system>' = ['Subset of standard Prolog '],
    '<Platform>' = ['VLSI Microprocessor'],
    '<Information Date>' = ['17/10/91']].
['<Program>' = ['ADES (ATP Design Expert System)'],'<Number>' = [425],
    '<Domain>' = ['Logic Circuit Design. '],
    '<Purpose>' =
        [   'Automatic design of the logic circuits constituting an Automatic Train Protection (ATP) system, starting from the station topography.'],
    '<Description>' =
    ...
    '<Developed by>' =
        ['Roberto Cremonini, Evelina Lamma, Paola Mello, Augusto Torchi.'],
    '<Organization>' =
        [   'SASIB S.p.a. Bologna, jointly with Dipartimento di Elettronica, Informatica e Sistemistica (University of Bologna).'],
    '<Country>' = ['Italy.'],'<Prolog system>' = ['Quintus Prolog. '],
    '<Other languages>' = ['Fortran, Graphic Kernel System.'],
    '<Lines>' = ['5000'],'<Predicates>' = ['800'],
    '<Platform>' = ['microVAX Digital  VMS'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1990'],
    '<No. of Users>' = ['10'],'<Information Date>' = ['January 1991'],
    '<References>' =
        ['Cremonini, R., Lamma, E. Lamma, Mello, P., ',
            'ADES: An Expert System for ATP Design ',
            'AI EDAM Journal, 1989, Vol. 3, N. 1, pages 1-21. ']].
['<Program>' = ['Aditi Compiler'],'<Number>' = ",",
    '<Domain>' = ['Deductive Databases '],
    '<Purpose>' =
        [   'Query and rule compilation of Aditi Prolog to the base relational language RL for the Aditi Deductive Database.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Peter Stuckey (the current version)'],
    '<Organization>' =
        ['Department of Computer Science; University of Melbourne'],
    '<Country>' = ['Australia'],'<Prolog system>' = ['NU-Prolog '],
    '<Other languages>' = ['Aditi relational engine is written in C.'],
    '<Lines>' = ['7000 -- lines of code (including blanks)'],
    '<Predicates>' = ['550'],
    '<Platform>' =
        ['Silicon Graphics R3000 based multiprocessors / Unix System 5'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['June 90'],'<No. of Users>' = ['8'],
    '<Information Date>' = ['Feb 92'],
    '<References>' =
...
['<Program>' = ['ADP (Arc Welding Diagnosis and Planning System.'],
    '<Number>' = [309],'<Domain>' = ['Design Manufacturing Systems '],
    '<Purpose>' =
        [   'Diagnosis and planning of technological parameters for gas- shielded metal arc welding applications.'],
    '<Description>' =
    ...
    '<Organization>' = ['Dep. Robot System Technology'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['IF-PROLOG 4.0 '],
    '<Other languages>' = ['C - extensions'],
    '<Lines>' = ['~ 1 MByte source'],
    '<Platform>' = ['VAX station 3100 VMS 5.4'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<Information Date>' = ['11/05/92'],
    '<References>' =
        ['IFAC/IFIP/IMACS   Symposium on Robot Control SYROCO Sept. ',
            '16-18, 1991, Vienna, Austria.  Preprint pp. 39. ']].
['<Program>' = ['ADRAM (after an ICL program of the same name).'],
    '<Number>' = [406],'<Domain>' = ['Data Conversion. '],
    '<Purpose>' = ['Syntax-directed data converter.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Jocelyn Paine.'],
    '<Organization>' = ['Institute of Fiscal Studies.'],
    '<Country>' = ['England.'],'<Prolog system>' = ['Poplog. '],
    '<Other languages>' = ['Algol68.'],'<Lines>' = ['3000.'],
    '<Predicates>' = ['600.'],'<Platform>' = ['VAX/VMS.'],
    '<Type of Use>' = ['In-house'],
    '<Current Status>' = ['No longer supported'],
    '<When Deployed>' = ['12/1987.'],
    '<No. of Users>' = ['1 (organisation).'],
    '<Information Date>' = ['3/1992.'],'<References>' = ['None. ']].
['<Program>' = ['ADW Knowledge Coordinator'],'<Number>' = [215],
    '<Domain>' = ['Systems development '],
    '<Purpose>' =
        [   'Tools to help developers to formalize, design and implement information systems'],
    '<Description>' =
    ...
    '<Prolog system>' = ['IBM Prolog for OS/2, IBM MVS Prolog '],
    '<Other languages>' = ['C code for screen graphics'],
    '<Lines>' = ['130 KLOC'],'<Platform>' = ['IBM PS/2 with OS/2, IBM 370'],
    '<References>' =
        ['B. Robinet: Logic Programming at IBM from the Lab to the ',
            'customer. Proc ICLP8. pp912-921. 1991 ']].
['<Program>' = ['AFARS - Asset Forfeiture advisor and reporting system'],
    '<Number>' = "h",'<Domain>' = ['Criminal Justice; Law enforcement '],
    '<Purpose>' =
        [   'Assists federal, state and local law enforecement agencies in conducting effective asset forfeiture programs to process seized criminal assets'],
    '<Description>' =
    ...
    '<Developed by>' = ['Dennis M. Scott, Presdent and Project manager'],
    '<Organization>' = ['Scott Enterprises'],'<Country>' = ['USA'],
    '<Prolog system>' = ['PDC Prolog '],
    '<Other languages>' =
        [   'Some Microsoft Quick Basic, which will be reprogrammed in PDC Prolog in the near future'],
    '<Platform>' =
        [   'IBM XT compatible, 640K RAM, Hard drive, CGA, EGA or SVGA Color monitor with 512K Graphics. Requires approximately 3MB disk space which will grow as data bases expand'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Evaluation'],
    '<Information Date>' = ['8 Apr 1992']].
['<Program>' = ['AGATHA'],'<Number>' = [3],
    '<Domain>' = ['Electronic Diagnosis '],
    '<Purpose>' =
        [   'Expert System to test and diagnose complex printed circuit boards'],
    '<Description>' =
    ...
    '<Developed by>' =
        [   'Daryl Allred; Mike Bennett; Chris Preist; Yossi Lichtenstein; Ajay Gupta'],
    '<Organization>' = ['Hewlett-Packard Co.'],'<Country>' = ['USA and UK'],
    '<Prolog system>' = ['Quintus Prolog '],
    '<Other languages>' = ['C & YACC (13 K lines); scripts (830 lines)'],
    '<Lines>' = ['26 K lines  (all lines are UN-commented)'],
    '<Predicates>' = ['2650'],'<Platform>' = ['HP 9000/370; HP-UX (Un*x)'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['Jan 1990'],
    '<No. of Users>' = ['3 sites internally'],
    '<Information Date>' = ['Oct. 1991'],
    '<References>' =
        ['Agatha: An Integrated Expert System to Test and Diagnose, ',
            ...
            '1991  AAAI Press" ']].
['<Program>' = ['AIA-TRANS'],'<Number>' = [381],
    '<Domain>' = ['Freight distribution. '],
    '<Purpose>' =
        [   'Automation of the information/management system for a transportation and freight company (packages distribution).'],
    '<Description>' =
    ...
    '<Developed by>' =
        [   'Antoni Trias, Patricias Llopis, Xavier Fustero, Paqui Cabezas and programmers team.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain.'],
    '<Prolog system>' = ['PDC Prolog 3.31 '],'<Other languages>' = [void],
    '<Lines>' = [void],'<Predicates>' = [void],
    '<Platform>' =
        ['Developed PC 386 /MS DOS Delivery local Novel network.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1991'],'<Information Date>' = ['07/1992']].
['<Program>' = ['AiGerm'],'<Number>' = "k",'<Domain>' = ['Database design '],
    '<Purpose>' = ['A Logic Programming Front End for Germ'],
    '<Description>' = ['Submitted to PAC. Paper 210 '],
    '<Developed by>' = ['Safaa H. Hashim'],'<Country>' = ['USA'],
    '<Prolog system>' = ['"Quintus, BIM, LDL" '],
    '<Information Date>' = ['17/10/91']].
['<Program>' = ['Air Pollution ControlSystem'],'<Number>' = [264],
    '<Domain>' = ['Pollution Control '],
    '<Purpose>' = ['To advise on air pollution levels of county districts'],
    '<Description>' =
    ...
    '<Developed by>' = ['J. Bendl, Gy. Lugosi, Z. Markusz'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984'],
    '<References>' =
...
['<Program>' = ['Air Sheduler'],'<Number>' = [483],'<Domain>' = [' '],
    '<Purpose>' =
    ...
    '<Description>' =
        ['Independent software section for air traffic control ',
            ...
            'planning. '],
    '<Developed by>' =
        [   'Prof. Stanislav Timokhin. post-graduate Serge Ivanets post-graduate Michail Krylov.'],
    '<Organization>' = ['Moscow Engineering Physics Institute.'],
    '<Country>' = ['Russia.'],'<Prolog system>' = ['Turbo Prolog 2.0 '],
    '<Other languages>' = ['not used'],'<Lines>' = ['4300'],
    '<Predicates>' = ['175'],'<Platform>' = ['MS DOS'],
    '<When Deployed>' = ['1992'],
    '<No. of Users>' =
        [   'State Institute "AirNavigation" Airport Mineralnye Vody (international code UUWW)']].
['<Program>' = ['AJAX'],'<Number>' = [229],
    '<Domain>' = ['Payroll administration '],
    '<Purpose>' = ['Administering payments for civil servants'],
    '<Description>' =
    ...
    '<Developed by>' = ['Jonathan Souster'],
    '<Organization>' = ['Telecomputing'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA Prolog Professional '],
    '<Other languages>' = [flex],'<Platform>' = ['IBM PC 286 with 2MB']].
['<Program>' = ['ALBERTUS'],'<Number>' = [362],
    '<Domain>' = ['Computer based training of Physics. '],
    '<Purpose>' = ['Training Physics in Highschool and College.'],
    '<Description>' =
        ['A graphics program which can be used for training ','Physics. ',
    ...
    '<Developed by>' = ['Osmo Miettinen, Antti Miettinen and Tapio Okkola.'],
    '<Organization>' =
        ['Taosan Ky, supported by Finnish School Department.'],
    '<Country>' = ['Finland.'],
    '<Prolog system>' = ['PDC Prolog 3.20 - 3.30 '],
    '<Other languages>' = ['Assembler.'],'<Lines>' = ['5831 + 2311'],
    '<Predicates>' = ['445 + 150'],
    '<Platform>' = ['IBM-PC/AP/PS2 and compatibles, PC-DOS or MS-DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['3/1989'],'<Information Date>' = ['4/1/1992'],
    '<References>' = ['Taosan Ky and MFKA OY. ']].
['<Program>' = ['ALIEN'],'<Number>' = [222],
    '<Domain>' = ['Equipment documentation '],
    '<Purpose>' = ['Documentation aid for equipment'],
    '<Description>' = [' '],'<Organization>' = ['Dassault Electronique'],
    '<Country>' = ['France'],'<Prolog system>' = ['Emicat '],
    '<Current Status>' = ['Prototype'],
    '<References>' =
        ['Dassault Electronique report: Les Techniques ',
            'Informatiques avancees et leurs applications. NE 485 352, 30th Apr 1991. ']].
['<Program>' = ['ALTES'],'<Number>' = [446],
    '<Domain>' = ['Mainframe Tuning. '],
    '<Purpose>' =
        [   'Real Time Expert System Diagnosis and Help for tuning Bull/GCOS8/TP8 mainframe.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Stephane Gratepanche.'],
    '<Organization>' = ['GFI / CdFi'],'<Country>' = ['France'],
    '<Prolog system>' = ['PDC Prolog '],'<Other languages>' = ['C, Pascal'],
    '<Lines>' = ['More than 10 thousands.'],
    '<Platform>' = ['80386, 486 / MsDos'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1990'],
    '<No. of Users>' = ['10'],'<Information Date>' = ['March 1992']].
['<Program>' =
    [   'An Automated Legal Reasoning System on Indian Governement\'s Reservation Policy for Scheduled Castes and Scheduled Tribes'],
'<Number>' = [436],'<Domain>' = ['Legal Reasoning. '],
'<Purpose>' =
    [   'Assists in the decision making on various issues related to Reservation Policy for Scheduled Castes and Scheduled Tribes.'],
'<Description>' =
...
'<Developed by>' = ['Srinivas Pavuluri, S.B.Yadavalli,K.K.Bajaj.'],
'<Organization>' =
    [   'National Informatics Centre,Government of India, Lodhi Road, CGO Complex, New Delhi-3,India.'],
'<Country>' = ['India.'],'<Prolog system>' = ['LPA Prolog Professional. '],
'<Other languages>' = ['Nil'],'<Lines>' = ['1000'],'<Predicates>' = ['7'],
'<Platform>' = ['DOS'],'<Type of Use>' = ['Licensed'],
'<Current Status>' = ['Evaluation'],
'<No. of Users>' = ['All Ministries/Departments in Government of India.'],
'<Information Date>' = ['April 16, 1992'],
'<References>' =
    ['Communicated to Second Pacific RIM International ',
        'Conference On AI, Scheduled to be held in Seoul,Korea in September 1992. ']].
['<Program>' = ['APACHE'],'<Number>' = [321],
    '<Domain>' = ['Interactive Scheduling. '],
    '<Purpose>' =
    ...
    '<Country>' = ['France'],'<Prolog system>' = ['CHIP '],
    '<Other languages>' = ['C  X11'],'<Lines>' = ['3000'],
    '<Platform>' =
        ['SUN/HP/IBM/DIGITAL workstations PC  386/486          UNIX    DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Prototype'],
    '<Information Date>' = ['03/92'],
    '<References>' =
...
['<Program>' = ['APEX'],'<Number>' = [440],
    '<Domain>' =
        ['Presentation for prospective customer of modular house. '],
    '<Purpose>' = ['Automatic living-room layout system for modular house.'],
    '<Description>' =
    ...
    '<Developed by>' = ['ISAC, Inc.'],
    '<Organization>' = ['Sekisui Chemical Corporation.'],
    '<Country>' = ['Japan.'],'<Prolog system>' = ['K-Prolog. '],
    '<Other languages>' = ['C (50%)'],'<Lines>' = ['50,000 lines.'],
    '<Predicates>' = ['5,000 predicates.'],
    '<Platform>' = ['SONY NEWS; 4.2/4.3BSD (development / delivery).'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['April 28, 1990'],
    '<No. of Users>' = ['100 persons (at 50 sites).'],
    '<Information Date>' = ['April 15, 1992'],
    '<References>' =
        ['NIKKEI ARTIFICIAL INTELLIGENCE No.105, pp.2-3 May 7, ','1990. ']].
['<Program>' = ['ARCHON'],'<Number>' = "l",
    '<Domain>' = ['Information systems '],
    '<Purpose>' = ['Cooperation in Industrial Systems'],
    '<Description>' = ['Submitted to PAC. Paper 405 '],
    '<Developed by>' = ['Jennings'],'<Country>' = ['UK']].
['<Program>' = ['ARIES'],'<Number>' = [508],'<Domain>' = ['M.I.S. '],
    '<Purpose>' =
        [   'Using Prolog to access relational databases with natural language.'],
    '<Description>' =
        ['Access to computer based MIS is typically gained via pre- ',
            ...
            'computer users. '],
    '<Developed by>' = ['Alan Burton.'],
    '<Organization>' = ['City University.'],'<Country>' = ['U.K.'],
    '<Prolog system>' = ['Quintus Prolog. '],
    '<Other languages>' = ['Keyling Database Interface.'],
    '<Platform>' = ['Del Vax Ivms.'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1990'],
    '<Information Date>' = ['Spring 1992.'],
    '<References>' = ['Burton and Steward-A NLI to Management Information. ']].
['<Program>' = ['ASIGNA'],'<Number>' = ";",
    '<Domain>' = ['Chemical processes scheduling '],
    '<Purpose>' =
        [   'This program is meant to schedule chemical processes sharing resources. It handles disjunctive constraints and large time periods.'],
    '<Description>' =
    ...
    '<Developed by>' = ['David A. Rosenblueth'],
    '<Organization>' = ['IIMAS-UNAM'],'<Country>' = ['Mexico'],
    '<Prolog system>' = ['Arity Prolog '],'<Other languages>' = [none],
    '<Lines>' = ['1900'],'<Predicates>' = ['211'],
    '<Platform>' = ['PC/MSDOS'],'<Type of Use>' = ['Personal'],
    '<Current Status>' = ['Prototype'],'<When Deployed>' = ['5/1992'],
    '<Information Date>' = ['3/1992']].
['<Program>' = ['ASK  (Associative System Kentek)'],'<Number>' = [327],
    '<Domain>' =
        ['Industrial Data Analysis and Management Information Systems. '],
    '<Purpose>' = ['Knowledge retrieval and data analysis.'],
    '<Description>' =
    ...
    '<Developed by>' = ['K. van Goor; R. F. Jansen.'],
    '<Organization>' = ['Kentek Expertise.'],
    '<Country>' = ['The Netherlands.'],
    '<Prolog system>' = ['PDC prolog 3.30 '],
    '<Other languages>' = ['Turbo-C Program shell.'],'<Lines>' = ['25000.'],
    '<Predicates>' = ['1000.'],'<Platform>' = ['Windows 3.1, Ms-dos.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['01/06/92']].
['<Program>' = ['ASTROLIZA / Aastro Brain Base'],'<Number>' = [328],
    '<Domain>' =
        ['Is used in Holland, Belgium, Germany, Austria and Switzerland ',
            ...
            'birth charts. '],
    '<Purpose>' = ['Astrological Expert System.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Ole Eshuis, Amsterdam.'],
    '<Organization>' = ['E.O. Eshuis Astrological Software.'],
    '<Country>' = ['Holland.'],
    '<Prolog system>' =
        ['First developed with Turbo Prolog, now running under PDC ',
            'Prolog 3.30. '],
    '<Other languages>' =
        ['Astro Brain Base uses a calculation module written in Turbo C++.'],
    '<Lines>' = ['2420 lines of source code divided over 5 modules.'],
    '<Predicates>' = ['186 local predicates and 26 global predicates.'],
    '<Platform>' = ['MS DOS 640 KB.'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['Spring 1988.'],
    '<Information Date>' = ['07/08/92.'],
    '<References>' =
        ['In the autumn of 1992 there will be an article on Astro ',
            'Brain Base in the German magazine "Meridian". ']].
['<Program>' = ['ATMI'],'<Number>' = "m",'<Domain>' = ['NL '],
    '<Purpose>' = ['A Natural Language Interface to Management Information'],
    '<Description>' = ['Submitted to PAC. Paper 164 '],
    '<Developed by>' = ['Dr A. P. Steward'],'<Country>' = ['UK'],
    '<Prolog system>' = ['Quintus '],'<Platform>' = ['Vax'],
    '<Information Date>' = ['19/10/91']].
['<Program>' = ['ATR Trainer'],'<Number>' = [213],'<Domain>' = ['Training '],
    '<Purpose>' = ['Authoring language for training'],
    '<Description>' =
    ...
    '<Developed by>' = ['Paul French'],
    '<Organization>' = ['Kingston Polytechnic'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA Prolog professional '],
    '<Platform>' = ['PC AT with 640K'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released']].
['<Program>' = ['AUNT'],'<Number>' = [196],
    '<Domain>' = ['Electronics Design '],
    '<Purpose>' =
        [   'Universal hardware description language translator for electronics design'],
    '<Description>' =
    ...
    '<References>' =
        ['P.B. Reintjes: A VLSI Design Environment in Prolog. ',
            'ICLP5, 1988, pp70-81 ']].
['<Program>' = ['Automatic Porting DNS -> CNS'],'<Number>' = [424],
    '<Domain>' = ['Automatic translating of specific software. '],
    '<Purpose>' =
        [   'It\'s an automatic porting tool enabling the simultaneous manufacture of the DNS and CNS communication software versions.'],
    '<Description>' =
        ['The tool translates intructions for Bull\'s Datanet ','system in ',
    ...
    '<Organization>' = ['Internal work for Bull S.A.'],
    '<Country>' = ['France.'],
    '<Prolog system>' = ['SP-Prolog  (Bull S.A. registered trademark). '],
    '<Lines>' = ['1500'],'<Predicates>' = ['104'],
    '<Platform>' = ['DPX 5000 Ros 4.1'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1988'],
    '<No. of Users>' = ['5'],'<Information Date>' = ['March 1992']].
['<Program>' = ['AUTOPROLOG'],'<Number>' = [262],
    '<Domain>' = ['Legal drafting '],'<Purpose>' = [''],
    '<Description>' =
        ['Generates an expert system for a specific set of rules ',
            'corresponding to an interpretation of a legal statute. '],
    '<Developed by>' = ['Charles S. Saxon, Layman E. Allen'],
    '<Organization>' =
        ['Eastern Michican University, U of Michigan Law School'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Turbo Prolog '],
    '<Platform>' = ['IBM PC'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1987'],
    '<Information Date>' = ['1988'],
    '<References>' =
...
['<Program>' = ['BAMBI'],'<Number>' = "n",
    '<Domain>' = ['Intelligent front end '],
    '<Purpose>' =
        [   'Intelligent aid to submission of several hundred interdependant jobs which update a fares database on a MVS system.'],
    '<Description>' =
    ...
    '<Developed by>' = ['David Barnard'],
    '<Organization>' = ['British Airways'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA Prolog Professional '],
    '<Other languages>' =
        ['Gresham Telecomputing\'s CONNEX software to link to mainframe.'],
    '<Lines>' = ['11000'],'<Predicates>' = ['736'],
    '<Platform>' = ['IBM  PS2 + DOS'],'<When Deployed>' = ['~ June 1990'],
    '<No. of Users>' = ['3'],'<Information Date>' = ['92/9/16'],
    '<References>' =
        ['1.  Proceedings 1st International Conference on the ',
            ...
            'or Sept. ']].
['<Program>' = ['BARBARA THE SYLLOGIZER.'],'<Number>' = [464],
    '<Domain>' = ['Logic exercises in syllogistic (monadic) logic. '],
    ...
    '<Description>' =
        ['BARBARA provides exercises in syllogistic ',
            ...
            'answers. '],
    '<Developed by>' = ['R. G. Wengert'],
    '<Organization>' = ['University of Illinois and IBM.'],
    '<Country>' = ['U.S.A.'],
    '<Prolog system>' = ['Arity Prolog interpreter and compiler. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['924 Lines (goals).'],
    '<Predicates>' = ['112 Predicates.'],
    '<Platform>' = ['IBM PCs and clones, 8088s and up.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['April, 1989.'],
    '<No. of Users>' =
        ['Several hundred at this university, unknown at others.'],
    '<Information Date>' = ['November, 1992.']].
['<Program>' = ['BATEX'],'<Number>' = [295],
    '<Domain>' = ['Building Design '],
    '<Purpose>' =
        [   'It is an expert system which helps to make the preliminary studies for the offices buildings, at the stage of the draft.'],
    '<Description>' =
        ['Batex is an expert system for global design, intended for ',
            ...
            'simulations. '],
    '<Developed by>' = ['Charles MENET - Marc MORO (expert)'],
    '<Organization>' = ['DIALEC'],'<Country>' = ['France'],
    '<Prolog system>' = ['Prolog II + '],
    '<Other languages>' = ['Microsoft C'],'<Lines>' = ['6500'],
    '<Predicates>' = ['315'],'<Platform>' = ['PC 386 - Windows 3 -MS- DOS'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['07/1988'],
    '<No. of Users>' = ['2 (SNCF)_ the french railway company.'],
    '<Information Date>' = ['30/03/92'],
    '<References>' =
        ['Systems Expert No.51-23 March  1992 ( A Jour, publisher - ',
            '11, rue du Marche - St. Homore, 75001, France). ']].
['<Program>' = ['BEACON'],'<Number>' = [202],
    '<Domain>' = ['Computer manufacture '],
    '<Purpose>' = ['Configuration of computer systems'],
    '<Description>' =
    ...
    '<Organization>' = ['Unisys, Paoli Research Center'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Quintus '],
    '<Platform>' = ['Unisys 5000/70']].
['<Program>' = ['BEARING'],'<Number>' = "*",
    '<Domain>' = ['Mechanical Engineering '],
    '<Purpose>' =
        [   'The BEARING program provides a mechanical engineer with computer-aided selection of rolling bearings.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Andres Lomp'],
    '<Organization>' = ['J/V IE Software.'],'<Country>' = ['Estonia'],
    '<Prolog system>' = ['LPA Prolog Professional 3.0. '],
    '<Other languages>' = ['C; dbase III'],
    '<Lines>' = ['40 000 lines in PROLOG'],
    '<Predicates>' = ['150 new predicates'],'<Platform>' = ['IBM PC'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1990'],'<No. of Users>' = ['Mechanical engineers'],
    '<References>' = ['Magazine"Design News" ',' ']].
['<Program>' = ['BinProlog'],'<Number>' = "N",
    '<Domain>' = ['Programming Language Implementation '],
    '<Purpose>' = ['Prolog Compiler'],
    '<Description>' =
    ...
    '<Developed by>' = ['Dr. Paul Tarau'],
    '<Organization>' = ['Universite de Moncton'],'<Country>' = ['Canada'],
    '<Prolog system>' = ['BinProlog 1.24 '],
    '<Other languages>' = ['C (30%)'],'<Lines>' = ['2675'],
    '<Predicates>' = ['242'],
    '<Platform>' = ['sparc,sun3 (SunOs), 386 with go32 DOS-extender'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['10/91'],
    '<No. of Users>' = ['200'],'<Information Date>' = ['Mars 10, 1992'],
    '<References>' =
        ['@inproceedings{Tarau90:PLILP, ',
            'title={{E}lementary {L}ogic {P}rograms}, ',
            'author={Paul Tarau and Michel Boyer}, ','pages={159--173}, ',
            'editor={P. Deransart and J. Ma{\\l}uszy{\\\'n}ski}, ',
            'booktitle={Proceedings of Programming Language Implementation and ',
            'Logic Programming}, ','year=1990, ','month=Aug, ',
            'publisher={Springer}, ',
            'series={Lecture Notes in Computer Science}, ',
            'keywords={Logic Programming}, ','number=456} ',
            '@inproceedings{Tarau91:JAP, ',
            'title={A  Simplified Abstract  Machine for  the Execution of ',
            'Binary  Metaprograms}, ','author={Paul Tarau}, ',
            'pages={119--128}, ',
            'booktitle={Proceedings of the Logic Programming Conference\'91}, ',
            'year=1991, ','month=Sep, ','publisher={ICOT, Tokyo}} ',
            ...
            'Programming}, ','year=1991, ','month=Sep, ',
            'publisher= {Springer}} ']].
['<Program>' = ['Biomarker'],'<Number>' = [426],
    '<Domain>' = ['Geochemistry for Oil Exploration. '],
    '<Purpose>' =
        [   'Expert system to help geochemists determine the depositional environment of a rock or oil sample.'],
    '<Description>' =
        ['This is an expert system designed to help ','geochemists ',
    ...
    '<Developed by>' =
        ['Dave Wolstenholme (Computing), Nigel Goodwin (Geochemistry).'],
    '<Organization>' = ['BP Research.'],'<Country>' = ['UK.'],
    '<Prolog system>' = ['LPA MacProlog. '],'<Lines>' = ['5000'],
    '<Predicates>' = ['252'],'<Platform>' = ['Macintosh II'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['9/90'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['4/92'],
    '<References>' =
        ['Wolstenholme, D.E. and Goodwin, N., ',
            ...
            'EC2, 1991. ']].
['<Program>' = ['BIS/Estimator System'],'<Number>' = "\\",
    '<Domain>' = ['Data Processing management '],'<Purpose>' = [''],
    '<Description>' =
    ...
    '<Prolog system>' = ['LPA Prolog Professional '],
    '<Other languages>' = ['C'],'<Platform>' = ['IBM PC'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released']].
['<Program>' = ['BUP'],'<Number>' = [248],
    '<Domain>' = ['computational linguistics '],
    '<Purpose>' = ['parsing of natural language'],
    '<Description>' =
        ['A bottom-up parser for natural language. ',
            'GALOP was developed from this (see Fuchi, Furukawa, 1986) '],
    '<Developed by>' = ['Y. Matsumoto et al'],'<Organization>' = ['ICOT'],
    '<Country>' = ['Japan'],
    '<References>' =
        ['Y. Matsumoto, H. Tanak, H. Hirakawa, H. Miyoshi, H. ',
            'Yasukawa: BUP A Bottom-up parser embedded in Prolog. New Generation ',
            'Computing. ']].
['<Program>' = ['Bus-guide'],'<Number>' = "o",
    '<Domain>' = ['Transport information '],
    '<Purpose>' =
        ['An interactive information terminal for Public Transport users'],
    '<Description>' = ['Submitted to PAC. Paper 504 '],
    '<Developed by>' = ['Le Dizes'],'<Country>' = ['France'],
    '<Prolog system>' = ['Prolog II '],'<Platform>' = ['"Sun, Mac IICX"'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['BUT'],'<Number>' = "p",'<Domain>' = ['PLAN '],
    '<Purpose>' =
        [   'A Prolog-Based Expert System for Underground Illumination in Coal Mines'],
    '<Description>' = ['Submitted to PAC. Paper 251 '],
    '<Developed by>' = ['Burgard, Luttrinhaus, Plumer'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['LPA Prolog. '],
    '<Platform>' = ['PC MS-DOS'],'<Information Date>' = ['25/10/91']].
['<Program>' = ['CAD tools in electronic engineering'],'<Number>' = [289],
    '<Domain>' = [' '],
    '<Purpose>' =
        [   'To apply logic programming for CAD tools in electronic engineering'],
    '<Description>' =
    ...
    '<Prolog system>' = ['MPROLOG '],'<Information Date>' = ['1984'],
    '<References>' =
...
['<Program>' = ['CAD tools in mechanical engineering'],'<Number>' = [287],
    '<Domain>' = ['CAD '],
    '<Purpose>' =
        ['To provide a set of CAD tools for mechanical engineering'],
    '<Description>' =
        ['The system explores PROLOG for the following ','submodules: ',
    ...
    '<Developed by>' = ['J. Farkas, J.Fileman, A. Markus, Z. Markusz'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984'],
    '<References>' =
        ['J. Farkas, J.Fileman, A. Markus, Z. Markusz (1982) ',
            'Fixture design by PROLOG. ','MICAD-82,Paris,France. ',' ',
            'B.E. Molnar, A. Markus (1981) ',
            'Logic programming in the modelling of machine parts. ',
            'Proc. of Compcontrol\'81, Varna,Bulgaria. ']].
['<Program>' = ['CADRAN'],'<Number>' = [311],'<Domain>' = ['CAD. '],
    '<Purpose>' = ['Transformation of CAD Data.'],
    '<Description>' =
        ['The systems transforms data between different CAD ','systems. ',
    ...
    '<Developed by>' = ['Dr.  Uwe Crenze.'],
    '<Organization>' = ['Interface Computer GmbH.'],
    '<Country>' = ['Germany.'],'<Prolog system>' = ['IF/PROLOG. '],
    '<Other languages>' = ['FORTRAN.'],'<Platform>' = ['DEC 3100'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/90'],'<No. of Users>' = ['5'],
    '<Information Date>' = ['14/02/92'],
    '<References>' =
        ['Wissensbasierter Datenaustausch zwischen CAD- ',
            'Systemen CIM 5/92. ','R. Oldenbourg Verlag, Munich. ']].
['<Program>' = ['Calculation of Physico-chemical Parameters'],
    '<Number>' = [275],'<Domain>' = ['Pharmaceutical industry '],
    '<Purpose>' =
        [   'To calculate the physico-chemical parameters for drug design purposes'],
    '<Description>' =
...
['<Program>' = ['CAPS - Computer Aided process Scheduling'],
    '<Number>' = [24],'<Domain>' = ['Intelligent Databases '],
    '<Purpose>' = ['Shop Floor planning; scheduling and monitoring'],
    '<Description>' =
    ...
    '<Developed by>' = ['Kim Thorshoej; Lars Henrik Jacobsen'],
    '<Organization>' = ['Prolog Development Center'],
    '<Country>' = ['Denmark'],'<Prolog system>' = ['PDC Prolog '],
    '<Lines>' = ['>10.000  <100.000'],'<Platform>' = ['OS/2 PM'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['09/91'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['01/92']].
['<Program>' = ['CAPTAINS'],'<Number>' = [476],'<Domain>' = ['Scheduling. '],
    '<Purpose>' = ['Pilot scheduling for airlines.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Large team effort.'],
    '<Organization>' = ['Syllogic.'],'<Country>' = ['Netherlands.'],
    '<Prolog system>' = ['BIM Prolog (OEMed by IBM). '],
    '<Other languages>' =
        [   'SQL (Oracle), Xwindows + motif, Syllogic Knowledge Sheet, C, Operations Research Lib.'],
    '<Lines>' = ['110.000'],'<Predicates>' = ['4.500'],
    '<Platform>' = ['IBM RISC System 6000.'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Released'],
    '<When Deployed>' = ['September 1992.'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['25 november 1992.']].
['<Program>' = ['CARE-X25 (version included in RETAT)'],'<Number>' = [512],
    '<Domain>' = ['Telecom Network Design & Planning. '],
    '<Purpose>' =
        [   'Propose minimal cost equipments for nodes and links an X25 private network according to X25 needs and engineering constraints.'],
    '<Description>' =
        ['A network study with CARE-X25 (included in RETAT ','tool) to: ',
    ...
    '<Developed by>' = ['H. FREI'],'<Organization>' = ['H. FREI'],
    '<Country>' = ['France.'],'<Prolog system>' = ['Prolog II+-Prolog 1A '],
    '<Lines>' = ['9400'],'<Predicates>' = ['680'],
    '<Platform>' = ['MacOS-Syst7 on MacII (68030) Windows 3.1 on PC-386'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['5/91'],'<No. of Users>' = ['50'],
    '<Information Date>' = ['2/93'],
    '<References>' =
...
['<Program>' =
    [   'CAS/FPS - Computer-Aided  Synthesis  of  Flexible Production Scheduling.'],
'<Number>' = [488],
'<Domain>' =
    ['Production Planning  and  Scheduling  of  Multiproduct  (Batch) ',
        'Plants. '],
'<Purpose>' =
    [   'Multicriteria  design  and  control  of  flexible multiproduct (batch) plants by computer-aided synthesis of the production plans and schedules from the possible building elements.'],
'<Description>' =
    ['In the traditional methods of  synthesizing  the ','multicriteria ',
...
'<Developed by>' =
    ['Bela Csukas, Zoltan Kozar, Rozalia Lakner, Gabor Wittinger'],
'<Organization>' =
    [   'University  of  Veszprem,  supported  by  the  Hungarian Basic Research Grant N OTKA-2550.'],
'<Country>' = ['Hungary.'],
'<Prolog system>' = ['TURBOPROLOG 2.0 ; PDC PROLOG 3.31 '],
'<Other languages>' =
    ['Can also be implemented in object oriented languages.'],
'<Lines>' = ['4000'],'<Predicates>' = ['500'],'<Platform>' = ['PC/AT 386'],
'<Current Status>' = ['Evaluation'],'<When Deployed>' = ['12/1989'],
'<No. of Users>' = ['20'],'<Information Date>' = ['12/1993'],
'<References>' =
    ['Csukas B., Kozar Z., Arva P.:  Multicriteria ','Evaluated  PROLOG ',
...
['<Program>' = ['CASEy'],'<Number>' = "R",
    '<Domain>' = ['expert system, manufacturing '],
    '<Purpose>' =
        [   'Expert System that guides shop floor personnel in the correct usage of electrical process specifications.'],
    '<Description>' =
    ...
    '<Developed by>' =
        [   'Bill McClay, G. Craig Johnson, R. Howard Mitchell, Dennis Hegedus, Michael Easter, Steve Miller, Max Robinson'],
    '<Organization>' = ['Boeing Computer Services'],'<Country>' = ['USA'],
    '<Prolog system>' = ['Quintus 3.1 '],
    '<Other languages>' = ['1,000 lines of C'],
    '<Lines>' = ['104,000 lines of Prolog'],
    '<Predicates>' = ['approximately 25,000'],
    '<Platform>' = ['Sun 4, VAX, RS6000'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['November 1986'],
    '<No. of Users>' = ['Shop floor personnel'],
    '<Information Date>' = ['March 18, 1992'],
    '<References>' =
...
['<Program>' = ['Cast Component'],'<Number>' = [210],
    '<Domain>' = ['Manufacturing design '],
    '<Purpose>' =
        [   'Optimise component design time in motor industry and check casting'],
    '<Description>' =
    ...
    '<Prolog system>' = ['Delphia '],
    '<Other languages>' = ['13,000 lines C'],'<Lines>' = ['12,000'],
    '<Platform>' = ['work station']].
['<Program>' = ['CAT2'],'<Number>' = [452],
    '<Domain>' =
        ['Fully automatic translation of informative texts; ',
            ...
            'texts. '],
    '<Purpose>' = ['Multilingual machine translation.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Randall Sharp.'],
    '<Organization>' = ['IAI (Institute for Applied Informatics).'],
    '<Country>' = ['Germany.'],'<Prolog system>' = ['SICStus 2.1 '],
    '<Lines>' = ['Approximate number of lines of Prolog.'],
    '<Predicates>' = ['350'],
    '<Platform>' = ['UNIX; system has been developed on SUN Workstations.'],
    '<Current Status>' = ['Prototype'],
    '<Information Date>' = ['October 26, 1992.'],
    '<References>' =
...
['<Program>' = ['CATS/DIANA'],'<Number>' = [230],
    '<Domain>' = ['Electronic diagnosis '],
    '<Purpose>' = ['diagnosis of analog electronic circuits'],
    '<Description>' =
    ...
    '<Country>' = ['France'],'<Prolog system>' = ['IBM Prolog and IPW '],
    '<Platform>' = ['370, OS/2'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation']].
['<Program>' =
    [   'CELLBUILDER.  It comprises several programs, the main one of which (and the only one using Prolog) was called cellmapper.'],
'<Number>' = [482],'<Domain>' = ['Communications '],
'<Purpose>' =
    [   'To generate optimal cell layouts for the cell library of the Crosspoint CP20K family of field-programmable gate arrays (FPGAs), starting from a transistor- or gate-level schematic.'],
'<Description>' = ['Of me, or the program? '],
'<Developed by>' =
    [   'Howard A. Landman One translator program was written by John McDonald.'],
'<Organization>' =
    [   'At time of program development: Crosspoint Solutions, Inc. Currently: HaL Computer Systems, Inc.'],
'<Country>' = ['USA'],
'<Prolog system>' =
    ['Initial feasibility testing was done using public domain ',
        ...
        '\307IF*** The text replacing this argument is too long ***\310<Other ',
        'languages>\tSomewhat over half the system was written in Perl.  The ',
        ...
        'munging, text ','formatting, error handling, etc. ',' ',
...
'<Lines>' =
    [   'A couple thousand each of hand-coded Perl and Prolog, plus a fair amount of Prolog "facts" which were generated automatically by Perl scripts from various databases.'],
'<Predicates>' =
    [   'A reasonably complete description of the system is available inside Crosspoint, but unfortunately it is proprietary at the moment.  I may try to write this up for publication soon.'],
'<Platform>' = ['SPARC + Sunos.'],'<Type of Use>' = [''],
'<When Deployed>' =
    [   'First prototype, June or July 1991. Replaced human cell designer, August 1991 First customer ship of cell library built with system, February 1992'],
'<No. of Users>' =
    [   'The author, and other members of Crosspoint\'s Design Technology group.']].
['<Program>' = ['Chemical Information System'],'<Number>' = [272],
    '<Domain>' = ['Chemistry '],
    '<Purpose>' = ['Provide logic based tools for the chemical domain'],
    '<Description>' =
    ...
    '<Developed by>' =
        ['F. Darvas, I. Futo, J.Szeredi,  J. Redei, J. Bendl, P. Koves.'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984'],
    '<References>' =
        ['F. Darvas, I. Futo, J.Szeredi, J. Bendl, P. Koves ','(1978) ',
...
['<Program>' = ['Chemical resource allocation'],'<Number>' = [257],
    '<Domain>' = ['Manufacturing planning '],
    '<Purpose>' = ['resource allocation in chemical plants'],
    '<Description>' =
    ...
    '<Developed by>' = ['David A. Rosenblueth'],
    '<Organization>' = ['IIMAS ?'],'<Country>' = ['Mexico'],
    '<References>' =
...
['<Program>' = ['ChemiSafe'],'<Number>' = [23],
    '<Domain>' = ['Intelligent Databases '],
    '<Purpose>' = ['Handling of directions for use for hazardous chemicals'],
    '<Description>' =
    ...
    '<Developed by>' = ['Henrik Zangenberg'],
    '<Organization>' = ['Prolog Development Center'],
    '<Country>' = ['Denmark'],'<Prolog system>' = ['PDC Prolog '],
    '<Lines>' = ['10.000  <100.000??'],'<Platform>' = ['DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['05/88'],'<No. of Users>' = ['100'],
    '<Information Date>' = ['01/92']].
['<Program>' = ['CK Expert Modeller'],'<Number>' = [186],
    '<Domain>' = ['Design '],
    '<Purpose>' =
        [   'To interpret and manipulate data from the CK cognitive Modeller system'],
    '<Description>' = [' '],'<Developed by>' = ['Rodney Myers'],
    '<Organization>' = ['Hodgson Myers Associates'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA Prolog Professional '],
    '<Platform>' = ['IBM PC'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released']].
['<Program>' = ['CLARE/CLE'],'<Number>' = [360],
    '<Domain>' = ['Natural Language Processing, particularly interactive. '],
    '<Purpose>' =
        [   'A research system for the interactive analysis and generation of natural language.'],
    '<Description>' = ['contact SRI for further details. '],
    '<Developed by>' = ['Researchers at SRI International Cambridge.'],
    '<Organization>' = ['SRI International, DTI, BP, BP and DRA.'],
    '<Country>' = ['UK.'],'<Prolog system>' = ['Quintus 3.1, 2.5. '],
    '<Other languages>' = ['C (< 1%).'],'<Lines>' = ['100,000.'],
    '<Predicates>' = ['5000.'],'<Platform>' = ['Sun and other.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['6/1991'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['4/1992'],
    '<References>' =
        ['Alshawi, H. (ed.) "The Core Language Engine", MIT ','Press, ',
            'Cambridge, Mass. 1992. ']].
['<Program>' = ['CLIENT RISK MANAGEMENT'],'<Number>' = [389],
    '<Domain>' =
        ['Risk handling in Bank front office, middle office and central ',
            'office. '],
    '<Purpose>' =
        [   'Minimize risk in Day-to-Day operations with client companies in banking institution.'],
    '<Description>' =
        ['Expert system for global treatment of risk under ',
            'development for Banc Sabadell. '],
    '<Developed by>' = ['Xavier Fustero, Xavier Orteu.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain'],
    '<Prolog system>' = ['PDC Prolog 3.31 for Windows. '],
    '<Other languages>' = ['C'],'<Lines>' = ['unknown.'],
    '<Predicates>' = ['unknown.'],
    '<Platform>' =
        ['Developed PC 386 / MS DOS Delivery PC 386 / MS DOS and Windows'],
    '<Type of Use>' = ['Sold Product'],'<Information Date>' = ['07/92']].
['<Program>' = ['CLINT'],'<Number>' = "q",'<Domain>' = ['Learning '],
    '<Purpose>' =
        ['An Overview of the Interactive concept-Learner Theory Revisor'],
    '<Description>' = ['Submitted to PAC. Paper 375 '],
    '<Developed by>' = ['Raedt, and Bruynooghe'],'<Country>' = ['Belgium'],
    '<Prolog system>' = ['LPA MacProlog '],
    '<Platform>' = ['Apple Macintosh II'],'<Information Date>' = ['6/11/91']].
['<Program>' = ['Cobol Program Generator'],'<Number>' = [279],
    '<Domain>' = ['Software applications '],
    '<Purpose>' = ['To generate Cobol Programs for data processing'],
    '<Description>' =
        ['The system generates Cobol Programs according to ',
            'the standards of SZKI. The generated programs solve data processing ',
            'problems of the following types: ','-listing data files ',
            '-data maintenance ','-merging two data files ',
    ...
    '<References>' =
        ['I. Futo, J.Szeredi, J. Redei (1979) ',
            ...
            'User\'s manual. ','SzKI report, 1979. ']].
['<Program>' = ['COMANDOS'],'<Number>' = "r",'<Domain>' = ['OO '],
    '<Purpose>' = ['A Prolog Object Oriented Persistent Environment'],
    '<Description>' = ['Submitted to PAC. Paper 244 '],
    '<Developed by>' = ['A. El Habbash et al'],'<Country>' = ['Ireland'],
    '<Prolog system>' = ['C-Prolog '],'<Information Date>' = ['25/10/91']].
['<Program>' = ['COMBAT'],'<Number>' = [319],'<Domain>' = ['Simulation. '],
    '<Purpose>' = ['Simulation of a ground-air battle.'],
    '<Description>' =
    ...
    '<Developed by>' = ['COSYTEC'],
    '<Organization>' = ['CLP Software and Services.'],
    '<Country>' = ['France'],'<Other languages>' = ['C  X11'],
    '<Platform>' =
        ['SUN/HP/IBM/DIGITAL workstations PC  386/486       UNIX   DOS'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['12/91'],'<Information Date>' = ['03/92'],
    '<References>' =
        ['M. Dincbas, P. VAn Hentenryck, H. Simonis, A. ',
            'Aggoun, T. Graf, F. Berthier, The Constraint Logic Programming ',
            'Language CHIP. ',
            'In Proc. of The Int. Conf. on Fifth Generation Computer Systems, p693-702. ',
            'Tokyo, Japan, November 1988. ']].
['<Program>' = ['COMMUNAL'],'<Number>' = "s",'<Domain>' = [' '],
    '<Purpose>' = ['The COMMUNAL Project'],
    '<Description>' = ['Submitted to PAC. Paper 82 '],
    '<Developed by>' = ['Tim F O\'Donoghue']].
['<Program>' = ['Conceptual Graph Editor (CGE)'],'<Number>' = [417],
    ...
    '<Description>' =
        ['CGE is a graphical interface to the Conceptual ',
            ...
            'object"). '],
    '<Developed by>' = ['Michel Wermelinger.'],
    '<Organization>' = ['AI Centre/UNINOVA.'],'<Country>' = ['Portugal.'],
    '<Prolog system>' = ['Quintus X Prolog 2.4 '],
    '<Other languages>' =
        ['C (used to program the Graph Widget and X Prolog).'],
    '<Lines>' = ['1700 (not including CGT code).'],'<Predicates>' = ['106'],
    '<Platform>' = ['VAX, Ultrix 3.1'],'<Type of Use>' = ['Personal'],
    '<Current Status>' = ['Prototype'],'<When Deployed>' = ['February 1991'],
    '<No. of Users>' = ['1'],'<Information Date>' = ['February 1992'],
    '<References>' =
        ['Salvador Abreu ','ALPES X-Prolog Programming Manual, ',
            ...
            'see also CGT entry ']].
['<Program>' = ['Conceptual Graph Tools (CGT)'],'<Number>' = [416],
    '<Domain>' = ['Knowledge Representation. '],
    '<Purpose>' =
        [   'to have a partial implementation of Sowa\'s Conceptual Structures.'],
    '<Description>' =
        ['As Sowa puts it, Conceptual Structures "are a ','system of ',
    ...
    '<Lines>' = ['3679 (including comments;'],'<Predicates>' = ['193'],
    '<Platform>' =
        [   'VAX, Ultrix 3.1 (or any other having a fairly "standard" Prolog system)'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['February 1991'],'<No. of Users>' = ['1'],
    '<Information Date>' = ['February 1992'],
    '<References>' =
        ['John F. Sowa, ',
            ...
            'November 1991. ']].
['<Program>' = ['CONSULT'],'<Number>' = "t",'<Domain>' = ['CAD '],
    '<Purpose>' =
        ['Object-Oriented Interactive CAD/CAM Programming in Prolog'],
    '<Description>' = ['Submitted to PAC. Paper 502 '],
    '<Developed by>' = ['Jarmo T Alander'],'<Country>' = ['Finland'],
    '<Prolog system>' = ['Turbo '],'<Platform>' = ['PC'],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['Contralto'],'<Number>' = "u",'<Domain>' = ['Transport '],
    '<Purpose>' =
        [   'Constraint Reasoning applied to Logistics of Transport Organisations'],
    '<Description>' = ['Submitted to PAC. Paper 503 '],
    '<Developed by>' = ['Le Dizes'],'<Country>' = ['France'],
    '<Prolog system>' = ['Prolog III '],'<Information Date>' = ['6/11/91']].
['<Program>' = ['CONTRALTO'],'<Number>' = [172],
    '<Domain>' = ['Transport planning '],
    '<Purpose>' =
        [   'To help freight transporters find a solution which best matches demand and usage constraints'],
    '<Description>' =
    ...
    '<Developed by>' = ['C. Guimaraes, J-M Le Dizes'],
    '<Organization>' = ['Cete-M\216diterran\216e'],'<Country>' = ['France'],
    '<Prolog system>' = ['Prolog III '],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation']].
['<Program>' = ['Coronary Network reconstruction'],'<Number>' = [237],
    '<Domain>' = ['Medical investigation '],
    '<Purpose>' =
        [   '3-D reconstruction and labelling of coronary networks from X- ray projections'],
    '<Description>' =
    ...
    '<Developed by>' =
        ['M. Garreau, C. Chardenon, A. Roug\216e, J.L. Coatrieux'],
    '<Organization>' = ['General Electric, University of ?'],
    '<Country>' = ['France'],'<Prolog system>' = ['Prolog by BIM '],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype']].
['<Program>' = ['COTORRA'],'<Number>' = [383],
    '<Domain>' = ['Train dispatching. '],
    '<Purpose>' =
        [   'Assistance for the operator in charge of trains line information in order to improve the service quality.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Xavier Orteu and programmers team.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain'],
    '<Prolog system>' = ['PDC Prolog 3.3 for Windows. '],
    '<Other languages>' = ['C'],'<Lines>' = ['5205'],
    '<Predicates>' = ['150'],
    '<Platform>' =
        ['Developed PC 386 / MS DOS Delivery PC 386 /MS DOS and WIndows'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['8/92'],'<Information Date>' = ['07/1992']].
['<Program>' = ['CPE'],'<Number>' = ")",
    '<Domain>' =
        ['Knowledge Based Programming ','Automation of Programming ',
            'Engineering Problems '],
    '<Purpose>' =
        [   'CPE is a knowledge programming environment. It supports different programming styles: logic programming; constraint programming; object-oriented programming; database programming; etc.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Andres Lomp'],
    '<Organization>' =
        [   'J/V IE Software joint venture between the Institute of Cybernetics (Estonia) and the TIW Systems (USA)'],
    '<Country>' = ['Estonia'],
    '<Prolog system>' = ['LPA Prolog Professional 3.0. '],
    '<Other languages>' = ['C'],'<Lines>' = ['15000 lines in PROLOG'],
    '<Predicates>' = ['150 new predicates'],
    '<Platform>' = ['IBM PC; MS DOS'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['02.04.1990'],
    '<References>' =
...
['<Program>' = ['CPLAN'],'<Number>' = [317],'<Domain>' = ['Planning. '],
    ...
    '<Organization>' = ['CLP Software and Services.'],
    '<Country>' = ['France.'],'<Prolog system>' = ['CHIP '],
    '<Other languages>' = ['C  X11'],'<Lines>' = ['2000'],
    '<Platform>' =
        ['SUN/HP/IBM/DIGITAL workstations PC  386/486          UNIX    DOS'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['01/92'],'<No. of Users>' = ['2'],
    '<Information Date>' = ['03/92'],
    '<References>' =
        ['M. Dincbas, P. Van Hentenryck, H. Simonis, A. ',
            'Aggoun, T. Graf, F. Berthier, The Constraint Logic Programming ',
            ...
            'In Proc.  of The Int. Conf. on Fifth Generation Computer Systems, p693-702. ',
            'Tokyo, November 1989. ']].
['<Program>' = ['CPPRO'],'<Number>' = [478],
    '<Domain>' =
        ['Test Engineering - diagnosis and repair recommendation of ',
            'faulty PBX circuit boards. '],
    '<Purpose>' = ['Circuit Board Diagnostic Troubleshooter Tool.'],
    '<Description>' =
        ['CPPRO allows a circuit board test engineer to ','graphically ',
    ...
    '<Developed by>' =
        [   'Dan M. Wages, Russell G. Bulsis, Kevin B. Tanguay, Kent D. Fishman'],
    '<Organization>' = ['AT&T - Denver Works, Denver, Colorado.'],
    '<Country>' = ['U.S.A.'],
    '<Prolog system>' = ['Quintus Prolog Release 3.1.1 '],
    '<Other languages>' = ['Quintus ProWindows 1.2 - SunView Version.'],
    '<Lines>' = ['10000'],'<Predicates>' = ['1000'],
    '<Platform>' = ['Sun SPARCstation 1+ running SunOS 4.1.1'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['9/90'],'<No. of Users>' = ['5'],
    '<Information Date>' = ['11/25/92']].
['<Program>' = ['CVE'],'<Number>' = [203],'<Domain>' = ['Digital design '],
    '<Purpose>' = ['A tool for symbolic verification of digital circuits'],
    '<Description>' =
    ...
    '<Developed by>' = ['R Schmid, E. Tid\216n'],'<Country>' = ['Germany'],
    '<Prolog system>' = ['SNI (Siemens) '],'<Other languages>' = ['C'],
    '<Platform>' = ['SICOMP WS30 workstation under SR 10'],
    '<References>' =
        ['R. Schmid, E. Tid\216n. Verifying ASICs by Symbolic ',
            'simulation. in European ASIC 90 Conference proceedings, IEEE order no. ',
            '2066. Paris 1990. ']].
['<Program>' = ['D- PROLOG'],'<Number>' = [298],'<Domain>' = [' '],
    '<Purpose>' = ['Prolog interpreter with Edinburgh syntax'],
    '<Description>' =
        ['D-Prolog is a prolog interpreter with Edinburgh syntax ',
            ...
            'Clos and Prolog. '],
    '<Developed by>' = ['Delphi S.p.A.'],
    '<Organization>' = ['Delphi S.p.A.'],'<Country>' = ['Italy'],
    '<Other languages>' = ['C/CL/CLOS'],
    '<Platform>' = ['Sun with Sundos 4.x PC 386/486 with SCO/ODT 1.0'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1/1/91'],'<No. of Users>' = ['80'],
    '<Information Date>' = ['02/12/91'],
    '<References>' = ['Article by Messrs. Saracco & Gaspari ']].
['<Program>' = ['DACH (Datenverarbeitung am Computer zu Hause)'],
    '<Number>' = [470],'<Domain>' = ['Training '],
    '<Purpose>' =
        ['Tutorial for office communication and long distance training.'],
    '<Description>' = [' '],
    '<Developed by>' = ['Dr Hans Juergen Schlaesser.'],
    '<Organization>' = ['German Ministry of Education and Science.'],
    '<Country>' = ['Germany.'],
    '<Prolog system>' = ['PDC Prolog 3.3 (Windows). '],
    '<Other languages>' = ['C'],'<Lines>' = ['10.000'],
    '<Platform>' = ['80286, MSDOS 4.0'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Evaluation'],'<Information Date>' = ['8/92']].
['<Program>' = ['DAMOCLES - Damage Monitoring and Control Expert System.'],
    '<Number>' = [329],
    '<Domain>' = ['Damage control, fire-fighting, stability and buoyancy. '],
    '<Purpose>' =
        [   'Damocles is supposed to aid a damage control officer aboard a Standard frigate of the Royal Netherlands Navy.'],
    '<Description>' =
        ['TNO Physics and Electronics Laboratory, in collaboration ',
            ...
            'and planning. '],
    '<Developed by>' =
        [   'Command and Control Group of the TNO Physics and Electronics Laboratory.'],
    '<Organization>' = ['Sponsored by the Royal Netherlands Navy.'],
    '<Country>' = ['The Netherlands.'],
    '<Prolog system>' = ['Quintus Prolog 3.1, Quintus ProWINDOWS 1.2 '],
    '<Other languages>' = ['None.'],'<Lines>' = ['68,997'],
    '<Predicates>' = ['2,069'],'<Platform>' = ['Sun'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['1988'],'<Information Date>' = ['07/92'],
    '<References>' =
...
['<Program>' = ['DART'],'<Number>' = [7],
    '<Domain>' = ['Analysis of concurrent programs '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['P. Rondogiannis and M.H.M. Cheng'],
    '<Organization>' = ['University of Victoria'],'<Country>' = ['Canada'],
    '<Prolog system>' = ['ALS-Prolog; version 1.01. '],'<Lines>' = ['1080'],
    '<Predicates>' = ['140'],
    '<Platform>' = ['Sun3/280S; SunOS Unix; release 4.1.1'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['July 1991'],
    '<No. of Users>' =
        ['2 (Has also been requested by another research institution).'],
    '<Information Date>' = ['October 25; 1991'],
    '<References>' =
        ['P. Rondogiannis and M.H.M. Cheng; "Using Petri net ','reduction ',
...
['<Program>' = ['DAS'],'<Number>' = [224],
    '<Domain>' = ['Financial  statistics '],
    '<Purpose>' = ['Performing statical analysis of financial information'],
    '<Description>' =
    ...
    '<Organization>' = ['O\'Connor Associates, Chicago'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Prolog by BIM '],
    '<Other languages>' =
        [   'C, C++, Fortran maths libraries, S statistical package, Sybase, graphics package and spreadsheets']].
['<Program>' = ['Data flow in Parlog'],'<Number>' = [218],
    '<Domain>' = ['Systems design '],
    '<Purpose>' =
        [   'To model and animate dataflow diagrams to produce a prototype system'],
    '<Description>' =
    ...
    '<Developed by>' = ['Kevin Steer'],
    '<Organization>' = ['Artificial Intelligence Ltd (now Strand?)'],
    '<Country>' = ['UK'],'<Prolog system>' = ['Parlog '],
    '<Platform>' = ['Unix'],'<Type of Use>' = ['Personal'],
    '<Current Status>' = ['Prototype'],
    '<References>' =
        ['K. Steer: Testing Data Flow diagrams with Parlog. ICLP5, ',
            '1988, pp96-110. ']].
['<Program>' = ['DATIN'],'<Number>' = [471],'<Domain>' = [' '],
    '<Purpose>' =
        [   'Social scientific dataretrieval. Instead of filling data into questionaeres it can be done direstly into the computer.'],
    '<Description>' =
        ['The program can be used in any area where a person ','is filing ',
    ...
    '<Prolog system>' = ['PDC Prolog (formaerly Turbo Prolog 2.0). '],
    '<Lines>' = ['1400.'],'<Predicates>' = ['150.'],
    '<Platform>' = ['MS-DOS.'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['August 1989.'],
    '<Information Date>' = ['August 1992.']].
['<Program>' = ['DBKUNDAR'],'<Number>' = [352],
    '<Domain>' = ['Customer support and follow-up, for sales people. '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['Sigve B_'],'<Organization>' = ['SigveSaker'],
    '<Country>' = ['Norway.'],
    '<Prolog system>' =
        ['Turbo Prolog 2.0 / PDC Prolog 3.21 + PDC Toolbox. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['700'],
    '<Predicates>' = ['16'],'<Platform>' = ['MS-DOS.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['12/90'],'<Information Date>' = ['12/08/92']].
['<Program>' = ['DECIBAC'],'<Number>' = [181],
    '<Domain>' = ['Expert systems '],
    '<Purpose>' = ['A hybrid expert system tool'],
    '<Description>' =
    ...
    '<Country>' = ['France'],
    '<Other languages>' = ['C, Assembler (including user modules)'],
    '<Platform>' = ['PC with MS-DOS and Unix SCO, soon OS/2']].
['<Program>' = ['Declarative graphics'],'<Number>' = [246],
    ...
    '<Description>' =
        ['A set of tools a programming environment for ',
            ...
            'program animation. '],
    '<Developed by>' = ['Richard Helm, Kim Marriott'],
    '<Organization>' = ['Univ. of Melbourne, Dept Computer Science'],
    '<Country>' = ['Australia'],'<Prolog system>' = ['MU-Prolog '],
    '<References>' =
        ['Richard Helm, Kim Marriott: Declarative Graphics. ICLP3, ',
            '1986. pp513-527 ']].
['<Program>' = ['DedChem'],'<Number>' = "T",
    ...
    '<Developed by>' = ['Christoph Draxler (1) Roland Kunz (2)'],
    '<Organization>' =
        [   '(1) Centre fuer Information- and Speechprocessing Ludwig-Maximilians-University Munich Leopoldstr. 139 D 8000 Munich (2) Organic Chemistry Institute University of Zurich Winterthurerstr. 190 CH 8057 Zurich'],
    '<Country>' = ['(1) Germany (2) Switzerland'],
    '<Prolog system>' = ['LPA MacProlog 3.5 '],
    '<Other languages>' =
        [   'Database access languages: SQL and proprietary database languages'],
    '<Lines>' =
        ['approx. 2000 lines incl. empty lines, one literal per line'],
    '<Predicates>' =
        [   'Database            20 User Interface      49 Synthesis Planning   7 Auxiliary            8 --- Total               84'],
    '<Platform>' = ['Macintosh 1 MB minimum'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['Oct 91'],
    '<No. of Users>' =
        [   'prototype versions delivered to Organic Chemistry Institute Zurich (Kunz) Polytechnic of North London        (Solomonides) University of California San Diego (Wibke) Technical University of Vienna     (Gottlob)'],
    '<References>' =
...
['<Program>' =
    ['DEFINE BENEFIT STRUCTURE/MODULE of PENSION  FUND VALUATION PROGRAM'],
'<Number>' = [325],'<Domain>' = ['Pension Fund Variation. '],
'<Purpose>' = ['Selection and Definition of Pension Benefits.'],
'<Description>' =
...
'<Developed by>' = ['Gavan Duffy, Andrew Collins, Andrew Langdon.'],
'<Organization>' = ['Bacon and Woudrow.'],'<Country>' = ['U.K.'],
'<Prolog system>' = ['Interface Prolog  (IF) '],
'<Other languages>' =
    [   'Informix 46L   50% \'C\'                      25% UNIX                   1%'],
'<Lines>' = ['50,000'],'<Predicates>' = ['2200'],
'<Platform>' = ['Howlett Packard Unix Box'],'<Type of Use>' = ['In-house'],
'<Current Status>' = ['Released'],'<When Deployed>' = ['Not yet/ 07/92'],
'<No. of Users>' = ['30'],'<Information Date>' = ['23/04/92']].
['<Program>' = ['DELBOLISM'],'<Number>' = [282],
    '<Domain>' = ['Computer architecture design '],
    '<Purpose>' = ['Evaluates and tests  high level architectures'],
    '<Description>' =
    ...
    '<References>' =
        ['V. Kiss and G. Simor (1979) ',
            ...
            'architectures -DELBOLISM. ','SzKI report, 1979. ']].
['<Program>' = ['DES'],'<Number>' = [200],
    '<Domain>' = ['Electronic manufacture '],
    '<Purpose>' =
        [   'Diagnostic system to provide early detection of errors in integrated circuits'],
    '<Description>' =
    ...
    '<Prolog system>' = ['Quintus '],'<Other languages>' = ['ProWindows'],
    '<Platform>' = ['Unix workstation'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation'],
    '<References>' =
...
['<Program>' = ['DESA - Desassembler of VSLI circuits'],'<Number>' = [418],
    '<Domain>' = ['CAD of VLSI circuits. '],
    '<Purpose>' =
        [   'Structural abstraction of VLSI.  This circuit desassembler is fully written in prolog  and  it  is part  of  a set of programs that perform the abstraction and the verification of the VLSI circuits.'],
    '<Description>' =
    ...
    '<Developed by>' = ['J.B.Guignet.'],'<Organization>' = ['BULL S.A.'],
    '<Country>' = ['France'],'<Prolog system>' = ['SP-PROLOG '],
    '<Other languages>' = ['C language (5000 lines).'],
    '<Lines>' = ['17000  lines well documented.'],'<Predicates>' = ['5000.'],
    '<Platform>' = ['SUN3,SUN4 and all BULL UNIX platforms.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1986'],
    '<No. of Users>' = ['more than 30 person in 2 Internal projects'],
    '<Information Date>' = ['26/03/92'],
    '<References>' =
        ['AFCET : "Les Utilisations Industrielles du Langage ','Prolog" ',
            'PARIS FRANCE - 5 Apr 90 ',
            'EDAC : "The European Conference on Design Automation" ',
            'BRUSSELS BELGIUM - 19 March 92 ']].
['<Program>' = ['DESBAT'],'<Number>' = [175],
    '<Domain>' = ['Architectural design '],
    '<Purpose>' = ['Architectural design system'],'<Description>' = [' '],
    '<Developed by>' = ['J. Autran, M. Florenzano'],
    '<Organization>' = ['Minist\217re de l"Equipment et du Logement'],
    '<Country>' = ['France'],'<Prolog system>' = ['Prolog II '],
    '<Other languages>' = ['VERSO database developed by INRIA'],
    '<Platform>' =
        [   'Macintosh Plus, II, Unix \307IF*** The text replacing this argument is too long ***\310<References>\tJ. Autran, M. Florenzano, N. Khayat-Mellah, J. le Maitre, C. Palisser. Realisation du prototype d\'un syst\217me d\'aide \210 la gestion de donn\216es pour l\'architecture et le b\211timent. DESBAT - Application \210 la r\216daction du devis descriptif de b\211timent. Rapport final de recherce GAMSAU - IN.PRO.BAT, Juillet 1988']].
['<Program>' = ['Detect5.pro'],'<Number>' = "6",
    '<Domain>' = ['Natural language processing '],
    '<Purpose>' = ['Didactic tool for second-language teaching'],
    '<Description>' =
    ...
    '<Developed by>' = ['Andr\216 Linden'],
    '<Organization>' = ['University of Geneva, Faculty of Humanities'],
    '<Country>' = ['Switzerland'],
    '<Prolog system>' = ['PDC Prolog (version 3.21) and SICstus Prolog '],
    '<Lines>' = ['1000'],'<Predicates>' = ['80'],
    '<Platform>' = ['AST 386SX and 286 PC under DOS 5.0'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['7/91'],'<Information Date>' = ['2/92']].
['<Program>' = ['DFT Spectral Analysis.'],'<Number>' = [467],
    '<Domain>' = ['Digital Signal Processing Analysis and Simulation. '],
    '<Purpose>' = ['Compute Power Spectral Density of Complex Sequences.'],
    '<Description>' =
        ['This program demonstrates the utility and ','expressive power ',
    ...
    '<Developed by>' = ['Sam M. Daniel.'],'<Organization>' = ['Motorola.'],
    '<Country>' = ['U.S.A.'],'<Prolog system>' = ['ALS Prolog. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['200.'],
    '<Predicates>' = ['40.'],
    '<Platform>' = ['Motorola 88K Unix V Delta System.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['12/87'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['11/92'],
    '<References>' =
        ['DFT Spectral Analysis in Prolog, Motorola Project ',
            'Memorandum, PM-70304-0130-01, May 5, 1990. ']].
['<Program>' = ['DIANA'],'<Number>' = [503],
    '<Domain>' =
        ['Technical Diagnosis (Fault finding in technical ',
            'installations). '],
    '<Purpose>' = ['Diagnostics of technical installations.'],
    '<Description>' =
        ['A knowledgebased application with the aim of ','educating in ',
            'technicalfaultfinding. '],
    '<Developed by>' = ['Rainer Knauf, Thomas Abel.'],
    '<Country>' = ['Germany.'],'<Prolog system>' = ['PDC Prolog 3.30 '],
    '<Other languages>' = ['Top Speed Modula 2.0'],
    '<Lines>' = ['5300 lines of Prolog, 15300 Lines of Modula.'],
    '<Platform>' = ['486 AT, MSDOS 5.0'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],
    '<When Deployed>' = ['mid 1989 (in Turbo Prolog version)']].
['<Program>' = ['DIAVOLA'],'<Number>' = [372],
    '<Domain>' =
        ['Mechanical Engineering:Failure Diagnosis,Product Training. '],
    '<Purpose>' = ['Diagnosis of failed or damaged rolling bearings.'],
    '<Description>' =
        ['Diavola permits a systematically structured ','summarizing of ',
            ...
            'identify a symptom. '],
    '<Developed by>' = ['Horst Koehler.'],'<Organization>' = ['none.'],
    '<Country>' = ['Germany(West).'],
    '<Prolog system>' = ['PDC 3.2 / 3.21 / 3.3 and Toolbox 2.01. '],
    '<Other languages>' = ['none.'],
    '<Lines>' = ['About 1850 lines of PDC Prolog.'],
    '<Predicates>' = ['About 90.'],
    '<Platform>' =
        ['MS-DOS 3.3 and 5.0,PC-AT,80286/80386DX,true compatible.'],
    '<Type of Use>' = [''],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1991'],
    '<Information Date>' = ['August,16th, 1992.'],
    '<References>' =
        ['Not yet published,but by the end of 1992 eventually. ']].
['<Program>' = ['DINSA HPP and Stocks'],'<Number>' = [387],
    '<Domain>' = ['Decision support for stocks management. '],
    '<Purpose>' = ['Optimization of stock management.'],
    '<Description>' =
    ...
    '<Organization>' = ['AIA'],'<Country>' = ['Spain.'],
    '<Prolog system>' = ['PDC Prolog 3.31 for Windows. '],
    '<Other languages>' = ['C++, Microsoft C'],'<Lines>' = ['11113'],
    '<Predicates>' = ['377'],
    '<Platform>' =
        ['Developed PC 386 / MS DOS Delivery PC 386 / MS DOS and Windows'],
    '<Type of Use>' = ['Sold Product'],'<Information Date>' = ['07/1992']].
['<Program>' = ['Direct Guide Insurance System'],'<Number>' = [363],
    '<Domain>' = ['Insurance administration. '],
    '<Purpose>' =
        [   'Administration of private insurance policies issued through banks.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Rune Tendal Kock (primarily).'],
    '<Organization>' = ['DanGarant international insurance brokers.'],
    '<Country>' = ['Denmark.'],'<Prolog system>' = ['PDC Prolog 3.3 '],
    '<Other languages>' =
        [   'In a very few cases, C, Pascal, and 8086-assembler have been used.'],
    '<Lines>' = ['23,000'],'<Predicates>' = ['1,100'],
    '<Platform>' = ['DOS and OS/2'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['September 1989'],'<No. of Users>' = ['200'],
    '<Information Date>' = ['July 1st, 1992']].
['<Program>' = ['DME(Distance Measuring Equipment)SIMULATOR'],
    '<Number>' = [330],'<Domain>' = ['Real Time simulation. '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['Jai Hakim, Duncan Campbell.'],
    '<Organization>' = ['Canadian Marconi Corporation.'],
    '<Country>' = ['Canada.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['C,  BASIC.'],'<Lines>' = ['700'],
    '<Predicates>' = ['100'],'<Platform>' = ['MSDOS'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['01/91'],'<Information Date>' = ['08/92']].
['<Program>' =
    ['DOFLEX (Dortmund Flexible Legal Expert System Environment)'],
'<Number>' = [310],'<Domain>' = [' '],
'<Purpose>' =
    [   'Exploration of techniques of knowledge based systems to the legal and planning domain, also hypertext.'],
'<Description>' =
...
'<Developed by>' = ['Klans Witulski'],
'<Organization>' = ['University of Dortmund, Dept. of Urban Planning'],
'<Country>' = ['Germany'],
'<Prolog system>' = ['IF-PROLOG, ARCLY-P, C-P, QUINTUS-P '],
'<Lines>' = ['~3000'],'<Predicates>' = ['> 100'],
'<Platform>' = ['PC, Workstations'],'<Type of Use>' = ['In-house'],
'<Current Status>' = ['Prototype'],'<When Deployed>' = ['Nov. 1989'],
'<No. of Users>' = ['~ 5'],'<Information Date>' = ['5/92'],
'<References>' =
...
['<Program>' = ['DOKSI'],'<Number>' = [269],
    ...
    '<Developed by>' = ['I. Fidrich'],'<Organization>' = ['SzKI'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984'],
    '<References>' =
        ['I. Fidrich (1980) ',
            ...
            'SzKI Report, 1980. ']].
['<Program>' = ['Drug interactions system'],'<Number>' = [273],
    '<Domain>' = ['Pharmaceutical Industry '],
    '<Purpose>' = ['To predict drug interactions in medical treatment'],
    '<Description>' =
    ...
    '<Developed by>' = ['F. Darvas, I.Futo, P.Szeredi'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984'],
    '<References>' =
        ['F. Darvas, I.Futo, P.Szeredi (1976) ',
            ...
            'Biology. ','1976, pp 413-422. ',' ',
            'F. Darvas, I.Futo, P.Szeredi (1978) ',
            'A logic-based system for predicting drug interactions. ',
            'International Journal of Biomedical Computing, Vol. 9., 1978, pp.259- ',
            '271. ',' ']].
['<Program>' = ['DtoP'],'<Number>' = [234],
    '<Domain>' = ['Manufacturing design '],
    '<Purpose>' =
        [   'provide an integrated product description through all phases of manufacturing from conception to manufacture'],
    '<Description>' =
        ['Design to Product was a demonstrator for AI ',
            'techniques in all aspects of manufacturing. ',
            'The total project used 200 man years and \2439m funding. '],
    '<Organization>' =
        ['Edinburgh University, Loughborough, GEC, Lucas CAV'],
    '<Country>' = ['UK'],'<Prolog system>' = ['POPLOG '],
    '<Other languages>' = ['Common Lisp, Pop-11, C, Fortran']].
['<Program>' = ['DUALS'],'<Number>' = [250],'<Domain>' = ['linguistics '],
    '<Purpose>' = ['discourse understanding in natural language'],
    '<Description>' =
    ...
    '<Developed by>' = ['Yasukawa'],'<Organization>' = ['ICOT'],
    '<Country>' = ['Japan'],'<Prolog system>' = ['DEC-10 Prolog, CIL '],
    '<References>' =
...
['<Program>' = ['DUST-EXPERT'],'<Number>' = [430],
    '<Domain>' = ['Design of Vents for explosion relief. '],
    '<Purpose>' =
        [   'Design and obtain the venting requirements for the relief of dust explosions.'],
    '<Description>' =
        ['The use of explosion relief vents to provide the ','ultimate ',
    ...
    '<Developed by>' = ['HSE,Salford University Business Services Ltd.'],
    '<Organization>' = ['British Materials Handling Board, and HSE.'],
    '<Country>' = ['UK'],
    '<Prolog system>' = ['Expert Systems Ltd\'s Prolog-2 386 '],
    '<Other languages>' = ['Small procedures in Micro-Soft C.'],
    '<Lines>' = ['over 10,000 lines (incl comments).'],'<Predicates>' = [??],
    '<Platform>' = ['PC-386 under MS-DOS 4.0'],'<Type of Use>' = [''],
    '<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['Under evaluation.'],
    '<No. of Users>' = ['Currently being evaluated by about 16 users.'],
    '<Information Date>' = ['February 1992'],
    '<References>' =
        ['R. Santon et. al. 1991, ',
            '"A feasibilty study into the use of expert systems for ',
            'Explosion Relief Vent Design", Proc. of HAZARDS XI, I. Chem. Eng. No ',
            '124. ',' ','S. Vadera, and S. Nechab, 1991, ',
...
['<Program>' = ['DYNAMIC - system'],'<Number>' = [331],
    '<Domain>' =
    ...
    '<Developed by>' = ['A. Saksa, T. Merinen, O. Koskimaa.'],
    '<Organization>' = ['Traditor Ltd.'],'<Country>' = ['Finland.'],
    '<Prolog system>' =
        ['PDC Prolog 3.30 and home ACL inference mechanism. '],
    '<Other languages>' = ['ACL  (20%), C++ (10%), ASM (5%)'],
    '<Lines>' = ['50,000'],'<Predicates>' = ['1000'],
    '<Platform>' = ['DOS, Windows with embedded computers.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1992'],'<Information Date>' = ['20/07/92']].
['<Program>' = ['DynaPay Payroll Awards Interpreter.'],'<Number>' = [505],
    '<Domain>' = ['Payroll. '],
    '<Purpose>' =
        [   'Calculates employees pays and allowances using user - specified rules.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Tony Burnell.'],
    '<Organization>' = ['Dynamation Services Pyt Ltd.'],
    '<Country>' = ['Australia.'],
    '<Prolog system>' = ['PDC Prolog Version 3.20 '],
    '<Other languages>' =
        [   'Data-entry functions are written in Microsoft C Version 6.0 - these represent about 20% of the system.'],
    '<Lines>' = ['12.000 lines of PDC Prolog, 1.500 lines of C.'],
    '<Predicates>' = ['800'],'<Platform>' = ['MSDOS 3.30 and above.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['July 1989'],'<Information Date>' = ['8/2/93']].
['<Program>' = ['EDF'],'<Number>' = [212],'<Domain>' = ['Power generation '],
    '<Purpose>' =
        [   'Real-time centralised control and maintenance of hydro-electric power plants'],
    '<Description>' =
    ...
    '<Country>' = ['France'],'<Prolog system>' = ['Delphia '],
    '<Other languages>' = ['ORACLE'],'<Platform>' = ['work station'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<No. of Users>' = ['2 (20 planned)']].
['<Program>' = ['EhLogico.'],'<Number>' = [468],
    '<Domain>' =
        ['Automated Theorem Proving, Cooperative Interfaces for ',
            'Knowledge-Based Systems. '],
    '<Purpose>' =
        [   'Natural Deduction Automatic Theorem Prover for Knowledge-Based Systems with an Explanations-Generating Cooperative User Interface.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Denise A. S. OLIVEIRA'],
    '<Organization>' =
        [   'Pontificia Universidade Catolica do Rio de Janeiro - PUC/RJ and Universidade Catolica de Petropolis - UCP.'],
    '<Country>' = ['Brazil'],
    '<Prolog system>' = ['PDC Prolog (formaerly Turbo PROLOG 2.0 '],
    '<Other languages>' =
        ['None. C language may be used in the future in some parts.'],
    '<Lines>' = ['6000 lines.'],'<Predicates>' = ['400 predicates.'],
    '<Platform>' = ['IBM PC-XT or compatible, with 640k memory.'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['May/1991.'],
    '<Information Date>' = ['November 05, 1992.'],
    '<References>' =
        ['On the generation of explanations based on Natural ','Deduction ',
            ...
            'Nantes, France, July 1992.> ','Unpublished: ',
            ...
            '1992. ','Also, on generation of explanations: ',
            '"Planning Explanations from Natural Deduction based reasoning" Nunes, ',
            'M.G.V. ',
            'Notas do ICMSC-USP (Brasil) no. 118, August 1992, 13p. ']].
['<Program>' = ['Electronic Catalog Construction Kit for Windows v1.0'],
    '<Number>' = [448],'<Domain>' = ['Electronic marketing and sales. '],
    '<Purpose>' =
        [   'Permits vendors to create their own interactive electronic catalog.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Mark Garber.'],
    '<Organization>' = ['Cerebral Software.'],'<Country>' = ['USA'],
    '<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['20% Multiscope Modula-2'],'<Lines>' = ['40,000'],
    '<Predicates>' = ['1000'],'<Platform>' = ['Windows.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['OCT 1992'],'<Information Date>' = ['11 MAY 1992'],
    '<References>' = ['None. ']].
['<Program>' = ['Electronic Catalog Construction Kit v3.04'],
    '<Number>' = [447],'<Domain>' = ['Electronic marketing and sales. '],
    '<Purpose>' =
        [   'Permits users to create their own electronic catalog ordering system.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Mark Garber.'],
    '<Organization>' = ['Cerebral Software.'],'<Country>' = ['USA'],
    '<Prolog system>' = ['PDC prolog. '],'<Other languages>' = ['None.'],
    '<Lines>' = ['6600'],'<Predicates>' = ['800'],
    '<Platform>' = ['MS-DOS/OCT 1991, WINDOWS/OCT 1992.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1 March 1990'],'<No. of Users>' = ['22'],
    '<Information Date>' = ['11 May 1992'],'<References>' = ['None. ']].
['<Program>' = ['ELKARLAN'],'<Number>' = [380],
    '<Domain>' =
        ['Train maintenance centres and parts replacement floor shop. '],
    '<Purpose>' =
        ['Optimization, revisions and maintenance of scheduling of trains.'],
    '<Description>' =
    ...
    '<Organization>' = ['AIA'],'<Country>' = ['Spain'],
    '<Prolog system>' = ['PDC Prolog 3.31 '],
    '<Other languages>' = ['Microsoft C'],'<Lines>' = ['2385'],
    '<Predicates>' = ['55'],
    '<Platform>' =
        [   'Developed PC 386 / MS DOS Delivery PC 386 / MS DOS and MS Windows'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/199'],'<Information Date>' = ['07/1992']].
['<Program>' = ['ELMA'],'<Number>' = "E",
    '<Domain>' = ['Library Management '],
    '<Purpose>' =
        [   'Organizing educational media (books, videos, films, etc) for the planning of courses, seminars, and personal professional development'],
    '<Description>' =
    ...
    '<Developed by>' = ['Audun Toennesen, Bjoern Bolstad'],
    '<Organization>' = ['STATOIL - The Norwegian National Oil Company'],
    '<Country>' = ['Norway'],'<Prolog system>' = ['PDC PROLOG '],
    '<Platform>' = ['IBM PC/ DOS'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Dead'],'<When Deployed>' = ['June 1988'],
    '<No. of Users>' = ['approx 5-10'],'<Information Date>' = ['March 1992']].
['<Program>' = ['EMANON'],'<Number>' = "v",'<Domain>' = ['CASE '],
    '<Purpose>' =
        [   'A CASE-tool for Developing Knowledge-Based Systems for Constructive Problems'],
    '<Description>' = ['Submitted to PAC. Paper 396 '],
    '<Developed by>' = ['Peter Nordin & Sundin'],'<Country>' = ['Sweden'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['EMEX'],'<Number>' = "?",
    '<Domain>' = ['Strategic Marketing. '],
    '<Purpose>' = ['Assist in building single equation econometric models.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Ted Walker, Simon McAllister, Mike Greenwell.'],
    '<Organization>' =
        [   'Expert Systems Ltd, Henley Centre for Forecasting, initially Alvey funded.'],
    '<Country>' = ['UK'],'<Prolog system>' = ['Prolog-2, ESL. '],
    '<Other languages>' = ['FORTRAN for statistical operations'],
    '<Lines>' = ['25300'],'<Predicates>' = ['977'],
    '<Platform>' = ['PC/DOS, SUN/SunView.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1987'],'<No. of Users>' = ['100+'],
    '<Information Date>' = ['24 March 1992']].
['<Program>' = ['EMICAT'],'<Number>' = "7",'<Domain>' = ['CASE Tool '],
    '<Purpose>' = ['KBS development environment'],
    '<Description>' =
        ['EMICAT is an object-oriented language extensionof ',
            ...
            'down considerably. '],
    '<Developed by>' = ['Dassault Electronique'],
    '<Organization>' = ['DASSAULT ELECTRONIQUE'],'<Country>' = ['France'],
    '<Other languages>' = ['C'],'<Lines>' = ['30000'],
    '<Predicates>' = ['>1000'],
    '<Platform>' = ['SUN, HP, IBM RS/6000 under UNIX PS40S2 IBM S390/VM'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1986'],'<No. of Users>' = ['200'],
    '<Information Date>' = ['27/2/92'],
    '<References>' =
...
['<Program>' = ['EMS'],'<Number>' = "9",
    ...
    '<Description>' =
        ['The modular program is designed for dynamic scheduling of ',
            ...
            'strategies. '],
    '<Developed by>' = ['Vincent K.M. CHING'],
    '<Organization>' =
        [   'Imperial College London Center for Robotics and Automated Systems'],
    '<Country>' = ['UK'],'<Prolog system>' = ['QUINTUS PROLOG '],
    '<Other languages>' =
        ['FORTRAN as foreign language module for interface/support'],
    '<Lines>' = ['7000'],'<Predicates>' = ['4500'],
    '<Platform>' = ['DEC VAX/VMS    min-VAX 2000 (QUINTUS PROLOG)'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['1/7/89'],'<No. of Users>' = ['2'],
    '<Information Date>' = ['13/4/92']].
['<Program>' = ['ENDELON'],'<Number>' = [500],
    '<Domain>' = ['Project management. '],
    '<Purpose>' =
        [   'ENDELON helps a project manager in estimating and planning projects of any kind, assuming that a methodology is used.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Maurilio Vehturini.'],
    '<Organization>' = ['Engineering - Ingegneria Informatica spa.'],
    '<Country>' = ['Italy.'],
    '<Prolog system>' = ['PDC Prolog 3.30 Windows. '],'<Lines>' = ['9200'],
    '<Predicates>' = ['500'],
    '<Platform>' =
        [   'Development : PS2 L40SX 80 Mbyte disk, 4 Mbyte RAM, DOS 5.0 andWindows 3.1; Delivery: any platform running Window 3.0, Windows 3.1 or OS/2 2.0 (thru WIN-OS2).'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['November 1990'],
    '<Information Date>' = ['January 1993']].
['<Program>' = ['ENZYME SEQUENCER'],'<Number>' = [290],
    '<Domain>' = ['Biochemistry '],
    '<Purpose>' =
    ...
    '<References>' =
        ['G. Matrai (1979) ',
            ...
            'enzyme sequences. ','MTA SZBK report, 1980. ']].
['<Program>' = ['EPSILON'],'<Number>' = "w",
    '<Domain>' = ['Software design '],
    '<Purpose>' =
        [   'Communication with a Relational DBMS in a Logic Programming Framework'],
    '<Description>' = ['Submitted to PAC. Paper 286 '],
    '<Developed by>' = ['Nurcan et al'],'<Country>' = ['France'],
    '<Prolog system>' = ['BIM Prolog + Informix '],
    '<Platform>' = ['standard UNIX.'],'<Information Date>' = ['6/11/91']].
['<Program>' = ['ERGOPRO'],'<Number>' = "F",
    '<Domain>' = ['Occupational Medicine '],
    '<Purpose>' =
        [   'Decision support in the prevention of musculo-skeletal disorders in the work environment'],
    '<Description>' =
        ['Users enter data about the work environment. The ','program ',
    ...
    '<Developed by>' = ['Audun Toennesen, Terje Salbo'],
    '<Organization>' = ['STATOIL (The Norwegian National Oil Company)'],
    '<Country>' = ['Norway'],'<Prolog system>' = ['PDC PROLOG '],
    '<Platform>' = ['IBM PC/ DOS'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Dead'],'<When Deployed>' = ['May 1989'],
    '<No. of Users>' = ['70'],'<Information Date>' = ['March 1992']].
['<Program>' = ['Erlang'],'<Number>' = "x",'<Domain>' = ['PAR '],
    '<Purpose>' =
        ['Use of Prolog for developing a new programming language'],
    '<Description>' = ['Submitted to PAC. Paper 130 '],
    ...
    '<Information Date>' = ['25/10/91']].
['<Program>' = ['ERS-1 Payload system'],'<Number>' = [225],
    '<Domain>' = ['Aerospace planning '],
    '<Purpose>' =
        [   'Expert system for planning the payload of the ERS-1 earth observation satellite.'],
    '<Description>' =
    ...
    '<Prolog system>' = ['Prolog by BIM ']].
['<Program>' = ['ESAP'],'<Number>' = [496],
    '<Domain>' =
        ['Safety and Risk analysis (nuclear stations, transport etc.) '],
    '<Purpose>' = ['Fault tree and Event tree analysis programs.'],
    '<Description>' =
        ['ESAP is a program for graphically entering fault ','trees and ',
    ...
    '<Developed by>' = ['Steve Lympany.'],
    '<Organization>' = ['Electrowatt Engineering.'],
    '<Country>' = ['England.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['8000'],
    '<Predicates>' = ['400'],'<Platform>' = ['MS-DOS on IBM PC.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['August 1992']].
['<Program>' = ['ESFA'],'<Number>' = [216],
    '<Domain>' = ['Electronic design '],
    '<Purpose>' = ['Help design integrated circuits'],
    '<Description>' =
    ...
    '<Organization>' = ['IBM La Gaude laboratory'],
    '<Country>' = ['France ?'],
    '<References>' =
        ['B. Robinet: Logic Programming at IBM from the Lab ',
            'to the customer. Proc ICLP8. pp912-921. 1991 ',
            'B. Bertrand: La Conception de Circuits Int\216gr\216s assist\216e par un ',
            'Syst\217me Expert. Les Utilisations Industrielles du Langage Prolog, ',
...
['<Program>' = ['ESTA'],'<Number>' = [192],'<Domain>' = ['Expert system '],
    '<Purpose>' =
    ...
    '<Prolog system>' = ['PDC Prolog '],'<Platform>' = ['IBM PC'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released']].
['<Program>' = ['EUODHILOS'],'<Number>' = "(",
    '<Domain>' = ['Symbolic proofs '],
    '<Purpose>' =
        [   'A logic-independent proof editor and constructor that allows users interactively to define the language and derivation rules of a logical system relevant for the universe of discourse under consideration; and to construct proofs in the defined system.'],
    '<Description>' =
        ['A logic-independent proof editor and constructor ',
            ...
            'National Laboratory '],
    '<Developed by>' = ['H. Sawamura; T. Minami; K. Ohashi and K. Yokota'],
    '<Organization>' = ['Fujitsu Laboratories'],'<Country>' = ['Japan'],
    '<Prolog system>' = ['ESP '],'<Lines>' = ['<Program Size> 1.7MB'],
    '<Predicates>' = ['2073 methods'],
    '<Platform>' =
        ['Personal Sequential Inference Machine PSI-II and PSI-III'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['September 1991'],'<No. of Users>' = ['4'],
    '<References>' =
...
['<Program>' = ['EUREX'],'<Number>' = "%",'<Domain>' = ['Law '],
    '<Purpose>' =
    ...
    '<Description>' =
        ['EUREX is an expert system that supports the ',
            ...
            'other regulations. '],
    '<Developed by>' = ['Fabienne Balfroid; Jan de Rijke; Geert Van Nevel'],
    '<Organization>' = ['BIM sa/nv'],'<Country>' = ['Belgium'],
    '<Prolog system>' = ['ProLog by BIM '],
    '<Other languages>' = ['Prolog/C interfaces to XView; Xlib'],
    '<Lines>' =
        [   'EUREX - core  : +-  26.000 lines EUREX - rules : +-   2.900 lines EUREX - dict  : +-   9.400 lines Total after merging: +/- 38.300 lines'],
    '<Predicates>' = ['+- 900'],'<Platform>' = ['Sun3; Sun4; SPARCstations'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['March 1992'],
    '<Information Date>' = ['January 1992'],
    '<References>' =
        ['"An Expert System for the Application of Import and ','Export ',
...
['<Program>' = ['EVA'],'<Number>' = [376],
    '<Domain>' =
        ['Automatic aquisition of knowledge in order to build and expert ',
            'system. '],
    '<Purpose>' = ['Decision making process support.'],
    '<Description>' =
        ['A generic product for decision support with the ','capability of ',
            'supervised learning in evaluation and classification problems. '],
    '<Developed by>' =
        ['Antoni Trias, Xavier Fustero and programmers team.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain.'],
    '<Prolog system>' = ['PDC Prolog 3.31. '],
    '<Other languages>' = ['Turbo C.'],'<Lines>' = [void],
    '<Predicates>' = [void],
    '<Platform>' = ['Developed PC 386 / MS DOS Delivered PC 386 / MS DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1990'],'<Information Date>' = ['07/1992'],
    '<References>' = ['AIA Software product description. ']].
['<Program>' = ['EVAL'],'<Number>' = "4",
    '<Domain>' = ['Financial Analysis and Evaluation '],
    '<Purpose>' = ['Support users in developing economical evaluations'],
    '<Description>' =
    ...
    '<Developed by>' = ['Francesco Costa'],
    '<Organization>' = ['IBM Semea spa'],'<Country>' = ['Italy'],
    '<Prolog system>' = ['IBM PROLOG 370 '],
    '<Other languages>' = ['IPW - IBM PROLOG WORKBENCH'],
    '<Lines>' = ['100000'],'<Predicates>' = ['500'],
    '<Platform>' = ['IBM 3090 (OS VM/SP)'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['3/92'],
    '<No. of Users>' = ['1000'],'<Information Date>' = ['1/3/92'],
    '<References>' =
...
['<Program>' = ['EXCAP'],'<Number>' = [233],
    '<Domain>' = ['Process planning '],
    '<Purpose>' =
        [   'A Kowledge-based system which automates process planning for computer aided design of turning operations in numerically controlled machining'],
    '<Description>' =
    ...
    '<Prolog system>' = ['POPLOG ']].
['<Program>' = ['EXEGETE'],'<Number>' = [332],
    '<Domain>' = ['Education in the Humanities. '],
    '<Purpose>' =
        [   'To provide a teaching and testing environment for students studying college level courses that allows hypertext commentary upon, interactive testing of documents in the humanities.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Dr. Gearge Teschner.'],
    '<Organization>' =
        ['Christopher Newport University, Newport News Virginia, 23606.'],
    '<Country>' = ['USA'],'<Prolog system>' = ['PDC Prolog 3.30 '],
    '<Other languages>' = ['None.'],'<Lines>' = ['20,000+'],
    '<Predicates>' = ['500+'],'<Platform>' = ['IBM and compatibles.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/89'],'<Information Date>' = ['09/09/92'],
    '<References>' =
...
['<Program>' = ['Expert system for production planning'],'<Number>' = [226],
    '<Domain>' = ['Process Planning '],
    '<Purpose>' =
        [   'providing an integrated planning and scheduling functionality for complex chemical processes'],
    '<Description>' =
    ...
    '<Organization>' = ['BIM, Sandoz, Switzerland'],
    '<Country>' = ['Belgium'],'<Prolog system>' = ['Prolog by BIM ']].
['<Program>' = ['EXPOD'],'<Number>' = [315],
    '<Domain>' = ['Chemical Design. '],
    '<Purpose>' = ['EXPOD is an Expert System for Polymer Design.'],
    '<Description>' =
    ...
    '<Organization>' = ['Mitsubishi Research Institute.'],
    '<Country>' = ['Japan.'],'<Prolog system>' = ['IF/PROLOG '],
    '<Other languages>' = ['C, X Windows.'],
    '<Platform>' = ['SUN, SONY, HP.'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['09/89'],
    '<No. of Users>' = ['50 sites.'],'<Information Date>' = ['03/92']].
['<Program>' = ['FAIRCHILD prototyping system'],'<Number>' = [201],
    '<Domain>' = ['Electronics design '],
    '<Purpose>' = ['Rapid prototyping of chip design'],
    '<Description>' =
        ['This system consists of a number of independent ',
            ...
            'standards. '],
    '<Organization>' = ['National Semiconductor, Fairchild division'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Quintus '],
    '<Type of Use>' = ['In-house'],
    '<Current Status>' = ['No longer supported']].
['<Program>' = ['Fantasy Basketball'],'<Number>' = "/",
    '<Domain>' = ['Sports statistics '],
    '<Purpose>' =
        [   'Maintains Routisserie/Fantasy Basketball leagues; keeps weekly NBA statistics in a Prolog database; ranks NBA players and teams.'],
    '<Description>' =
    ...
    '<Developed by>' = ['John Dowding'],'<Organization>' = [none],
    '<Country>' = ['USA'],
    '<Prolog system>' = ['Quintus Prolog versions 2.5-3.1 '],
    '<Other languages>' = [none],'<Lines>' = ['1500'],
    '<Predicates>' = ['200'],'<Platform>' = ['Sun Sparc-2'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10-90'],'<No. of Users>' = ['1'],
    '<Information Date>' = ['3-7-92']].
['<Program>' = ['FARGETZT'],'<Number>' = [353],
    '<Domain>' = ['Programming utility. '],
    '<Purpose>' =
        [   'To test different colour combinations, to find nice colours to use in my windows.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Sigve B_'],'<Organization>' = ['SigveSaker'],
    '<Country>' = ['Norway.'],
    '<Prolog system>' = ['Turbo Prolog 2.0 (now PDC Prolog). '],
    '<Other languages>' = ['None.'],'<Lines>' = ['13'],
    '<Platform>' = ['MS-DOS.'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1990'],
    '<Information Date>' = ['12/08/92']].
['<Program>' = ['FAST PHONEBOOK'],'<Number>' = [301],
    '<Domain>' = ['Office Productivity '],
    '<Purpose>' =
        [   'Allows the user to store and retrieve data based on two fields either of which can be key or value.'],
    '<Description>' =
    ...
    '<Prolog system>' = ['TURBO PROLOG   V 2.0 '],'<Lines>' = ['~ 200'],
    '<Predicates>' = ['~ 12'],'<Platform>' = ['IBM  PC DOS or OS/2'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['June 1989'],
    '<No. of Users>' = ['30'],'<Information Date>' = ['Jan.  1992']].
['<Program>' = ['FAULTY'],'<Number>' = [354],
    '<Domain>' = ['Fault isolation aid. '],
    '<Purpose>' =
        [   'To log how to fix common faults on equipment, to aid unexperienced technicians.'],
    '<Description>' =
    ...
    '<Country>' = ['Norway.'],
    '<Prolog system>' = ['Turbo Prolog 2.0 (Now PDC Prolog). '],
    '<Other languages>' = ['None.'],'<Lines>' = ['1000'],
    '<Predicates>' = ['40'],'<Platform>' = ['MS-DOS.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Dead'],
    '<When Deployed>' = ['1989'],'<Information Date>' = ['12/08/92']].
['<Program>' = ['FAUST'],'<Number>' = [236],
    '<Domain>' = ['Electricity supply diagnosis '],
    '<Purpose>' =
        [   'on-line diagnosis of faults in the elctricity supply on the National Grid'],
    '<Description>' = ['is this POP++ or Prolog? '],
    '<Organization>' = ['ERDC Capenhurst, Thames Polytechnic'],
    '<Country>' = ['UK'],'<Prolog system>' = ['POPLOG ']].
['<Program>' = ['FELIX - FEL and Logica Interactive Expertsystem'],
    '<Number>' = [333],
    '<Domain>' =
        ['Intelligent Computer Assisted Instruction, Computer Based ',
            'Training. '],
    '<Purpose>' =
        [   'To investigate the applicability and value of Intelligent Computer Assisted Instruction.'],
    '<Description>' =
    ...
    '<Developed by>' = ['TNO-FEL and Logica.'],
    '<Organization>' =
        [   'Sponsred by the Ministry of Defence.  (Directorate- General Research and Development'],
    '<Country>' = ['The Netherlands.'],
    '<Prolog system>' = ['Quintus Prolog 3.1, Quintus ProWINDOWS 1.2. '],
    '<Other languages>' = ['C.'],'<Lines>' = ['15000'],
    '<Predicates>' = ['750'],'<Platform>' = ['Sun.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['03/92'],'<No. of Users>' = ['2'],
    '<Information Date>' = ['07/92'],
    '<References>' =
...
['<Program>' = ['FEREL-FERTIGUNGSREGELUNG'],'<Number>' = [326],
    '<Domain>' = ['CAM '],
    '<Purpose>' = ['Shop floor control system - line capacity scheduling.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Dr. Kupec, Simon.'],
    '<Organization>' = ['Institute of Germany'],'<Country>' = ['Germany.'],
    '<Prolog system>' = ['IF PROLOG 4.1 '],
    '<Other languages>' = ['C, X-WINDOWS, MOTIF, SQL, PASCAL, GKS'],
    '<Lines>' = ['~13,000'],'<Predicates>' = ['~700'],
    '<Platform>' = ['Decstation 5000 ULTRIX 4.2'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['06/88'],'<Information Date>' = ['04/06/92'],
    '<References>' =
        ['Intergration of Autonomous Mobile Robots in Flexible ',
            'Manufacturing Systems.  Proceedings of IAS-2 Amsterdam, 11-14/12/89. ']].
['<Program>' = ['FIM'],'<Number>' = [385],
    '<Domain>' = ['Front office sales of investment funds. '],
    '<Purpose>' =
        [   'Help the sales force of investment funds for a bank holding by defining clients\' profiles.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Xavier Orteu'],'<Organization>' = ['AIA'],
    '<Country>' = ['Spain'],'<Prolog system>' = ['PDC Prolog 3.21 '],
    '<Other languages>' = ['C'],'<Lines>' = ['12000'],
    '<Predicates>' = ['717'],
    '<Platform>' = ['Developed PC 386 / MS DOS Delivery PC 386 / MS DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['01/1992'],'<Information Date>' = ['07/1992']].
['<Program>' = ['FLiPSiDE'],'<Number>' = [28],
    '<Domain>' = ['Distributed AI '],
    '<Purpose>' =
        [   'Financial Logic Programming System for Distributed Expertise. Blackboard system to coordinate distribute heterogenous knowledge sources.'],
    '<Description>' =
        ['A prolog-based blackboard system to integrate and control ',
            'distributed heterogeneous knowledge sources. '],
    '<Developed by>' = ['David G. Schwartz'],
    '<Organization>' = ['Case Western Reserve University'],
    '<Country>' = ['USA'],'<Prolog system>' = ['BIM ProLog '],
    '<Other languages>' = ['C'],'<Lines>' = ['~3000'],'<Predicates>' = [?],
    '<Platform>' = ['Sun/3 and SPARC'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Prototype'],
    '<References>' =
        ['"The FLiPSiDE Blackboard: A Financial Logic ',
            ...
            'Applicati ','ons on Wall Street; Oct. 1991. ',
            ...
            'report; 1991" ',' ']].
['<Program>' = ['Floor Plan Design'],'<Number>' = "y",
    '<Domain>' = ['Architectural Design '],
    '<Purpose>' =
        [   'An Incremental Prolog Systems Development for Floor Plan Design by Dissectioning'],
    '<Description>' = ['Submitted to PAC. Paper 86 '],
    '<Developed by>' = ['Laszlo Bela Kovacs'],'<Country>' = ['Denmark'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['FMOL'],'<Number>' = "z",
    '<Domain>' = ['Software production '],
    '<Purpose>' =
        ['Graphical Tools in an Automatic Prototyping Environment'],
    '<Description>' = ['Submitted to PAC. Paper 292 '],
    '<Developed by>' = ['I Ferrandiz et al'],'<Country>' = ['Spain'],
    '<Prolog system>' = ['BIM '],'<Platform>' = ['Sun'],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['FOM'],'<Number>' = [178],'<Domain>' = ['Hotel management '],
    '<Purpose>' = ['Expert system for hotel managers'],
    '<Description>' =
        ['The Front Office Manager (FOM) uses skill and ',
            ...
            'should be opened or closed. ',' ','May not be Prolog! ',' '],
    '<Organization>' =
        ['DCM Data Products, East India Hotels (Oberoi) group'],
    '<Country>' = ['UK']].
['<Program>' = ['FORMALL'],'<Number>' = [394],
    '<Domain>' = ['Form processing. '],
    '<Purpose>' =
        [   'Fills in, processes and generates 26 pre-printed forms commonly used in small businesses. FORMALL creates an electronic environment for form processing in a small business.'],
    '<Description>' =
        ['An inexpensive, easy to use program that lets you ','fill and ',
    ...
    '<Developed by>' = ['Randolph Krofick, Chief Developer; Patrick Conte.'],
    '<Organization>' = ['North Winds.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['PDC Prolog (90%) '],
    '<Other languages>' = ['Borland C (10%).'],'<Lines>' = ['10.000'],
    '<Predicates>' = ['60'],
    '<Platform>' =
        [   'MSDOS 2.0, 512K memory, most dot matrix, daisywheel & laser printers, hard or floppy drive systems.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['January 1, 1989.'],
    '<Information Date>' = ['9/1/92'],
    '<References>' = ['PC Magazine Article, PCM Magazine. ']].
['<Program>' = ['FORMZ'],'<Number>' = [393],
    '<Domain>' = ['Form Processing. '],
    '<Purpose>' =
        [   'To create, fill in, print, and process pre-printed forms. FORMZ creates an electronic environment for form processing.'],
    '<Description>' =
        ['An inexpensive, easy to use program that lets you ','fill in ',
    ...
    '<Developed by>' = ['Randolph Krofick, Chief Developer; Patrick Conte.'],
    '<Organization>' = ['North Winds.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['PDC Prolog (85%). '],
    '<Other languages>' = ['Borland C (15%).'],'<Lines>' = ['22.000'],
    '<Predicates>' = ['1000'],
    '<Platform>' =
        [   'MSDOS 2.0, 512 K memory, most dot matrix, daisywheel & laser printers, hard or floppy drive systems.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['October 1, 1987.'],
    '<Information Date>' = ['9/1/92'],
    '<References>' = ['PC Magazine Article, PCM Magazine. ']].
['<Program>' = ['FRENCHIP'],'<Number>' = [220],
    '<Domain>' = ['Electronic design '],
    '<Purpose>' = ['synthesis of logic circuits'],
    '<Description>' =
    ...
    '<Organization>' = ['Dassault Electronique'],'<Country>' = ['France'],
    '<Prolog system>' = ['Delphia '],'<Lines>' = ['60,000'],
    '<Platform>' = ['Unix workstations with X-windows'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<No. of Users>' = ['60+']].
['<Program>' = ['FuPlan'],'<Number>' = [504],
    '<Domain>' = ['Engineering of Automated Building Management Systems. '],
    '<Purpose>' = ['CAE . System for Configuration of Control System.'],
    '<Description>' =
        ['In a building management system, a substation is ','one ',
            ...
            'space. '],
    '<Developed by>' = ['Hans Grob.'],
    '<Organization>' = ['Fr. Sauter AG, CH - 4016  Basel.'],
    '<Country>' = ['Switzerland.'],'<Prolog system>' = ['PDC-Prolog. '],
    '<Lines>' = ['12.000'],'<Predicates>' = ['1.200'],
    '<Platform>' = ['DOS.'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['8.1990'],
    '<Information Date>' = ['2.1993'],'<References>' = ['User*s Guide ']].
['<Program>' = ['GALOP'],'<Number>' = [249],
    '<Domain>' = ['computational linguistics '],
    '<Purpose>' = ['parsing of natural language'],
    '<Description>' =
    ...
    '<Developed by>' = ['Y. Matsumoto et al'],'<Organization>' = ['ICOT'],
    '<Country>' = ['Japan'],'<Prolog system>' = ['DECsystem-10 ? '],
    '<References>' =
        ['Y. Matsumoto, H. Tanak, H. Hirakawa, H. Miyoshi, H. ',
            'Yasukawa: BUP A Bottom-up parser embedded in Prolog. New Generation ',
            'Computing. ',
            'K. Fuchi, K. Furukawa: The Role of Logic Programming in the Fifth ',
            'Generation Computer Project. ICLP3, 1986. pp1-24. ']].
['<Program>' = ['GARP (General Architecture for Reasoning about Physics)'],
    '<Number>' = [450],
    '<Domain>' =
    ...
    '<Purpose>' = ['A qualitative reasoning shell.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Bert Bredeweg.'],
    '<Organization>' = ['University of Amsterdam.'],'<Country>' = ['NL'],
    '<Prolog system>' =
        ['SWI-Prolog (see J. Wielemaker, 1992, University of ',
            'Amsterdam) '],
    '<Other languages>' = ['none.'],'<Lines>' = ['10000 lines of Prolog.'],
    '<Predicates>' = [???],'<Platform>' = ['Sun workstations.'],
    '<Type of Use>' = [''],'<Current Status>' = [''],
    '<When Deployed>' = ['January 1990'],
    '<No. of Users>' =
        [   'About 15 research institutes used tapes of ftp to get the program (it is unknown how many people actually use GARP)'],
    '<Information Date>' = ['May 25, 1992'],
    '<References>' =
        ['- B. Bredeweg and B.J. Wielinga (1988), ',
            'Integrating qualitative reasoning approaches, Proceedings of ECAI-- ',
            '88, Munich, Page 195-201. ','- B. Bredeweg (1989), ',
            ...
            'Amsterdam. ']].
['<Program>' = ['GASMAD'],'<Number>' = [386],
    '<Domain>' =
        ['Maintenance decision support in gas distribution strategies. '],
    '<Purpose>' =
        [   'Optimize global and daily maintenance in decisions repair/replace a gas distributions network.'],
    '<Description>' =
        ['Expert system for the maintenance of a Gas ',
            'Distribution networks. ',
            'Project in development for Gas Madrid (Gas Natural S.A.). '],
    '<Developed by>' =
        [   'Regina Llopis, Rosa Fors, Frederic Casanovas and programmers team.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain.'],
    '<Prolog system>' = ['PDC Prolog 3.31 for Windows '],
    '<Other languages>' = ['C++'],'<Lines>' = ['26909'],
    '<Predicates>' = ['421'],
    '<Platform>' =
        ['Developed PC 386 / MS DOS Delivey PC 386 / MS DOS and Windows.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['Sep. 1992'],'<Information Date>' = ['07/1992']].
['<Program>' = ['GemTest'],'<Number>' = [412],
    '<Domain>' = ['Mineral and precious stone (gemstone) identification. '],
    '<Purpose>' =
        ['To assist in fast, reliable mineral (Gemstone) identification.'],
    '<Description>' =
    ...
    '<Developed by>' = ['CIM Research Laboratory.'],
    '<Organization>' =
        [   'Computer and Automation Institute, Hungarian Academy of Sciences.'],
    '<Country>' = ['Hungary.'],'<Prolog system>' = ['Turbo Prolog. '],
    '<Lines>' = ['400'],'<Predicates>' = ['90'],
    '<Platform>' = ['PC XT/AT, MS-DOS'],'<Type of Use>' = ['Personal'],
    '<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['September 1986.'],
    '<Information Date>' = ['March 1992'],
    '<References>' =
...
['<Program>' = ['Gene Sequence Alignment'],'<Number>' = "b",
    '<Domain>' = ['Biological Research '],'<Purpose>' = [''],
    '<Description>' =
    ...
    '<Prolog system>' = ['Strand88 ']].
['<Program>' = ['Generalized Query System'],'<Number>' = "U",
    '<Domain>' = ['database front-end, system integration '],
    '<Purpose>' =
        [   'Provides a high-level general data access abstraction mechanism using a client - server architecture for access to diverse sources of data and knowledge.'],
    '<Description>' =
        ['An access mechanism for either a Prolog program or ',
            ...
            'oriented syntax. '],
    '<Developed by>' =
        [   'Bill McClay, Roger Speigle, George Hendrickson, Dennis Hegedus, Michael Easter, Steve Miller, Jerry Gerstmann, Max Robinson'],
    '<Organization>' = ['Boeing Computer Services'],'<Country>' = ['USA'],
    '<Prolog system>' = ['Quintus 3.1 '],
    '<Other languages>' = ['9,000 lines of C'],
    '<Lines>' = ['20,000 lines of Prolog'],
    '<Predicates>' = ['approximately 3,000'],
    '<Platform>' = ['Sun 4, VAX, RS6000'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['January 1992'],
    '<No. of Users>' = ['Other applications'],
    '<Information Date>' =
        [   'March 1992 \307IF*** The text replacing this argument is too long ***\310<References> First mentioned in the "Harnessing Detailed Assembly Process Knowledge" presentation by Bill McClay and John Thompson at the Conference on Innovative Applications of Artificial Intelligence, March 1989, sponsored by the American Association of Artificial Intelligence.  It is the main theme of the paper, "A Query Server for Diverse Sources of Data and Knowledge" to be presented at the First International Conference on Practical Applications of Prolog.']].
['<Program>' = ['Generator of Cobol programs for Data Validation'],
    '<Number>' = [278],'<Domain>' = ['Software applications '],
    '<Purpose>' =
...
['<Program>' = [geons],'<Number>' = "A",'<Domain>' = ['Computer vision '],
    '<Purpose>' =
        [   'To recognise the class of a 3-D volumetric primitive object in an image description which consists of curve properties and relations.'],
    '<Description>' =
        ['In an area of computer vision research, classes of ',
            ...
            'geometric primitive. '],
    '<Developed by>' = ['Roger Munck-Fairwood'],
    '<Organization>' = ['University of Surrey'],'<Country>' = ['UK'],
    '<Prolog system>' = ['Poplog (others also) '],
    '<Lines>' = ['800 (with comments, etc.)'],'<Platform>' = ['Sun4'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['1988'],'<No. of Users>' = ['2'],
...
['<Program>' = ['GESER'],'<Number>' = [211],'<Domain>' = ['Ship design '],
    '<Purpose>' =
        ['To check that a ship design satisfies all applicable regulations'],
    '<Description>' =
    ...
    '<Prolog system>' = ['Delphia '],'<Other languages>' = ['Emicat'],
    '<Platform>' = ['work station'],'<When Deployed>' = ['1990']].
['<Program>' = ['GET - Graphic Editor and Tools'],'<Number>' = "{",
    '<Domain>' = ['Software production '],
    '<Purpose>' =
        [   'An X-Windows Toolkit for Knowledge Acquisition and Representation based on Conceptual Structures'],
    '<Description>' = ['Submitted to PAC. Paper 275 '],
    '<Developed by>' = ['Wermelinger & Lopes'],'<Country>' = ['Portugal'],
    '<Prolog system>' = ['X-Prolog '],'<Information Date>' = ['6/11/91']].
['<Program>' = ['GEX-Tool'],'<Number>' = "a",
    '<Domain>' = ['electronic assembly '],
    '<Purpose>' =
    ...
    '<Prolog system>' = ['Quintus '],'<Other languages>' = ['C'],
    '<Platform>' = ['Unix workstation'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released']].
['<Program>' = ['Git\'N GO P.O.S & Inventory System'],'<Number>' = [334],
    '<Domain>' = ['Business Application. '],
    '<Purpose>' =
        [   'To allow multi-user Point of Sale / Inventory Control for bonded warehouses.  Automate US Customs paperwork.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Tom Unger.'],
    '<Organization>' = ['RAM CONTROL, Champlain, NY.'],
    '<Country>' = ['USA.'],'<Prolog system>' = ['PDC Prolog 3.21 '],
    '<Other languages>' = ['None.'],'<Lines>' = ['Approx. 5000'],
    '<Predicates>' = ['Approx.  400'],
    '<Platform>' = ['IBM PC clones running DOS 5 and Lantastic NOS.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['12/91'],'<Information Date>' = ['07/92']].
['<Program>' = ['GOLDFINDER'],'<Number>' = [296],'<Domain>' = ['Geology '],
    '<Purpose>' =
        [   'To advise an exploration geologist on the best location to site a drill hole to find gold.'],
    '<Description>' =
    ...
    '<Developed by>' = ['D.D. Hawkes'],'<Organization>' = ['Micro Prof'],
    '<Country>' = ['England'],'<Prolog system>' = ['LPA Mac Prolog '],
    '<Lines>' = ['275 K'],'<Predicates>' = ['280 relations'],
    '<Platform>' = ['Foppy disc with Macintosh, hard disc and 2 Mb RAM'],
    '<When Deployed>' = ['June 1992'],'<No. of Users>' = ['new release'],
    '<Information Date>' = ['17 June 1992'],
    '<References>' =
        ['Hawkes, D D 1992 Goldfinder: a knowledge-based system for ',
            'mineral prospecting.  Jour. Geol. Soc. London 149, 465-471. ']].
['<Program>' = ['Grammar Development Tool'],'<Number>' = [421],
    '<Domain>' = ['Natural language processing. '],
    '<Purpose>' = ['A tool for development of grammars by linguists.'],
    '<Description>' =
    ...
    '<Developed by>' = ['NLP Department, IBM Nordic Laboratories.'],
    '<Organization>' = ['IBM'],'<Country>' = ['Sweden.'],
    '<Prolog system>' = ['IBM Prolog. '],'<Other languages>' = ['REXX'],
    '<Lines>' = ['Around 5000 (comments not counted).'],
    '<Predicates>' = ['Not counted.'],
    '<Platform>' = ['VM/XA for IBM Mainframe.'],
    '<Type of Use>' = ['In-house'],'<When Deployed>' = ['December 1989'],
    '<No. of Users>' = ['10'],'<Information Date>' = ['March 1992']].
['<Program>' = ['Graph?'],'<Number>' = "|",'<Domain>' = ['Software design '],
    '<Purpose>' = ['Managing Networks of Persistent Data in Prolog'],
    '<Description>' = ['Submitted to PAC. Paper 229 '],
    '<Developed by>' = ['Martin Schnuch'],'<Country>' = ['Germany'],
    '<Prolog system>' = ['IF Prolog. '],'<Information Date>' = ['27/1/91']].
['<Program>' = ['Graphical Front Ends'],'<Number>' = [17],
    '<Domain>' = ['Electronic design; data modelling '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['Greg Munger'],'<Organization>' = ['IBM'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Quintus '],
    '<Other languages>' = [awk],
    '<Lines>' = ['1000-2000 per tool; 2 written so far'],
    '<Predicates>' = ['300'],
    '<Platform>' = ['IBM Risc System 6000; AIX 3.1'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['10-91'],'<No. of Users>' = ['20'],
    '<Information Date>' = ['11-91']].
['<Program>' = ['GraphicKnowledge'],'<Number>' = [479],
    '<Domain>' = ['Geographic Information Systems (GIS). ',' '],
    '<Purpose>' =
        [   'Extract structure from unstructured graphic files (e.g., "un-WYSIWYG" a 2-d line map).'],
    '<Description>' =
        ['GraphicKnowledge provides a framework for ','extracting ',
    ...
    '<Developed by>' = ['Peter Ludemann.'],
    '<Organization>' =
        ['Quintus, Intergraph Canada, City of Edmonton (Alberta).'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Quintus. '],
    '<Other languages>' = ['MDL (for data extract).'],
    '<Lines>' = ['5000 (plus use of Quintus Prolog library).'],
    '<Predicates>' = ['900'],
    '<Platform>' = ['SUN, Clipper / SunOS, CLIX / SunOS, CLIX.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['12/92'],'<No. of Users>' = ['N/A'],
    '<Information Date>' = ['09 Dec. 1992.']].
['<Program>' = ['GROG - General Recognition Of Gates in VLSI circuits'],
    '<Number>' = [419],'<Domain>' = ['CAD of VLSI circuits. '],
    '<Purpose>' =
        [   'Structural and Functional abstraction of VLSI. The prototype of this expert system is built upon Prolog. It performs the hierarchical abstraction of full custom VLSI circuits.'],
    '<Description>' =
        ['CAD verification tools employed in BULL make use of ',
            'an  abstraction process that extracts the structural and functional ',
    ...
    '<Developed by>' = ['J.B.Guignet.'],'<Organization>' = ['BULL S.A.'],
    '<Country>' = ['France'],
    '<Prolog system>' = ['SP-PROLOG (contains OOP capabilities). '],
    '<Lines>' = ['2000'],'<Predicates>' = ['1500'],
    '<Platform>' = ['SUN3,SUN4 and all BULL UNIX platforms.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['18/12/91'],'<Information Date>' = ['26/03/92']].
['<Program>' = ['GRONPAR'],'<Number>' = [335],
    '<Domain>' = ['Genetic research, parallel programming. '],
    '<Purpose>' =
        [   'MS-DOS operating system extensions for PROLOG interprocess communication over serial ports between programs running in parallel.'],
    '<Description>' =
    ...
    '<Country>' = ['The Netherlands.'],
    '<Prolog system>' = ['PDC Prolog 3.20 and later '],
    '<Other languages>' = ['C, Assembler.'],'<Lines>' = ['1000'],
    '<Predicates>' = ['10'],
    '<Platform>' = ['IBM PC, MSDOS 3.2 and higher, OS/2 machines.'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['06/91'],
    '<Information Date>' = ['17/02/92'],
    '<References>' =
...
['<Program>' = ['GULICO'],'<Number>' = "}",
    '<Domain>' = ['Medical information '],
    '<Purpose>' =
        ['Prolog Based Medical Data Manipulating System for Cardiologists'],
    '<Description>' = ['Submitted to PAC. Paper 296 '],
    '<Developed by>' = ['V. Meskhi'],'<Country>' = ['Russia'],
    '<Prolog system>' = ['Turbo '],'<Platform>' = ['PC AT'],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['GUNGA CLERK'],'<Number>' = [336],
    '<Domain>' = ['Legal expert systems. '],
    '<Purpose>' =
    ...
    '<Description>' =
        ['GUNGA CLERK is designed to accept key facts of a criminal ',
            ...
            'inferences. '],
    '<Developed by>' = ['David E. Woodin, Esq.'],
    '<Organization>' = ['Due Process Software.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['Turbo Prolog 2.0 (Now PDC Prolog) '],
    '<Other languages>' = ['None.'],'<Lines>' = ['3227 plus Toolbox.'],
    '<Predicates>' = ['220 plus Toolbox.'],
    '<Platform>' = ['IBM-PC and compatibles, MS DOS 2.0 or later.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['06/88'],'<Information Date>' = ['30/07/92'],
    '<References>' =
...
['<Program>' = ['HAMP'],'<Number>' = [194],
    '<Domain>' = ['Shipping scheduling '],
    '<Purpose>' = ['Dynamic voyage scheduling for tankers etc.'],
    '<Description>' =
    ...
    '<Prolog system>' = ['PDC '],
    '<Platform>' =
        [   '286/386 based PC with 8MB RAM, VGA or EGA monitor, OS/2 v 1.1 or later, any OS/2 compatible network']].
['<Program>' = ['HAPPS'],'<Number>' = [441],
    '<Domain>' = ['Production management system. '],
    '<Purpose>' = ['Parts selection for a type of modular house.'],
    '<Description>' =
    ...
    '<Other languages>' =
        ['Graphic library for the X window system written in C.(10%)'],
    '<Lines>' = ['150,000 lines (including parts database).'],
    '<Predicates>' = ['3,000 methods (equivalent to 10,000 predicates).'],
    '<Platform>' = ['SONY NEWS; 4.2/4.3BSD (development / delivery).'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['April 18, 1989'],
    '<No. of Users>' = ['60 persons (at 10 sites, including 7 plants).'],
    '<Information Date>' = ['April 15, 1992'],
    '<References>' =
        ['NIKKEI ARTIFICIAL INTELLIGENCE No.72 p.3 ',
            'December 19, 1988(bi-weekly newsletter) ']].
['<Program>' = ['HAPPS, TAPPS and MAPPS'],'<Number>' = [435],
    '<Domain>' = [' '],
    '<Purpose>' = ['Parts selection for modular housing.'],
    '<Description>' =
    ...
    '<Other languages>' = ['\araphic library on X window written by C.'],
    '<Lines>' = ['Over 100,000 lines.'],
    '<Predicates>' = ['3,000 methods (equivalent to 10,000 predicates).'],
    '<Platform>' =
        ['Ews (Sony News) ; 4.2/4.3BSD (development / delivery).'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['June 1, 1989.'],
    '<No. of Users>' = ['60 persons (at 10 sites, including 7 plants).'],
    '<Information Date>' = ['April 9, 1992.'],
    '<References>' =
        ['NIKKEI ARTIFICIAL INTELLIGENCE No.72 p.3 ',
...
['<Program>' = ['HATE'],'<Number>' = "#",
    '<Domain>' = ['Natural Language Processing '],
    '<Purpose>' = ['Semiautomatic extension of a thesaurus'],
    '<Description>' =
        ['HATE builds up thesaurus relations based on an existing ',
            'thesaurus and syntactic relations between words '],
    '<Developed by>' = ['R. Wirth'],'<Organization>' = ['IKBS'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['VM/Prolog '],
    '<Lines>' = ['950'],'<Predicates>' = ['270'],'<Platform>' = ['VM'],
    '<Type of Use>' = ['In-house'],
    '<Current Status>' = ['No longer supported'],
    '<When Deployed>' = ['12/84'],'<Information Date>' = ['1/92']].
['<Program>' = ['HESS (House Estimating System)'],'<Number>' = ":",
    '<Domain>' = ['Construction Estimating '],
    '<Purpose>' =
        [   'Prepares accurates estimates for the construction of houses using typical methods of construction'],
    '<Description>' =
    ...
    '<Developed by>' = ['Robin Drogemuller, John Smith'],
    '<Organization>' =
        ['James Cook University, University of Central Queensland'],
    '<Country>' = ['Australia'],
    '<Prolog system>' = ['LPA PROLOG, MACPROLOG '],
    '<Other languages>' = [none],'<Lines>' = ['4500'],
    '<Predicates>' = ['350'],'<Platform>' = ['IBM PC- MSDOS, Machintosh'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['11/91'],'<No. of Users>' = ['1'],
    '<Information Date>' = ['3/91'],
    '<References>' =
...
['<Program>' = ['HESYOD'],'<Number>' = "~",
    '<Domain>' = ['Program Synthesis '],
    '<Purpose>' =
        [   'Prototypes as Specifications for Automatic Synthesis of Logic Programs'],
    '<Description>' = ['Submitted to PAC. Paper 234 '],
    '<Developed by>' = ['A. Ja. Dikovsky'],'<Country>' = ['Russia'],
    '<Information Date>' = ['19/10/91']].
['<Program>' = ['HOSROS'],'<Number>' = [404],'<Domain>' = ['Health. '],
    '<Purpose>' = ['Optimizing a roster of Doctors in a hospital.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Stewart Rosenberg.'],
    '<Organization>' = ['Bourges Psychiatric Hospital.'],
    '<Country>' = ['France.'],'<Prolog system>' = ['Turbo Prolog. '],
    '<Other languages>' =
        ['UNIX / SB - Prolog     + 80386 / LPA - Prolog ++'],
    '<Lines>' = ['850'],'<Predicates>' = ['105  (non-system).'],
    '<Platform>' = ['8088/DOS 3.0'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['July 1988'],
    '<No. of Users>' = ['unknown.'],'<Information Date>' = ['06/10/92'],
    '<References>' =
        ['Programming medical rosters in Prolog, Medical ',
            'Informatics (1988), Vol. 13, 187-198. ']].
['<Program>' = ['HPLus'],'<Number>' = [308],
    '<Domain>' = ['Computer Based Training '],
    '<Purpose>' =
        [   'Diagnosis of errors during execution of PROLOG programmes and generation of alternatives.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Karlhorst Klotz'],
    '<Organization>' = ['Technische Universitat Munchen'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['IF/PROLOG '],
    '<Other languages>' = ['MOTIF (Interface)'],'<Lines>' = ['20,000'],
    '<Platform>' = ['HP, SUN, VAX UNIX'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['5/91'],
    '<No. of Users>' = ['30'],'<Information Date>' = ['4/92']].
['<Program>' = ['HPSG-PL'],'<Number>' = [444],
    '<Domain>' = ['Computational linguistics, natural language parsing. '],
    '<Purpose>' = ['Designing grammars for parsing natural language.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Fred Popowich, Sandi Kodric, Carl Vogel.'],
    '<Organization>' = ['Natural Language Lab, Simon Fraser University.'],
    '<Country>' = ['Canada.'],
    '<Prolog system>' = ['Quintus Prolog / Sicstus Prolog. '],
    '<Other languages>' =
        [   'Has an interface to the TreeTool system, a graphic interface written in C running under Sunview and X view Has also been used with a Lisp-based program for converting natural language queries into SQL which is then passed onto an Oracle Database.'],
    '<Lines>' =
        [   'Total number of lines (blank and comment lines included) comes to approx. 1000.'],
    '<Predicates>' = ['about 110'],'<Platform>' = ['SUN / UNIX'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['October 1991'],
    '<No. of Users>' = ['20'],'<Information Date>' = ['Apr 22, 1992'],
    '<References>' =
        ['@TechReport(Pop91d, ',
            'author =        "Popowich, Fred and Carl Vogel", ',
            'title = "The {HPSG-PL} System", ',
            'institution =   "School of Computing Science, ',
            'Simon Fraser University, Burnaby, B.C.", ','year =  "1991", ',
            'number =        "CSS-IS TR 91-08", ',
            'key =   "Popowich and Vogel") ','@InCollection ','(Pop91a, ',
            'author =        "Popowich, Fred and Carl Vogel", ',
            'title = "A Logic Based Implementation of Head-Driven Phrase ',
            'Structure ','Grammar", ','year =  "1991", ',
            'editor = "C.G. Brown and G. Koch", ',
            'booktitle = "Natural Language Understanding and Logic ',
            'Programming, III" ',', ',
            'publisher = "Elsevier, North-Holland", ','pages= "227-246", ',
            'key =   "Popowich and Vogel") ','@InProceedings(Pop92a, ',
            ...
            'organization =  "Nantes, France", ','year =  "1992", ',
            'key =   "Popowich et. al.") ']].
['<Program>' = ['HRM SIMULATOR'],'<Number>' = [300],
    '<Domain>' = ['Human Resourse Management '],
    '<Purpose>' =
        [   'Model the impacts of human resource management policies within organizations.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Gregory Bourassa, Patrick Cunningham'],
    '<Organization>' =
        [   'The Cody Group (under contract to Department of National Defence.'],
    '<Country>' = ['Canada'],
    '<Prolog system>' = ['PDC PROLOG  (OS/2)  ver. 3.21 '],
    '<Other languages>' =
        [   'PROLOG meta-interpreter written in PDC PROLOG.  Less than 1/5 of code but does all user rule interpretation.'],
    '<Lines>' = ['~5000'],'<Predicates>' = ['~700'],
    '<Platform>' = ['IBM Compatible     386, 486, machines running OS/2'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['March 1991'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['Jan. 1992'],
    '<References>' =
        ['User guide and system reference manual available from ',
            '(above) contact. ']].
['<Program>' = ['Human Rights Hypertext System'],'<Number>' = [405],
    '<Domain>' = ['International Relations, Education. '],
    '<Purpose>' =
        ['Hypertext System for eight international human rights documents.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Michael Niemann.'],
    '<Organization>' = ['Trinity College.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['PDC Prolog. '],'<Other languages>' = ['none.'],
    '<Lines>' = [??],'<Predicates>' = ['500'],
    '<Platform>' = ['MS DOS Computers.'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['September 1991'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['March 1992'],'<References>' = ['none. ']].
['<Program>' = ['Hypertext Toolbox'],'<Number>' = [193],
    '<Domain>' = ['Hypertext system '],
    '<Purpose>' =
        ['To provide the building blocks to develop a hypertext system'],
    '<Description>' =
        ['There are three basic building blocks in the ','toolkit. ',
    ...
    '<Prolog system>' = ['PDC Prolog '],'<Platform>' = ['IBM PC'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released']].
['<Program>' = ['IBM SAA LanguageAccess'],'<Number>' = [423],
    '<Domain>' = ['Natural language processing. '],
    '<Purpose>' = ['Natural language interface to relational databases.'],
    '<Description>' =
    ...
    '<Developed by>' = ['NLP Department, IBM Nordic Laboratories.'],
    '<Organization>' = ['IBM'],'<Country>' = ['Sweden.'],
    '<Prolog system>' = ['IBM Prolog, Quintus Prolog, Arity Prolog. '],
    '<Other languages>' = ['C, Assembler.'],
    '<Lines>' = ['Around 80000 (comments not counted).'],
    '<Predicates>' = ['Not counted.'],
    '<Platform>' =
        [   'VM/XA, MVS/XA, and MVS/ESA for IBM mainframe,  AIX for RS/6000, and OS/2 for IBM PS/2.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['December 1990'],
    '<No. of Users>' = ['Information not available.'],
    '<Information Date>' = ['March 1992'],
    '<References>' =
...
['<Program>' = ['ICEBERG ELECTRIC'],'<Number>' = [390],
    '<Domain>' = ['Electrical dispatching. '],
    '<Purpose>' =
        ['Support for the train tracks electrical network management.'],
    '<Description>' =
        ['Expert system that is associated with tools for ','editing the ',
    ...
    '<Developed by>' = ['Jose A. Marques and programmers team.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain.'],
    '<Prolog system>' = ['PDC Prolog 3.21 '],'<Other languages>' = ['void.'],
    '<Lines>' = ['35000'],'<Predicates>' = ['1500'],
    '<Platform>' = ['Developed PC 386 / MS DOS Delivery PC 386 / MS DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['05/1992'],'<Information Date>' = ['07/1992']].
['<Program>' = ['IF/Man'],'<Number>' = [324],
    '<Domain>' = ['Text analysis. '],
    '<Purpose>' =
        [   'Automatic conversion of the IF/PROLOG programming manual into hypertext.'],
    '<Description>' =
        ['The program converts the input data-a programming manual- ',
            ...
            'topic. '],
    '<Developed by>' = ['Norbert Rossler, Thomas Schonauer.'],
    '<Organization>' = ['Interface Computer GmbH, Munich.'],
    '<Country>' = ['Germany.'],
    '<Prolog system>' = ['IF/PROLOG  Version 4.1 '],
    '<Other languages>' = ['C for printer emulation  (~ 5000 l.o.c.)'],
    '<Lines>' = ['7200'],'<Predicates>' = ['380'],
    '<Platform>' = ['Any UNIX system.'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['06/91'],
    '<No. of Users>' = ['4'],'<Information Date>' = ['04/92'],
    '<References>' =
        ['Conference Proceedings: ',
            '-IF/PROLOG User Day 1991  (also:  Newsletter Vol. 6) ',
            '-GUUG 1991, Wiesbaden. ']].
['<Program>' = ['IMAGIA'],'<Number>' = [221],
    '<Domain>' = ['Electronic manufacture '],
    '<Purpose>' =
    ...
    '<Organization>' = ['Dassault Electronique'],'<Country>' = ['France'],
    '<Prolog system>' = ['Emicat '],
    '<References>' =
        ['Dassault Electronique report: Les Techniques ',
            'Informatiques avancees et leurs applications. NE 485 352, 30th Apr 1991. ']].
['<Program>' = ['INDICAID (Intelligent diagnostic computer aid)'],
    '<Number>' = [338],
    '<Domain>' = ['Trouble-shooting in technical installations. '],
    '<Purpose>' =
        [   'Correlation of faults detected by built-in test equipment in the sensor, weapon and command system on the Dutch Multipurpose-frigate.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Paul van Oordt.'],
    '<Organization>' = ['Sponsored by the Royal Netherlands Navy.'],
    '<Country>' = ['The Netherlands.'],
    '<Prolog system>' = ['Quintus Prolog. '],'<Other languages>' = ['None.'],
    '<Lines>' = ['6000'],'<Predicates>' = ['300'],'<Platform>' = ['Sun.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['06/92'],'<Information Date>' = ['07/92'],
    '<References>' =
        ['Van Oordt, H.P.  INDICAID:  zeer hoog nivo model- ',
            ...
            'Dutch. ']].
['<Program>' = ['Infologics Faultfinder System'],'<Number>' = "Z",
    '<Domain>' = ['Service Engineering '],'<Purpose>' = [''],
    '<Description>' =
    ...
    '<Prolog system>' = ['LPA MacProlog '],'<Platform>' = ['Macintosh'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released']].
['<Program>' =
    ['Information retrieval system processing data on pests and pesticides'],
'<Number>' = [281],'<Domain>' = ['Retrieval Systems '],
'<Purpose>' = ['Retrieves and processes data about pests and pesticides'],
'<Description>' =
...
'<Developed by>' = ['I. Futo, F. Darvas, P. Szeredi'],
'<Country>' = ['Hungary'],'<Information Date>' = ['1984'],
'<References>' =
    ['I. Futo, F. Darvas, P. Szeredi (1978) ',
        'The application  of Prolog to the development of QA and DBM systems. ',
        'In Logic and Databases ','H. Gallaire and J. Minker (eds) ']].
['<Program>' =
    ['Initial growth model for radiata pine in the Central North Island'],
'<Number>' = [6],'<Domain>' = ['Forest management '],
'<Purpose>' =
    [   'To represent a mathematical model of the response of young Radiata pine trees to weed control; ripping; discing; and fertilisation on a range of sites.'],
'<Description>' =
...
'<Developed by>' = ['E.G. Mason'],
'<Organization>' = ['Forest plantation establishment'],
'<Country>' = ['New Zealand'],'<Prolog system>' = ['PDC Prolog 3.2 '],
'<Other languages>' = ['None'],'<Lines>' = ['3000 approx'],
'<Predicates>' = ['150 approx'],'<Platform>' = ['MS-DOS'],
'<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
'<When Deployed>' = ['not yet deployed to managers'],
'<No. of Users>' = ['none yet'],'<Information Date>' = ['24 October 1991'],
'<References>' =
    ['E.G. Mason; (in prep); PhD thesis at the University ','of ',
        'Canterbury. ',
        ...
        '; edited by J.C. Allen ','and A.G.D. Whyte; pp 292-300 ','New ',
        'Directions in Forestry: Costs and Benefits of Change ']].
['<Program>' = ['INTERACT'],'<Number>' = [239],
    '<Domain>' = ['medical prescription '],
    '<Purpose>' =
    ...
    '<Description>' =
        ['The knowledge base contains information about how ',
            ...
            'drugs '],
    '<Organization>' = ['Hungarian Institute of  Pharmacy, IQSOFT'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MProlog '],
    '<Lines>' = ['1800 clauses (KB), 900  (maintenance) 800 question'],
    '<Platform>' = ['PC 286, MS-DOS'],
    '<References>' =
        [   'K. Konzn\216 Zar\207ndy, K. Moln\207r: INTERACT: consulting system ',
            'for drug interaction. in A. G\207bor (ed) Expert Systems 88 - Knowledge based ',
            'information processing, Sz\214malk, Budapest, 1988. pp213-231 (in Hungarian). ']].
['<Program>' = ['IPHONE'],'<Number>' = [457],
    '<Domain>' = ['Office Automation. '],
    '<Purpose>' = ['On-line electronic corporate phone book.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Peter Reintjes.'],
    '<Organization>' = ['Intergraph Corporation.'],'<Country>' = ['USA'],
    '<Prolog system>' = ['Quintus Prolog '],'<Other languages>' = [none],
    '<Lines>' = ['553'],'<Predicates>' = ['131'],
    '<Platform>' = ['Quintus Platforms'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['12/90'],
    '<No. of Users>' = ['10'],'<Information Date>' = ['11/92'],
    '<References>' =
        ['``Prolog for an Afternoon on the Phone\'\' ',
            'Intergraph internal document ']].
['<Program>' = ['ISCN Expert'],'<Number>' = "W",'<Domain>' = ['Health '],
    '<Purpose>' = ['Interpret chromosomal abnormalities'],
    '<Description>' =
        ['The expert system allows geneticists to better reference ',
            ...
            'the registry. '],
    '<Developed by>' = ['Dr. Glen Cooper,  Dr. J.M. Friedman'],
    '<Organization>' =
        [   'British Columbia Health Care Research Foundation, Ministry of Advanced Education, Training and Technology of Canada'],
    '<Country>' = ['Canada'],'<Prolog system>' = ['Arity Prolog '],
...
['<Program>' = ['(IT) 2  Information-theoretic induction tools'],
    '<Number>' = [304],'<Domain>' = ['Process optimization '],
    '<Purpose>' =
        [   'Induction of rules from examples with real-valued attributes used for the classification of semiconductor films'],
    '<Description>' =
        ['Based on given pre-classified examples the system ',
            ...
            'induced classifiers. '],
    '<Developed by>' = ['Erik-Kamsties, Gunter Seidelmann'],
    '<Organization>' = ['Hahn-Meitner-Institut, Berlin GmbH'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['IF/PROLOG '],
    '<Other languages>' = ['None'],'<Lines>' = ['~ 4000'],
    '<Predicates>' = ['~ 200'],'<Platform>' = ['DECstation ULTRIX'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['October 1991'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['April 1992'],
    '<References>' =
...
['<Program>' = ['JONSWAP 3D Wave Force Analysis'],'<Number>' = "c",
    '<Domain>' = ['Nautical Research '],'<Purpose>' = [''],
    '<Description>' =
    ...
    '<Developed by>' = ['Newastle University, Imperial College, London'],
    '<Country>' = ['UK'],'<Prolog system>' = ['Strand88 ']].
['<Program>' = ['JUMAN'],'<Number>' = [438],
    '<Domain>' = ['Natural Language Processing '],
    '<Purpose>' = ['Morphological analysis for Japanese language.'],
    '<Description>' =
        ['A Japanese sentence is segmented into a lattice ',
            'structure of words.  The dictionary transfomation and look-up part are ',
            'written in C. '],
    '<Developed by>' = ['Yuji Matsumoto.'],
    '<Organization>' =
        ['Deptartment of Electrical Engineering, Kyoto University.'],
    '<Country>' = ['Japan.'],'<Prolog system>' = ['SICStus Prolog '],
    '<Other languages>' =
        ['C programs for the interface of the dictionary.'],
    '<Lines>' = ['500'],'<Predicates>' = ['35'],
    '<Platform>' = ['SUN SPARCstation.'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['February 1992'],
    '<No. of Users>' = ['20'],'<Information Date>' = ['20 April 1992']].
['<Program>' = ['KALIPSOS'],'<Number>' = [232],
    '<Domain>' = ['User interfaces '],
    '<Purpose>' =
        [   'converting natural language sentences into a rigorous formal representation in order to allow deduction and information retrieval'],
    '<Description>' =
    ...
    '<Organization>' = ['IBM Paris Scientic Center'],
    '<Country>' = ['France'],'<Prolog system>' = ['IBM Prolog '],
    '<Platform>' = ['370 (VM/SP) and OS/2']].
['<Program>' = ['KAMIIH       (Kasmoc  Models programming environment'],
    '<Number>' = [303],'<Domain>' = ['Engineering drawing in 2D and 3 D '],
    '<Purpose>' =
        [   'Graphic definition and management of objects in 2D and 3D domains'],
    '<Description>' =
    ...
    '<Developed by>' = ['SUSI DULLI - VITALIANO MILANESE'],
    '<Organization>' = ['University of Padova and University of Udine'],
    '<Country>' = ['Italy'],'<Prolog system>' = ['LPA PROLOG 3.0 '],
    '<Lines>' = ['800'],'<Predicates>' = ['200'],
    '<Platform>' = ['Apple Macintosh II FX Soft:  KASMOC'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['January 1989'],'<No. of Users>' = ['4'],
    '<Information Date>' = ['Nov. 25, 1991'],
    '<References>' =
...
['<Program>' = ['KANAL (KArlsruhe NArrowing Laboratory)'],'<Number>' = [367],
    '<Domain>' = ['Logic-functional programming. '],
    '<Purpose>' = ['Narrowing laboratory.'],
    '<Description>' =
        ['Narrowing can be used for equation solving in ','equational ',
    ...
    '<Organization>' =
        [   'University of Karlsruhe, partly supported by the Deutsche Forschungsgemeinschaft (SFB 314, project S2).'],
    '<Country>' = ['Germany.'],
    '<Prolog system>' =
    ...
    '<Lines>' = ['circa 9400'],'<Predicates>' = ['circa 580'],
    '<Platform>' = ['UNIX, SUN workstations.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['1990'],'<No. of Users>' = ['5'],
    '<Information Date>' = ['August 12th, 1992'],
    '<References>' =
        ['S. Krischer: Vergleich und Bewertung von ',
            ...
            'Verlag), 1992. ']].
['<Program>' = ['KANN (KArlsruhe Normal Narrowing)'],'<Number>' = [369],
    '<Domain>' =
        ['Used as declarative language for general purposes like PROLOG ',
            'itself. '],
    '<Purpose>' =
        [   'Compiler for the logical-functional language KANN which is an extension of the KA-Prolog compiler.'],
    '<Description>' =
        ['A logical-functional KANN program consists of a ','set of con ',
            ...
            'Prolog compiler. '],
    '<Developed by>' = ['N. Lindenberg, C. Scharnhorst.'],
    '<Organization>' =
        [   'University of Karlsruhe, partly supported by the Deutsche Forschungsgemeinschaft (SFB 314, project S2).'],
    '<Country>' = ['Germany.'],
    '<Prolog system>' = ['KA-Prolog (WAM based). '],
    '<Lines>' = ['7500 (500)'],'<Predicates>' = ['400  (20)'],
    '<Platform>' = ['UNIX-OS, SUN workstations.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['does exist since 12 months.'],
    '<No. of Users>' = ['5'],'<Information Date>' = ['August 11th, 1992.'],
    '<References>' =
        ['M. Gollner, C. Scharnhorst: "Integration logischer ','und fun ',
...
['<Program>' = ['Karyotype parser'],'<Number>' = [206],
    '<Domain>' = ['Genetics Research '],'<Purpose>' = [''],
    '<Description>' =
    ...
    '<Developed by>' = ['D. B. Searls'],
    '<Organization>' = ['Paoli Research Center, Unisys Corp.'],
    '<Country>' = ['USA'],
    '<References>' =
...
['<Program>' = ['KASA'],'<Number>' = "Q",
    '<Domain>' = ['Software Engineering '],
    '<Purpose>' =
        ['To analyse the structure of large (Ada) software systems.'],
    '<Description>' =
        ['Information about the structure of a software ','system ',
            ...
            'the hot-spots. '],
    '<Developed by>' = ['Philip Dart Rudi Vernik Gina Kingston'],
    '<Organization>' = ['Defence Science & Technology Organisation'],
    '<Country>' = ['Australia'],
    '<Prolog system>' =
        ['Quintus Prolog with Quintus Prowindows and ','Quintus ProDBI. '],
    '<Other languages>' =
        [   'Oracle database for information retrieval, and results storage. An Ada parser is used to put the initial information into the database.'],
    '<Lines>' = ['3500 (lines in current in-use system)'],
    '<Predicates>' = ['326'],'<Platform>' = ['Sun SPARC OS 4.1.1'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' =
        [   'Jan 1991 - Information and views were in use as they we added to the system. Text files of the information were used before any views were available.'],
    '<No. of Users>' = ['3 (directly) + 3 (use results, screen dumps ...)'],
    '<Information Date>' = ['17 March 1992'],
    '<References>' = ['Paper in progress. ']].
['<Program>' = ['KBTDA'],'<Number>' = [127],'<Domain>' = ['DDB '],
    '<Purpose>' =
        [   'a Knowledge-Based Database Transaction Design Tool Implemented in Prolog'],
    '<Description>' = ['Submitted to PAC. Paper 233 '],
    '<Developed by>' = ['Wang, Gray & Fiddian'],'<Country>' = ['UK'],
    '<Prolog system>' = ['Poplog '],'<Platform>' = ['Sun'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['KCM Help- Desk'],'<Number>' = [128],
    '<Domain>' = ['Computer Systems '],
    '<Purpose>' = ['The KCM / Help- Desk Project'],
    '<Description>' = ['Submitted to PAC. Paper 317 '],
    '<Developed by>' = ['Richard Bland et al'],'<Country>' = ['UK'],
    '<Prolog system>' = ['SEPIA '],'<Platform>' = ['KCM'],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['KNOWLEDGE EDITOR 3.20'],'<Number>' = [340],
    '<Domain>' = ['Computer Based Training. '],
    '<Purpose>' = ['General Purpose Training Program.'],
    '<Description>' =
    ...
    '<Prolog system>' = ['PDC Prolog 3.20 '],
    '<Other languages>' =
        ['DOS batch language for graphic and sound application.'],
    '<Lines>' = [void],'<Predicates>' = [void],
    '<Platform>' = ['DOS 4.01, AT 1 MB RAM, 20 MB Disk.'],
    '<When Deployed>' = ['ca.  1988 (including previous version).'],
    '<No. of Users>' = ['1'],'<Information Date>' = ['23/06/92'],
    '<References>' = ['void. ']].
['<Program>' = ['Knowledge-based Image analysis system'],'<Number>' = [228],
    ...
    '<Developed by>' = ['BIM, Saab Instruments'],
    '<Country>' = ['Belgium, Sweden']].
['<Program>' = ['KONE Predicate library'],'<Number>' = [129],
    '<Domain>' = ['Software Develpment '],
    '<Purpose>' = ['Prolog Predicate Library: A Practioners Approach'],
    '<Description>' = ['Submitted to PAC. Paper 209 '],
    '<Developed by>' = ['Mr Kari Hakkarainen'],'<Country>' = ['Finland'],
    '<Information Date>' = ['17/10/91']].
['<Program>' = ['KONFIRM'],'<Number>' = [355],
    '<Domain>' = ['Database for church use. '],
    '<Purpose>' = ['Database to log candidates for confirmation.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Sigve B_'],'<Organization>' = ['SigveSaker'],
    '<Country>' = ['Norway.'],
    '<Prolog system>' = ['PDC Prolog 3.21 + PDC Toolbox. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['1500'],
    '<Predicates>' = ['37'],'<Platform>' = ['MS-DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['07/91'],'<Information Date>' = ['12/08/92']].
['<Program>' = ['KONFIX'],'<Number>' = [130],'<Domain>' = ['PLAN '],
    '<Purpose>' =
        ['a Configuration System For SOS-Emergency Services Systems'],
    '<Description>' = ['Submitted to PAC. Paper 505 '],
    ...
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['KonText'],'<Number>' = [12],'<Domain>' = ['Text Analysis '],
    ...
    '<Developed by>' = ['Paul Holmes-Higgin'],
    '<Organization>' = ['University of Surrey'],'<Country>' = ['England'],
    '<Prolog system>' = ['Quintus Prolog '],
    '<Other languages>' = ['Quintus ProWindows'],'<Lines>' = ['3000'],
    '<Predicates>' = ['330'],'<Platform>' = ['Sun 4 / SunOS4'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1991'],'<No. of Users>' = ['5'],
    '<Information Date>' = ['Oct 1991'],
    '<References>' =
...
['<Program>' = ['KORE/IE'],'<Number>' = [219],
    '<Domain>' = ['Expert systems '],
    '<Purpose>' = ['A fast implementation of a production system in Prolog'],
    '<Description>' =
    ...
    '<Developed by>' = ['Toramatsu Shintani'],
    '<Organization>' = ['IIAS-SIS Fujitsu Ltd'],'<Country>' = ['Japan'],
    '<Prolog system>' = ['C-Prolog, Quintus '],
    '<Platform>' = ['VAX 11/780, SUN 3/52'],
    '<References>' =
        ['T. Shintani: A Fast Prolog-based Production System ',
            'KORE/IE. ICLP5, 1988, pp26-41 ']].
['<Program>' = ['KORNPLAN'],'<Number>' = [19],'<Domain>' = ['Logistics '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['Lars Bo Steffensen'],
    '<Organization>' = ['AHTS; Rosenoerns Alle 1; Frederiksberg C.'],
    '<Country>' = ['Denmark'],'<Prolog system>' = ['PDC Prolog 3.21 ',' '],
    '<Other languages>' = ['None'],'<Lines>' = ['10000?'],
    '<Predicates>' = ['500?'],
    '<Platform>' = ['IBM comp. PC; DOS 3.3 or higher.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1/10 1990'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['6/1 1992']].
['<Program>' = ['L-Form'],'<Number>' = [403],
    '<Domain>' = ['Form Processing. '],
    '<Purpose>' =
        [   'L-Form is used in corporate or government markets to automate form processing. Generate a laser graphic form.'],
    '<Description>' =
        ['The L-Form program series generates froms on ',
            ...
            'transfer. '],
    '<Developed by>' = ['North Winds.'],
    '<Organization>' = ['North Winds & Hoffmann-La Roche, Inc.'],
    '<Country>' = ['USA.'],'<Prolog system>' = ['PDC Prolog '],
    '<Other languages>' = ['None.'],'<Lines>' = ['15000'],
    '<Predicates>' = ['600'],
    '<Platform>' =
        [   'MSDOS 2.0 512K memory, most dot matrix, daisywheel & laser, printers hard or floppy drive systems.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['September 15, 1992.'],
    '<Information Date>' = ['September 14, 1992.'],'<References>' = ['N/A ']].
['<Program>' = ['LanguageAccess'],'<Number>' = [30],
    '<Domain>' = ['cross industry '],
    '<Purpose>' = ['Natural language query of relational databases'],
    '<Description>' =
        ['LanguageAccess is a multilingual natural language ',
    ...
    '<Developed by>' =
        ['M. Sanamrad; G. Jonsson; H. Lehmann; M. Zoeppritz; B. White'],
    '<Organization>' = ['IBM Nordic Lab; IKBS; T.J.Watson RC'],
    '<Country>' = ['Sweden; Germany; USA'],
    '<Prolog system>' = ['VM/Prolog; Quintus Prolog; BIM, Arity, Sicstus '],
    '<Other languages>' = ['C; Assembler'],'<Lines>' = ['60000'],
    '<Predicates>' = ['10000'],'<Platform>' = ['MVS;VM'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['12/91'],'<Information Date>' = ['1/92'],
    '<References>' =
...
['<Program>' = ['Laser Blankrupter'],'<Number>' = [396],
    '<Domain>' = ['Legal forms processing. '],
    '<Purpose>' =
        [   'Completely processes all the Federal Bankruptcy Forms for chapter 7, 11, 12 & 13 bankruptcy filings.'],
    '<Description>' =
    ...
    '<Developed by>' = ['North Winds and Julius Blumberg Inc.'],
    '<Organization>' = ['North Winds and Julius Blumberg Inc.'],
    '<Country>' = ['USA.'],'<Prolog system>' = ['PDC Prolog (100%) '],
    '<Other languages>' = ['none.'],'<Lines>' = ['18.000'],
    '<Predicates>' = ['600'],
    '<Platform>' =
        [   'MSDOS 2.0 512K memory, most dot matrix, daisywheel & laser printers, hard or floppy drive systems.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/1/91'],'<Information Date>' = ['9/1/92'],
    '<References>' = ['Article: National Law Review by Richard Gertler. ']].
['<Program>' = ['LDM'],'<Number>' = [268],
    '<Domain>' = ['Software development tools '],
    '<Purpose>' = ['A logic based development method'],
    '<Description>' =
    ...
    '<Developed by>' = ['K. Balogh, Z. Farkas, E. Santane-Toth, P. Szeredi'],
    '<Organization>' = ['SzKI'],'<Country>' = ['Hungary'],
    '<Prolog system>' = ['MPROLOG '],'<Information Date>' = ['1984'],
    '<References>' =
        ['K. Balogh, Z. Farkas, E. Santane-Toth, P. Szeredi ','(1979) ',
            ...
            'Society, Szeged ','1979. pp 36-45 ',' ',
            'K. Balogh, Z. Farkas, E. Santane-Toth, P. Szeredi (1979) ',
            'The LDM system - a design outline. ',
            'SzKI report, SOFTECH D46, SZAMKI, 1979. ',' ',
            'Z. Farkas (1981) ','User\'s manual of the LDM system ',
            'SzKI report, 1981. ',' ',
            ...
            ' ',' ']].
['<Program>' = ['Leonardo'],'<Number>' = [177],
    '<Domain>' = ['Database interface '],
    '<Purpose>' = ['Intelligent front end to free text database'],
    '<Description>' =
    ...
    '<Prolog system>' = ['Quintec ']].
['<Program>' = ['LES - Laboratory Expert System'],'<Number>' = "X",
    '<Domain>' = ['Biomedical Research '],
    '<Purpose>' = ['Expert System for Designing PC Boards'],
    '<Description>' =
    ...
    '<Prolog system>' = ['Arity Prolog '],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released']].
['<Program>' = ['LEX0'],'<Number>' = [31],
    '<Domain>' = ['Legal expert system '],
    '<Purpose>' = ['Expert System on German traffic law'],
    '<Description>' =
    ...
    '<Developed by>' = ['S. Grundmann; W. Schoenfeld'],
    '<Organization>' = ['IKBS'],'<Country>' = ['Germany'],
    '<Prolog system>' = ['VM/Prolog '],'<Lines>' = ['1000'],
    '<Predicates>' = ['200'],'<Platform>' = ['VM'],
    '<Type of Use>' = ['In-house'],
    '<Current Status>' = ['No longer supported'],
    '<When Deployed>' = ['6/84'],'<Information Date>' = ['1/92']].
['<Program>' = ['LEX1'],'<Number>' = " ",
    '<Domain>' = ['Legal expert system '],
    '<Purpose>' = ['Expert System on German traffic law'],
    '<Description>' =
    ...
    '<Organization>' = ['IKBS'],'<Country>' = ['Germany'],
    '<Prolog system>' = ['VM/Prolog '],'<Other languages>' = ['PL1'],
    '<Lines>' = ['10000'],'<Predicates>' = ['2000'],'<Platform>' = ['VM'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['9/87'],'<Information Date>' = ['1/92']].
['<Program>' = ['LEX2'],'<Number>' = "!",
    '<Domain>' = ['Legal expert system '],
    '<Purpose>' = ['Expert System on German traffic law'],
    '<Description>' =
    ...
    '<Organization>' = ['IKBS'],'<Country>' = ['Germany'],
    '<Prolog system>' = ['VM/Prolog '],'<Other languages>' = ['PL1'],
    '<Lines>' = ['1000'],'<Predicates>' = ['200'],'<Platform>' = ['VM'],
    '<Type of Use>' = ['In-house'],
    '<Current Status>' = ['No longer supported'],
    '<When Deployed>' = ['12/87'],'<Information Date>' = ['1/92']].
['<Program>' = ['LIMBO'],'<Number>' = [195],
    '<Domain>' = ['Airline planning '],
    '<Purpose>' = ['Aircraft maintenance planning'],
    '<Description>' =
    ...
    '<Prolog system>' = ['PDC '],
    '<Platform>' =
        [   '386 based PC with 12MB RAM, VGA or EGA monitor, OS/2 v 1.2 or later. 3270 and LU6.2 communications currently implemented'],
    '<Current Status>' = ['Released']].
['<Program>' = ['LIMBO - Line Maintenance Bottleneck Detection'],
    '<Number>' = [21],'<Domain>' = ['Airline Fleet Management '],
    '<Purpose>' = ['Integrated Flight and Maintenance Planning'],
    '<Description>' =
    ...
    '<Developed by>' =
        ['Lars Malmgren Hansen; Lars Henrik Jacobsen; Mikael Nielsen'],
    '<Organization>' = ['Prolog Development Center'],
    '<Country>' = ['Denmark'],'<Prolog system>' = ['PDC Prolog '],
    '<Other languages>' = ['C'],'<Lines>' = ['>10.000  <100.000'],
    '<Platform>' = ['OS/2 PM'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['03/92'],
    '<No. of Users>' = ['25'],'<Information Date>' = ['01/92']].
['<Program>' = ['Linear Objects (LO)'],'<Number>' = [15],
    '<Domain>' = ['Computer systems '],
    '<Purpose>' =
        [   'Prototype of an interpreter for a process based concurrent programming language (called LO).'],
    '<Description>' =
    ...
    '<Developed by>' = ['JM. Andreoli and R. Pareschi'],
    '<Organization>' = ['European Computer Industry Research Center'],
    '<Country>' = ['Germany'],
    '<Prolog system>' =
        ['Sepia ','- compiles to some extended WAM code ',' '],
    '<Other languages>' = [none],'<Lines>' = ['1200'],
    '<Predicates>' = ['150'],'<Platform>' = ['Sun workstation; Unix'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['around June 91'],'<No. of Users>' = ['4'],
    '<Information Date>' = ['November 91'],
    '<References>' =
        ['Among others ','"LO and behold! Concurrent structured Processes" ',
            'JM. Andreoli and R. Pareschi ',
            'proc. of OOPSLA\'91 (Phoenix; Az) ']].
['<Program>' = ['LMT'],'<Number>' = [204],
    '<Domain>' = ['Machine translation '],
    '<Purpose>' = ['Machine translation system for English to German'],
    '<Description>' =
    ...
    '<Developed by>' = ['M. McCord'],
    '<Organization>' = ['IBM Yorktown Heights Laboratory'],
    '<Country>' = ['USA'],'<Prolog system>' = ['VM/Prolog '],
    '<Lines>' = ['1,950 clauses, plus 1,750 for lexicons'],
    '<Platform>' = ['IBM 3081'],
    '<References>' =
...
['<Program>' = ['LMTX'],'<Number>' = [205],
    '<Domain>' = ['Machine translation '],
    '<Purpose>' = ['Multi-target machine translation system'],
    '<Description>' =
...
['<Program>' = ['Loganair Scheduler'],'<Number>' = [185],
    '<Domain>' = ['Airline scheduling '],
    '<Purpose>' =
        [   'Help in planning and calculation of flight crew duty rosters for airline'],
    '<Description>' =
...
['<Program>' = ['LogicBase'],'<Number>' = [131],'<Domain>' = ['KBS '],
    '<Purpose>' = ['"LogicBase, A Knowledge Base Program"'],
    '<Description>' = ['Submitted to PAC. Paper 368 '],
    '<Developed by>' = ['Ruggles'],'<Country>' = ['UK'],
    '<Prolog system>' = ['PDC Prolog '],'<Platform>' = ['any IBM XT'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['LOGICLANDIA'],'<Number>' = [433],
    '<Domain>' =
        ['Education, more precisely the teaching of predicates logic. '],
    '<Purpose>' =
        [   'Supporting the teaching of predicates logic in Italian middle and upper secondary schools.'],
    '<Description>' =
        ['LOGICLANDIA is a Prolog shell to create, edit and ',
            ...
            'Italian schools. '],
    '<Developed by>' = ['Donatella Persico, Carlo Innocenti.'],
    '<Organization>' =
        ['Consiglio Nazionale Ricerche - Istituto Tecnologie Didattiche'],
    '<Country>' = ['Italy.'],'<Prolog system>' = ['Arity Prolog '],
    '<Other languages>' = ['Microsoft C 6.0'],'<Lines>' = ['30000'],
    '<Predicates>' = ['1000'],'<Platform>' = ['286 micro + DOS OS'],
    '<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['September \'92'],
    '<No. of Users>' =
        ['400 during evaluation, hopefully many more when sold.'],
    '<Information Date>' = ['April 92'],
    '<References>' =
        ['Persico D. (1990) ','Teaching logic: why and how ',
            'in: Roy Winterburn (ed) Aspects of Educational and Training ',
            'Technology, Vol. XXIV, Kogan Page, London, pp.111-116 ',
            'Persico D. (1990) ','Guided discovery learning of logic ',
...
'<Number>' = [370],
'<Domain>' =
    ['Used as declarative language for general purposes like ','PRO ',
        'LOG itself. '],
'<Purpose>' =
    [   'Compiler for the order-sorted logical language LOPSTER which is an extension of the KA-Prolog compiler.'],
'<Description>' =
...
'<Organization>' =
    [   'University of Karlsruhe, partly supported by the Deutsche Forschungsgemeinschaft (SFB 314, project S2).'],
'<Country>' = ['Germany.'],'<Prolog system>' = ['KA-Prolog (WAM based). '],
'<Lines>' = ['9500 (1000)'],'<Predicates>' = ['500   (40)'],
'<Platform>' = ['UNIX-OS, SUN workstations.'],'<Type of Use>' = ['Licensed'],
'<Current Status>' = ['Evaluation'],
'<When Deployed>' = ['does exist since 2 years.'],'<No. of Users>' = ['10'],
'<Information Date>' = ['August 11th, 1992.'],
'<References>' =
    ['H. Huber, I. Varsek: "Extended Prolog with Order- ','Sorted Re ',
...
['<Program>' = ['Loqui'],'<Number>' = [132],'<Domain>' = ['NL '],
    '<Purpose>' = ['A new approach to natural language interfaces'],
    '<Description>' =
    ...
    '<Prolog system>' = ['BIM '],'<Lines>' = ['30,000'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released']].
['<Program>' = ['LORSMS'],'<Number>' = [494],
    '<Domain>' = ['Risk Calculation for optimising Safety. '],
    '<Purpose>' = ['Transport Risk Analysis.'],
    '<Description>' =
        ['Performs automatic event tree generation and ','consequence ',
            'analysis to calculate the risks to passengers, the public and employees on ',
            'Rail Systems. '],
    '<Developed by>' = ['Steve Lympany.'],
    '<Organization>' = ['British Rail.'],'<Country>' = ['England.'],
    '<Prolog system>' = ['PDC Prolog. '],'<Other languages>' = ['None.'],
    '<Lines>' = ['2000'],'<Predicates>' = ['200'],
    '<Platform>' = ['MS-DOS on IBM PC.'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Prototype'],'<Information Date>' = ['Feb 1993.']].
['<Program>' = ['LTUTOR'],'<Number>' = "\"",'<Domain>' = ['Legal '],
    '<Purpose>' = ['Teaching a Law student about German Civil Law'],
    '<Description>' =
        ['Interactive solution of cases involving expert system ',
            'techniques '],
    '<Developed by>' = ['S. Grundmann'],'<Organization>' = ['IKBS'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['VM/Prolog '],
    '<Lines>' = ['1500'],'<Predicates>' = ['300'],'<Platform>' = ['VM'],
    '<Type of Use>' = ['In-house'],
    '<Current Status>' = ['No longer supported'],
    '<When Deployed>' = ['12/86'],'<Information Date>' = ['1/92']].
['<Program>' = ['MacCLINT'],'<Number>' = [18],
    '<Domain>' = ['Machine Learning; Inductive Logic Programming '],
    '<Purpose>' =
    ...
    '<Description>' =
        ['MacCLINT is a user-friendly interactive concept- ',
            ...
            'apprentices. '],
    '<Developed by>' = ['Luc De Raedt; Wim Van Holder; Maurice Bruynooghe'],
    '<Organization>' = ['K.U. Leuven'],'<Country>' = ['Belgium'],
    '<Prolog system>' = ['LPA MacPROLOG 3.5 '],'<Lines>' = ['9000'],
    '<Predicates>' = ['525'],'<Platform>' = ['Apple Macintosh'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['June 1991'],
    '<No. of Users>' = ['15'],'<Information Date>' = ['Dec 17 91'],
    '<References>' =
...
['<Program>' = ['Machiavelli'],'<Number>' = [182],
    '<Domain>' = ['Sales planning '],'<Purpose>' = ['Sales planner'],
    '<Description>' = ['An extension to Prolog which offers '],
    '<Developed by>' = ['Dermot Bradley'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA MacProlog '],'<Platform>' = ['Macintosh']].
['<Program>' = ['Machine Assisted Terminology Elicitation Environment.'],
    '<Number>' = [510],'<Domain>' = ['Translation. '],
    '<Purpose>' =
    ...
    '<Description>' =
        ['M.A.T.E. provides a multi lingual text processing ',
            ...
            'dictionary formats. '],
    '<Organization>' = ['University of Surrey-A.I. Group.'],
    '<Country>' = ['U.K.'],'<Prolog system>' = ['Quintus Prolog. '],
    '<Platform>' = ['Unix.'],'<Current Status>' = ['Evaluation'],
    '<No. of Users>' = ['5'],'<Information Date>' = ['Jan 1992.'],
    '<References>' =
        ['Ahmad,K, Fulwood,H; Griffin, S; and Holmes, P; ','(1991) ',
...
['<Program>' = ['MacLogic'],'<Number>' = [188],
    '<Domain>' = ['Teaching system '],
    '<Purpose>' = ['Teaching of systems of natural deduction in logic'],
    '<Description>' =
    ...
    '<Developed by>' = ['Dr. Roy Dyckhoff'],
    '<Organization>' = ['University of St. Andrews'],'<Country>' = ['UK'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released']].
['<Program>' = ['Macmillan Rehabilitation ?'],'<Number>' = [184],
    '<Domain>' = ['Disabled computing '],
    '<Purpose>' =
        [   'To aid disabled people to configure and maintain appropriate settings on computer input devices'],
    '<Description>' = [' '],'<Developed by>' = ['Rod McGill'],
    '<Organization>' =
        ['U. Toronto with Hugh Macmillan Rehabilitation centre'],
    '<Country>' = ['Canada'],'<Prolog system>' = ['LPA MacProlog '],
    '<Other languages>' = ['100KB compiled Think Pascal'],
    '<Lines>' = ['(170KB)'],'<Platform>' = ['Macintosh IIci']].
['<Program>' = ['MailerMate II'],'<Number>' = [398],
    '<Domain>' = ['Form processing. '],
    '<Purpose>' =
        [   'Used to fill and print self-mailer forms using a micro computer and printer.'],
    '<Description>' =
        ['MailerMate II is a friendly, easy way to fill in ','your self- ',
    ...
    '<Developed by>' = ['North Winds.'],
    '<Organization>' = ['North Winds and Transkrit Corporation.'],
    '<Country>' = ['USA.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['12.000'],
    '<Predicates>' = ['500'],
    '<Platform>' =
        [   'MSDOS 2.0 512K memory, most dot matrix, daisywheel & laser printers, hard or floppy drive systems.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['January 1, 1991.'],
    '<Information Date>' = ['September 1, 1992.'],
    '<References>' = ['Literature. ']].
['<Program>' = ['||MAPLE|| (speak: parallel Maple)'],'<Number>' = [27],
    '<Domain>' = ['Symbolic mathematics '],
    '<Purpose>' = ['System for Parallel Symbolic Computation'],
    '<Description>' =
        ['||MAPLE|| is a System for parallel Symbolic ',
            ...
            ' '],
    '<Developed by>' = ['Kurt Siegl'],
    '<Organization>' = ['RISC-Linz; University of Linz'],
    '<Country>' = ['AUSTRIA'],'<Prolog system>' = ['STRAND88 '],
    '<Other languages>' =
        [   'Maple computer algebra system: 400 KB object code C written kernel; 8 MB sequential library. Interface Kernel: 300 lines C-code'],
    '<Lines>' = ['250 lines Strand code'],
    '<Predicates>' = ['one guard and two body calls.'],
    '<Platform>' =
        [   '16 Transputer system under Helios; delivered: All where STRAND88 is available.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['1.quarter 1992'],'<No. of Users>' = ['2'],
    '<Information Date>' = ['2. 12. 91']].
['<Program>' = ['Marvin'],'<Number>' = [8],
    '<Domain>' = ['Knowledge Based Systems '],
    '<Purpose>' = ['Knowledge Based Systems Development Environment.'],
    '<Description>' =
    ...
    '<Organization>' = ['University of Surrey'],'<Country>' = ['England'],
    '<Prolog system>' = ['Quintus Prolog '],
    '<Other languages>' = ['Quintus ProWindows'],'<Lines>' = ['3600'],
    '<Predicates>' = ['1180'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1988'],
    '<No. of Users>' = ['10'],'<Information Date>' = ['Oct 1991']].
['<Program>' =
    ['MASS-C (Mechanical Assembly Sequence Satisfiability-Checker)'],
'<Number>' = [365],'<Domain>' = ['Mechanical Assembly Sequence Planning. '],
'<Purpose>' =
    [   'Verifies and generates all assembly sequences based on the task precedence ordering specifications written as a logic program of implemented temporal predicates.'],
'<Description>' =
...
'<Developed by>' = ['KiamTian Seow (Mr) and R.Devanathan (Dr).'],
'<Organization>' =
    [   'Division of Instrumentation and Control School of Electrical and Electronic Engineering Nanyang Technological University.'],
'<Country>' = ['Singapore.'],
'<Prolog system>' = ['Quintus Prolog Release 3.1.1 for Sun-3 and Sun-4. '],
'<Other languages>' = ['Nil'],'<Lines>' = ['145'],'<Predicates>' = ['32'],
'<Platform>' = ['IPC SUN SPARC Workstation, Unix operating system.'],
'<Type of Use>' = ['Personal'],'<Current Status>' = ['Prototype'],
'<When Deployed>' = ['March 1992'],'<No. of Users>' = ['N.A'],
'<Information Date>' = ['15th July 1992'],
'<References>' =
...
['<Program>' = ['Master Project Coordinating Program'],'<Number>' = [461],
    '<Domain>' =
        ['Intelligent Computer-Aided Building Design.Computer Integrated ',
            'Construction using Component-Based Building Systems. '],
    '<Purpose>' =
        [   'The MPCP is a Blackboard System based on the Edinburgh BBS. It is used to maintain a 3D solid model of a building for intelligent design purposes.'],
    '<Description>' =
        ['The MPCP underpins a collection of computer-aided ',
            ...
            'to do about it. '],
    '<Developed by>' = ['Colin Bridgewater'],
    '<Organization>' =
        [   'Construction Robotics Research Group, Dept of Civil Engineering, Imperial College.'],
    '<Country>' = ['UK'],
    '<Prolog system>' =
        ['Sussex Poplog PROLOG, v14.1. ',
            '\307IF*** The text replacing this argument is too long ***\310<Other languages> ',
    ...
    '<Lines>' =
        [   'The disk usage is ~ 250 Kb. I have no idea how many lines that is.'],
    '<Predicates>' =
        ['150 MPCP-specific predicates, 240 BBS-specific predicates.'],
    '<Platform>' =
        ['SUN Microsystems SPARCstation 1, running SunOS 4.1.1 (Unix).'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['April 1992.'],
    '<No. of Users>' =
        ['2 (one in Construction Robotics, the other in VR).'],
    '<Information Date>' = ['Current.'],
    '<References>' =
...
['<Program>' = ['MATE'],'<Number>' = [133],'<Domain>' = ['NL '],
    '<Purpose>' =
        [   'The Machine Assisted Terminology Elicitation Environment : Text and Data Processing and Management in Prolog'],
    '<Description>' = ['Submitted to PAC. Paper 428 '],
    '<Developed by>' = ['Paul Holmes - Higgin'],'<Country>' = ['UK'],
    '<Platform>' = ['PC + Windows'],'<Information Date>' = ['6/11/91']].
['<Program>' = ['Mathias'],'<Number>' = "1",'<Domain>' = ['Mathematics '],
    '<Purpose>' = ['Animation of Discrete Mathematics'],
    '<Description>' =
    ...
    '<Developed by>' = ['Dr Ron Knott'],
    '<Organization>' = ['University of Surrey'],'<Country>' = ['UK'],
    '<Prolog system>' =
        ['Quintus; LPA MacProlog; Arity; CProlog; SDProlog; ',
            'SICStus; NIP; PrologIX '],
    '<Other languages>' = [''],
    '<Lines>' = ['3415 Mathias +400 (under)+ 3980 (Graphs)'],
    '<Predicates>' = ['262(Mathias+Underware)'],
    '<Platform>' = ['Vax; Sun; PC; Apple Mac; Prime'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],
    '<When Deployed>' = ['1988; latest version 1991'],
    '<No. of Users>' =
        ['Software developers; Z users; mathematicians; education.'],
    '<Information Date>' = ['9 March 1992'],
    '<References>' =
        ['"Making Discrete Maths Executable on a Computer" ',
            ...
            'mathematics. ']].
['<Program>' = ['MATRUSKA'],'<Number>' = "G",
    '<Domain>' = ['Language Research '],
    '<Purpose>' =
        ['For creating specialized Russian-English/vice versa dictionaries'],
    '<Description>' =
    ...
    '<Developed by>' = ['Audun Toennesen'],
    '<Organization>' = ['Public Domain'],'<Country>' = ['Norway'],
    '<Prolog system>' = ['PDC PROLOG '],
    '<Other languages>' = ['Requires a Russian Character-driver'],
    '<Platform>' = ['IBM PC/ DOS'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['May 1991'],
    '<No. of Users>' = ['Unknown.'],'<Information Date>' = ['March 1992']].
['<Program>' = ['Max'],'<Number>' = [134],'<Domain>' = ['Decision Support '],
    '<Purpose>' =
        [   'Knowledge-based Decision Support : A Practical Application of Logic Programming and Prolog'],
    '<Description>' = ['Submitted to PAC. Paper 278 '],
    '<Developed by>' = ['Bhargava, Bieber, Kimbrough'],'<Country>' = ['USA'],
    '<Platform>' = ['Mac'],'<Information Date>' = ['6/11/91']].
['<Program>' = ['MCDS ?'],'<Number>' = [256],
    '<Domain>' = ['manufacturing systems '],
    '<Purpose>' = ['Manufacturing Cell Design System'],
    '<Description>' =
    ...
    '<Developed by>' =
        ['George Kov\207cs-Istv\207n, Mezg\207r-S\207ndor Kop\207csi'],
    '<Organization>' =
        ['Hungarian Academy of Sciences, Computer and Automation Institute'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['CS-Prolog '],
    '<Other languages>' = ['C, GSS*CGI graphics package'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<Information Date>' = ['Apr 92'],
    '<References>' =
        [   'George Kov\207cs-Istv\207n, Mezg\207r-S\207ndor Kop\207csi: A Prolog ',
...
['<Program>' = ['McExpert'],'<Number>' = [135],
    '<Domain>' = ['Decision Support '],
    '<Purpose>' =
        ['A logic programming model of multiple criteria decision making'],
    '<Description>' = ['Submitted to PAC. Paper 151 '],
    '<Developed by>' = ['David McSherry'],'<Country>' = ['UK'],
    '<Prolog system>' = ['MacProlog '],'<Platform>' = ['Mac'],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['Medical Expert Diagnostic System'],'<Number>' = "`",
    '<Domain>' = ['Medical - GP '],'<Purpose>' = [''],
    '<Description>' =
        ['The Imperial Cancer Research Foundation developed this ',
            ...
            'drug therapy. '],
    '<Developed by>' = ['Imperial Cancer Research Foundation'],
    '<Country>' = ['UK'],'<Prolog system>' = ['Quintec '],
    '<Lines>' = ['20,000  facts and rules'],'<Platform>' = ['PC'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation']].
['<Program>' = ['MedPro'],'<Number>' = [342],
    '<Domain>' = ['Medical records and billing. '],
    '<Purpose>' =
        [   'Record patient information and bill for services provided by a Medical Practitioner operating in Ontario, Canada.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Steve Luck.'],
    '<Organization>' = ['J.C.L. Enterprises Ltd.'],'<Country>' = ['Canada.'],
    '<Prolog system>' = ['PDC Prolog 3.21 '],
    '<Other languages>' =
        [   'RT Link used for overlayes and run under VM 386 for multi-station access.'],
    '<Lines>' =
        [   '9642 source lines, i.e. including blank lines and comments 7795 lines original 1847 lines taken from Prolog Toolbox.'],
    '<Predicates>' =
        [   '334 made up as follows: 73 global; 229 local;32 global data base.'],
    '<Platform>' = ['IBM PC running DOS or DOS network.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['06/91'],'<Information Date>' = ['08/92']].
['<Program>' = ['MEES.'],'<Number>' = [408],'<Domain>' = ['Expert System. '],
    '<Purpose>' = ['Economic Simulator.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Jocelyn Paine.'],
    '<Organization>' = ['Mike Salant (private).'],'<Country>' = ['England.'],
    '<Prolog system>' = ['Poplog. '],'<Other languages>' = ['None.'],
    '<Lines>' = ['500.'],'<Predicates>' = ['50.'],
    '<Platform>' = ['VAX/VMS.'],'<Type of Use>' = ['Personal'],
    '<Current Status>' = ['Dead'],'<When Deployed>' = ['12/1984.'],
    '<No. of Users>' = ['1 (person).'],'<Information Date>' = ['3/1992.'],
    '<References>' =
        ['Referred to briefly in "The Guide to Expert  Systems" by ',
            'Alex Goodall, Learned Information, 1985. ']].
['<Program>' = ['MEGALOG'],'<Number>' = [244],
    '<Domain>' = ['Database implementation '],
    '<Purpose>' = ['a persistent logic programming environment'],
    '<Description>' =
        ['Megalog provides a persistent store with database ',
            'transparency, database functionality, graphic systems, debugger and ',
            'profiler '],
    '<Developed by>' = ['Michael Dahment'],'<Organization>' = ['ECRC'],
    '<Country>' = ['Germany']].
['<Program>' = ['Member Risk System'],'<Number>' = [509],
    '<Domain>' = ['Financial Analysis. '],
    '<Purpose>' =
        [   'To analyse the credit assessments of customers to assess risk analysis.'],
    '<Description>' =
    ...
    '<Developed by>' = ['London Clearing House.'],
    '<Organization>' = ['Martyn Holmes.'],'<Country>' = ['U.K.'],
    '<Prolog system>' = ['Quintus Prolog '],'<Platform>' = ['Unix.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<No. of Users>' = ['720'],'<Information Date>' = ['Summer 1991']].
['<Program>' = ['MessageQ'],'<Number>' = [420],
    '<Domain>' = ['Business and information systems. '],
    '<Purpose>' = ['Phone Message tracking system.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Georges Saab.'],
    '<Organization>' = ['Quintus Corporation.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['Quintus Prolog 3.1.1. '],
    '<Other languages>' = ['C, 5%'],'<Lines>' = ['1000 unique lines.'],
    '<Predicates>' = [?],
    '<Platform>' = ['Sun, Dec, IBM RS6000, HP, Intergraph.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['March 1991'],'<No. of Users>' = ['100'],
    '<Information Date>' = ['March 1992'],'<References>' = ['none. ']].
['<Program>' = ['MESSE'],'<Number>' = [240],
    '<Domain>' = ['medical treatment '],
    '<Purpose>' =
        [   'consulting system for advice on special gastroenerological examination'],
    '<Description>' =
    ...
    '<Organization>' = ['St. Margaret Hospital, Budapest, IQSOFT'],
    '<Country>' = ['Hungary'],
    '<Prolog system>' = ['MProlog 2.3 and MProlog Dialog '],
    '<Lines>' = ['1500 clauses'],'<Predicates>' = ['610'],
    '<Platform>' = ['PC 286, MS-DOS'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Prototype']].
['<Program>' = ['MINOTAURO 1000'],'<Number>' = [378],
    '<Domain>' = ['Train dispatching and control. '],
    '<Purpose>' =
        [   'Decrease the operator resolution time of failures on trains on the track lines by means of dialoging expert system.'],
    '<Description>' =
        ['Expert system for the control of failures on the series ',
            ...
            'since 1989. '],
    '<Developed by>' = ['Antonio Trias.'],'<Organization>' = ['AIA'],
    '<Country>' = ['Spain.'],
    '<Prolog system>' = ['Turbo Prolog 2.0 (Now PDC Prolog). '],
    '<Lines>' = ['3500'],'<Predicates>' = ['280'],
    '<Platform>' = ['Developed PC 386 / MS DOS Delivery PS/2 IBM / MS DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['08/1989'],'<Information Date>' = ['07/92']].
['<Program>' = ['MINOTAURO 3000'],'<Number>' = [382],
    '<Domain>' = ['Train dispatching and control. '],
    '<Purpose>' =
        [   'Decrease resolution time of failures on trains on the track lines by means of a dialoging expert system.'],
    '<Description>' =
        ['Expert system for failures control on the 3000 and 4000 ',
            ...
            'Barcelona. '],
    '<Developed by>' = ['Xavier Fustero and programmers team.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain'],
    '<Prolog system>' = ['PDC Prolog 3.31 '],'<Other languages>' = [void],
    '<Lines>' = ['3780'],'<Predicates>' = ['287'],
    '<Platform>' = ['Developed PC 386 / MS DOS Delivery PC 386 / MS DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<Information Date>' = ['07/1992']].
['<Program>' = ['MIS'],'<Number>' = [252],
    '<Domain>' = ['Program synthesis '],
    '<Purpose>' = ['program synthesis from examples'],
    '<Description>' =
    ...
    '<Developed by>' = ['Ehud Y. Shapiro'],
    '<Organization>' = ['Yale University'],'<Country>' = ['USA'],
    '<References>' =
        ['E. Y. Shapiro: Algorithmic Program Debugging. MIT Press, ',
            '1982. ']].
['<Program>' = ['MISTRAL'],'<Number>' = [474],'<Domain>' = ['Dam safety. '],
    '<Purpose>' =
        [   'Filtering, intepretation and explanation of alarms coming from automatic monitoring systems of dams.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Marco Lazzari.'],'<Organization>' = ['ISMES'],
    '<Country>' = ['Italy.'],'<Prolog system>' = ['ESLPDProlog2. '],
    '<Other languages>' = ['Microsoft Visual Basic.'],'<Lines>' = ['1500'],
    '<Predicates>' = ['120'],'<Platform>' = ['PC 386 / MS-DOS.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['October/1992.'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['November/1992.'],
    '<References>' =
        ['J.B. Comerford, M. Lazzari, P. Salvaneschi et al., ',
            ...
            'N.Y., 618-627. ']].
['<Program>' = ['Mixtus 0.3.3'],'<Number>' = [14],
    '<Domain>' = ['CASE Tool '],
    '<Purpose>' = ['An automatic partial evaluator for full Prolog'],
    '<Description>' =
        ['Mixtus is an automatic partial evaluator for full Prolog. ',
            ...
            'queries. '],
    '<Developed by>' = ['Dan Sahlin'],'<Organization>' = ['SICS'],
    '<Country>' = ['Sweden'],'<Prolog system>' = ['SICStus Prolog '],
    '<Other languages>' = [none],'<Lines>' = ['3776'],
    '<Predicates>' = ['460'],
    '<Platform>' = ['Unix (whatever SICStus runs on)'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['24 May 91'],'<No. of Users>' = ['100'],
    '<Information Date>' = ['31 Oct 91'],
    '<References>' =
        ['"An Automatic Partial Evaluator for Full Prolog" by Dan ',
            'Sahlin;\tSICS Dissertation Series 4; 1991 ']].
['<Program>' = ['MM4 Weather Modelling System'],'<Number>' = "d",
    '<Domain>' = ['Weather Forecasting '],'<Purpose>' = [''],
    '<Description>' =
        ['MM4 is a  mesoscale (medium-scale) weather modelling ',
            ...
            'processors. '],
    '<Developed by>' =
        [   'Penn State University, National Center for Atmospheric Research,Boulder, Colorado'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Strand88 '],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation']].
['<Program>' = ['MMI2'],'<Number>' = "&",
    '<Domain>' = ['Multimodal interfaces / Expert systems '],
    '<Purpose>' =
        [   'Multimodal interface for man machine interaction with knowledge based systems'],
    '<Description>' =
    ...
    '<Developed by>' = ['Esprit II Consortium'],
    '<Organization>' =
        ['BIM sa/nv; RAL;  INRIA; ISS; Leeds Univ.; EMSE; CRISS'],
    '<Country>' =
        ['Belgium; England; France; Spain; England; France; France'],
    '<Prolog system>' = ['ProLog by BIM '],
    '<Other languages>' = ['Prolog/C interfaces to SunView; C'],
    '<Lines>' = ['+- 121.000 lines'],'<Predicates>' = ['+- 4700'],
    '<Platform>' = ['Sun3; Sun4; SPARCstations'],
    '<Information Date>' = ['October 1991'],
    '<References>' =
...
['<Program>' = ['MODEL OODB'],'<Number>' = [392],
    '<Domain>' = ['Object-Oriented Databases. '],
    '<Purpose>' =
        [   'Add routines to make Prolog into a distributed object-oriented deductive database.'],
    '<Description>' =
        ['Adds immediate and delayed assignments to Prolog. ','e.g. ',
            'b:=integer.  /*Integer type is readOnly*/ ','b#value:= 10 . ',
            'c(2):=b+b.  /* Assign 20 to array element ','c[2].*/ ',
            ...
            'etc. '],
    '<Developed by>' = ['Prof. Dan Buehrer.'],
    '<Organization>' =
        [   'Institute of Computer Science and Information Engr. National Chung Cheng University.'],
    '<Country>' = ['Taiwan, Republic of China.'],
    '<Prolog system>' = ['Sicstus. '],'<Other languages>' = [csh],
    '<Lines>' = ['1000'],'<Predicates>' = ['20'],
    '<Platform>' = ['Sparc, Sun 3, Sun 4, Dec Ultrix.'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Prototype'],'<When Deployed>' = ['Oct. 1992.'],
    '<Information Date>' = ['Sept. 23, 1992.']].
['<Program>' = ['MODGEN 2.0-model generator for chemical processes.'],
    '<Number>' = [484],'<Domain>' = ['Dynamic Simulation. '],
    '<Purpose>' =
        [   'Dynamic simulation of chemical engineering process units by  a discrete  structural  model,  generated  automatically   in the knowledge  of  the   user-defined   decomposition   pattern   and prototypes.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Bela Csukas, Karoly Varga, Rozalia Lakner.'],
    '<Organization>' =
        [   'University  of  Veszprem,  supported  by  the  Hungarian Basic Research Grant N OTKA-2550.'],
    '<Country>' = ['Hungary.'],
    '<Prolog system>' =
        ['TURBOPROLOG 2.0, PDC PROLOG 3.1 CSPROLOG 3.25 ','(ALL- ',
            'MULTILOGIC Ltd., Budapest) '],
    '<Other languages>' =
        ['Can also be implemented in object oriented languages.'],
    '<Lines>' = ['3000'],'<Predicates>' = ['350'],
    '<Platform>' =
        ['PC/AT 386; transputer and work station versions in preparation.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['9/1990'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['12/92'],
    '<References>' =
        ['Csukas, B., Lakner, R., Varga, K., Jambor, L.: ','Intelligent ',
...
'<Number>' = [491],
'<Domain>' = ['Dynamic Simulation of Technological Plants. '],
'<Purpose>' =
    [   'Dynamic simulation of  complex  technological  plants  using  a dynamic  modular  technique  comprising  the  quasi-parallel   or parallel execution of the  generated  structural  models  of  the process units.'],
'<Description>' =
    ['In  the  conventional  methods   used   for   the ','simulation ',
...
'<Developed by>' = ['Bela Csukas, Karoly Varga, Eszter Pozna.'],
'<Organization>' =
    [   'University of Veszprem, supported  by  the  Hungarian Research Grant N OTKA-2550'],
'<Country>' = ['Hungary .'],
'<Prolog system>' =
    ['TURBOPROLOG 2.0, PDC PROLOG 3.31, CSPROLOG 3.25; ','(ALL- ',
        'MULTILOGIC Ltd., Budapest. '],
'<Lines>' = ['1500'],'<Predicates>' = ['200'],
'<Platform>' =
    [   'PC/AT 386, PC/AT 386 with transputer; work station  version in preparation .'],
'<Type of Use>' = ['In-house'],'<Current Status>' = [''],
'<When Deployed>' = ['4/1992'],'<No. of Users>' = ['5'],
'<Information Date>' = ['12/1993']].
['<Program>' =
    [   'MODGEN/HPLC -  Modeling  Preparative  High  Performance  Liquid Chromatography.'],
'<Number>' = [490],'<Domain>' = ['Simulation of Preparative HPLC. '],
'<Purpose>' =
    [   'Dynamic simulation of preparative HPLC (High Performance Liquid Chromatography) columns  by  an  automatically  generated  PROLOG structural model.'],
'<Description>' =
...
'<Developed by>' =
    ['Bela Csukas , Karoly Varga , Sandor Kovats  , Antal Aranyi'],
'<Organization>' =
    ['University of Veszprem  and Pharmacenticals Gedeon Richter Ltd.'],
'<Country>' = ['Hungary.'],
'<Prolog system>' =
...
'<Platform>' =
    ['PC/AT 386; transputer and work station versions in preparation.'],
'<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
'<When Deployed>' = ['3/1992'],'<No. of Users>' = ['4'],
'<Information Date>' = ['12/1993'],'<References>' = ['In preparation. ']].
['<Program>' = ['Mondel Development Environment'],'<Number>' = [429],
    '<Domain>' =
        ['Object-oriented specification development: Compiling, ',
            'execution, and validation. '],
    '<Purpose>' =
        [   'Supports the formal specification language MONDEL: compiling, execution, and validation.'],
    '<Description>' =
        ['Mondel Development Environment supports the ',
            ...
            'specification. '],
    '<Developed by>' =
        [   'Prof. Gregor von Bochmann, Prof. Michel Barbeau, Normand Williams, and Aiwu Liu.'],
    '<Organization>' =
        [   'Centre de recherche informatique de Montreal (CRIM). Sponsered by: Bell Northern Research  (BNR)'],
    '<Country>' = ['Canada.'],'<Prolog system>' = ['Quintus Prolog '],
    '<Other languages>' = ['C language, YACC and LEX. Extent : 20%'],
    '<Lines>' = ['Approximatly 15000 lines of Prolog.'],
    '<Predicates>' = ['Approximatly 1000 Prolog predicates.'],
    '<Platform>' = ['SUN workstations/UNIX'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['January 1991'],
    '<No. of Users>' = ['15'],'<Information Date>' = ['March 1992'],
    '<References>' =
...
['<Program>' = ['MOP2'],'<Number>' = "L",
    '<Domain>' = ['Project management, manpower planning and recording '],
    '<Purpose>' =
        [   'MOP2 (Managing Our Projects, Monitoring Our Programme) is a program and database to aid NPL DITC Software Engineering Group in its project management, planning, and monitoring.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Roger Scowen'],
    '<Organization>' = ['National Physical Laboratory'],'<Country>' = ['UK'],
    '<Prolog system>' = ['SICStus 2.1 #3 '],'<Other languages>' = ['None'],
    '<Lines>' =
        [   '1500 (320 code, 350 database facts, 770 person/effort/project facts)'],
    '<Predicates>' = ['33 (14 database facts, 19 program)'],
    '<Platform>' = ['Sun 3/50, Sun OS Release 4.1'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['February 1992'],
    '<No. of Users>' = ['2'],'<Information Date>' = ['March 1992'],
    '<References>' =
        ['MOP2 (Managing Our Projects, Monitoring Our Programme) ',
            'Internal NPL DITC SEG report, SEG N12, March 1992. ']].
['<Program>' = ['Morphological Analysis of Hungarian Texts'],
    '<Number>' = [265],'<Domain>' = ['Natural language '],
    '<Purpose>' = ['To analyse the morphology of Hungarian texts.'],
    '<Description>' =
        ['The system analyses the morphology of Hungarian ',
            'texts. The analysis is based on heuristics and it is done in two ',
            'stages: ','a- the morphological analysis of verb forms ',
            'b- the morphological analysis of tagged nouns. ',' ',' '],
    '<Developed by>' = ['Z. Kiss,  G. Proszeki, L. Toth'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984'],
    '<References>' =
        ['Z. Kiss,  G. Proszeki, L. Toth (1979) ',
            ...
            'No. XV., Budapest, 1982. ']].
['<Program>' = ['Morse'],'<Number>' = [501],'<Domain>' = ['Education. '],
    '<Purpose>' =
        ['Learn and practice receive morse code with sound or light .'],
    '<Description>' =
        ['Morse is program developed with its main purpose to ','learn to ',
    ...
    '<Prolog system>' = ['PDC Prolog 3.20 /3.30 + PDC Prolog Toolbox 2.10 '],
    '<Other languages>' = ['No.'],'<Lines>' = ['1500'],
    '<Predicates>' = ['100'],'<Platform>' = ['PC/XT/AT, MS DOS, DS/DD'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['12/1991'],
    '<Information Date>' = ['2/2/93']].
['<Program>' = ['Mosaic, 1.A.0'],'<Number>' = [453],
    '<Domain>' = ['Strategy Board Game (with graphic interface.) '],
    '<Purpose>' = ['Mosaic is a strategy board game for the Macintosh.'],
    '<Description>' =
        ['Mosaic is a strategy board game for the Macintosh. ','The ',
    ...
    '<Developed by>' = ['Lindsey Spratt.'],'<Organization>' = ['(none).'],
    '<Country>' = ['USA.'],'<Prolog system>' = ['LPA MacProlog 3.5 '],
    '<Other languages>' = ['none.'],'<Lines>' = ['4000'],
    '<Predicates>' = ['800'],
    '<Platform>' = ['Macintosh / MacOS Systems 6 and 7'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['June/1992'],
    '<No. of Users>' = ['2 registered (160 downloads).'],
    '<Information Date>' = ['10/30/1992'],'<References>' = ['None. ']].
['<Program>' = ['MPSSS'],'<Number>' = [136],'<Domain>' = ['SIM '],
    '<Purpose>' = ['Power Systems Protection Simulator'],
    '<Description>' = ['Submitted to PAC. Paper 268 '],
    '<Developed by>' = ['Peter Kadar'],'<Country>' = [?],
    '<Prolog system>' = ['Turbo Prolog/ Clipper/ C and dBase '],
    '<Platform>' = ['IBM PC @ 286'],'<Information Date>' = ['30/10/91']].
['<Program>' = ['MTN'],'<Number>' = [270],
    '<Domain>' = ['Teleprocessing Networks '],
    '<Purpose>' = ['To generate models of teleprocessing networks'],
    '<Description>' =
    ...
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984']].
['<Program>' = ['MULTI'],'<Number>' = [456],
    '<Domain>' = ['Software Development, Electronic CAD Tool development. '],
    '<Purpose>' =
        [   'Builds complementary parsers and generator from a single specification language.'],
    '<Description>' =
    ...
    '<Organization>' = ['Quintus Corporation.'],'<Country>' = ['USA'],
    '<Prolog system>' = ['Quintus Prolog '],'<Other languages>' = ['none.'],
    '<Lines>' = ['881'],'<Predicates>' = ['183'],
    '<Platform>' = ['Quintus Platforms'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['N/A'],
    '<No. of Users>' = ['3'],'<Information Date>' = ['11/93']].
['<Program>' = ['Multipurpose Substation  Simulator Shell (MPSSS)'],
    '<Number>' = "5",'<Domain>' = ['Power Systems Training Analysis '],
    '<Purpose>' =
        [   'Simulation of the operation of the protection devices in the Power System Substations'],
    '<Description>' =
    ...
    '<Developed by>' = ['Department of system Planning'],
    '<Organization>' =
        ['EROTERV - Power plant and Network Engineering Company - Budapest'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['Turbo PROLOG '],
    '<Other languages>' = ['Microsoft C4'],'<Lines>' = ['8000'],
    '<Predicates>' = ['270'],'<Platform>' = ['IBM PC 286/386 DOS System'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['6/91'],'<No. of Users>' = ['4'],
    '<Information Date>' = ['1/2/92'],
    '<References>' =
        ['Peter Kadar "A multipurpose Substation Simulator ','Shell" ',
            '2nd Conference on AI, Budapest, 24-26 January 1991 ',
            'Peter Kadar  "An Expert System Application in the Hungarian Power ',
            'System" ','Eng. Appl. of AI Vol.5 No.1 1992 ']].
['<Program>' = ['N Derivatives of Composite Real Functions'],
    '<Number>' = [266],'<Domain>' = ['Mathematics '],
    '<Purpose>' =
...
['<Program>' = ['Name matching'],'<Number>' = [183],
    '<Domain>' = ['Office procedures '],
    '<Purpose>' = ['Matching of non-European people\'s names'],
    '<Description>' =
    ...
    '<Developed by>' = ['Graeme Smith'],
    '<Organization>' = ['BBN, Edinburgh'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA MacProlog '],'<Platform>' = ['Macintosh IICX']].
['<Program>' = ['NeoMail'],'<Number>' = [343],
    '<Domain>' = ['Communications. '],
    '<Purpose>' = ['Electronic Mail Interface.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Andrew Petukhov, Duncan Campbell.'],
    '<Organization>' = ['NeoText SophtWear.'],
    '<Country>' = ['Canada / Russia.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['C'],'<Lines>' = ['2000'],
    '<Predicates>' = ['400'],'<Platform>' = ['UNIX, MSDOS.'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['06/92'],
    '<Information Date>' = ['07/92'],'<References>' = ['None. ']].
['<Program>' = ['NEST'],'<Number>' = [137],'<Domain>' = ['Network design '],
    '<Purpose>' = ['a Network design Expert SysTem'],
    '<Description>' = ['Submitted to PAC. Paper 324 '],
    '<Developed by>' = ['Christine Jouve & Fabienne Balfroid'],
    '<Country>' = ['France'],'<Prolog system>' = ['BIM '],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['Nestor'],'<Number>' = "B",
    '<Domain>' =
    ...
    '<Developed by>' =
        [   'Annica Andersson, Rabbe Fogelholm, Nils Hagner, Theo Kanter, Maria Lennman, Mats Lordin, Ann-Christine Nilsson, Ingela Olsson, Mark Plotnick, Johan Svedberg, Anders Tunevi, Dag Westling'],
    '<Organization>' = ['Infologics AB, Sollentuna, Sweden'],
    '<Country>' = ['Sweden'],'<Prolog system>' = ['Prolog-2 '],
    '<Other languages>' =
        [   'Subsystem for retrieving technical documentation implemented by means of Microsoft C and an Oracle RDBMS. Subsystem for inspecting fault records implemented by means of Microsoft C and Oracle SQL*Net for dial-up access to a central Oracle server.'],
    '<Lines>' =
        [   '4500 lines of program code, plus 84000 lines of Prolog clauses that make up the diagnostic knowledge of the system'],
    '<Predicates>' = ['376'],
    '<Platform>' = ['IBM AT compatibles, MS-DOS 3.3 or higher'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['April, 1991'],'<No. of Users>' = ['30'],
    '<Information Date>' = ['12th December, 1991'],
    '<References>' =
        ['"Hela stationen i en PC", Televarlden no 17, 1991, ','p 14, ',
            'in Swedish. ',' ']].
['<Program>' = ['Network Management'],'<Number>' = "_",
    '<Domain>' = ['Retail network management '],'<Purpose>' = [''],
    '<Description>' =
        ['A sophisticated technology demonstrator for a retail ',
            ...
            'be altered graphically by the operator \321 by clicking and dragging nodes and ',
...
['<Program>' = ['NORMALIZER'],'<Number>' = [261],
    ...
    '<Country>' = ['USA'],'<Prolog system>' = ['Turbo Prolog '],
    '<Platform>' = ['IBM PC'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1985'],
    '<Information Date>' = ['1988'],
    '<References>' =
        ['Layman E. Allen, Charles S. Saxon: Multiple ',
            'interpretation of the structure of legal rules: Impediment or boon to ',
            ...
            'Co. 1985 pp495-572 ']].
['<Program>' = ['NTM (Nurse Teaching Manager)'],'<Number>' = [502],
    '<Domain>' = ['Administration '],
    '<Purpose>' =
        [   'Planning and documentation of the education of nurses at German hospitals.'],
    '<Description>' =
        ['Planning and documentation of the education of ','male/female ',
            'nurses at nurse schools in Germany. '],
    '<Developed by>' = ['Dr. Raimund F_hnrich.'],
    '<Organization>' = ['Dr. F_hnrich & Partner.'],
    '<Country>' = ['Germany.'],
    '<Prolog system>' =
        ['PDC Prolog 3.2/ 3.21/ 3.30 (formerly Turbo Prolog ','1.0/2.0) '],
    '<Other languages>' =
        [   'There has been attempts to mix with C but they have been cancelled.'],
    '<Lines>' = ['7250'],'<Predicates>' = ['approx. 1200'],
    '<Platform>' =
        [   'MS-DOS 3.3 / 5.0 & DR-DOS 6.0. In addition to PharLap DOS extender and OS/2.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released']].
['<Program>' = ['OBIS'],'<Number>' = [475],
    '<Domain>' = ['Education configuration. '],
    '<Purpose>' =
        [   'Configuration of an educational curriculum based on professional requirements.'],
    '<Description>' =
    ...
    '<Developed by>' = ['5 person company & customer team.'],
    '<Organization>' = ['Syllogic.'],'<Country>' = ['Netherlands.'],
    '<Prolog system>' = ['SWI-prolog. '],
    '<Other languages>' =
        ['SQL (Oracle), Xwindows + Motif, Syllogc Knowledge Sheet.'],
    '<Lines>' = ['65.000'],'<Predicates>' = ['2.100'],
    '<Platform>' = ['IBM RISC System 6000.'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['july 1990.'],
    '<No. of Users>' = ['30'],'<Information Date>' = ['25 november 1992.'],
    '<References>' = ['None. ']].
['<Program>' = ['Objective-Prolog'],'<Number>' = [138],'<Domain>' = ['OO '],
    '<Purpose>' =
        [   'Programming by step-wise refinement of data using Objective- Prolog'],
    '<Description>' = ['Submitted to PAC. Paper 363 '],
    '<Developed by>' = ['Mattias Waldau'],'<Country>' = ['Sweden'],
    '<Prolog system>' = ['Objective Prolog '],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['Oceanic'],'<Number>' = [214],
    '<Domain>' = ['Insurance systems design '],
    '<Purpose>' =
        [   'To provide all the programs for introducing a new insurance product within a few days'],
    '<Description>' =
    ...
    '<Organization>' = ['SOCS (French insurance software house)'],
    '<Country>' = ['France'],
    '<Prolog system>' = ['IBM Prolog for OS/2, IBM Prolog for VM '],
    '<Lines>' = ['150,000'],'<Platform>' = ['IBM PS/2 with OS/2, IBM 370'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<No. of Users>' = ['3 (currently)'],
    '<References>' =
        ['B. Robinet: Logic Programming at IBM from the Lab to the ',
            'customer. Proc ICLP8. pp912-921. 1991 ']].
['<Program>' = ['OF'],'<Number>' = "H",'<Domain>' = ['Activity Planning '],
    '<Purpose>' = ['Activity planning and tracing'],
    '<Description>' =
    ...
    '<Platform>' = ['IBM PC/ DOS'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['November 1990'],'<No. of Users>' = ['12'],
    '<Information Date>' = ['March 1992']].
['<Program>' = ['OLP'],'<Number>' = [139],'<Domain>' = ['TOOL '],
    '<Purpose>' = ['A set of Prolog Programming Tools'],
    '<Description>' = ['Submitted to PAC. Paper 343 '],
    '<Developed by>' = ['Cristina Ruggieri, Sancassani'],
    '<Country>' = ['Italy'],'<Prolog system>' = ['OLP+ALPES '],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['OMAR (operative management of aircraft bouting).'],
    '<Number>' = [140],'<Domain>' = ['Aircraft Scheduling. '],
    '<Purpose>' =
        [   'A Scheduling of the Alitalia Fleet, i.e. assigning tail number of aircraft to flights.'],
    '<Description>' =
        ['An interactive system designed for the predictive ',
            ...
            'techniques. '],
    '<Developed by>' = ['Momigliano, Paltrinieri, Torquati'],
    '<Organization>' = ['Bull Italia-Direzione sistemi esperti.'],
    '<Country>' = ['Italy'],'<Prolog system>' = ['Quintus Prolog. '],
    '<Other languages>' =
        ['5QL - Database Interface C++/Windows - Graphical Interface'],
    '<Lines>' = ['20000'],'<Predicates>' = ['2500'],
    '<Platform>' = ['Bull X-20 Minicomputer'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['June 1991'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['March 1992'],
    '<References>' =
...
['<Program>' = ['ONE-LEVEL WORKSHOP PLANNER'],'<Number>' = [285],
...
['<Program>' = ['Operational Rations Advisor  (ORA)'],'<Number>' = [294],
    '<Domain>' = ['Expert system for U.S. Army field operations. '],
    '<Purpose>' =
        [   'Automatically prepare ration menus from given food base, nutritionally balanced according to stated goals and environment.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Ray Reeves  (Contractor).'],
    '<Organization>' = ['U.S. Army Natick Research Labs.'],
    '<Country>' = ['U.S.A.'],'<Prolog system>' = ['Arity Prolog. '],
    '<Other languages>' = ['None'],'<Lines>' = ['1300'],
    '<Platform>' = ['PC'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1989'],
    '<No. of Users>' = ['Unknown'],'<Information Date>' = ['May 1992'],
    '<References>' = ['None. ']].
['<Program>' = ['Opium'],'<Number>' = [2],'<Domain>' = ['CASE tool '],
    '<Purpose>' = ['An automated and extensible debugger for Prolog'],
    '<Description>' =
    ...
    '<Developed by>' = ['Mireille Ducass\216 and Anna-Maria Emde'],
    '<Organization>' = ['European Computer-Industry Research Centre'],
    '<Country>' = ['Germany'],
    '<Prolog system>' = ['Sepia (ECRC\'s Prolog) '],
    '<Other languages>' = ['C'],
    '<Lines>' =
        ['21000 lines of commented Prolog; 17000 lines of plain Prolog'],
    '<Predicates>' = ['3000'],'<Platform>' = ['Sun3/4; Unix'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['December 90'],'<No. of Users>' = ['5'],
    '<Information Date>' = ['November; 11th 1991'],
    '<References>' =
        ['M. Ducass\216 and A.-M. Emde. Opium user manual. ',
            'Technical report TR-LP-60; ECRC Arabellastrasse 17; D-8000 Munich 81; ',
            'Germany. May 91. ',
            'M. Ducass\216.  Abstract views of prolog executions in Opium.  In V. ',
            'Saraswat and K. Ueda; editors; Proceedings of the International Logic ',
            'Programming Symposium. ALP; MIT Press; October 1991. ',
            'M. Ducass\216 and A.-M. Emde.  Opium: a debugging environment for Prolog ',
...
['<Program>' = ['Optimist'],'<Number>' = "<",
    '<Domain>' = ['Oil exploration '],
    '<Purpose>' = ['To assist geologists in oil exploration'],
    '<Description>' =
    ...
    '<Developed by>' = ['Turing Institute Ltd., Glasgow, UK'],
    '<Organization>' = ['written for Enterprise Oil plc., London, UK'],
    '<Country>' = ['UK'],'<Prolog system>' = ['Quintus Prolog (V3) '],
    '<Other languages>' =
        ['C (<5%), HyperNeWS (direct manipulation user interface)'],
    '<Lines>' = ['15000'],'<Platform>' = ['(Current) Sun Sparc / UNIX'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['October 1989'],'<No. of Users>' = ['5'],
    '<Information Date>' = ['24th March 1992'],
    '<References>' =
        ['Clark P. (1990) "Representing Knowledge As ',
            ...
            'Glasgow, UK. ']].
['<Program>' = ['OPUSPC'],'<Number>' = "'",
    '<Domain>' = ['Airline Planning '],
    '<Purpose>' =
        [   'Real-Time Monitoring and decision support for airline Movement Control Center and placing grain.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Andrew Parrett; Finn Groenskov'],
    '<Organization>' = ['Prolog Development Center'],
    '<Country>' = ['Denmark'],'<Prolog system>' = ['PDC Prolog '],
    '<Other languages>' = [none],'<Lines>' = ['>10,000'],
    '<Platform>' = ['IBM comp. PC; DOS 3.3 or higher.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['April 1988'],'<No. of Users>' = ['100'],
    '<Information Date>' = ['01/92']].
['<Program>' = ['OSM'],'<Number>' = [208],
    '<Domain>' = ['Medical information systems '],
    '<Purpose>' =
        [   'a comprehensive information management and decision support system for general practitioners'],
    '<Description>' =
    ...
    '<Developed by>' = ['John Fox, et al.'],
    '<Organization>' = ['Imperial Cancer Research Fund'],
    '<Country>' = ['UK'],'<Prolog system>' = ['Prolog 2? '],
    '<Other languages>' = ['C'],'<Platform>' = ['PC AT or better'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<References>' =
        ['John Fox, A Glowinski, C. Gordon, S. Hajnal, M. O\'Neill. ',
            ...
            'pp323-339. 1990 ']].
['<Program>' = ['OTAS'],'<Number>' = [217],'<Domain>' = ['Financial '],
    '<Purpose>' =
        [   'a decision support system for analysis of stock options investment stratgies'],
    '<Description>' =
    ...
    '<Developed by>' = ['T. Huynh, Catherine Lassez'],
    '<Organization>' = ['IBM T.J. Watson Research Center, Yorktown Heights'],
    '<Country>' = ['USA'],'<Prolog system>' = ['CLP(R) compiler '],
    '<Platform>' = ['IBM RT/PC and VM'],'<Current Status>' = ['Evaluation'],
    '<References>' =
...
['<Program>' = ['P/FDM'],'<Number>' = [141],'<Domain>' = ['OODB '],
    '<Purpose>' =
        [   'Using Prolog to Provide Access to Metadata in an Object- Oriented Database'],
    '<Description>' = ['Submitted to PAC. Paper 128 '],
    '<Developed by>' = ['Suzanne Embury'],'<Country>' = ['UK'],
    '<Prolog system>' = ['Prolog/FDM '],'<Information Date>' = ['30/10/91']].
['<Program>' = ['PAGAI'],'<Number>' = [25],
    '<Domain>' = ['Intelligent Databases '],
    '<Purpose>' =
        [   'Bibliographic database system with intelligent retrieval using term relationship networks'],
    '<Description>' =
    ...
    '<Organization>' = ['Prolog Development Center'],
    '<Country>' = ['Denmark'],'<Prolog system>' = ['PDC Prolog '],
    '<Lines>' = ['>10.000  <100.000'],'<Platform>' = ['DOS  OS/2'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['05/89'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['01/92']].
['<Program>' = ['PAPAIN'],'<Number>' = [507],
    '<Domain>' = ['Genetic Research. '],
    '<Purpose>' = ['Protein sequence analysis.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Imperial Cancer Research Foundation.'],
    '<Country>' = ['U.K.'],'<Prolog system>' = ['Quintus Prolog. '],
    '<Other languages>' = ['Quintus ProWindows.'],
    '<Platform>' = ['Unix (Sun).'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<Information Date>' = ['April 1992.']].
['<Program>' = ['PARAFLOG'],'<Number>' = [267],
    '<Domain>' = ['Dataflow Modelling '],
    '<Purpose>' = ['Emulate the dataflow language PARAFLOG'],
    '<Description>' =
    ...
    '<Developed by>' = ['A. Doman'],'<Organization>' = ['SzKI'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984'],
    '<References>' =
        ['A. Doman (1981) ',
            'An applicative language for highly parallel programming. ',
            'SzKI Report, 1981 ',' ','A. Doman (1982) ',
            'Cellural dataflow parallel processor for high speed computation. ',
            '(Hungarian) PhD Dissertation, 1982 ']].
['<Program>' = ['PC-PARLOG and MAC PARLOG'],'<Number>' = [302],
    '<Domain>' = ['Parallel programming '],
    '<Purpose>' =
        [   'Programming language systems for PARLOG on the IBM-PC and Macintosh.'],
    '<Description>' =
        ['These are full implementations of the PARLOG language, ',
            ...
            'primitives. '],
    '<Developed by>' = ['Tom Conlon and Steve Gregory'],
    '<Organization>' = ['Parallel Logic Programming Ltd'],
    '<Country>' = ['UK'],
    '<Prolog system>' = ['LPA - Professional/MacProlog '],
    '<Other languages>' = ['PARLOG - about 5%'],
    '<Lines>' = ['200K Source approx.'],
    '<Platform>' = ['IBM + MS DOS Mac + System 6 or 7'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['October 1989'],'<No. of Users>' = ['100+'],
    '<Information Date>' = ['December 1991'],
    '<References>' =
...
['<Program>' = ['PCM'],'<Number>' = "=",
    '<Domain>' = ['Program development,  configuration management '],
    '<Purpose>' =
        [   'support Prolog program development, rapid prototyping, configuration management, software re-use, program visualisation'],
    '<Description>' =
        ['PCM is a repository for Prolog, C and SQL ','procedures, ',
    ...
    '<Developed by>' = ['System Engineering Research Group'],
    '<Organization>' = ['Computer Science Dept., Keele University'],
    '<Country>' = ['UK'],'<Prolog system>' = ['Quintus Prolog 3.X '],
    '<Other languages>' =
        [   'C and SQL (tightly coupled to an Oracle V6 RDBMS kernel via Keylink\'s ProDATA interface)'],
    '<Lines>' = ['25,000 lines of code including comments'],
    '<Predicates>' = ['1,000 (plus another 15,000 in libraries)'],
    '<Platform>' = ['Sun 4 (SPARC) under SunOS 4.1'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['November 1988'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['6th April 1992'],
    '<References>' = ['Technical reports available from "Contact" ']].
['<Program>' = ['PCUBE or P3'],'<Number>' = [142],
    '<Domain>' = ['Production and other scheduling. '],
    '<Purpose>' =
        [   'Prolog-like Surfaced Expert System for an Overall Support of Parallel and Concurrent Process Systems'],
    '<Description>' =
        ['P3 gives every such possible schedulings of a system of ',
            ...
            'on IBM XT/AT. '],
    '<Developed by>' = ['Katalin Szenes & Peter Forro'],
    '<Organization>' = ['Hungarian Telecomm../ Ctr. of Information.'],
    '<Country>' = ['Hungary'],
    '<Other languages>' =
        ['FORTH programming language (base implementation)'],
    '<Platform>' = ['IBM PC      XT/AT    HW none- SW'],
    '<Information Date>' = ['20/03/92'],
    '<References>' =
        ['K. Szenes:  Planning the activity schedule of ',
            ...
            ', 139 - 144. ']].
['<Program>' = ['PDM'],'<Number>' = [414],
    '<Domain>' =
        ['Used to define an intelligent model construction ','assistant to ',
            'decision support systems designed to support production and distribution ',
            'planning. '],
    '<Purpose>' =
        [   'Assists in the formulation of Linear Programming models in the Production Planning Domain.'],
    '<Description>' = [' '],'<Developed by>' = ['Ramayya Krishnan.'],
    '<Country>' = ['USA'],'<Prolog system>' = ['C Prolog '],
    '<Lines>' = ['1000'],
    '<Platform>' = ['Developed on Vax 11/780, Ported to a DEC 3100 .'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['12/87'],'<No. of Users>' = ['1'],
    '<Information Date>' = ['5/88'],
    '<References>' =
        ['Two  papers in the Internation Journal of Decision ',
            'Support Systems,  DSS, Vol. 6, pp. 123-152; Vol. 7, pp. 301-314. ']].
['<Program>' = ['PDS - diagnosis system'],'<Number>' = [253],
    '<Domain>' = ['Program debugging '],
    '<Purpose>' = ['a declarative debugging system for a subset of Prolog'],
    '<Description>' =
    ...
    '<Developed by>' = ['Ehud Y. Shapiro'],
    '<Organization>' = ['Yale University'],'<Country>' = ['USA'],
    '<Prolog system>' = ['Wisdom Prolog, Dec-10 Prolog '],
    '<References>' =
        ['E. Y. Shapiro: Algorithmic Program Debugging. MIT Press, ',
            '1982. ']].
['<Program>' = ['PEP2'],'<Number>' = [143],'<Domain>' = ['NL '],
    '<Purpose>' =
        [   'Parallel Expert Parser: A Rule- Based Spreading-Activation Model for Natural Language Understanding'],
    '<Description>' = ['Submitted to PAC. Paper 327 '],
    '<Developed by>' = ['Bourgois et al'],'<Country>' = ['Germany'],
    '<Prolog system>' = ['Flat Concurrent Prolog '],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['Peptides Model Prediction System'],'<Number>' = [263],
    '<Domain>' = ['Pharmaceutical research '],
    '<Purpose>' =
        [   'Calculation of parameters predicting biological activity for peptides'],
    '<Description>' =
    ...
    '<Developed by>' = ['F. Darvas, A. Lopata, Gy. Matrai'],
    '<Organization>' = ['EGYT (Pharmaceutical works)'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Other languages>' = ['FORTRAN'],
    '<Platform>' = ['ORDRA 1305/GEORGE OS'],'<When Deployed>' = ['1980'],
    '<Information Date>' = ['1984'],
    '<References>' =
...
['<Program>' = ['Perfect Pitch'],'<Number>' = "g",
    '<Domain>' = ['Sports medecine '],
    '<Purpose>' = ['Sports surfaces advisor'],
    '<Description>' =
    ...
    '<Developed by>' = ['Michael Brown'],
    '<Organization>' = ['Entretec Pty & Sports Technology Pty'],
    '<Country>' = ['Australia'],'<Prolog system>' = ['PDC Prolog v 3.21 '],
    '<Lines>' = ['4600'],'<Predicates>' = ['550'],'<Platform>' = ['DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['June 1990'],'<Information Date>' = ['March 1992']].
['<Program>' = ['PERSONAL CASHFLOW'],'<Number>' = [449],
    '<Domain>' = ['Personal financial analysis. '],
    '<Purpose>' = ['Home budgeting program.'],
    '<Description>' =
        ['PERSONAL  CASHFLOW  applies modern  business ',
            ...
            'all  these ','spreadsheets to update them. ',' ',
            ...
            'a demo disk. '],
    '<Developed by>' = ['Ken Tyson.'],
    '<Organization>' = ['Majengo Software Ltd.'],
    '<Country>' = ['United Kingdom.'],
    '<Prolog system>' = ['PDC Prolog 3.21 '],'<Other languages>' = ['None.'],
    '<Lines>' = ['1,897'],'<Predicates>' = ['142'],
    '<Platform>' = ['IBM PC and compatibles.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['February 1991'],'<No. of Users>' = ['500'],
    '<Information Date>' = ['May 15, 1992']].
['<Program>' = ['Personal Notekeeper'],'<Number>' = [361],
    '<Domain>' =
        ['Intelligent Text-retrieval for multilingual Documents; Secure ',
            'Electronic Notebook. '],
    '<Purpose>' =
        [   'Integrated, intelligent, multilingual, Fulltext Database for documents up to 64 KB, providing enhanced security features as high-speed encryption and access control. Specially suited for sensitive text\'s and notes on laptop\'s.'],
    '<Description>' =
        ['Personal Notekeeper is an intelligent text- ','retrieval system ',
    ...
    '<Developed by>' = ['Stefan Lago.'],'<Organization>' = ['none.'],
    '<Country>' = ['Switzerland.'],
    '<Prolog system>' = ['PDC Prolog 3.30 for DOS '],
    '<Other languages>' = ['10 % C'],'<Lines>' = ['app. 25.000'],
    '<Predicates>' = ['app. 800'],
    '<Platform>' = ['IPDC Prolog 3.30 for DOS'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['June 1992'],'<No. of Users>' = [void],
    '<Information Date>' = ['July 1. 1992']].
['<Program>' = ['PESKY'],'<Number>' = [344],
    '<Domain>' = ['Quarantine, Management of Naure Reserves, Farming. '],
    '<Purpose>' =
        [   'To assess the risk of damage to plants or animals caused by introduction of potential pests.'],
    '<Description>' =
    ...
    '<Developed by>' = ['W. Bottomley and R.W. Sutherst.'],
    '<Organization>' =
        ['Cooperative Research Centre for Tropical Pest Management.'],
    '<Country>' = ['Australia.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['1500'],
    '<Predicates>' = ['125'],'<Platform>' = ['PC using MSDOS.'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['1991'],
    '<Information Date>' = ['07/92']].
['<Program>' = ['PFT'],'<Number>' = [318],
    '<Domain>' = ['Chemical industry. '],
    '<Purpose>' = ['Production Formulisation Tool.'],
    '<Description>' =
    ...
    '<Organization>' = ['CPL Software and Services.'],
    '<Prolog system>' = ['CHIP '],'<Other languages>' = ['C  X11'],
    '<Lines>' = ['7000'],
    '<Platform>' =
        ['SUN/HP/IBM/DIGITAL workstations PC  386/486      UNIX   DOS'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['02/92'],'<No. of Users>' = ['1.'],
    '<Information Date>' = ['03/92'],
    '<References>' =
        ['M. Dincbas, P. Van Hentenryck, H. Simonis, A. ',
            'Aggoun, T. Graf, F. Berthier, The Constraint Logic Programming ',
            ...
            'Tokyo, Japan, November 1988. ']].
['<Program>' = ['PHARGEST.'],'<Number>' = "K",
    '<Domain>' = ['inventory management (drugs), decision support '],
    '<Purpose>' =
        [   'Management of the central medical store of the Tchadian Public Health services (inventories, orders, deliveries, follow-up of consumption).'],
    '<Description>' =
        ['PHARGEST offers all the usual facilities of a ',
            ...
            'constraints. '],
    '<Developed by>' =
        [   'Programming: Paul-Marie BOULANGER from ADRASS and Alain WODON from AEDES. Analysis:Paul-Marie BOULANGER et Daniel VANDENBERG (AEDES)'],
    '<Organization>' =
        [   'A.D.R.A.S.S. (Association Pour le Developpement de la Recherche Appliquee en Sciences Sociales) and A.E.D.E.S. (Association Europeenne pour le Developpement et la Sante) or (European Association for Health and Development).'],
    '<Country>' = ['Belgium and Tchad (Africa).'],'<Lines>' = ['10500'],
    '<Predicates>' = ['480'],
    '<Platform>' = ['80386 25MHz with 4MB of RAM and 120MB HD. MS-DOS 3.3'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<No. of Users>' = ['1 (Tchadian Central Medical Store)'],
    '<Information Date>' = ['02/18/1992']].
['<Program>' = ['PHILO THE LOGICIAN.'],'<Number>' = [463],
    '<Domain>' =
        ['Introductory logic classes in which students are required to ',
            'translate English sentences into truth-functional formulas. '],
    '<Purpose>' =
        [   'Exercises for translating English sentences into truth- functional logic.'],
    '<Description>' =
    ...
    '<Organization>' = ['University of Illinois and IBM.'],
    '<Country>' = ['U.S.A.'],
    '<Prolog system>' = ['Arity Prolog compiler and interpreter. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['779 lines.'],
    '<Predicates>' = ['126 predicates.'],
    '<Platform>' = ['PCs and clones, from 8088s on up.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['January, 1986.'],
    '<No. of Users>' = ['Over 500 students on this campus alone.'],
    '<Information Date>' = ['November 6, 1992.']].
['<Program>' = ['PHOEBUS'],'<Number>' = [144],
    '<Domain>' =
    ...
    '<Description>' = [' '],
    '<Developed by>' = ['F. Martinolle, C. Rominger, C. Guibout'],
    '<Organization>' = ['INSAT/DGE/GERII'],'<Country>' = ['France'],
    '<Prolog system>' = ['MacProlog"Prolog_by_BIM, Release 4.0 '],
    '<Other languages>' = ['None.'],'<Lines>' = ['1200'],
    '<Predicates>' = ['160'],
    '<Platform>' = ['Sun4 Sparcstation SLC / Unix_Berkeley'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<No. of Users>' = ['2'],'<Information Date>' = ['09/89'],
    '<References>' =
        ['* F. Martinolle, "Analyse de la commandabilite et ','de l\'obs ',
            ...
            'Multiconference, Erlangen, Germ ','any, June 1990 ',
...
['<Program>' = ['Phoebus'],'<Number>' = [258],
    '<Domain>' = ['Systems testing '],
    '<Purpose>' = ['analysis of hierarchical finite state machines'],
    '<Description>' =
    ...
    '<Developed by>' = ['C. Rominger, J.C.Geffroy, B. Soulas, C. Guibout'],
    '<Organization>' = ['INSAT-GERII, EDF-DER'],'<Country>' = ['France'],
    '<Prolog system>' = ['Prolog by BIM '],
...
['<Program>' = ['Phosulk'],'<Number>' = "c",
    '<Domain>' = ['Conservation Agriculture '],
    '<Purpose>' = ['Land Conservation Advisor'],
    '<Description>' =
    ...
    '<Developed by>' = ['Michael Brown'],
    '<Organization>' = ['Entretec Pty & Dept Agric, West Australia'],
    '<Country>' = ['Australia'],'<Prolog system>' = ['PDC Prolog v 3.21 '],
    '<Other languages>' = ['C about 10%'],'<Lines>' = ['4000'],
    '<Predicates>' = ['450'],'<Platform>' = ['DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['June 1991'],'<No. of Users>' = ['6'],
    '<Information Date>' = ['March 1992']].
['<Program>' = ['PHRASE'],'<Number>' = [497],
    '<Domain>' =
        ['Projects involving safety, where human factor contribute to ',
            'safe system operation. '],
    '<Purpose>' = ['Human reliability Analysis.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Steve Lympany, Barry Whittingam.'],
    '<Organization>' = ['Electrowatt Engineering.'],
    '<Country>' = ['England.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['800'],
    '<Predicates>' = ['200'],'<Platform>' = ['MS-DOS on IBM PC.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['Not yet released.']].
['<Program>' = ['PI'],'<Number>' = [1],'<Domain>' = ['Theorem proving '],
    '<Purpose>' = ['Interactive development and editing of formal proofs.'],
    '<Description>' =
        ['PI is a system for the interactive development of proofs ',
            ...
            'mouse. '],
    '<Developed by>' = ['Lars-Henrik Eriksson'],
    '<Organization>' = ['Swedish Institute of Computer Science (SICS)'],
    '<Country>' = ['Sweden'],'<Prolog system>' = ['SICSTUS '],
    '<Other languages>' = ['None'],'<Lines>' = ['3500, excl comment lines'],
    '<Predicates>' = ['290'],'<Platform>' = ['Sun-3/4, UNIX w/ Xwindows'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['August, 1990'],'<No. of Users>' = ['2'],
    '<Information Date>' = ['October 18, 1991']].
['<Program>' = ['PIAF'],'<Number>' = [445],
    '<Domain>' = ['Electronic Design. '],
    '<Purpose>' = ['Full custom integrated circuit floorplanning.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Marwan Anwar Jabri.'],
    '<Organization>' =
        [   'Systems Engineering and Design Automation Laboratory Sydney University Electrical Engineering.'],
    '<Country>' = ['Australia.'],
    '<Prolog system>' =
        ['Quintus Prolog (first version) later on Sicstus Prolog. '],
    '<Other languages>' =
        [   'Pascal and C to implement the algorithmic library of graph processing algorithms.'],
    '<Lines>' = ['16,000'],'<Predicates>' = ['5,000'],
    '<Platform>' = ['Sparc station (Unix).'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Prototype'],'<When Deployed>' = ['1989'],
    '<No. of Users>' = ['3'],'<Information Date>' = ['1992'],
    '<References>' =
        ['M. Jabri, ``An Artificial Intelligence Approach to ','Integrated ',
            'Circuit Floorplanning\'\',  Springer-Verlag, Lecture Notes in Engineering, ',
            'Vol 1.66, 1991. ']].
['<Program>' = ['Pictorial Janus'],'<Number>' = [16],
    '<Domain>' = ['Program Visualization '],
    '<Purpose>' =
        [   'Provide a visual programming environment for concurrent logic (and more generally constraint) programming'],
    '<Description>' =
    ...
    '<Developed by>' =
        [   'Ken Kahn with help from Vijay Saraswat; Volker Haarslev; and Susan Kropf'],
    '<Organization>' = ['Xerox PARC'],'<Country>' = ['USA'],
    '<Prolog system>' = ['Strand88 '],
    '<Other languages>' = ['C (5%); Postscript (10%); cshell (5%)'],
    '<Lines>' = ['11000'],'<Predicates>' = ['500'],
    '<Platform>' = ['SparcStations (stand-alone and networks of them)'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['3/91'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['12/91'],
    '<References>' =
        ['Kenneth M. Kahn and Vijay A. Saraswat ',
            ...
            'Concurrent Constraint Programs ','1991 ',
            '(submitted for publication) ',' ','Kenneth M. Kahn ',
            'Towards Visual Concurrent Constraint Programming) ','1991 ',
            '(submitted for publication) ',' ','Kenneth M. Kahn ',
            'Animation of Horn Clause Proofs ','1991 ',
            '(submitted for publication) ']].
['<Program>' = ['PigE'],'<Number>' = "+",'<Domain>' = ['farm management. '],
    '<Purpose>' =
        [   'An expert system for optimising the growth of pigs raised in pig pens.'],
    '<Description>' =
    ...
    '<Organization>' =
        [   'Black & Fleming:  Commonwealth Scientific Industrial Research Organisation (CSIRO); Division of Animal Production; Prospect; Sydney.  Menzies & Dean:  Stowe Computing Australia'],
    '<Country>' = ['Australia'],'<Prolog system>' = ['Arity Prolog '],
    '<Other languages>' = ['Pascal; MKS Toolkit; some shell script.'],
    '<Lines>' =
        [   'Is this a serious measure of a program?  The code listing is an inch thick.  Many comments. Lots of files.'],
    '<Predicates>' = ['211'],'<Platform>' = ['DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['Mid-1988 onwards'],
    '<No. of Users>' =
        [   'Farm managers in America; Holland; Belgium; France; Spain and Australia.  Pig diet manufacturers in Europe and USA'],
    '<Information Date>' = ['23-2-92'],
    '<References>' =
        ['"An Expert System for Raising Pigs"; in Proceedings of ',
            ...
            'April 2-3; 1992. ']].
['<Program>' = ['PISSARRA'],'<Number>' = [384],
    '<Domain>' = ['Maintenance and repair centres train tracks. '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['Jose A. Marques and programmers team.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain'],
    '<Prolog system>' = ['PDC Prolog 3.31 '],'<Lines>' = ['20000'],
    '<Predicates>' = ['625'],
    '<Platform>' =
        [   'Developed PC 386 / MS DOS Delivery PC 386 / MS DOS Novell Netware DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['07/1992'],'<Information Date>' = ['07/1992']].
['<Program>' = ['PLANE'],'<Number>' = [145],
    '<Domain>' = ['Production planning. '],
    '<Purpose>' =
        ['An evolutive planning system for scheduling Aircraft Production.'],
    '<Description>' =
    ...
    '<Developed by>' = ['DASSAULT/COSYTEC'],
    '<Organization>' = ['CLP Software and Services.'],
    '<Country>' = ['France'],'<Prolog system>' = ['CHIP '],
    '<Other languages>' = ['C  X11'],'<Lines>' = ['1000'],
    '<Platform>' =
        ['SUN/HP/ IBM/DIGITAL workstations PC  386/486          UNIX   DOS'],
    '<When Deployed>' = ['12/91'],'<Information Date>' = ['03/92'],
    '<References>' =
        ['M. Dincbas, P. Van Hentenryck, H. Simonis, A. ',
            ...
            'In Proc. of The Int. Conf. on Fifth Generation Computer Systems, p693-702. ',
            'Tokyo, Japan, November 1988. ']].
['<Program>' = ['PLANE:  PLANIFICATION EVOLUTION'],'<Number>' = [322],
    '<Domain>' = ['Scheduling. '],
    '<Purpose>' =
        ['Gives Schedule and load of the long term production of aircraft.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Jacques Bellone.'],
    '<Organization>' = ['DASSAULT AVIATION'],'<Country>' = ['France.'],
    '<Prolog system>' = ['CHIP of COSYTEC '],
    '<Lines>' = ['Kennel:  2,500, You Interface:  4,500'],
    '<Predicates>' = ['Kennel:  100 - N:of constraints:  47'],
    '<Platform>' = ['SUN 4 UNIX X11'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Prototype'],'<When Deployed>' = ['03/89'],
    '<No. of Users>' = ['2 for the evaluation'],
    '<Information Date>' = ['09/03/92'],
    '<References>' =
...
['<Program>' = ['Planning (more than) one-level buildings'],
    '<Number>' = [274],'<Domain>' = ['Architecture, Planning '],
    '<Purpose>' =
        [   'Supports the planning process of a building with more than one level.'],
    '<Description>' =
...
['<Program>' = ['Planning of panel buildings'],'<Number>' = [286],
    '<Domain>' = ['Computer aided design '],
    '<Purpose>' = ['Plans the architectural planning of panel buildings'],
    '<Description>' =
...
['<Program>' = ['PLASMA'],'<Number>' = [312],
    '<Domain>' = ['Re-Engineering. '],
    '<Purpose>' =
    ...
    '<Description>' =
        ['PLASMA Targets the market of existing large scale ',
            ...
            'Application Areas: ','1.  Software maintenance support. ',
            '2.  Job operation optimization support. ',
            '3.  Condition analysis during construction of data dictionaries. '],
    '<Developed by>' = ['Computer Applications Corporation Tokyo, Japan.'],
    '<Organization>' = ['Computer Applications Corporation Tokyo, Japan.'],
    '<Country>' = ['Japan.'],'<Prolog system>' = ['IF/PROLOG. '],
    '<Other languages>' = ['IF/PROLOG, OSF/MOTIF.'],
    '<Platform>' = ['all UNIX platforms.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['12/91.'],'<Information Date>' = ['03/ 92.']].
['<Program>' = ['PLASTIC'],'<Number>' = [377],
    '<Domain>' = ['Train control centre. '],
    '<Purpose>' = ['Intelligent operator control in a train dispatching.'],
    '<Description>' =
        ['Expert system train coordination control (logical, ','physical ',
    ...
    '<Developed by>' = ['Antoni Trias.'],'<Organization>' = ['AIA'],
    '<Country>' = ['Spain.'],'<Prolog system>' = ['PDC Prolog 3.31 '],
    '<Other languages>' = [void],'<Lines>' = ['14000'],
    '<Predicates>' = ['1200'],
    '<Platform>' =
        ['Developed PC 386 / MS DOS Delivered PC 386 386 / MS DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1991'],'<Information Date>' = ['07/1992']].
['<Program>' = ['PLASYNT'],'<Number>' = "@",
    '<Domain>' = ['Combinational logic synthesis '],
    ...
    '<Developed by>' = ['Mats Carlsson'],
    '<Organization>' = ['Swedish Institute of Computer Science'],
    '<Country>' = ['Sweden'],'<Prolog system>' = ['SICStus Prolog 2.1 '],
    '<Lines>' = ['1045'],'<Predicates>' = ['120'],'<Platform>' = ['UNIX'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['11/91'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['24/3/92'],
    '<References>' =
        ['Proc. The Practical Application of Prolog Conf., London ','1992. ']].
['<Program>' = ['PLEX'],'<Number>' = [455],
    '<Domain>' = ['Software Development. '],
    '<Purpose>' =
        ['LEX for Prolog: A lexical analyzer generator for Prolog.'],
    '<Description>' =
        ['PLEX creates a tokenizer from a lexical ','specification very ',
    ...
    '<Developed by>' = ['Suresh Rajgopal and Peter Reintjes.'],
    '<Organization>' = ['DAZIX/Intergraph Corporation.'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Quintus Prolog '],
    '<Other languages>' = ['none.'],'<Lines>' = ['646'],
    '<Predicates>' = ['131'],'<Platform>' = ['Quintus Platforms.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['6/92'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['11/92']].
['<Program>' =
    [   'PPLC 2.0 -  flexible  process  control  by  Prolog represented higher order Petri-nets .'],
'<Number>' = [485],'<Domain>' = ['Process Control. '],
'<Purpose>' =
    [   'Process  control  of  single  units  or  small  chemical and biotechnological plants by a structure-based  model,  integrating the batch, sequential, feedforward and feedback control actions.'],
'<Description>' =
    ['PPLC integrates the pseudo-parallel executing ','abilities of  the ',
...
'<Developed by>' = ['Bela Csukas, Laszlo Jambor, Rozalia Lakner .'],
'<Organization>' =
    [   'University  of  Veszprem,  Supported  by  the  Hungarian Basic Research Grant N OTKA-2550'],
'<Country>' = ['Hungary.'],
'<Prolog system>' =
...
'<Other languages>' =
    ['Can also be implemented in object oriented languages.'],
'<Lines>' = ['1000'],'<Predicates>' = ['150'],
'<Platform>' =
    ['PC/AT 386; transputer and work station versions in  preparation .'],
'<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Evaluation'],
'<When Deployed>' = ['6/1990'],'<No. of Users>' = ['10'],
'<Information Date>' = ['12/1993'],'<References>' = ['In preparation. ']].
['<Program>' = ['Practitioner Awards KBS'],'<Number>' = [191],
    '<Domain>' = ['Pensions administration '],'<Purpose>' = [''],
    '<Description>' =
        ['The system calculates retirement benefits for ',
            ...
            'documentation. '],
    '<Developed by>' = ['Gerry Piper'],
    '<Organization>' = ['Telecomputing PLC, IBiS Ltd.'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA Prolog, flex '],'<Platform>' = ['PC'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['June 1990'],'<No. of Users>' = ['11'],
    '<References>' =
        ['KBS system calculates pension awards to GPs. Expert ',
            'Systems Applications, Jan 1991. p21-22/ ']].
['<Program>' = ['Pre-Printed Blankrupter'],'<Number>' = [395],
    '<Domain>' = ['Legal forms processing and decision making. '],
    '<Purpose>' =
        [   'Completely processes all the Federal Bankruptcy Forms for chapter 7, 11, 12 & 13 bankruptcy filings.'],
    '<Description>' =
        ['Blankrupter processes and fills in Julius ',
            ...
            'Price: $ 200.00. '],
    '<Developed by>' = ['Norths Winds and Julius Blumberg Inc.'],
    '<Organization>' = ['Norths Winds and Julius Blumberg Inc.'],
    '<Country>' = ['USA.'],'<Prolog system>' = ['PDC Prolog (100%) '],
    '<Other languages>' = ['none.'],'<Lines>' = ['15.000'],
    '<Predicates>' = ['500'],
    '<Platform>' =
        [   'MSDOS 2.0, 512K memory, most dot matrix, daisywheel & laser printers, hard or floppy drive systems.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/1/88'],'<Information Date>' = ['9/1/92'],
    '<References>' = ['Catalog. ']].
['<Program>' = ['PRECIS'],'<Number>' = [190],
    '<Domain>' = ['Systems analysis and design '],
    '<Purpose>' = ['Analysis and CASE tool'],
    '<Description>' =
        ['Precis offers the ability to record a business ',
            ...
            'computer systems. '],
    '<Developed by>' = ['John Warren, Basil Barnett'],
    '<Organization>' = ['Precision Design'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA Prolog Professional '],
    '<Platform>' = ['IBM PS/2'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released']].
['<Program>' = ['Preditor'],'<Number>' = [197],
    '<Domain>' = ['Electronics Design '],
    '<Purpose>' = ['A VLSI design editor'],
    '<Description>' =
    ...
    '<Organization>' = ['Microelectronics Center of North Carolina'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Quintus '],
    '<Lines>' = ['5,000'],'<Platform>' = ['Unix, VAX workstation'],
    '<References>' =
        ['P.B. Reintjes: A VLSI Design Environment in Prolog. ',
            'ICLP5, 1988, pp70-81 ']].
['<Program>' = ['PRESS'],'<Number>' = "M",
    '<Domain>' = ['Programming Language Interpreters '],
    '<Purpose>' =
        [   '(PRolog Execution of Standard Semantics) (1) To check and validate the informal semantics of draft standard Prolog, and (2) To investigate techniques of writing high quality maintainable Prolog programs.'],
    '<Description>' =
    ...
    '<Prolog system>' = ['SICStus 2.1 #3 '],'<Other languages>' = ['None'],
    '<Lines>' =
        [   '1000 lines, approximately 100 -- history of PRESS, 250 -- internal checks, 200 -- subsidiary predicates, 100 -- test cases, 350 -- interpreter.'],
    '<Predicates>' = ['38'],'<Platform>' = ['Sun 3/50, Sun OS Release 4.1'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['September 1991'],'<No. of Users>' = ['1'],
    '<Information Date>' = ['March 1992'],
    '<References>' =
        ['ISO/IEC JTC1 SC22 WG17 N92: Draft for Standard ',
            'Prolog, March 1992. ',
            'National Physical Laboratory, Teddington, Middlesex. ']].
['<Program>' = ['Print-A-Form'],'<Number>' = [397],
    '<Domain>' = ['From Processing. '],
    '<Purpose>' =
        [   'Automates the processing of a unique Deluxe Check Printer\'s Inc. Form.  For example an invoice or check.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Norths Winds & Deluxe Check Printer Inc.'],
    '<Organization>' = ['North Winds.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['PDC Prolog (100%) '],
    '<Other languages>' = ['none.'],'<Lines>' = ['9.000'],
    '<Predicates>' = ['400'],
    '<Platform>' =
        [   'MSDOS 2.0 512K memory, most dot matrix, daisywheel & laser printers, hard or floppy drive systems.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/1987'],'<Information Date>' = ['9/15/92'],
    '<References>' = ['Deluxe Catalogues 1988-92. ']].
['<Program>' = ['Pro*CONSUL'],'<Number>' = [242],
    '<Domain>' = ['Communications design '],
    '<Purpose>' =
        ['to help the designer and implementer of communications protocols'],
    '<Description>' =
    ...
    '<Prolog system>' = ['MProlog and FAIR '],
    '<References>' =
        ['K. Tarnay, S Dibuz-W\207gner, Peter Ecsedi-T\227th, P. A. ',
            'W\207gner: A Knowledge-based approach to communication protocol endingeering. ',
            'Proc Seminar on Future Trends in Information Engineering, Univ. Salzburg, ',
            'Sep 1990, pp115-127 ']].
['<Program>' = ['Pro-Sylvia'],'<Number>' = [146],
    '<Domain>' = ['Agriculture '],
    '<Purpose>' =
    ...
    '<Description>' =
        ['The aim is to define a cutting diagram for a set of ',
            ...
            '3-5% ',' '],
    '<Developed by>' = ['Michel Rueher, Bruno Legeard'],
    '<Country>' = ['France'],'<Prolog system>' = ['Prolog III '],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['PROCAPS'],'<Number>' = [227],
    '<Domain>' = ['Electronic scheduling '],
    '<Purpose>' =
        [   'support and control the planning and scheduling of production lines of electronic components'],
    '<Description>' =
        ['The Process Oriented Capacity Production Scheduler ',
            ...
            'already available. '],
    '<Organization>' = ['BIM, Philips of Eindhoven'],
    '<Country>' = ['Belgium, Netherlands'],
    '<Prolog system>' = ['Prolog by BIM ']].
['<Program>' = ['PROCUT'],'<Number>' = [481],
    '<Domain>' = ['Building and woodworking industry. '],
    '<Purpose>' =
        ['Optimize layout plan for cutting of rectangular panels.'],
    '<Description>' =
        ['Menu driven, single user program intended for use ','by the ',
            ...
            'Performance benchmark: ','Platform: AT/286 16 Meg CPU no EMS ',
            'Number of items: 1000 ','Best case: 20 seconds ',
            'Worst case: 17 minutes. '],
    '<Developed by>' = ['Tinus Wille.'],
    '<Organization>' = ['Tinus Wille and Compuchem cc (sponsor).'],
    '<Country>' = ['South-Africa.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' =
        [   'Assembler routines for graphics hard copy RTLink Plus for the overlay version.'],
    '<Lines>' = ['1670 Prolog source.'],
    '<Predicates>' = ['106 defined predicates.'],
    '<Platform>' =
        [   '(ISA) IBM PC/AT and compatible 640 K base RAM minimum 2 Meg EMS optional but recommended Graphics support: Hercules (Mono) EGA and VGA Printing Epson 9 pin DOS 3.2 or later'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['Beta release 2/12/1991.'],
    '<Information Date>' = ['8/92']].
['<Program>' = ['ProdAction'],'<Number>' = [345],
    '<Domain>' =
    ...
    '<Developed by>' = ['Ignacio, Adrian Kromer, Alejandro Scheuer.'],
    '<Organization>' = ['Invap S.E.'],'<Country>' = ['Argentina.'],
    '<Prolog system>' =
        ['PDC Prolog 3.20 for DOS, now upgrading to PDC Prolog 3.30 ',
            'for Windows. '],
    '<Other languages>' = ['C (15%), Fox (20%), Quattro(5%).'],
    '<Lines>' = ['1.5 MB of Source code.'],'<Predicates>' = ['approx. 800'],
    '<Platform>' =
        ['80386/486 IBM compatible, DOS 5.0 for development and delivery.'],
    '<Type of Use>' = ['Licensed'],'<When Deployed>' = ['06/91'],
    '<Information Date>' = ['07/92'],
    '<References>' =
...
['<Program>' = ['PRODATA'],'<Number>' = [306],'<Domain>' = ['RDBMS '],
    '<Purpose>' = ['Interface to commercial RDBMS'],
    '<Description>' =
        ['PRODATA is a tightly coupled transparent interface ',
            'between PROLOG SYSTEMS and RDBMS, which include ORACLE, INFORMIX ',
            'and ','SYBASE. '],
    '<Developed by>' = ['Rob Lucus'],
    '<Organization>' = ['Keylink Computers Ltd'],'<Country>' = ['England'],
    '<Prolog system>' = ['LPA/QUINTUS/POPLOG '],
    '<Other languages>' = ['C 20%'],'<Lines>' = ['1500 per I/F'],
    '<Predicates>' = ['90 per I/F'],
    '<Platform>' = ['Mac/Sun/PC/HP/Sequent/Vax (Unix/vms)'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['Jan. 1988'],'<No. of Users>' = ['60'],
    '<Information Date>' = ['24/07/92'],
    '<References>' =
        ['PROLOG-relational database INTERFACES.  R.J. Lucus. ',
            'Information and Software Technology.  Dec. 1991 Vol. 33 No. 10. ']].
['<Program>' = ['Prof\'Expert'],'<Number>' = [373],
    '<Domain>' = ['Computer based training. '],
    '<Purpose>' =
        [   'The purpose of the system is to provide computer training in basic skills.'],
    '<Description>' =
    ...
    '<Developed by>' =
        [   'Jean-Pierre Baer, Marie-Louise Carrera, Anne Marechal, Luc-Olivier Pochon, Christophe von Siebenthal.'],
    '<Organization>' =
        [   'Centre de Formation Professionelle du Littoral Neuchatelois (CPLN),'],
    '<Country>' = ['Switzerland.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['IBM compatible, DOS, Windows planned.'],
    '<Lines>' = ['15000'],'<Predicates>' = ['300 relevants'],
    '<Platform>' = ['IBM compatible, DOS, Windows planned.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['Oct. 1990'],
    '<Information Date>' = ['August 1, 1992.'],
    '<References>' =
...
['<Program>' = ['PROGART'],'<Number>' = [280],
    '<Domain>' = ['Software applications '],
    '<Purpose>' =
        [   'To analyse programming style and effectiveness of syntactically correct PL/I and COBOL programs'],
    '<Description>' =
    ...
    '<Developed by>' = ['E. Halmay, P. Gero'],'<Organization>' = ['SZAMOK'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Other languages>' = ['PL/I'],'<Information Date>' = ['1984'],
    '<References>' =
        ['E. Halmay, P. Gero (1981) ','The PROGART system ',
            'SZAMOK report, 1981. ',' ','E. Halmay, P. Gero (1981) ',
...
['<Program>' = ['PROLAB'],'<Number>' = [147],'<Domain>' = ['Medical '],
    '<Purpose>' =
        ['PROLOG-based assistant for biochemical data interpretation'],
    '<Description>' = ['Submitted to PAC. Paper 33 '],
    '<Developed by>' = ['Peter Hammond et al'],'<Country>' = ['UK'],
    '<Prolog system>' = ['MacProlog '],'<Platform>' = ['Mac'],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['PROLEX'],'<Number>' = [148],'<Domain>' = ['Expert system '],
    '<Purpose>' = ['A Prolog Based Flexible Expert Sytem'],
    '<Description>' = ['Submitted to PAC. Paper 221 '],
    '<Developed by>' = ['Julius Csonto'],'<Country>' = ['Czechoslovakia'],
    '<Prolog system>' = ['Arity Prolog '],'<Platform>' = ['PC'],
    '<Information Date>' = ['18/10/91']].
['<Program>' = ['PROLOG VERIFIER'],'<Number>' = [288],
    '<Domain>' = ['Program verification '],
    '<Purpose>' = ['A system to verify Prolog programs'],
    '<Description>' =
...
['<Program>' = ['Prolog-D-Linda'],'<Number>' = [462],
    '<Domain>' = ['Parallel Prolog Programming. '],
    '<Purpose>' = ['To provide a Parallel Prolog Programming environment.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Geoff Sutcliffe, James Pinakis.'],
    '<Organization>' = ['The University of Western Australia.'],
    '<Country>' = ['Australia.'],'<Prolog system>' = ['SICStus Prolog. '],
    '<Other languages>' = ['C - 40%.'],'<Lines>' = ['642'],
    '<Predicates>' = ['60'],'<Platform>' = ['SUN Sparc/SUN OS / Any/UNIX.'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['11/91'],
    '<No. of Users>' = ['C - 40%'],'<Information Date>' = ['2/11/92'],
    '<References>' =
        ['Sutcliffe G., and Pinakis J. (To appear), Prolog-D- ','Linda: An ',
...
['<Program>' = ['PROM'],'<Number>' = [29],
    '<Domain>' = ['Institute of Theoretical Computer Science '],
    '<Purpose>' = ['flexible "make" tool'],
    '<Description>' =
        ['PROM is a flexible "make" tool designed for the special ',
            ...
            'files. '],
    '<Developed by>' = ['T. Kielmann'],
    '<Organization>' = ['Technical University Darmstadt'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['C-Prolog; V1.5 '],
    '<Lines>' = ['500'],'<Predicates>' = ['80'],
    '<Platform>' =
        [   'HP 9000; S400(and other 32-bit UNIX machines with running C- Prolog)'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<No. of Users>' = ['5'],'<Information Date>' = ['1991']].
['<Program>' = ['PROM'],'<Number>' = [277],
    '<Domain>' = ['Systems Programming/ Computer architecture '],
    '<Purpose>' = ['Mapping of INTEL 3000 Microprograms'],
    '<Description>' =
        ['PROM performs  the task for address assignment for ',
            ...
            'microprogram. '],
    '<Developed by>' =
        [   'K. Balogh, Z. Farks, I. Futo, P. Garami, I. Herenyi, E, Santane-Toth, J. Szeredi, P. Szeredi, J.Visnyovszky'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984'],
    '<References>' =
...
['<Program>' = ['Prometheus'],'<Number>' = [409],
    '<Domain>' = ['Expert Systems Toolkit. '],
    '<Purpose>' = ['To provide a flexible tool for developing KBS.'],
    '<Description>' =
        ['Prometheus is a general purpose expert system ','toolkit. ',
    ...
    '<Organization>' = ['Expert Systems Ltd.'],'<Country>' = ['UK.'],
    '<Prolog system>' = ['Prolog-2 from ESL. '],
    '<Other languages>' = ['none.'],'<Lines>' = ['12889'],
    '<Predicates>' = ['955'],'<Platform>' = ['PC/DOS and SUN/SunView.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['Dec 1988'],'<No. of Users>' = ['100 approx'],
    '<Information Date>' = ['25 March 1992'],
    '<References>' =
        ['"Prometheus - an advanced logic based toolkit." ',
            'R. Broughton, J. Paine and M. Yazdani. ',
            'Intellect 1991.  ISBN 1-871516-13-7 ']].
['<Program>' = ['PROMOTEX'],'<Number>' = [173],
    '<Domain>' = ['Automobile diagnosis '],
    '<Purpose>' =
        [   'Breakdown diagnosis for siz-cylinder Mercedes engines equipped with Bosch ignition'],
    '<Description>' = [' '],'<Developed by>' = ['Reinhardt Skuppin'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['Prolog III ']].
['<Program>' = ['Propagator'],'<Number>' = [149],'<Domain>' = ['TOOL '],
    '<Purpose>' = ['A Prolog-Based Causal Reasoning System'],
    '<Description>' = ['Submitted to PAC. Paper 211 '],
    '<Developed by>' = ['Ming Xi Tang'],'<Country>' = ['UK'],
    '<Prolog system>' = ['Poplog '],'<Information Date>' = ['1/10/91']].
['<Program>' = ['PROS 800 / PROVISA'],'<Number>' = [469],
    '<Domain>' =
        ['Industrial uses, mainly in areas of thermo procedure ',
            'techniques. '],
    '<Purpose>' =
        [   'Process visualisation and registration, analysis of process data.'],
    '<Description>' = [' '],'<Developed by>' = ['Peter Mueller Mannhardt.'],
    '<Organization>' = ['Hennig Software Engineering GmbH.'],
    '<Country>' = ['Germany.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['Stony Book Pascal, Turbo Assembler.'],
    '<Lines>' = ['20.000 LOC'],'<Predicates>' = ['500'],
    '<Platform>' = ['DOS , IBM compatible.'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1989'],
    '<Information Date>' = ['07/92']].
['<Program>' = ['PROSPEX'],'<Number>' = [179],'<Domain>' = [' '],
    '<Purpose>' =
        [   'process scheduling and planning system for the food, chemcial and petrochemical industries.'],
    '<Description>' =
        ['Configuration is a three stage process. ',
            ...
            'facility. ',' ','May not be Prolog! '],
    '<Organization>' = ['SIRA'],'<Country>' = ['UK']].
['<Program>' = ['Protee'],'<Number>' = [150],
    '<Domain>' = ['Biology research '],
    '<Purpose>' =
        ['Protee : A Knowledge based system to assist biology researchers'],
    '<Description>' = ['Submitted to PAC. Paper 382 '],
    '<Developed by>' = ['Le Dizes'],'<Country>' = ['France'],
    '<Prolog system>' = ['Prolog II + hyper card. '],
    '<Platform>' = ['MacII FX'],'<Information Date>' = ['6/11/91']].
['<Program>' = ['Protein Structure'],'<Number>' = [245],
    '<Domain>' = ['Genetics research '],
    '<Purpose>' = ['represent and reason about protein structure topology'],
    '<Description>' =
    ...
    '<Developed by>' =
        ['Chris Rawlings, John Fox, W. Taylor, J. Nyakairuy, M. Sternberg'],
    '<Organization>' = ['Imperial Cancer Research Fund'],
    '<Country>' = ['UK'],'<Prolog system>' = ['Decsystem-10 Prolog '],
...
['<Program>' = ['Protein Structure Prediction'],'<Number>' = "e",
    '<Domain>' = ['Molecular biology '],'<Purpose>' = [''],
    '<Description>' =
    ...
    '<Prolog system>' = ['Strand88 ']].
['<Program>' = ['ProTest'],'<Number>' = [151],'<Domain>' = ['TOOL '],
    '<Purpose>' =
        ['A Knowledge Analysis Tool for the Development of Expert Systems'],
    '<Description>' = ['Submitted to PAC. Paper 305 '],
    '<Developed by>' = ['Dr I D Watson & Norman'],'<Country>' = ['UK'],
    '<Prolog system>' = ['Asymetrix\'s Toolbox '],
    '<Platform>' = ['PC + Windows'],'<Information Date>' = ['31/10/91']].
['<Program>' = ['Prototyping in Prolog'],'<Number>' = [434],
    '<Domain>' =
        ['Computer Aided Design of New Software Tools for Task ','Support '],
    '<Purpose>' = ['Communication aid for the purpose of system design .'],
    '<Description>' =
        ['The system is used to describe simple tasks for ',
            ...
            'the design process. '],
    '<Developed by>' = ['Lars Oestreicher.'],
    '<Organization>' = ['Uppsala University, NUTEC'],
    '<Country>' = ['Sweden.'],
    '<Prolog system>' =
        ['LPA Mac Prolog/Prolog++ 4.0 (Object-Oriented ','version ',
            'of Prolog with graphics management) '],
    '<Other languages>' =
        [   'Under development is a graphical front-end which is supposed to replace graphics management under Prolog. Currently, however, the system is completely contained within Prolog.'],
    '<Platform>' = ['Macintosh II fx (runs on any Macintosh II) 8 MB, RAM'],
    '<Type of Use>' = [''],'<Current Status>' = [''],
    '<When Deployed>' = ['Early summer 1992.'],'<No. of Users>' = ['2-3'],
    '<Information Date>' = ['7 april 1992.'],
    '<References>' =
...
['<Program>' = ['PSI.'],'<Number>' = [465],
    '<Domain>' = ['Information Management. '],
    '<Purpose>' =
        [   'PSI is an application for data management and retrieval, intended for the non-commercial user.'],
    '<Description>' =
        ['PSI is a handy system for the management and ','retrieval of ',
    ...
    '<Developed by>' = ['Markus P.J. Fromherz.'],
    '<Country>' = ['Switzerland, USA.'],
    '<Prolog system>' = ['LPA MacProlog. '],'<Lines>' = ['5000 ?'],
    '<Predicates>' = ['500 ?'],'<Platform>' = ['Apple Macintosh.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/89'],'<No. of Users>' = ['40'],
    '<Information Date>' = ['7/92']].
['<Program>' = ['PULSE STREAM CLASSIFIER'],'<Number>' = [299],
    '<Domain>' = ['Radar/ EW '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['Gregory Bourassa'],
    '<Organization>' = ['Lockheed Canada Inc.'],'<Country>' = ['Canada'],
    '<Prolog system>' = ['PDC PROLOG  V3.21 '],'<Lines>' = ['~200'],
    '<Predicates>' = ['~14'],'<Platform>' = ['IBM 386 MS - DOS'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['01/91'],'<No. of Users>' = ['30'],
    '<Information Date>' = ['01/92'],
    '<References>' =
        ['NATO AGARD CONFERENCE PROCEEDINGS 499 ',
            ...
            'KENTIGERN ','HOUSE,  65 Brown St. Glasgow G2 8EX. ']].
['<Program>' = ['PX Telephone Attendant'],'<Number>' = "S",
    '<Domain>' = ['Telephony Application '],
    '<Purpose>' = ['Conversational Answering Machine'],
    '<Description>' =
        ['Answers a users telephone and takes a message by ',
            'repeatedly prompting the caller and recording the responses. '],
    '<Developed by>' = ['Larry Brunet'],
    '<Organization>' = ['Bell-Northern Research Ltd.'],
    '<Country>' = ['Canada'],'<Prolog system>' = ['BNR Prolog '],
    '<Other languages>' = ['Pascal, C'],'<Lines>' = ['7500'],
    '<Predicates>' = ['500'],'<Platform>' = ['Macintosh'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['12/90'],'<No. of Users>' = ['30'],
    '<Information Date>' = ['2/92'],
    '<References>' =
...
['<Program>' = ['PYTHON'],'<Number>' = [473],
    '<Domain>' = ['Problem Solving Methodologies. '],
    '<Purpose>' =
        [   'Expert system for recognizing and performing squeeze plays, an advanced strategy in the game of bridge.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Yossi Nygate & Prof. Leon Sterling.'],
    '<Organization>' = ['Weizmann Institute of Science .'],
    '<Country>' = ['Israel.'],'<Prolog system>' = ['Siscstus. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['2500'],
    '<Predicates>' = ['300'],'<Platform>' = ['VAX'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['12 months.'],'<Information Date>' = ['11/92.'],
    '<References>' =
        ['Journal of Logic Programming, Vol 8, pp. 21-39, 1990. ']].
['<Program>' = ['QD-Janus'],'<Number>' = [431],
    '<Domain>' = ['programming language implementation. '],
    '<Purpose>' =
        [   'A translator for a sequential implementation of the language Janus.'],
    '<Description>' =
    ...
    '<Developed by>' = ['S. K. Debray.'],
    '<Organization>' = ['The University of Arizona.'],'<Country>' = ['USA'],
    '<Prolog system>' = ['Sicstus Prolog v2.1 '],
    '<Other languages>' = [none],'<Lines>' = ['4500'],
    '<Predicates>' = ['430'],'<Platform>' = ['Sparcstation-2'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Prototype'],'<When Deployed>' = ['12/90'],
    '<No. of Users>' = ['6'],'<Information Date>' = ['6/91'],
    '<References>' =
...
['<Program>' = ['Rapidforms Forms Template - Contractor'],'<Number>' = [401],
    '<Domain>' = ['Form Processing. '],
    '<Purpose>' = ['To process 9 contractor related forms.'],
    '<Description>' =
    ...
    '<Developed by>' = ['North Winds.'],
    '<Organization>' = ['North Winds & Rapidforms, Inc.'],
    '<Country>' = ['USA.'],'<Prolog system>' = ['PDC Prolog '],
    '<Other languages>' = ['None.'],'<Lines>' = ['10000'],
    '<Predicates>' = ['400'],
    '<Platform>' =
        [   'MSDOS 2.0 512K memory, most dot matrix, daisywheel & laser printers, hard or floppy drive systems'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['March 1991.'],'<Information Date>' = ['9/1/92'],
    '<References>' = ['Catalogs. ']].
['<Program>' = ['Rapidforms Forms Template - Tax Template'],
    '<Number>' = [402],'<Domain>' = ['Form Processing. '],
    '<Purpose>' = ['To process W-2 and 1099 Tax Forms.'],
    '<Description>' =
    ...
    '<Platform>' =
        [   'MSDOS 2.0 512K memory, most dot matrix, daisywheel & laser printers, hard or floppy drive systems.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['September 1991.'],
    '<Information Date>' = ['9/1/92'],'<References>' = ['Catalogs. ']].
['<Program>' = ['$RD'],'<Number>' = "i",
    '<Domain>' = ['Software Develpment '],
    '<Purpose>' = ['The Prolog Rapid Development Toolkit'],
    '<Description>' = ['Submitted to PAC. Paper 273 '],
    '<Developed by>' = ['Harry Brown'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA '],'<Information Date>' = ['30/10/91']].
['<Program>' = ['Real Time ABLE compiler'],'<Number>' = "2",
    '<Domain>' = ['Multi-agent systems domains ',' '],
    ...
    '<Developed by>' = ['Peter Wavish'],
    '<Organization>' = ['Philips Research Laboratories'],
    '<Country>' = ['UK'],'<Prolog system>' = ['Quintus '],
    '<Other languages>' = [none],'<Lines>' = ['4000'],
    '<Predicates>' = ['200'],'<Platform>' = ['Sun'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['Jan 91'],'<No. of Users>' = ['5'],
    '<Information Date>' = ['8-3-92'],
    '<References>' =
...
['<Program>' = ['REDO Window Manager'],'<Number>' = [152],
    '<Domain>' = ['TOOL '],
    '<Purpose>' = ['An Intelligent Software Maintenance Management System'],
    '<Description>' = ['Submitted to PAC. Paper 223 '],
    '<Developed by>' = ['P. Breuer & Papapanagiotakis'],'<Country>' = ['UK'],
    '<Prolog system>' = ['"Quintus, Turbo" ']].
['<Program>' =
    ['REKPERT PLUS (Rectification Knowledge based Expert System.'],
'<Number>' = [305],'<Domain>' = ['Chemical Engineering. '],
'<Purpose>' =
    [   'REKPERT PLUS consists of several distributed cooperating expert systems to seperate multicomponant mixtures.'],
'<Description>' =
    ['For the implementation of an expert system for ',
        ...
        'selected. ','- REKPERT for usual columns and sidestreams. ',
        '_ TEAGPERT for special cases of the rectification like azeotropic or ',
        'extractive distillation. ','- SOLPERT choses suitable solvents. ',
...
'<Organization>' =
    ['Department of Chemical Engineering at the University of Dortmund.'],
'<Country>' = ['Germany.'],'<Prolog system>' = ['IF/PROLOG '],
'<Other languages>' = ['ORACLE (SQL), C, FORTRAN X-Windows'],
'<Lines>' = ['5MB'],
'<Platform>' = ['386(Ix), Mac (aux), Apollo (Domain OS), LAN'],
'<When Deployed>' = ['1984'],
'<No. of Users>' = ['several industrial requests'],
'<Information Date>' = ['29. 04. 92'],
'<References>' =
...
['<Program>' = ['REPROBATE'],'<Number>' = [323],
    ...
    '<Description>' =
        ['REPROBATE (the Redo Esprit Project Reporter of Bugs and ',
            ...
            'representation, then ???? '],
    '<Developed by>' = ['C.P.W. Hornsby, M.J. Metcalfe.'],
    '<Organization>' = ['Lloyd\'s Register, U.K.  (Esprit Redo Project).'],
    '<Country>' = ['U. K.'],'<Lines>' = ['18,000'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['06/92'],'<No. of Users>' = ['2'],
    '<Information Date>' = ['18/05/92'],
    '<References>' =
...
['<Program>' = ['RIGEN'],'<Number>' = "O",
    ...
    '<Prolog system>' = ['PDC Prolog 3.2 with Toolbox '],
    '<Other languages>' = ['Microsoft Multiplan 3.0, approx. 50%'],
    '<Lines>' = ['550'],'<Predicates>' = ['40'],
    '<Platform>' = ['IBM PS/2 DOS 3.3 development and delivery'],
    '<Type of Use>' = ['Free/Public Domain'],'<Current Status>' = ['Dead'],
    '<When Deployed>' = ['2/1992'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['2/1992']].
['<Program>' = ['ROADS'],'<Number>' = "3",
    '<Domain>' = ['Communication networks; private exchanges '],
    '<Purpose>' =
        [   'The term ROADS stands for Rule Oriented Application Design System. ROADS is a tool for rapid prototyping and simulation of applications based upon finite state machine principles.'],
    '<Description>' =
    ...
    '<Developed by>' = ['R.Schloeglhofer; M.Puchhammer'],
    '<Organization>' = ['Alcatel Austria AG'],'<Country>' = ['Austria'],
    '<Prolog system>' = ['Prolog by BIM; release 3.1 '],
    '<Other languages>' = ['Some interface routines have been written in C'],
    '<Lines>' = ['4000'],'<Predicates>' = ['200'],
    '<Platform>' = ['SUN4; XView'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['Nov 90'],
    '<No. of Users>' =
        ['Application development engineers within Alcatel Austria AG'],
    '<Information Date>' = ['June 90']].
['<Program>' = ['RoadWeather Pro'],'<Number>' = [346],
    '<Domain>' =
    ...
    '<Purpose>' =
        [   'User-interactive 24-hour weather prediction system for snow and ice control on highways.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Elmar R. Reiter and Luiz Teixeira'],
    '<Organization>' = ['WELS Research Corporation.'],'<Country>' = ['USA'],
    '<Prolog system>' = ['PDC Prolog 3.30 for Windows 3.1. '],
    '<Other languages>' =
        [   'WATCOM FORTRAN used for "front-end" numerical prediction model, ca. 25,000 lines of code.'],
    '<Lines>' = ['ca.  10,000 lines of Prolog code.'],
    '<Predicates>' = ['ca.  1000'],
    '<Platform>' =
        [   'Minimum:  386/25 MHz with math coprocessor, 6 Mbyte RAM, 10 Mbyte hard disk space available; Recommended:  486/50 MHz DX, 8 Mbyte RAM, 10 Mbyte available hard disk space.'],
    '<When Deployed>' = ['05/92'],
    '<Information Date>' =
        [   '07/92 \307IF*** The text replacing this argument is too long ***\310<References>\tE. R. Reiter, 1991:  "Hybrid modeling in meteorological applications.  Part 1:  Concepts and approaches. "Meteorology and Atmospheric Physics, Vol. 46, pp 77-99.  E.R. Reiter, David K. Doyle and Luiz Teixeira, 1992:  Intelligent and localized weather prediction.  WELS Research Corporation, Final Report to Strategic Highway Research Program, National Research Council, 140 pp.']].
['<Program>' = ['RPROLOG - Re-evaluable Prolog .'],'<Number>' = [487],
    '<Domain>' = ['Synthesis of Evolutionary Learning Algorithms. '],
    '<Purpose>' =
        [   'RPROLOG is a metainterpreter for the programming of the uncertain  possibilistic information feedback accompanying evolutionary synthesis from genetic building blocks.'],
    '<Description>' =
        ['The Re-evaluable PROLOG (RPROLOG) is  a  new ',
            ...
            'certain strategies. '],
    '<Developed by>' = ['Bela Csukas, Rozalia Lakner, Laszlo Horvath.'],
    '<Organization>' =
        [   'University  of  Veszprem,  supported  by  the  Hungarian Basic Research Grant N OTKA-2550.'],
    '<Country>' = ['Hungary.'],
    '<Prolog system>' = ['TURBOPROLOG 2.0, PDC PROLOG 3.31 '],
    '<Other languages>' = ['TURBOPASCAL and FORTRAN versions existed.'],
    '<Lines>' = ['2000'],'<Predicates>' = ['250'],
    '<Platform>' = ['PC/AT 386'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['12/1989'],
    '<No. of Users>' = ['20'],'<Information Date>' = ['12/1993'],
    '<References>' =
...
['<Program>' =
    [   'RTSC - Real Time Supervisory Control by structure-based  PROLOG program.'],
'<Number>' = [489],
'<Domain>' = ['Real Time Supervisory Control and Database Management. '],
'<Purpose>' =
    [   'Supervisory control of  a  flexible  multiproduct  batch plant including supervision  of  a  PLC  and  a  six-channel periphery interface, as well as receipt interpreter  software  balance  and database manipulation.'],
'<Description>' =
    ['In  the  structure-based  supervisory  control  and ','real-time ',
...
'<Developed by>' =
    [   'Bela Csukas, Karoly Varga, Laszlo  Jambor,  Lajos  Nagy, Tibor Chovan, Gabor Wittinger.'],
'<Organization>' =
    [   'University  of  Veszprem,  supported  by  the  Hungarian basic Research Grant N OTKA-2550.'],
'<Country>' = ['Hungary.'],
'<Prolog system>' = ['TURBOPROLOG 2.0; PDC PROLOG 3.31 '],
'<Other languages>' =
    [   'Certain tasks of low level periphery communication and database management can be advantageously implemented in C.'],
'<Lines>' = ['5000'],'<Predicates>' = ['600'],
'<Platform>' = ['PC/AT 286 and 386 optionally under CDOS .'],
'<Type of Use>' = ['Sold Product'],'<Current Status>' = [''],
'<When Deployed>' = ['9/1991'],'<No. of Users>' = ['1'],
'<Information Date>' = ['12/1993'],'<References>' = ['In preparation. ']].
['<Program>' = ['SALI'],'<Number>' = [153],
    '<Domain>' = ['Power distribution '],
    '<Purpose>' = ['a Substation ALarms Interpreter'],
    '<Description>' = ['Submitted to PAC. Paper 364 '],
    '<Developed by>' = ['Vlado Milosevic'],'<Country>' = ['Switzerland'],
    '<Prolog system>' = ['AAIS Prolog '],'<Platform>' = ['Macintosh II'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['SAME'],'<Number>' = [187],'<Domain>' = ['Systems design '],
    '<Purpose>' = ['Structured Analysis Modelleling Environment'],
    '<Description>' =
...
['<Program>' = ['SANOCOR'],'<Number>' = "I",
    ...
    '<Developed by>' = ['Audun Toennesen'],
    '<Organization>' = ['STATOIL - The Norwegian National Oil Company'],
    '<Country>' = ['Norway'],'<Prolog system>' = ['PDC ESTA '],
    '<Other languages>' = [void],'<Lines>' = [void],'<Predicates>' = [void],
    '<Platform>' = ['IBM PC/ DOS'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation'],'<When Deployed>' = ['May 1987'],
    '<No. of Users>' = ['50'],'<Information Date>' = ['March 1992'],
    '<References>' =
        ['Internal company publications, seminars on ','Artificial ',
            'Intelligence. ']].
['<Program>' = ['SAR'],'<Number>' = [388],
    '<Domain>' = ['Electrical dispatching. '],
    '<Purpose>' =
        [   'Restoration of an electrical power network after a general black-out.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Antoni Trias and programmers team.'],
    '<Organization>' = ['AIA'],'<Country>' = ['Spain.'],
    '<Prolog system>' =
        ['PDC Prolog 3.3 for Windows, Delphia Prolog on RISC ','station. '],
    '<Other languages>' = ['Oracle, STORIA, XMOTIF, C.'],
    '<Lines>' = ['unknown.'],'<Predicates>' = ['unknown.'],
    '<Platform>' =
        [   'Developed PC 386 / MS DOS and RISC station Delivery        RISC station (SUN and IBM)'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Prototype'],
    '<Information Date>' = ['07/1992']].
['<Program>' = ['SAX'],'<Number>' = [439],
    '<Domain>' = ['Natural Language Processing. '],
    '<Purpose>' = ['A parser generator for DCGs.'],
    '<Description>' =
        ['A parser generator for a Definite Clause Grammar ','which ',
    ...
    '<Country>' = ['Japan.'],'<Prolog system>' = ['SICStus Prolog '],
    '<Other languages>' = ['No'],'<Lines>' = ['1500'],
    '<Predicates>' = ['150'],'<Platform>' = ['SUN SPARCstation.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['October 1991'],'<No. of Users>' = ['5'],
    '<Information Date>' = ['22 April 1992'],
    '<References>' =
        ['Yuji Matsumoto and Ryoichi Sugimura, A Parsing System ',
            'based on Logic Programming, IJCAI-87, Aug. 1987. ']].
['<Program>' = ['SCE'],'<Number>' = [154],'<Domain>' = ['TOOL '],
    '<Purpose>' =
        [   'A Tool for defining Routing Information for the freephone Service in AXE.'],
    '<Description>' = ['Submitted to PAC. Paper 121 '],
    '<Developed by>' = ['Hans Nilsson'],'<Country>' = ['Sweden'],
    '<Prolog system>' = ['Prolog 2 '],'<Platform>' = ['IBM PC family'],
    '<Information Date>' = ['30/10/91']].
['<Program>' = ['Scheduling and Planning'],'<Number>' = "a",
    '<Domain>' = ['Car Manfacturing '],'<Purpose>' = [''],
    '<Description>' =
    ...
    '<Developed by>' = ['Quintec Systems Ltd'],'<Country>' = ['UK'],
    '<Prolog system>' = ['Quintec '],'<Platform>' = ['PC with Windows'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation']].
['<Program>' = ['Schikorre'],'<Number>' = [155],
    '<Domain>' = ['Power distribution '],
    '<Purpose>' =
        [   'Schikorre: A Knowledge Based System for the Correlation of Stratigraphic Sequences in Prolog'],
    '<Description>' = ['Submitted to PAC. Paper 249 '],
    '<Developed by>' = ['Dr Lutz Plumer & Baumbach'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['LPA Prolog '],
    '<Platform>' = ['PC'],'<Information Date>' = ['31/10/91']].
['<Program>' = ['SCORE'],'<Number>' = [22],
    '<Domain>' = ['Airline Fleet Management '],
    '<Purpose>' =
        [   'Decision support system for traffic planning and coordination in large airports.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Dan Ole Johansen'],
    '<Organization>' = ['Prolog Development Center'],
    '<Country>' = ['Denmark'],'<Prolog system>' = ['PDC Prolog '],
    '<Other languages>' = [none],'<Lines>' = ['>10.000  <100.000'],
    '<Platform>' = ['DOS; OS/2'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1/12 1988'],
    '<No. of Users>' = ['15'],'<Information Date>' = ['01/92']].
['<Program>' = ['Scrivener\252 - A Document Assembly Legal Expert System'],
    '<Number>' = "Y",'<Domain>' = ['Legal drafting '],
    '<Purpose>' = ['an expert system based document assembly program'],
    '<Description>' =
        ['To create a document for a user which is compatible ',
            'with Word Perfect\250, Scrivener asks for necessary information to ',
            ...
            'provisions. ',
            'Scrivener offers the following features: \245 The user is only asked necessary ',
            ...
            'answers. \245 Scrivener can display the model in outline form, with the ',
            'conditions for including (or excluding) each clause, and provides pull-down ',
            'menus and other development tools for quick and easy model editing.. \245 ',
    ...
    '<Developed by>' = ['Dianoetic Development Company, Pennsylvania, U.S'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Arity Prolog '],
    '<Other languages>' = ['30 lines of C'],
    '<Lines>' = ['7,500 lines of Prolog'],'<Platform>' = ['IBM PC'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released']].
['<Program>' = ['SD-Scicon Analyst System'],'<Number>' = "[",
    '<Domain>' = ['Computer Aided Software Engineering '],
    '<Purpose>' =
        [   'provides a complete and automated support system for specifying project requirements'],
    '<Description>' =
    ...
    '<Prolog system>' = ['LPA MacProlog '],
    '<Other languages>' = ['Pascal and Assembler'],
    '<Platform>' = ['Macintosh'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1983'],
    '<Information Date>' = ['1991']].
['<Program>' = ['SEAP (Systeme expert d\'alerte precoce).'],'<Number>' = "J",
    '<Domain>' = ['Famine Prediction '],
    '<Purpose>' =
        [   'Help the team in charge of the Malian "Early Warning System" (SAP:Systeme d\'Alerte Precoce), to predict and assess the nutritional status of the Malian population.'],
    '<Description>' =
    ...
    '<Developed by>' =
        [   'Programming: Paul-Marie BOULANGER from ADRASS and Jean-Michel GUILLAUME from AEDES. Analysis:Francoise ANDRE et Jean-Michel GUILLAUME (AEDES),Paul- Marie BOULANGER (ADRASS) + all the technical staff of the "SAP-MALI" (Systeme d\'Alerte Precoce).'],
    '<Organization>' =
        [   'A.E.D.E.S.: Association Europeenne pour le Developpement et la Sante (European Association for Health and Development).'],
    '<Country>' = ['Belgium and Mali (Africa).'],'<Lines>' = ['3580'],
    '<Predicates>' = ['330'],
    '<Platform>' = ['80286 with 1MB of RAM and 42 MB of HD. MS-DOS 3.3'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['02-1990'],'<No. of Users>' = ['1'],
    '<Information Date>' = ['02/18/1992'],
    '<References>' =
        ['F.ANDRE,P-M BOULANGER & J-M GUILLAUME:"Le systeme ',
            'd\'alerte precoce au Mali:l\'approche expert", AEDES, Bruxelles, 1991. ']].
['<Program>' = ['SECReTS'],'<Number>' = [189],
    ...
    '<Prolog system>' = ['LPA MacProlog '],'<Platform>' = ['Macintosh'],
    '<Type of Use>' = [''],'<Current Status>' = ['Released']].
['<Program>' = ['See Mail, Version 1.3'],'<Number>' = [411],
    '<Domain>' =
        ['Communications and Networking, group work support tools. '],
    '<Purpose>' =
        [   'Comprehensive e-mail system for DOS based LAN, with MCI Mail for external e-mail.'],
    '<Description>' =
    ...
    '<Developed by>' = ['David RR Webber.'],
    '<Organization>' = ['Gnosis Inc.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['PDC 3.21. '],'<Other languages>' = ['Assembler.'],
    '<Lines>' = ['30,000'],'<Predicates>' = ['6,000'],
    '<Platform>' = ['PC compatibles, PS/2.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['March 1991'],'<No. of Users>' = ['100+'],
    '<Information Date>' = ['March 1992'],'<References>' = ['None. ']].
['<Program>' = ['SEED'],'<Number>' = [156],
    '<Domain>' = ['Software Development '],
    '<Purpose>' =
        [   'Using Prolog to Develop Tools Supporting Formal Methods in Software Development'],
    '<Description>' = ['Submitted to PAC. Paper 276 '],
    '<Developed by>' = ['Betty Cheng & Gannod'],'<Country>' = ['USA'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['SEILBAHN'],'<Number>' = [347],
    '<Domain>' =
    ...
    '<Developed by>' = ['H. Geschwindner.'],
    '<Organization>' = ['Sisyphos/Doppelmayer.'],
    '<Country>' = ['Germany/Austria.'],
    '<Prolog system>' = ['Turbo Prolog/PDC Prolog 2.0/ PDC Prolog 3.30. '],
    '<Other languages>' = ['None.'],
    '<Lines>' = ['in Prolog:  With comments 13000 lines.'],
    '<Predicates>' = ['void.'],
    '<Platform>' =
        ['PC\'s 80286/386/486 MS-DOS 640 KB RAM Diskspace 20 MB EGA/VGA'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/89'],'<No. of Users>' = ['void.'],
    '<Information Date>' = ['05/08/92']].
['<Program>' = ['SEL Compiler'],'<Number>' = [157],'<Domain>' = ['PAR '],
    '<Purpose>' =
        ['Compiler For Subset Equational Language & Abstract Analyzers'],
    '<Description>' = ['Submitted to PAC. Paper 347 '],
    '<Developed by>' = ['Giancarlo Succi'],'<Country>' = ['Italy'],
    '<Platform>' = ['RISC Sun 4 architecture'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['SERPES'],'<Number>' = [11],
    '<Domain>' = ['Water Engineering Expert Systems '],
    '<Purpose>' = ['Perform Sewerage Rehabilitation Planning'],
    '<Description>' =
    ...
    '<Developed by>' = ['Charles Hornsby; Mike Metcalfe'],
    '<Organization>' = ['University of Surrey'],'<Country>' = ['England'],
    '<Prolog system>' = ['Quintus Prolog; Quintec Prolog '],
    '<Other languages>' = ['Quintus ProWindows; Fortran'],
    '<Lines>' = ['40000'],'<Predicates>' = ['1500'],
    '<Platform>' = ['Sun 4 / SunOS4'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1987'],
    '<No. of Users>' = ['n/a'],'<Information Date>' = ['Oct 1991'],
    '<References>' =
...
['<Program>' = ['Sesam-Chimio Hypertext system'],'<Number>' = [207],
    '<Domain>' = ['Medical information '],
    '<Purpose>' = ['Browsing of patient medical records'],
    '<Description>' =
        ['Sesam-Chimio is itself a prototype knowledge-based system ',
            ...
            'Prolog. '],
    '<Developed by>' = ['I. de Zegher, Philippe Jassem'],
    '<Organization>' = ['BIM'],'<Country>' = ['Belgium'],
    '<Prolog system>' = ['Prolog by BIM, with BIM_Probe '],
    '<Platform>' = ['SUN'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Evaluation'],'<No. of Users>' = ['3'],
    '<References>' =
        ['I. de Zeger, P. Jassem. Coupling hypertext to an object- ',
            'oriented environment. Artificial Intelligence in Medecine 2, (1990) pp205- ',
            '216. ']].
['<Program>' =
    [   'SEXSY (Studiefinancierings EXpert Systeem // Scholarship Expert System)'],
'<Number>' = [371],
'<Domain>' = ['Expert system, legislation on scholarships. '],
'<Purpose>' =
    [   'SEXSY is a tool to compute the composition and amount of governmental scholarships.'],
'<Description>' =
...
'<Developed by>' = ['Dick Schrauwen, Miguel Carrasquer.'],
'<Organization>' =
    ['Joint-venture of Niceware and Hogeschool Rotterdam en Omstreken.'],
'<Country>' = ['The Netherlands.'],'<Prolog system>' = ['PDC Prolog 3.30. '],
'<Other languages>' =
    [   'Borland C++ 3.0, PharLap DOS-Extender, PDC Hypertext Toolbox and regular PDC Prolog Toolbox.'],
'<Lines>' = ['5000 (+/- 30% excluding toolboxes)'],
'<Predicates>' = ['478 (excluding toolboxes and libraries)'],
'<Platform>' = ['MS-DOS, 286-extended DOS, OS/2 (textmode).'],
'<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
'<When Deployed>' = ['August 1992'],
'<Information Date>' = ['12th of August 1992'],
'<References>' = ['12th of August 1992. ']].
['<Program>' = ['Simapro'],'<Number>' = [391],
    '<Domain>' = ['Environmental analysis of products. '],
    '<Purpose>' =
        [   'Calculating environmental impact of production/use/waste handling of products.'],
    '<Description>' =
        ['Description Experimental program that reflects Life ','Cycle ',
    ...
    '<Developed by>' = ['R. Heule/L. van Oers/J. Guinae/P. Mulder.'],
    '<Organization>' =
        ['Centre for environmental Science of the Leiden University.'],
    '<Country>' = ['Holland.'],'<Prolog system>' = ['PDC Prolog 3.2 '],
    '<Other languages>' = ['None.'],'<Lines>' = ['Approx. 3000'],
    '<Predicates>' = ['Approx. 250'],'<Platform>' = ['MS-DOS 5.0'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = [''],
    '<When Deployed>' = ['April 1991.'],
    '<Information Date>' = ['April 1991.'],
    '<References>' = ['Simapro manual (1991). ']].
['<Program>' = ['SIMPOS'],'<Number>' = [254],
    '<Domain>' = ['Operating systems '],
    '<Purpose>' =
        ['operating system for the personal sequential inference machine'],
    '<Description>' =
        ['SIMPOS has been developed under the following ','principles: ',
    ...
    '<Prolog system>' = ['ESP '],'<Lines>' = ['145,000'],
    '<Predicates>' = ['15,000'],'<Platform>' = ['PSI'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['1985?'],'<Information Date>' = ['1986'],
    '<References>' =
        ['K. Fuchi, K. Furukawa: The Role of Logic Programming in ',
            'the Fifth Generation Computer Project. ICLP3, 1986. pp1-24. ']].
['<Program>' = ['SimSched'],'<Number>' = [413],
    '<Domain>' = ['Design and  control of Flexible Manufacturing Systems. '],
    '<Purpose>' =
        [   'Creating manufacturing schedule and analyzing  the work of Flexible Manufacturing Systems using simulation.'],
    '<Description>' =
    ...
    '<Other languages>' =
        [   'Microsoft C and Graphic Software  Systems*   Computer Graphic Interface (GSS*CGI) for the connected  Animation Package.'],
    '<Lines>' = ['800'],'<Predicates>' = ['200'],
    '<Platform>' = ['IBM PC AT, OS/2;  MicroVAX, VMS'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['July 1991'],'<Information Date>' = ['Marc 1992'],
    '<References>' =
...
['<Program>' = ['SINTESIS'],'<Number>' = [158],
    '<Domain>' = ['Software Development '],
    '<Purpose>' = ['Towards an Automated Software Production Environment'],
    '<Description>' = ['Submitted to PAC. Paper 290 '],
    '<Developed by>' = ['I Ramos et al'],'<Country>' = ['Spain'],
    '<Prolog system>' = ['BIM Prolog '],
    '<Platform>' = ['Sun 3/XX Workstations'],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['SIPS'],'<Number>' = [159],
    '<Domain>' = ['CIM, QA, Education, Artificial Intelligence. '],
    '<Purpose>' =
        [   'Inductive Analysis:  A machine learning algorithm as an alternative statistical technique.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Guido Cosemans'],
    '<Organization>' =
        ['V.I.T.O. (The Flemish Institute for Technology and Research)'],
    '<Country>' = ['Belgium'],
    '<Prolog system>' = ['Turbo Prolog (now PDC Prolog). '],
    '<Other languages>' = ['Assembler (100 lines).'],'<Lines>' = ['18,000'],
    '<Predicates>' = ['1500'],
    '<Platform>' =
        [   'development:  386-PC, MS-DOS 3, PDC Prolog delivery:  PC-AT, 640 KB RAM and hard disk SUN (in PC-DOS envirinment)'],
    '<When Deployed>' = ['06/92'],'<No. of Users>' = ['Void.'],
    '<Information Date>' =
        [   '09/07/92 \307IF*** The text replacing this argument is too long ***\310<References>\t1)  Cosemans g., Dijkstra J., Hajek J., Post W. Schaefer W, Vavra F. and Melichar J., Methoden voor klasse- identificatie empirisch vergeleken, Internal Report, University of Eindhoven, Dept. of Building Sciences, 1991. 2)  Cosemans g.  and Samyn J. Inductive Analysis of Data Sets, Proceedings of the SEAS Annual Meeting, Amsterdam, September 25-28.']].
['<Program>' = ['SIRIUS'],'<Number>' = [379],
    '<Domain>' = ['Train dispatching and control. '],
    '<Purpose>' =
        [   'Decrease the operator resolution time of failures on trains on the track lines by means of dialoging expert system.'],
    '<Description>' =
    ...
    '<Organization>' = ['AIA'],'<Country>' = ['Spain.'],
    '<Prolog system>' = ['PDC Prolog 3.31 '],'<Other languages>' = [void],
    '<Lines>' = ['4790'],'<Predicates>' = ['354'],
    '<Platform>' = ['Developed PC 386/ MS DOS Delivery PC / MS DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1992'],'<Information Date>' = ['07/1992']].
['<Program>' = ['SKIL'],'<Number>' = [160],'<Domain>' = ['CASE '],
    '<Purpose>' = ['Synthesizing Knowledge in Intuitionistic Logic'],
    '<Description>' = ['Submitted to PAC. Paper 387 '],
    '<Developed by>' = ['D Galmiche, Conraud, & Herman'],
    '<Country>' = ['France'],'<Prolog system>' = ['Quintus '],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['Skilaki'],'<Number>' = ">",'<Domain>' = ['Expert systems '],
    '<Purpose>' = ['Logic based expert system shell'],
    '<Description>' =
        ['An expert system shell similar to `apes\'. It ','provides ',
    ...
    '<Developed by>' = ['Marek Sergot and Yannis Cosmadopoulos'],
    '<Organization>' = ['The developers'],'<Country>' = ['UK'],
    '<Prolog system>' = ['LPA MacProlog '],'<Lines>' = ['1200'],
    '<Predicates>' = ['150'],'<Platform>' = ['Apple Mac'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['Month/year of inital practical use of program'],
    '<No. of Users>' = ['10'],
    '<Information Date>' =
        [   '27/3/92 \307IF*** The text replacing this argument is too long ***\310<References>\tPeter Hammond, APES: A User Manual", Report 82/9, Department of Computing, Imperial College", 1982 Yannis Cosmadopoulos and Richard W. Southwick, Using Meta-Level Information for Expert System Control: A Blending Transformer Approach, In Nigel Shadbolt (Ed) "Research and Development in Expert Systems VI, Cambridge University Press, pp54-65,1989 Yannis Cosmadopoulos and Marek Sergot and Richard W. Southwick. Data- driven Transformation of Meta-interpreters: A Sketch. In Michael M. Richter, Harold Boley (Eds) Proceedings of the International Workshop on Processing Declarative Knowledge. Springer Verlag, 1991']].
['<Program>' = ['SKOL EXPERT'],'<Number>' = [410],
    '<Domain>' = ['Education. '],
    '<Purpose>' =
        [   'Introduce pupils to expert systems / logic / automated reasoning.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Per Gregers Bilse, Goeran Nydahl.'],
    '<Organization>' =
        [   'Prolog Development Center, Swedish Ministry of Education, respectively.'],
    '<Country>' = ['Denmark, Sweden.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['5% C, by volume.'],'<Lines>' = ['4500'],
    '<Predicates>' = ['400'],'<Platform>' = ['DOS'],'<Type of Use>' = [''],
    '<Current Status>' = [''],'<When Deployed>' = ['Autumn 1988'],
    '<No. of Users>' = ['Not reported.'],
    '<Information Date>' = ['25th 1992'],
    '<References>' =
        ['"SKOL EXPERT User\'s Guide" by Goeran Nydahl, ','Swedish ',
            'Ministry of Education. ']].
['<Program>' = ['SMES'],'<Number>' = [314],'<Domain>' = ['Monitoring. '],
    '<Purpose>' = ['Monitoring a tunnel-drill-machine.'],
    '<Description>' =
        ['The system monitors the drilling process in ',
            'realtime.  In case of malfunction (pipe-clogs, influxes, .....) ',
            'diagnosis is started. ','The system has two parts: ',
    ...
    '<Developed by>' = ['Dr. Oskar Bartenstein.'],
    '<Organization>' = ['Interface Computer Japan Ltd.'],
    '<Country>' = ['Japan.'],'<Prolog system>' = ['IF/PROLOG '],
    '<Other languages>' = ['GKS'],'<Platform>' = ['HP 9300'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['08/87'],'<No. of Users>' = ['1.'],
    '<Information Date>' = ['14/02/92']].
['<Program>' = ['SMI'],'<Number>' = [161],'<Domain>' = ['OODB '],
    '<Purpose>' =
        [   'A Meta-Integration System for a Heterogeneous Object-Oriented Database Environment - Implementation in Prolog'],
    '<Description>' = ['Submitted to PAC. Paper 361 '],
    '<Developed by>' = ['Qutaishat, Fiddian, & Gray'],'<Country>' = ['UK'],
    '<Prolog system>' = ['POPLOG '],'<Platform>' = ['Sun'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['SMS'],'<Number>' = [271],'<Domain>' = ['Mathematics '],
    '<Purpose>' = ['To simplify mathematical structures'],
    '<Description>' =
...
['<Program>' = ['Socrate'],'<Number>' = [498],
    '<Domain>' = ['Computer based training. '],
    '<Purpose>' =
        [   'Is a CAI system for developing lessons by teachers don*t know anything about computers.'],
    '<Description>' =
    ...
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['September *92'],'<Information Date>' = ['10/12/92']].
['<Program>' = ['Software development information system'],
    '<Number>' = [284],'<Domain>' = ['Software development '],
    '<Purpose>' =
        [   'An information system for the "Answer" software development system'],
    '<Description>' =
    ...
    '<Information Date>' = ['1984'],
    '<References>' =
        ['P. Ban, J. Kohegyi, Gy. Suhai, A. Veszepremi, L. ','Zsako (1979) ',
            'An information system for Answer ','ELTE report. ',
            'SOFTTECH D20, SZAMKI, 1979. ']].
['<Program>' = ['SOLITAIRE FOUNDATION PLANNING'],'<Number>' = [291],
    '<Domain>' = [' '],
    '<Purpose>' = ['To automate the planning of Solitaire Foundation'],
    '<Description>' =
    ...
    '<References>' =
        ['D. Holnapy (1979) ',
            ...
            'ETI report, 1979. ']].
['<Program>' = ['Sonar performance'],'<Number>' = [174],
    '<Domain>' = ['Sonar design '],
    '<Purpose>' = ['Optimization of sonar performance'],
    '<Description>' =
    ...
    '<Developed by>' = ['Thomson SIntra ASM, Toulon'],
    '<Country>' = ['France'],'<Prolog system>' = ['Prolog III ']].
['<Program>' = ['SP-Motif'],'<Number>' = [428],
    '<Domain>' = ['Graphical User Interface. '],
    '<Purpose>' = ['Prolog Interface to OSF/Motif.'],
    '<Description>' =
        ['It provides an Object Oriented Interface to the ','OSF/Motif ',
    ...
    '<Developed by>' = ['Ph. Coq ,J. Dalle Rive.'],
    '<Organization>' = ['Bull S.A.'],'<Country>' = ['France.'],
    '<Prolog system>' =
        ['SP-Prolog Compiler (Bull S.A) ',
            '(SP-Prolog Compiler has been extended to incorporate ',
            'smalltalk-like object oriented mechanisms) '],
    '<Other languages>' = ['C'],'<Lines>' = ['6000'],
    '<Predicates>' = ['600'],
    '<Platform>' = ['DPX5000,DPX2000,DPX/2 100,200,300 MIPS, AIX RS/6000'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['02/91'],'<No. of Users>' = ['15'],
    '<Information Date>' = ['03/92']].
['<Program>' = ['SPADE'],'<Number>' = [492],
    '<Domain>' = ['High integrity software. '],
    '<Purpose>' =
        [   'To provide formal validation and verification of high- integrity software.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Ian O\'Neill'],
    '<Organization>' = ['Program Validation Limited.'],
    '<Country>' = ['U.K.'],'<Prolog system>' = ['POPLOG Prolog. '],
    '<Other languages>' = ['No.'],'<Lines>' = ['17,000'],
    '<Predicates>' = ['700'],'<Platform>' = ['VAX   VMS   SUN    MicroVAX'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/87 (practical use)'],'<No. of Users>' = ['20'],
    '<Information Date>' =
        [   '19.1.93 \307IF*** The text replacing this argument is too long ***\310'],
    '<References>' =
        ['Logic Programming Tools and Techniques for ',
            ...
            'A Proof Tool for Program Proving ','Ian M. O\'Neill ',
            ...
            'Machine-Assisted Program Proof ','Ian M. O\'Neill ',
            ...
            ' ']].
['<Program>' = ['Speech synthesis'],'<Number>' = [235],
    '<Domain>' = ['Speech synthesis '],
    '<Purpose>' = ['high quality speech synthesis system'],
    '<Description>' =
    ...
    '<Prolog system>' = ['Poplog '],'<Platform>' = ['MicroVax 3400']].
['<Program>' = ['Spiral Menu'],'<Number>' = [513],
    '<Domain>' =
        ['Sprial menu is a graphics user interface, hence a general ',
            ...
            'geographic indexes, lexical ','collections, catalogues, etc. '],
    '<Purpose>' =
        [   'Thanks to mouse selection, Sprial Menu allows random access to up to 53 items, in graphics mode.'],
    '<Description>' =
        ['Spiral Menu becomes of use in applications ','requiring fast ',
    ...
    '<Developed by>' = ['Pierre Chirouze.'],'<Organization>' = ['None.'],
    '<Country>' = ['France.'],'<Prolog system>' = ['PDC Prolog 3.31a '],
    '<Other languages>' = ['None.'],'<Lines>' = ['1000'],
    '<Predicates>' = ['18'],
    '<Platform>' = ['386, VGA monitor, DOS 4.01 and above.'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['4/92'],'<No. of Users>' = ['10'],
    '<Information Date>' = ['9 feb 1993']].
['<Program>' = ['SRI Business Analysis'],'<Number>' = [199],
    '<Domain>' = ['Systems analysis '],'<Purpose>' = [''],
    '<Description>' =
    ...
    '<Prolog system>' = ['Quintus '],'<Other languages>' = ['C'],
    '<Platform>' = ['Unix']].
['<Program>' = ['SSPA'],'<Number>' = [163],'<Domain>' = ['PLAN '],
    '<Purpose>' =
        [   'A KBS for Writing Safe Sequences of Operations on a High Voltage Electricity Network'],
    '<Description>' = ['Submitted to PAC. Paper 201 '],
    '<Developed by>' = ['Brint et al'],'<Country>' = ['UK'],
    '<Prolog system>' = ['Quintec Prolog '],
    '<Platform>' = ['"Sun 3, to PCs running windows"'],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['SSTREN'],'<Number>' = [356],
    '<Domain>' = ['Computer Aided Training for mentally impaired pupils. '],
    '<Purpose>' =
        [   'Software/Hardware training package for severely mentally inpaired.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Sigve B_'],'<Organization>' = ['SigveSaker'],
    '<Country>' = ['Norway.'],
    '<Prolog system>' = ['PDC Prolog 3.3 + PDC Toolbox. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['600'],
    '<Predicates>' = ['20'],'<Platform>' = ['MS-DOS.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['08/92'],'<Information Date>' = ['12/08/92']].
['<Program>' = ['Staff'],'<Number>' = [20],
    '<Domain>' = ['Staff Scheduling '],
    '<Purpose>' =
        [   'Creation and maintenance of work schedules for large companies and institutions.'],
    '<Description>' =
        ['Staff is a system for decentralized creation and ',
            ...
            'heuristics. '],
    '<Developed by>' = ['Jens Kjaerum; Lars Malmgren-Hansen'],
    '<Organization>' = ['Prolog Development Center'],
    '<Country>' = ['Denmark'],'<Prolog system>' = ['PDC Prolog '],
    '<Lines>' = ['>10.000   <100.000'],
    '<Platform>' =
        [   'IBM PC with DOS version 3.30 or OS/2 version 1.1 or later, with 640K RAM (OS/2 version 4M RAM)'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['02/89'],'<No. of Users>' = ['200'],
    '<Information Date>' = ['01/92']].
['<Program>' = ['STEUFF'],'<Number>' = [480],
    '<Domain>' =
        ['Nuclear technique still in use ! in preliminary use at a ',
            'nuclear station. '],
    '<Purpose>' =
        [   'Producing in-data for a computer that surveys and controls the stearing mechanism in a KWU hot-water reactor.'],
    '<Description>' =
        ['XPS with a nice graphical user interface, mouse, ','OOP, print ',
            'options of end forms. '],
    '<Developed by>' = ['Siemens KWU0143, Joachim Lorek.'],
    '<Organization>' = ['Siemens KWU internally.'],
    '<Country>' = ['Germany.'],
    '<Prolog system>' = ['PDC Prolog 3.0 (formerly Turbo Prolog 2.0) '],
    '<Other languages>' = ['C for a printer routine.'],
    '<Lines>' = ['approx. 16.000'],'<Predicates>' = ['approx. 1500'],
    '<Platform>' = ['DOS 5, PC 286...486'],
    '<Current Status>' = ['Prototype'],'<When Deployed>' = ['10/91'],
    '<Information Date>' = ['10/92'],
    '<References>' =
        ['Expert Systems and Computer Simulation in Energy ',
            'Engineering, March 92, 8520 Erlangen ']].
['<Program>' = ['STRAND88 Programming System'],'<Number>' = [26],
    '<Domain>' = ['practical (symbolic) parallel processing '],
    '<Purpose>' = ['a portable programmng system for parallel computers'],
    '<Description>' =
    ...
    '<Developed by>' = ['RGT Barnes MA Gittins WB Pickles et al'],
    '<Organization>' = ['The STRAND Group'],'<Country>' = ['UK'],
    '<Prolog system>' = ['STRAND88 '],
    '<Other languages>' = ['interface to X-windows'],'<Lines>' = ['10000'],
    '<Predicates>' = ['~800'],'<Platform>' = ['networks of workstations'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['September 1991'],'<No. of Users>' = ['n/a'],
    '<Information Date>' = ['October 1991']].
['<Program>' = ['Studygram'],'<Number>' = [164],'<Domain>' = ['NL '],
    '<Purpose>' = ['Prolog for Natural Language Morphology'],
    '<Description>' = ['Submitted to PAC. Paper 208 '],
    '<Developed by>' = ['Peter Greenfield et al'],'<Country>' = ['UK'],
    '<Information Date>' = ['31/10/91']].
['<Program>' = ['SUMO_SAMA'],'<Number>' = [477],
    '<Domain>' =
        ['Process Engineering for manufacture of circuit packs using ',
            'Surface Mount technology. '],
    '<Purpose>' = ['SUrface MOunt Slot And Machine Allocator.'],
    '<Description>' =
        ['For a family of circuit boards specified by the ','user, ',
    ...
    '<Developed by>' = ['Russell G. Bulsis.'],
    '<Organization>' = ['AT&T - Denver Works, Denver, Colorado.'],
    '<Country>' = ['U.S.A.'],
    '<Prolog system>' = ['Quintus Prolog Release 3.1.1 '],
    '<Other languages>' = ['Quintus ProWindows 1.2 - SunView Version.'],
    '<Lines>' = ['5000'],'<Predicates>' = ['500'],
    '<Platform>' = ['Sun SPARCstation 1+ running SunOS 4.1.1'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['9/91'],'<No. of Users>' = ['6'],
    '<Information Date>' = ['11/25/92']].
['<Program>' = ['SXL'],'<Number>' = [165],
    '<Domain>' = ['Software Development '],
    '<Purpose>' = ['Modeling and Prototyping with Structured Logic'],
    '<Description>' = ['Submitted to PAC. Paper 138 '],
    '<Developed by>' = ['Stanley Lee'],'<Country>' = ['USA'],
    '<Prolog system>' = ['"C Prolog, Quintus Prolog and Arity Prolog." '],
    '<Platform>' =
        ['SXL 2.0 + 3.0 Unix systems and IBM compatible personal'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['Syclops II'],'<Number>' = [443],
    '<Domain>' = ['Software development. '],
    '<Purpose>' = ['Developer\'s workbench for database applications.'],
    '<Description>' =
        ['SyclopsII is a developer\'s workbench to build GUI ',
            'interface and DB access methods. '],
    '<Developed by>' = ['ISAC, Inc.'],'<Organization>' = ['ISAC, Inc.'],
    '<Country>' = ['Japan.'],'<Prolog system>' = ['K-Prolog. '],
    '<Other languages>' = ['C (90%).'],'<Lines>' = ['4000 lines.'],
    '<Predicates>' = ['600 predicates.'],
    '<Platform>' = ['Sparc,HP-9000,SONY NEWS.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['June 1, 1991.'],
    '<No. of Users>' = ['unknown persons (at 60 sites).'],
    '<Information Date>' = ['April 17, 1992'],'<References>' = ['N/A ']].
['<Program>' = ['SYLAE'],'<Number>' = [231],
    '<Domain>' = ['expert systems interface '],
    '<Purpose>' =
    ...
    '<Organization>' = ['IBM Paris Scientific Center'],
    '<Country>' = ['France'],'<Prolog system>' = ['IBM Prolog ']].
['<Program>' = ['SYLLOG'],'<Number>' = "0",
    '<Domain>' =
        ['Deductive database; expert system;  natural language query '],
    '<Purpose>' =
        [   'Strongly declarative deductive database system; with end-user level knowledge authoring and use. Direct execution of near-English specifications.'],
    '<Description>' =
    ...
    '<Developed by>' =
        [   'Adrian Walker; Daphne Tzoar; Peter Sheridan. Gustaf Neumann. Andrew Taylor.'],
    '<Organization>' = ['IBM Research Division'],'<Country>' = ['USA'],
    '<Prolog system>' = ['IBM Prolog Program Product '],
    '<Other languages>' = ['SQL; REXX'],
    '<Lines>' = ['10,000 lines of Prolog'],'<Predicates>' = ['4,000'],
    '<Platform>' = ['VM; on an IBM 3090 computer'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['Jan 1987'],'<No. of Users>' = ['20'],
    '<Information Date>' =
        [   'March 1992 \307IF*** The text replacing this argument is too long ***\310<References>\tTheory basis is "Towards a Theory of Declarative Knowledge" by Apt; Blair and Walker; in: Foundations of Deductive Databases and Logic Programming; J. Minker (Ed.); Morgan Kaufman 1988. A. Walker; M. McCord; J. Sowa and W. Wilson. "Knowledge Systems and Prolog: Developing Expert; Database; and Natural Language Systems"; second edition; Addison-Wesley; 1990. SYLLOG user notes; available from Adrian Walker.']].
['<Program>' = ['Symbolic Differentiatio and Integrator (DS)'],
    '<Number>' = [499],
    '<Domain>' = ['Instruction and practical use of Calculus. '],
    '<Purpose>' =
        [   'This program symbolically differentiates all common mathematical functions and solves most simple integrals ( including integration by parts, but not substitution ).'],
    '<Description>' =
        ['This program symbolically differentiates and ','integrates ',
    ...
    '<Developed by>' = ['Martin Szummer.'],
    '<Organization>' = ['Hj. Lundbohmsskolan, Kiruna (school).'],
    '<Country>' = ['Sweden.'],
    '<Prolog system>' = ['PDC Prolog v. 3.20 ','Turbo Prolog Toolbox v. 1 '],
    '<Other languages>' = ['None.'],'<Lines>' = ['3000'],
    '<Predicates>' = ['300'],'<Platform>' = ['DOS v. 3.3'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['May 1990'],
    '<Information Date>' = ['January 1993'],
    '<References>' =
        ['"Symbolisk derivering och integrering i Prolog - ',
            'ett specialarbete ','" Martin Szummer. ',
            '(Unpublished thesis, in Swedish.) ']].
['<Program>' = ['System 9'],'<Number>' = [166],
    '<Domain>' = ['Hospital information '],
    '<Purpose>' =
        [   'System 9: An Application Environment for Hospital Information Systems'],
    '<Description>' = ['Submitted to PAC. Paper 119 '],
    '<Developed by>' = ['Dr. Bart Van den Bosch'],'<Country>' = ['Belgium'],
    '<Prolog system>' = ['Prolog by BIM. '],
    '<Platform>' = ['"Macworkstation, Apple terminal Services"'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['SysView'],'<Number>' = [427],
    '<Domain>' = ['System Administration. '],
    '<Purpose>' = ['Distributed System Administration.'],
    '<Description>' =
        ['- SysView is a set of applications which allows ','centralized ',
            ...
            'Prolog application. '],
    '<Developed by>' = ['Ph. Donz\'s team.'],
    '<Organization>' = ['Bull S.A.'],'<Country>' = ['France.'],
    '<Prolog system>' =
        ['SP-Prolog Compiler (Bull S.A) ',
            '(SP-Prolog Compiler has been extended to incorporate ',
            'smalltalk-like object oriented mechanisms) '],
    '<Other languages>' = ['C'],'<Lines>' = ['30000 lines'],
    '<Predicates>' = ['3000'],'<Platform>' = ['DPX/2, AIX RS/6000'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['01/92'],'<Information Date>' = ['03/92']].
['<Program>' = ['Tangram'],'<Number>' = [176],
    '<Domain>' = ['Teaching programming '],
    '<Purpose>' = ['Teaching system for programming'],
    '<Description>' = ['in PrologIA Applications notes (French) '],
    '<Developed by>' = ['A. Lucci'],'<Country>' = ['France'],
    '<Prolog system>' = ['Prolog II, v.2.2 to 2.4 '],
    '<Platform>' = ['Macintosh Plus, SE or II'],
    '<References>' =
        ['A. Lucci. Le syst\216me Tangram; un environment de ',
...
['<Program>' = ['TAPPS'],'<Number>' = [442],
    '<Domain>' = ['Production management system. '],
    '<Purpose>' = ['Parts selection for another type of modular house.'],
    '<Description>' =
        ['For each customer\'s housing plan, ',
            '1) enter the plan using GUI operation, ',
            '2) solve the constraints between the parts, ',
    ...
    '<Organization>' = ['Sekisui Chemical Corporation.'],
    '<Country>' = ['Japan.'],'<Prolog system>' = ['K-Prolog '],
    '<Other languages>' = ['As of HAPPS.'],
    '<Lines>' = ['50,000 lines (including parts database).'],
    '<Predicates>' = ['1,500 methods.'],
    '<Platform>' = ['SONY NEWS; 4.2/4.3BSD (development / delivery).'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['February 21,1992.'],
    '<No. of Users>' = ['6 persons (at 2 sites, including 1 plants).'],
    '<Information Date>' = ['April 15, 1992.'],'<References>' = ['N/A. ']].
['<Program>' = ['TARIFICA DATABASE'],'<Number>' = "8",
    '<Domain>' = ['Telecommunications Research '],
    '<Purpose>' =
        [   'An Intelligent Costing system for International Leased-line circuits'],
    '<Description>' =
    ...
    '<Developed by>' = ['David Whitgift (of Logica plc) and David Wightman'],
    '<Organization>' = ['Intelidata Ltd'],'<Country>' = ['UK'],
    '<Prolog system>' = ['Prolog-2 for Windows 3 '],
    '<Other languages>' = ['NONE'],
    '<Platform>' =
        [   '80386 IBM-PC Compatible with 4Mb of RAM. Also Windows 3.0 and 3.1'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['2/91'],'<No. of Users>' = ['15'],
    '<Information Date>' = ['30/1/92']].
['<Program>' = ['TEMA'],'<Number>' = [357],
    '<Domain>' = ['Installation program. '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['Sigve B_'],'<Organization>' = ['SigveSaker'],
    '<Country>' = ['Norway.'],'<Prolog system>' = ['PDC Prolog 3.21 '],
    '<Other languages>' = ['None.'],'<Lines>' = ['220'],
    '<Predicates>' = ['8'],'<Platform>' = ['MS-DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['03/91'],'<Information Date>' = ['12/08/92']].
['<Program>' = ['Term Refiner/Browser'],'<Number>' = [13],
    '<Domain>' = ['Relational Databases '],
    '<Purpose>' = ['Generic Relational Database Frontend'],
    '<Description>' =
    ...
    '<Organization>' = ['University of Surrey'],'<Country>' = ['England'],
    '<Prolog system>' = ['Quintus Prolog '],
    '<Other languages>' = ['Quintus ProWindows;  Quintus ProDB'],
    '<Lines>' = ['4000'],'<Predicates>' = ['550'],
    '<Platform>' = ['Sun 4 / SunOS4'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1991'],
    '<No. of Users>' = ['n/a'],'<Information Date>' = ['Oct 1991'],
    '<References>' =
        ['Ahmad; Fulford; Griffin & Holmes-Higgin; 1990; "The ',
            'Translator\'s Workbench";In (Ed.) C.Picken; \'Translating and the Computer ',
            'II\'; pp. 394-403. ASLIB; London. ']].
['<Program>' = ['Termbase.'],'<Number>' = [400],
    '<Domain>' =
        ['Natural Language Processing, Computer Aided Translation. '],
    '<Purpose>' =
        [   'To provide a multilingual terminology management system for translators.'],
    '<Description>' =
        ['Termbase/DOS (and Termbase/Windows) is a ','networkable ',
    ...
    '<Developed by>' = ['Mr. V. Srinivasan.'],'<Organization>' = ['None.'],
    '<Country>' = ['Germany.'],
    '<Prolog system>' =
        ['Initially Turbo Prolog then PDC Prolog 2...finally PDC ',
            'Prolog 3.3 '],
    '<Other languages>' = ['A little LISP (approx. 3%)'],
    '<Lines>' = ['Approx. 2000'],
    '<Predicates>' = ['312 (DOS) add a percentage for Windows.'],
    '<Platform>' =
        ['IBM PC/AT or compatibles, DOS 2.11 or greater, Windows 3.0 & 3.1'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1.7.87'],'<Information Date>' = ['28.9.92'],
    '<References>' =
...
['<Program>' = ['TES (TErm rewriting System)'],'<Number>' = [368],
    '<Domain>' = ['Term rewriting, completion. '],
    '<Purpose>' =
        [   'Programming environment for term rewriting systems  (term rewriting laboratory).'],
    '<Description>' =
        ['TES is an experimental environment for computing ','with ',
            'term rewriting systems. It offers ','- term reduction ',
            '- critical pair computation ','- checking of local confluence ',
            '- proving termination of term rewriting systems ',
            '- checking of sort decreasingness of term rewriting systems  (order- ',
            'sorted version) ','- completion of term rewriting systems. '],
    '<Developed by>' =
        [   'Roland Dietrich (original version), Wolfgang Wagner (KA-Prolog version),                  Christoph Brzoska (reduction ordering extensions) and  Andreas Werner (order-sorted version).'],
    '<Organization>' =
        [   'University of Karlsruhe, partly supported by the Deutsche Forschungsgemeinschaft (SFB 314, project S2).'],
    '<Country>' = ['Germany.'],
    '<Prolog system>' =
        ['C-Prolog (original version of the program),  KA- ','Prolog, ',
            'LOPSTER  (LOgic Programming with SubTypes and Extended ',
            'Resolution, order-sorted version of the program). '],
    '<Lines>' =
        ['KA-Prolog version: circa 5500 LOPSTER version: circa 6500'],
    '<Predicates>' =
        ['KA-Prolog version: circa 360 LOPSTER version: circa 440'],
    '<Platform>' = ['UNIX, SUN workstations.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' =
        [   '1985 (original version), 1989 (KA-Prolog version), 1991 (order-sorted version).'],
    '<No. of Users>' = ['3'],'<Information Date>' = ['August 12th, 1992.'],
    '<References>' =
...
'<Number>' = [283],'<Domain>' = ['Biochemistry '],
'<Purpose>' = ['To test and model self reproducing biochemical processes'],
'<Description>' =
...
'<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
'<Information Date>' = ['1984']].
['<Program>' = ['Test Tool'],'<Number>' = [422],
    '<Domain>' = ['Natural language processing. '],
    '<Purpose>' = ['A tool for testing Prolog programs.'],
    '<Description>' =
    ...
    '<Developed by>' = ['NLP Department, IBM Nordic Laboratories.'],
    '<Organization>' = ['IBM.'],'<Country>' = ['Sweden.'],
    '<Prolog system>' = ['IBM Prolog '],'<Other languages>' = ['None.'],
    '<Lines>' = ['Around 2000 (comments not counted).'],
    '<Predicates>' = ['Not counted.'],
    '<Platform>' = ['VM/XA for IBM Mainframe.'],
    '<Type of Use>' = ['In-house'],'<When Deployed>' = ['February 1992'],
    '<No. of Users>' = ['10'],'<Information Date>' = ['March 1992']].
['<Program>' = ['TESTING COMPUTER ARCHITECTURES'],'<Number>' = [292],
    '<Domain>' = ['Computer architecture design '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['V. Kiss, G. Simor'],'<Organization>' = ['SzKI'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MPROLOG '],
    '<Information Date>' = ['1984'],
    '<References>' =
        ['V. Kiss, G. Simor(1978). ',
            ...
            'SzKI report, 1978. ']].
['<Program>' = ['TEX4'],'<Number>' = [348],
    '<Domain>' = ['CASE/Document Research. '],
    '<Purpose>' = ['Specification Research Tool.'],
    '<Description>' =
    ...
    '<Developed by>' = ['M Cavanagh, D. Campbell.'],
    '<Organization>' = ['NeoText SophtWear.'],'<Country>' = ['Canada.'],
    '<Prolog system>' = ['PDC Prolog. '],'<Other languages>' = ['C'],
    '<Lines>' = ['2500'],'<Predicates>' = ['750'],
    '<Platform>' = ['UNIX, MSDOS.'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['04/91'],
    '<Information Date>' = ['08/92']].
['<Program>' = ['The Configurer Graphics Service, CGS'],'<Number>' = [415],
    '<Domain>' = ['Automatic Diagram Generation. '],
    '<Purpose>' =
        [   'To produce professional quality diagrams of ICL hardware configurations for use by salesforce in proposals.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Steve Sharman, Dick Higgs.'],
    '<Organization>' = ['ICL Computers Limited.'],
    '<Country>' = ['United Kingdom.'],
    '<Prolog system>' = ['DECISIONPOWER PROLOG '],
    '<Other languages>' =
        ['awk, C shell, Maker Interchange Format (Framemaker)'],
    '<Lines>' = ['unknown, but not much below 8000.'],
    '<Predicates>' = ['unknown, in the hundreds.'],
    '<Platform>' = ['Sun 4, running SunOS 4.1.1'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['11/90'],'<No. of Users>' = ['14,000 !!'],
    '<Information Date>' = ['25/03/92'],'<References>' = ['none. ']].
['<Program>' = ['THE INSPECTION NETWORK'],'<Number>' = [339],
    '<Domain>' = ['Remote access expert system, pay-per-use network. '],
    '<Purpose>' = ['Inspection Analysis.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Kort E. Patterson.'],
    '<Organization>' = ['Overall Technology.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['PDC  Prolog 3.30 '],
    '<Other languages>' =
        ['C/10%, ASM/10%, Turbo Pascal/10% (aux programs).'],
    '<Lines>' = [unknown],
    '<Predicates>' =
        ['System composed of several programs with 1000+ preds each.'],
    '<Platform>' = ['MS-DOS/DR-DOS'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['11/87'],
    '<Information Date>' = ['08/03/92']].
['<Program>' = ['The Interpreter and Explainer, (TIE), version 3.5'],
    '<Number>' = [514],
    '<Domain>' =
        ['Language transliteration. Education. Bulletin Board ',
            'communication. '],
    '<Purpose>' =
        [   'TIE is both a transliterator and instantdictionary tool. It can be used to convert words from one language into another or used as a transcriber of terms, especially for research work.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Mr. Craig Walter .'],
    '<Organization>' =
        ['Software Writers Independent Marketing or SWIMware.'],
    '<Country>' = ['Australia.'],
    '<Prolog system>' = ['PDC Prolog (formerly Turbo Prolog version 2.0) '],
    '<Other languages>' = ['No other languages for this version.'],
    '<Lines>' = ['Including the "include" files, approximately 1,500.'],
    '<Predicates>' =
        [   '55 in main module, plus 40 or so in "include" files. Over 20 database declarations.'],
    '<Platform>' =
        [   'IBM and MSDOS compatibles, CGA< EGA, VGA. Hercules displays suitable. Not mouse dependt for this version.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = [''],
    '<When Deployed>' = ['22/5/92'],
    '<References>' =
        ['Australian PC World magazine, September issue n the ',
            'shareware section. ']].
['<Program>' = ['The Logic Programming Tutor.'],'<Number>' = [407],
    '<Domain>' = ['Prolog Teaching. '],
    '<Purpose>' = ['Front-end for teaching Prolog to novices.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Jocelyn Paine.'],
    '<Organization>' = ['Oxford University.'],'<Country>' = ['England.'],
    '<Prolog system>' = ['Poplog. '],'<Other languages>' = ['Pop-11.'],
    '<Lines>' = ['10000.'],'<Predicates>' = ['1000.'],
    '<Platform>' = ['VAX/VMS.'],'<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Released'],
    '<When Deployed>' = ['2/1985 - to date.'],
    '<No. of Users>' = ['1 (organisation).'],
    '<Information Date>' = ['3/1992.'],
    '<References>' =
        ['"The Logic Programming Tutor", Jocelyn Paine, Intellect ',
            'Books, 1992. ']].
['<Program>' = ['THE MANAGER\'S EDGE'],'<Number>' = [341],
    '<Domain>' = ['Leadership; Participatory Management; Group Dynamics. '],
    '<Purpose>' =
        [   'Portrays trade-off between efficiency and participation for autocratic and group leadership styles known to be effective in a situation.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Mighetto and Associates.'],
    '<Organization>' = ['Tribase.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['PDC Prolog 3.20 '],'<Other languages>' = ['None.'],
    '<Lines>' = ['5000 not including standard modules.'],
    '<Predicates>' = ['1622 total; 222 local;43 global;1347 public.'],
    '<Platform>' =
        ['IBM PC, DOS 3.0 and above, 512K, CGA, VGA, EGA, Hercules Mono.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['04/91 as prototype.'],
    '<Information Date>' = ['07/92'],
    '<References>' =
        ['National Science Foundation Proposed Project June 17 ',
            '1992, Title "Individual/Group Decision Analysis Software Acceptance". ']].
['<Program>' = ['THE MAX AUDIOMETRIC TESTING SYSTEM'],'<Number>' = [307],
    '<Domain>' = ['Medical diagnosis. '],
    '<Purpose>' =
        [   'Expert System for Audiometric screening testing for industrial, medical and school markets.'],
    '<Description>' =
    ...
    '<Developed by>' = ['David Lypka, Errol Davis.'],
    '<Organization>' = ['Sound Linked Data Inc. and Future Logic Inc.'],
    '<Country>' = ['Canada'],'<Prolog system>' = ['95% ARITY PROLOG (DOS) '],
    '<Other languages>' =
        [   '1% Assembler (8086), ARITY SQL 1% MSC 5.1 1% GSS Graphics Library 1% AIM  Machine Learning (by ABTECH)'],
    '<Lines>' = ['100,000+'],'<Predicates>' = ['1000+'],
    '<Platform>' =
        [   'MS DOS, 286/386, companion Audiometer 4 megs RAM, 30 meg disk, VGA'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['07/89'],'<No. of Users>' = ['100'],
    '<Information Date>' = ['13/08/92'],
    '<References>' =
        ['Intelligent Systems Review (I think), 1991 (Don\'t ',
            'remember exact name or date). ']].
['<Program>' = ['The T-Prolog Interpreter'],'<Number>' = [276],
    '<Domain>' = ['Programming languages '],
    '<Purpose>' = ['An interpreter for the language T-Prolog'],
    '<Description>' =
...
['<Program>' = ['Theorist-S'],'<Number>' = [251],'<Domain>' = ['Theory '],
    ...
    '<Developed by>' = ['Randy Goebel, David Poole, Koichu Furukawa'],
    '<Organization>' = ['University of Waterloo, ICOT'],
    '<Country>' = ['Canada, Japan'],'<Prolog system>' = ['Waterloo ? '],
    '<Platform>' = ['IBM VM/CMS ?'],'<Type of Use>' = ['In-house'],
    '<Current Status>' =
        [   'Prototype \307IF*** The text replacing this argument is too long ***\310<References>\tRandy Goebel, David Poole, Koichu Furukawa: Using definite clauses and integrity constraints as the basis for a stheory formation approach to diagnostic reasoning. ICLP3, 1986. pp211-222. D.L.Poole, R.G. Goebel, R. Aleliunas: Theorist: a logical reasoning system for defaults and diagnosis. in N.J.Cercone, G. McCalla (eds) Knowledge Representation. Springer-Verlag, 1986.']].
['<Program>' = ['THREAD'],'<Number>' = [495],
    '<Domain>' =
        [' ',
            ...
            'documents. '],
    '<Purpose>' = ['Intelligent document tracking database.'],
    '<Description>' =
        ['The program was written specifically for Safety ','Case ',
    ...
    '<Country>' = ['England.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['None.'],'<Lines>' = ['1000'],
    '<Predicates>' = ['100'],'<Platform>' = ['MS-DOS on IBM PC.'],
    '<Type of Use>' = ['Personal'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['Not released.']].
['<Program>' = ['Timetable Scheduler.'],'<Number>' = [493],
    '<Domain>' = ['Planning, Scheduling. '],
    '<Purpose>' = ['Producing timetables for a Polytechnic.'],
    '<Description>' =
        ['A Prolog-based assignment algorithm was written to ',
            ...
            'assignments besides ','certain other administrative duties. ',
    ...
    '<Developed by>' = ['Ngee Ann Polytechnic.'],
    '<Organization>' = ['Ngee Ann Polytechnic.'],
    '<Country>' = ['Singapore.'],'<Prolog system>' = ['Poplog Prolog. '],
    '<Other languages>' = ['Nil.'],'<Lines>' = ['1500'],
    '<Predicates>' = ['88'],'<Platform>' = ['Sun SPARCStation.'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['May 1992.'],'<No. of Users>' = ['1'],
    '<Information Date>' =
        [   'Dec 1992 \307IF*** The text replacing this argument is too long ***\310<References>\t Integrating Genetic Algorithms with a Prolog Assignment Program as a Hybrid Solution for a Polytechnic Timetable Problem - Ling Si Eng 1991. Logic Programming for solving the timetable problem, Journal of Ngee Ann Polytechnic, Ling Si Eng, Oct. 1992.']].
['<Program>' =
    [   'TMDS Comm (Tandem Maintenance and Diagnostic System, Communications).'],
'<Number>' = [358],
'<Domain>' =
    ['Computers System Maintenance and Diagnostics for communications ',
        'controllers. '],
'<Purpose>' = ['Diagnosis of communications-related equipment problems.'],
'<Description>' =
...
'<Developed by>' =
    [   'Prolog:  Rahdall McRee/Heather McKelvey TAL  (Tandem Application Language):  Ian Earnest/ Paul Komosinski.'],
'<Organization>' = ['Tandem Computers Inc.'],'<Country>' = ['U.S.A.'],
'<Prolog system>' = ['TL, Test Language interpreter, by Randall McRee. '],
'<Other languages>' = ['TAL (60%)    (TAL is comparable to "C").'],
'<Lines>' = ['7250  (including comments), ~2000 just prolog.'],
'<Predicates>' = ['568  (including builtins).'],
'<Platform>' = ['Tandem Computers Guardian 90 systems.'],
'<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
'<When Deployed>' = ['10/91'],'<No. of Users>' = ['50'],
'<Information Date>' = ['03/92'],
'<References>' = ['TMDS Reference Manual, Tandem part number 061249. ']].
['<Program>' = ['TML Genealogy System'],'<Number>' = [374],
    '<Domain>' = ['Genealogy. '],
    ...
    '<Prolog system>' = ['3.3 PDC Prolog WINDOWS. '],
    '<Other languages>' = ['Borland C++'],
    '<Lines>' = ['3,935 lines prolog source and 1.084 lines of C++ source'],
    '<Predicates>' = ['409 (12 linked to C++)'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' =
        ['First version 1978, First prolog based version = June 1988.'],
    '<No. of Users>' = ['5'],'<Information Date>' = ['17 Aug 1992.'],
    '<References>' = ['none. ']].
['<Program>' = ['TOERNOOI ASSISTENT'],'<Number>' = [349],
    '<Domain>' =
        ['Sports (tennis).  Administration, ranking. planning and ',
            'scheduling.  Tournament optimalisation. '],
    '<Purpose>' =
        [   'To automate everything around tennis tournaments.  Optimal planning and scheduling of matches.  Easy and fast replanning in case of rain (!).'],
    '<Description>' =
    ...
    '<Developed by>' = ['J.G. de Lint, private.'],
    '<Organization>' =
        ['RAET automatisering as the distribuution and support channel.'],
    '<Country>' = ['Netherlands.'],'<Prolog system>' = ['PDC Prolog 3.3. '],
    '<Other languages>' =
        ['Some Turbo C (<5%).  Use of PDC Prolog Toolbox.'],
    '<Lines>' = ['15000'],'<Predicates>' = ['730'],
    '<Platform>' =
        [   'PC with 640k and hard disk, PCDOS-MSDOS-0S/2.  Developed under OS/2 and ported (cross-compiled) to DOS.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['03/91'],'<Information Date>' = ['09/07/91'],
    '<References>' =
        ['Some press releases.  Program has \'official\' status with ',
            'Royal Dutch Tennis Union (KNLTB). ']].
['<Program>' = ['TopNet'],'<Number>' = [223],
    '<Domain>' = ['Network design '],
    '<Purpose>' = ['an environment to support network design tasks'],
    '<Description>' =
    ...
    '<Organization>' = ['BIM'],'<Country>' = ['Belgium'],
    '<Prolog system>' = ['Prolog by BIM '],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released']].
['<Program>' = ['Total Network Management - Event Correlation Package.'],
    '<Number>' = [472],
    '<Domain>' =
        ['Telecommunications - network monitoring and ','troubleshooting. '],
    '<Purpose>' =
        [   'User defined correlation of anomolous  events in telecommunication networks.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Yossi Nygate, Warren Britt.'],
    '<Organization>' = ['AT&T.'],'<Country>' = ['U.S.A'],
    '<Prolog system>' = ['American Interface Computer Inc. '],
    '<Other languages>' = ['C++ and C.'],
    '<Lines>' = ['2500 of Prolog code.'],'<Predicates>' = ['300.'],
    '<Platform>' = ['Tandem (an FT platform running  UNIX V.3).'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = [''],
    '<When Deployed>' = ['1/18/93.'],
    '<No. of Users>' =
        [   'Initially deployed at 5 sites in NYNEX and New England Telephone Regional Bell Operating Companies. It will then be included in all future releases of TNM - at least an additional 20 sites - in the U.S. and Europe.'],
    '<Information Date>' = ['Current.']].
['<Program>' =
    ['Towa Mold Press Diagnostic & Maintenance Expert System (TMES)'],
'<Number>' = [466],
'<Domain>' = ['electronic, mechanical, pneumatic & hydraulic diagnostics. '],
'<Purpose>' =
    [   'To diagnose failures and prescribe repairs for a 60-ton mold press used in molding plastic semiconductor packages.'],
'<Description>' =
...
'<Developed by>' =
    ['M. Alan Newman (Lester Ticey & Jim Hodges, domain experts)'],
'<Organization>' = ['Motorola.'],'<Country>' = ['U.S.A.'],
'<Prolog system>' = ['Arity V.5 compiler. '],
'<Other languages>' = ['Interfaced to existing network interface in C.'],
'<Lines>' = ['2800 (plus about 400 domain rules).'],
'<Predicates>' = ['350.'],
'<Platform>' =
    ['Desqview 2.0/DOS 3.1, developed on a 386, delivered on a 286.'],
'<Type of Use>' = ['In-house'],'<Current Status>' = ['No longer supported'],
'<When Deployed>' = ['March, 1990.'],'<No. of Users>' = ['60'],
'<Information Date>' = ['November 3, 1992.'],
'<References>' =
    ['"Custom Shells and Automated Factories",  M. Alan ',
        'Newman, AI Expert, Sept. 1990. ']].
['<Program>' = ['TransLexis dictionary conversion programs'],
    '<Number>' = "$",'<Domain>' = ['Natural Language Processing '],
    '<Purpose>' =
        [   'Conversion of dictionary entries from and into the TransLexis lexical database'],
    '<Description>' =
    ...
    '<Developed by>' = ['R. Wirth'],'<Organization>' = ['IKBS'],
    '<Country>' = ['Germany'],'<Prolog system>' = ['VM/Prolog '],
    '<Other languages>' = ['REXX'],'<Lines>' = ['6000'],
    '<Predicates>' = ['1000'],'<Platform>' = ['VM'],
    '<Type of Use>' = ['In-house'],
    '<Current Status>' = ['No longer supported'],
    '<When Deployed>' = ['12/84'],'<Information Date>' = ['1/92']].
['<Program>' = ['TSM - Twin Structure Model of controlled objects .'],
    '<Number>' = [486],
    '<Domain>' = ['Analysis and Synthesis of Controlled Objects. '],
    '<Purpose>' =
        [   'Dynamic simulation of controlled process units or technological systems by  the optionally in parallel  executable   coupled structural models of conservation and information processes.'],
    '<Description>' =
        ['The Twin Structure Model (TSM) is a coupled pair of ',
            ...
            'question. '],
    '<Developed by>' = ['Bela Csukas, Karoly Varga, Laszlo Jambor .'],
    '<Organization>' =
        [   'University  of  Veszprem,  supported  by  the  Hungarian Basic Research Grant N OTKA-2550.'],
    '<Country>' = ['Hungary.'],
    '<Prolog system>' =
    ...
    '<Other languages>' =
        ['Can also be implemented in object oriented languages.'],
    '<Lines>' = ['3500'],'<Predicates>' = ['400'],
    '<Platform>' =
        ['PC/AT 386; transputer and work station versions in preparation .'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['1/1992'],'<No. of Users>' = ['5'],
    '<Information Date>' = ['12/1993'],'<References>' = ['In preparation. ']].
['<Program>' = ['TWAICE'],'<Number>' = [4],
    '<Domain>' = ['knowledgebased system '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['AI Centre;  AP333'],
    '<Organization>' = ['Siemens Nixdorf Informationssysteme AG'],
    '<Country>' = ['Germany'],
    '<Prolog system>' =
        ['Prolog from Siemens Nixdorf and ',
            'IF/Prolog from InterFace Computer GmbH '],
    '<Other languages>' = ['C; 15 %'],
    '<Lines>' = ['70000 (without comments); 93000 (with comments) (Prolog)'],
    '<Predicates>' = ['4.750 (14000 clauses)'],
    '<Platform>' =
        ['SINIX Systems; UNIX Systems; MS/DOS System (with DOS extender)'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1985'],'<No. of Users>' = ['200'],
    '<Information Date>' = ['October 1991']].
['<Program>' = ['UBL'],'<Number>' = [260],'<Domain>' = [' '],
    '<Purpose>' = ['A problem solver with learning capabilities'],
    '<Description>' =
    ...
    '<Organization>' = ['IBM France?'],'<Prolog system>' = ['IBM Prolog ']].
['<Program>' = ['UNZ & Co. Export Software'],'<Number>' = [399],
    '<Domain>' = [' '],
    '<Purpose>' =
        [   'Process the required documents for completing U.S. and Canada export forms.'],
    '<Description>' =
    ...
    '<Developed by>' = ['North Winds and UNZ & Co.'],
    '<Organization>' = ['North Winds.'],'<Country>' = ['USA.'],
    '<Prolog system>' = ['PDC Prolog. '],'<Other languages>' = ['None.'],
    '<Lines>' = ['10000'],'<Predicates>' = ['400'],
    '<Platform>' =
        [   'MSDOS 2.0 512K memory, most dot matrix, daisywheel & laser printers, hard or floppy drive systems.'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['Summer 1989.'],
    '<Information Date>' = ['September 14, 1992.'],
    '<References>' = ['Product Literature. ']].
['<Program>' = ['US Export Control Expert System'],'<Number>' = [180],
    '<Domain>' = ['Shipping regulations '],
    '<Purpose>' = ['To determine US license requirements for shipments'],
    '<Description>' =
    ...
    '<Other languages>' = ['Dbase III+'],'<Type of Use>' = ['In-house'],
    '<Current Status>' = ['Released']].
['<Program>' = ['Ushell'],'<Number>' = ".",
    '<Domain>' = ['Programming environments '],
    '<Purpose>' =
        [   'To provide an environment for an introductory logic programming course for developing simple logic programs'],
    '<Description>' =
    ...
    '<Developed by>' = ['L. Umit Yalcinalp'],
    '<Organization>' = ['Case Western Reserve University'],
    '<Country>' = ['USA'],
    '<Prolog system>' = ['XPRO; Sicstus Prolog; Quintus Prolog '],
    '<Lines>' = ['550'],'<Predicates>' = ['60'],
    '<Platform>' = ['Atari; Sun/Unix'],'<Current Status>' = ['Prototype'],
    '<When Deployed>' = ['1988'],'<No. of Users>' = ['130'],
    '<Information Date>' = ['1992'],
    '<References>' =
...
['<Program>' = ['UTI'],'<Number>' = [238],
    ...
    '<Description>' =
        ['UTI advises on antibiotic treatments of urinary ',
            ...
            'Clinical validation has been performed in in P\216terfy S\207ndor Hospital and ',
            'beta testing in Korvin Ott\227 Hospital and Szent-Gy\232rgyi Albert Medical ',
            'University . '],
    '<Organization>' =
        [   'IQSOFT and Medical division of P\216tefy S\207ndor Hospital, Semmelweis Medical University'],
    '<Country>' = ['Hungary'],
    '<Prolog system>' = ['MProlog 2.3 and MProlog Dialog '],
    '<Lines>' = ['1250 clauses in 25 modules'],'<Predicates>' = ['450'],
    '<Platform>' = ['PC 286 and 386 with MS-DOS'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<References>' =
...
['<Program>' = ['VALERE'],'<Number>' = [350],
    '<Domain>' = ['Environment, Chemical analysis. '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['Guideo Cosemans.'],
    '<Organization>' =
        ['V.I.T.O.  (The Flemish Insitute for Technology and Research)'],
    '<Country>' = ['Belgium.'],
    '<Prolog system>' = ['PDC Prolog version 2. '],
    '<Other languages>' = ['Assembler (100 lines).'],'<Lines>' = ['5000'],
    '<Predicates>' = ['370'],
    '<Platform>' =
        [   'Development:  386-PC + co-processor, MS-DOS 5, PDC Prolog delivery:  PC-XT with co-processor, 640 KB RAM and hard disk.'],
    '<Type of Use>' = ['In-house'],'<When Deployed>' = ['04/90'],
    '<Information Date>' = ['09/07/92']].
['<Program>' = ['Vascular Surgery decision support'],'<Number>' = [259],
    '<Domain>' = ['Medical decision support '],
    '<Purpose>' = ['providing advice for clinical management decisions'],
    '<Description>' =
    ...
    '<Developed by>' = ['Paul Soper, Geetha Abeysinghe, Charles Ranaboldo'],
    '<Organization>' =
    ...
    '<References>' =
        ['Paul Soper, Geetha Abeysinghe, Charles Ranaboldo: ',
            ...
            'sessions, Int. Conference on Practical Application of Prolog, London 1992. ']].
['<Program>' = ['Vegetation Management Tools'],'<Number>' = [5],
    '<Domain>' = ['Forest management '],
    '<Purpose>' =
        [   'To provide a framework within which forest managers can select the best herbicide treatment for a particular set of weeds and crop situation.'],
    '<Description>' =
    ...
    '<Organization>' = ['Forest plantation establishment'],
    '<Country>' = ['New Zealand'],'<Prolog system>' = ['PDC Prolog 3.2 '],
    '<Other languages>' = ['None'],'<Lines>' = ['7000 approx'],
    '<Predicates>' = ['300 approx'],'<Platform>' = ['MS-DOS'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['10/90'],'<No. of Users>' = ['20'],
    '<Information Date>' = ['24 October 1991'],
    '<References>' =
        ['Mason; E.G.; D.J. Geddes; B. Richardson; & N.A. ','Davenhill; ',
            '1991; Application of Knowledge-based programming techniques to ',
            'cost-effective selection of herbicides in forestry ']].
['<Program>' = ['VEX/ATL'],'<Number>' = "C",
    '<Domain>' = ['Planning in distributed networks '],
    '<Purpose>' =
    ...
    '<Developed by>' = ['Mark Plotnick, Infologics AB'],
    '<Organization>' = ['FMV Sweden, (Swedish Defense Materials Authority)'],
    '<Country>' = ['Sweden'],
    '<Prolog system>' =
        ['Prolog-2 (8086 version) from Expert Systems Int\'l '],
    '<Other languages>' =
        [   'C used minimally for external device access (plotter) & access to Operating System functions ( 200 lines)'],
    '<Lines>' = ['9000'],'<Predicates>' = ['1483'],
    '<Platform>' = ['MS-DOS (Both development and delivery)'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['January 1991'],'<No. of Users>' = ['3'],
    '<Information Date>' = ['November 1991'],
    '<References>' =
        ['Expert Systems Support in Telecommunication, Proceedings ',
            ...
            'ISBN: 0 444 70503 1 ']].
['<Program>' = ['View Creation System'],'<Number>' = [209],
    '<Domain>' = ['Database design '],
    '<Purpose>' = ['Design of datbases used by large complex organizations'],
    '<Description>' =
        ['The user interacts with the expert system by entering ',
            ...
            'assembly and use. '],
    '<Developed by>' = ['Dr. Glen Cooper, Dr. Goldstein'],
    '<Country>' = ['Canada'],'<Prolog system>' = ['Arity Prolog '],
    '<Platform>' = ['IBM PC']].
['<Program>' = ['VLSI Test pattern generator'],'<Number>' = [247],
    '<Domain>' = ['Electronic design '],
    '<Purpose>' =
        [   'A hierarchical approach to fault injection as a means of diagnosing VLSI circuits'],
    '<Description>' =
...
['<Program>' = ['VOR (VHF omniderectional Range) Simulator'],
    '<Number>' = [351],'<Domain>' = ['Real Time simulation. '],
    '<Purpose>' =
    ...
    '<Organization>' = ['Canadian Marconi Corporation.'],
    '<Country>' = ['Canada.'],'<Prolog system>' = ['PDC Prolog. '],
    '<Other languages>' = ['C, Assembler.'],'<Lines>' = ['3000'],
    '<Predicates>' = ['700'],'<Platform>' = ['DesqView 386'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['04/90'],
    '<Information Date>' = ['08/92']].
['<Program>' = ['VORAN/ABS'],'<Number>' = [241],
    '<Domain>' = ['Banking advice '],
    '<Purpose>' = ['advisory system for small investors in bank'],
    '<Description>' = [' '],
    '<Organization>' = ['Zentralsparkasse und Kommerzialbank, IQSOFT'],
    '<Country>' = ['Hungary'],'<Prolog system>' = ['MProlog '],
    '<Platform>' = ['IBM MVS/TSo'],'<Current Status>' = ['Prototype'],
    '<References>' =
        ['Imre Kili\207n: An approach to integrate the spreadsheet ',
            'paradigm and logic programming. Proc 2nd Conf. on AI, Budapest, Jan 1991. ']].
['<Program>' = ['VSTA'],'<Number>' = [167],'<Domain>' = ['Digital design '],
    '<Purpose>' = ['Using Prolog as a Tool for Systolic Array Designs'],
    '<Description>' = ['Submitted to PAC. Paper 419 '],
    '<Developed by>' = ['Fuyau Lin, Shih, Ling & Davis'],
    '<Country>' = ['USA'],'<Prolog system>' = ['SICSTUS '],
    '<Platform>' = ['Sun 4'],'<Information Date>' = ['6/11/91']].
['<Program>' = ['WADNES'],'<Number>' = [10],
    '<Domain>' = ['Water Distribution '],
    '<Purpose>' = ['Assist Engineers in Water Distribution Emergencies'],
    '<Description>' =
    ...
    '<Developed by>' = ['Paul Holmes-Higgin; Andrew Langdon'],
    '<Organization>' = ['University of Surrey'],'<Country>' = ['England'],
    '<Prolog system>' = ['Quintus Prolog; Quintec Prolog '],
    '<Other languages>' = ['Quintus ProWindows; Fortran'],
    '<Lines>' = ['30000'],'<Predicates>' = ['1200'],
    '<Platform>' = ['Sun 4 / SunOS4'],'<Type of Use>' = ['Licensed'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['1987'],
    '<No. of Users>' = ['n/a'],'<Information Date>' = ['Oct 1991'],
    '<References>' =
        ['Ahmad; Holmes-Higgin; Hornsby & Langdon; 1988; "Expert ',
            'Systems for Planning andControlling Complex Physical Networks"; Knowledge ',
            'Based Systems Journal 1 (3)pp 153-165. ']].
['<Program>' = ['WALLS'],'<Number>' = [168],
    '<Domain>' = ['Engineering design '],
    '<Purpose>' =
        ['A program to aid in the building of poured concrete structures'],
    '<Description>' = ['Submitted to PAC. Paper 196 '],
    '<Developed by>' = ['Sharon Sickel Beach & Brian Beach'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Turbo '],
    '<Platform>' = ['PC 286'],'<Information Date>' = ['17/10/91']].
['<Program>' = ['Weeds In Sugar Cane'],'<Number>' = [169],
    '<Domain>' = ['Agriculture '],
    '<Purpose>' =
        [   'An Example of Maintainable Program Design in Prolog : Weeds In Sugar Cane'],
    '<Description>' = ['Submitted to PAC. Paper 198 '],
    '<Developed by>' = ['Coulston, Smith and Tilley'],
    '<Country>' = ['Australia'],'<Prolog system>' = ['LPA Prolog. '],
    '<Platform>' = ['Any IBM compatible computer with graphics card.'],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['WFProlog (well-founded Prolog).'],'<Number>' = [506],
    '<Domain>' =
        ['Default reasoning systems needing an underlying inference ',
            'system (Prolog style interpreter) based on well-founded semantics. '],
    '<Purpose>' =
        [   'A Prolog meta-interpreter that computes well-founded semantics for normal logic programs using negation as failure.'],
    '<Description>' =
    ...
    '<Developed by>' = ['John R. Fisher.'],
    '<Organization>' = ['California State Polytechnic University.'],
    '<Country>' = ['USA'],'<Prolog system>' = ['Quintus Prolog. '],
    '<Other languages>' = ['None (at present).'],'<Lines>' = ['75'],
    '<Predicates>' = ['14'],
    '<Platform>' = ['Easily modifiable for any Prolog.'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['February 1992.'],'<No. of Users>' = ['6'],
    '<Information Date>' = ['9 February 1993.'],
    '<References>' =
        ['Fisher, J.R., Tree semantics for logic programs ','with ',
...
['<Program>' = ['WHALE'],'<Number>' = [320],'<Domain>' = ['Logistic. '],
    '<Purpose>' = ['Analyse warehouse placement.'],
    '<Description>' =
    ...
    '<Organization>' = ['CPL Software and Services.'],
    '<Country>' = ['France.'],'<Prolog system>' = ['CHIP '],
    '<Other languages>' = ['C  X11'],'<Lines>' = ['1100'],
    '<Platform>' =
        ['SUN/HP/IBM/DIGITAL workstations PC  386/486        UNIX   DOS'],
    '<Type of Use>' = ['In-house'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['02/92'],'<No. of Users>' = ['2'],
    '<Information Date>' = ['03/92'],
    '<References>' =
        ['M. Dincbas, P. Van Hentenryck, H. Simonis, A. ',
            'Aggoun, T. Graf, F. Berthier, The Constraint Logic Programming ',
            ...
            'In Proc. of The Int. Conf. on Fifth Generation Computer Systems, p693-702. ',
            'Tokyo, Japan, November 1988. ']].
['<Program>' = ['WIESSE'],'<Number>' = [9],
    '<Domain>' = ['Water Engineering Expert Systems '],
    '<Purpose>' = ['Development of Expert Systems for the Water Industry'],
    '<Description>' =
    ...
    '<Developed by>' = ['Paul Holmes-Higgin; Charles Hornsby'],
    '<Organization>' = ['University of Surrey'],'<Country>' = ['England'],
    '<Prolog system>' = ['Quintus Prolog; Quintec Prolog '],
    '<Other languages>' = ['Quintus ProWindows'],'<Lines>' = ['7542'],
    '<Predicates>' = ['1170'],'<Platform>' = ['Sun 4 / SunOS4'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['1987'],'<No. of Users>' = ['n/a'],
    '<Information Date>' = ['Oct 1991'],
    '<References>' =
        ['Hornsby; Holmes-Higgin & Ahmad; 1987; "The Water ',
            ...
            'Press. ',' ']].
['<Program>' = ['WSUFP'],'<Number>' = [364],
    '<Domain>' =
        ['Language development, parallelism, and functional programming. '],
    '<Purpose>' = ['To develop an FP interpreter in Prolog.'],
    '<Description>' =
        ['An FP(Language developed by Backus, FP stands for ',
            ...
            'lnaguages. '],
    '<Developed by>' = ['Chris Fickert.'],
    '<Organization>' = ['WRight State University.'],'<Country>' = ['U.S.A.'],
    '<Prolog system>' = ['Quintos '],'<Lines>' = ['700'],
    '<Predicates>' = ['55'],'<Platform>' = ['Ultrix(unix-based).'],
    '<When Deployed>' = ['Fall 1988'],'<No. of Users>' = [unknown],
    '<Information Date>' = ['July 1992'],
    '<References>' = ['Sigplan Notices November 1992. ']].
['<Program>' = ['XLSIOR'],'<Number>' = [170],'<Domain>' = ['Insurance '],
    '<Purpose>' =
        ['An Intelligent System for Reinsurance Recoveries Calculation'],
    '<Description>' = ['Submitted to PAC. Paper 207 '],
    '<Developed by>' = ['Martin Wood, Corlett, & Hopson'],
    '<Country>' = ['UK'],'<Prolog system>' = ['SD-Prolog '],
    '<Information Date>' = ['6/11/91']].
['<Program>' = ['XPL (eXplanation for ProLog)'],'<Number>' = "-",
    '<Domain>' = ['Expert System Shells '],
    '<Purpose>' =
    ...
    '<Organization>' = ['Case Western Reserve University'],
    '<Country>' = ['USA'],
    '<Prolog system>' = ['Sictus Prolog; Quintus Prolog '],
    '<Other languages>' = ['C'],'<Lines>' = ['2000'],
    '<Predicates>' = ['240'],'<Platform>' = ['Sun/UNIX'],
    '<Type of Use>' = ['Free/Public Domain'],
    '<Current Status>' = ['Prototype'],'<When Deployed>' = ['Feb 88'],
    '<No. of Users>' = ['2;3'],
    '<Information Date>' =
        [   'Feb 92 \307IF*** The text replacing this argument is too long ***\310<References>\tL. Sterling and L. U. Yalcinalp; Explaining Prolog- Based Expert Systems Using a Layered Meta-Interpreter; in Proceedings of 11th International Joint Conference in Artificial Intelligence; Morgan--Kaufmann; pp 66-71;1989 L. U. Yalcinalp and L. Sterling; An Integrated Interpreter for Explaining Prolog\'s Successes and Failures; in Meta Programming in Logic Programming; eds. Abramson and Rogers; pp. 191-203; 1989.']].
['<Program>' = ['XTEL'],'<Number>' = [313],
    '<Domain>' = ['Techn. configuration. '],
    '<Purpose>' = ['Configuration of Telephone Systems.'],
    '<Description>' =
    ...
    '<Developed by>' = ['Mr. Thuy, Mr. Schnupp.'],
    '<Organization>' = ['Interface Computer GmbH.'],
    '<Country>' = ['Germany.'],'<Prolog system>' = ['IF/PROLOG '],
    '<Other languages>' = ['Siemens Collage.'],
    '<Platform>' = ['Siemans MX300'],'<Type of Use>' = ['Sold Product'],
    '<Current Status>' = ['Released'],'<When Deployed>' = ['10/89'],
    '<No. of Users>' = ['150'],'<Information Date>' = ['14/02/92'],
    '<References>' =
        ['Der Postexperte ','KI, 1-89 ','Oldenbourg Verlag, Munich. ']].
['<Program>' = ['XTRACT'],'<Number>' = [451],
    '<Domain>' = ['Text analysis for information extraction. '],
    '<Purpose>' =
        [   'Extract and analyse costing information from capture files generated from communication dialogues with on-line databases.'],
    '<Description>' =
        ['The application consists of two parts: ',
            ...
            'Total cost at HR; MIN is COST dollars ','Will match: ',
            'Total cost at 3:15 is 20.32 dollars ',
            'With variables bound as follows: ','HR=3. MIN=15, COST=20.32 ',
            ...
            'then be asserted into a database. ',' ','Database reports: ',
            '----------------- ',
    ...
    '<Developed by>' = ['John Jones, Jim Smith, Jill Cousins.'],
    '<Organization>' = ['Trade Ware Systems, First Contact.'],
    ...
    '<Predicates>' =
        ['180 Does not include the large amount of toolbox code used.'],
    '<Platform>' = ['IBM PC compatible, DOS version 3.3 or later.'],
    '<Type of Use>' = ['Licensed'],'<Current Status>' = ['Evaluation'],
    '<When Deployed>' = ['October 1992']].
['<Program>' = ['XWIN'],'<Number>' = [316],
    '<Domain>' = ['Graphical interface. '],
    '<Purpose>' = ['UIMS tool for building graphical user interfaces.'],
    '<Description>' =
    ...
    '<Organization>' = ['CLP Software and Services.'],
    '<Country>' = ['France.'],'<Prolog system>' = ['CHIP '],
    '<Other languages>' = ['C  X11'],'<Lines>' = ['1500'],
    '<Platform>' =
        [   'SUN/HP/IBM/DIGITAL workstations. PC  386/486          UNIX      DOS'],
    '<Type of Use>' = ['Sold Product'],'<Current Status>' = ['Released'],
    '<When Deployed>' = ['01/92'],'<No. of Users>' = ['25'],
    '<Information Date>' = ['03/92'],
    '<References>' =
        ['M. Dincbas, P. Van Hentenryck, H. Simonis, A. ',
            'Aggoun, T. Graf, F. Berthier, The Constraint Logic Programming ',
            ...
            'In Proc. of The Int. Conf. on Fifth Generation Computer Systems, p693-702. ',
            'Tokyo, Japan, November 1988. ']].
['<Program>' = ['Ytoolkit'],'<Number>' = [255],'<Domain>' = ['Graphics '],
    '<Purpose>' = ['portable graphics package forProlog applications'],
    '<Description>' =
    ...
    '<Developed by>' = ['Jos\216 Paulo Leal, Luis Damas'],
    '<Organization>' = ['Universidade de Porto, Centro da Inform\207tica'],
    '<Country>' = ['Portugal'],'<Prolog system>' = ['Many '],
    '<References>' =
        ['Jos\216 Paulo Leal, Luis Damas: Ytoolkit: a portable ',
            'graphics package forProlog applications. Abstracts of poster sessions, Int. ',
            'Conference on Practical Application of Prolog, London 1992. ']].
['<Program>' = ['ZEXPERT'],'<Number>' = [171],'<Domain>' = ['Finance '],
    '<Purpose>' = ['a Prolog-based expert system shell'],
    '<Description>' = ['Submitted to PAC. Paper 332 '],
    '<Developed by>' = ['Zsuzsa Farkas et al'],'<Country>' = ['Austria'],
    '<Prolog system>' = ['MProlog '],'<Information Date>' = ['6/11/91']].
