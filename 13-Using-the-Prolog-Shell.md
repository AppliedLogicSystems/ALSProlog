...
created for consulted files to be created in the same directory as the source file 
from which they were generated.
````
````
-giac The option -giac ("Generated In Architecture sub-directory of Current directory") 
causes the *.obp files which are created for consulted
...
````
````
-gias The option -gias ("Generated In Architecture sub-directory of Sources directory") 
causes the *.obp files which are created for consulted
