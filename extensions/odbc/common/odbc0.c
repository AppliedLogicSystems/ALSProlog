...
static int odbc_dispatch0(void)
{
	...
	{
		case 0:
			retval = (unsigned long) SQLGetDescRec(((SQLHDESC  ) arg2),((SQLSMALLINT  ) arg3),((SQLCHAR * ) arg4),((SQLSMALLINT  ) arg5),((SQLSMALLINT * ) arg6),((SQLSMALLINT * ) arg7),((SQLSMALLINT * ) arg8),((SQLINTEGER * ) arg9),((SQLSMALLINT * ) arg10),((SQLSMALLINT * ) arg11),((SQLSMALLINT * ) arg12));
			break;
		default:
			PI_FAIL;
	}
	PI_makedouble(&rval,&rtype,(double) retval);
	if (PI_unify(arg13,type13,rval,rtype))
		PI_SUCCEED;
	PI_FAIL;
}
...
static int odbc_dispatch4(void)
{
	...
	{
		case 0:
			retval = (unsigned long) SQLGetCursorName(((SQLHSTMT  ) arg2),((SQLCHAR * ) arg3),((SQLSMALLINT  ) arg4),((SQLSMALLINT * ) arg5));
			break;
		default:
			PI_FAIL;
	}
...
static int odbc_dispatch6(void)
{
	...
	{
		case 0:
			retval = (unsigned long) SQLDriverConnect(((SQLHDBC  ) arg2),((SQLHWND  ) arg3),((SQLCHAR * ) arg4),((SQLSMALLINT  ) arg5),((SQLCHAR * ) arg6),((SQLSMALLINT  ) arg7),((SQLSMALLINT * ) arg8),((SQLUSMALLINT  ) arg9));
			break;
		default:
			PI_FAIL;
	}
...
static int odbc_dispatch8(void)
{
	...
	{
		case 0:
			retval = (unsigned long) SQLGetDiagRec(((SQLSMALLINT  ) arg2),((SQLHANDLE  ) arg3),((SQLSMALLINT  ) arg4),((SQLCHAR * ) arg5),((SQLINTEGER * ) arg6),((SQLCHAR * ) arg7),((SQLSMALLINT  ) arg8),((SQLSMALLINT * ) arg9));
			break;
		case 1:
			retval = (unsigned long) SQLError(((SQLHENV  ) arg2),((SQLHDBC  ) arg3),((SQLHSTMT  ) arg4),((SQLCHAR * ) arg5),((SQLINTEGER * ) arg6),((SQLCHAR * ) arg7),((SQLSMALLINT  ) arg8),((SQLSMALLINT * ) arg9));
			break;
		default:
			PI_FAIL;
	}
...
static int odbc_dispatch12(void)
{
	...
	{
		case 0:
/*			retval = (unsigned long) TraceOpenLogFile();    */
			retval = 0;
			break;
		default:
			PI_FAIL;
	...
	PI_makedouble(&rval,&rtype,(double) retval);
	if (PI_unify(arg2,type2,rval,rtype))
		PI_SUCCEED;
	PI_FAIL;
}
...
static int odbc_dispatch14(void)
{
	...
	{
		case 0:
			retval = (unsigned long) SQLBindParameter(((SQLHSTMT  ) arg2),((SQLUSMALLINT  ) arg3),((SQLSMALLINT  ) arg4),((SQLSMALLINT  ) arg5),((SQLSMALLINT  ) arg6),((SQLUINTEGER  ) arg7),((SQLSMALLINT  ) arg8),((SQLPOINTER  ) arg9),((SQLINTEGER  ) arg10),((SQLINTEGER * ) arg11));
			break;
		case 1:
			retval = (unsigned long) SQLSetDescRec(((SQLHDESC  ) arg2),((SQLSMALLINT  ) arg3),((SQLSMALLINT  ) arg4),((SQLSMALLINT  ) arg5),((SQLINTEGER  ) arg6),((SQLSMALLINT  ) arg7),((SQLSMALLINT  ) arg8),((SQLPOINTER  ) arg9),((SQLINTEGER * ) arg10),((SQLINTEGER * ) arg11));
			break;
		default:
			PI_FAIL;
	}
...
static int odbc_dispatch18(void)
{
	...
	{
		case 0:
			retval = (unsigned long) SQLDescribeCol(((SQLHSTMT  ) arg2),((SQLUSMALLINT  ) arg3),((SQLCHAR * ) arg4),((SQLSMALLINT  ) arg5),((SQLSMALLINT * ) arg6),((SQLSMALLINT * ) arg7),((SQLUINTEGER * ) arg8),((SQLSMALLINT * ) arg9),((SQLSMALLINT * ) arg10));
			break;
		default:
			PI_FAIL;
	}
...
PI_BEGIN
	PI_PDEFINE("odbc0",13,odbc_dispatch0,"_odbc_dispatch0")
	PI_PDEFINE("odbc1",9,odbc_dispatch1,"_odbc_dispatch1")
	PI_PDEFINE("odbc2",9,odbc_dispatch2,"_odbc_dispatch2")
	PI_PDEFINE("odbc3",6,odbc_dispatch3,"_odbc_dispatch3")
	PI_PDEFINE("odbc4",6,odbc_dispatch4,"_odbc_dispatch4")
	PI_PDEFINE("odbc5",10,odbc_dispatch5,"_odbc_dispatch5")
	PI_PDEFINE("odbc6",10,odbc_dispatch6,"_odbc_dispatch6")
	PI_PDEFINE("odbc7",10,odbc_dispatch7,"_odbc_dispatch7")
	PI_PDEFINE("odbc8",10,odbc_dispatch8,"_odbc_dispatch8")
	PI_PDEFINE("odbc9",3,odbc_dispatch9,"_odbc_dispatch9")
	PI_PDEFINE("odbc10",7,odbc_dispatch10,"_odbc_dispatch10")
	PI_PDEFINE("odbc11",5,odbc_dispatch11,"_odbc_dispatch11")
	PI_PDEFINE("odbc12",2,odbc_dispatch12,"_odbc_dispatch12")
	PI_PDEFINE("odbc13",5,odbc_dispatch13,"_odbc_dispatch13")
	PI_PDEFINE("odbc14",12,odbc_dispatch14,"_odbc_dispatch14")
	PI_PDEFINE("odbc15",12,odbc_dispatch15,"_odbc_dispatch15")
	PI_PDEFINE("odbc16",11,odbc_dispatch16,"_odbc_dispatch16")
	PI_PDEFINE("odbc17",11,odbc_dispatch17,"_odbc_dispatch17")
	PI_PDEFINE("odbc18",11,odbc_dispatch18,"_odbc_dispatch18")
	PI_PDEFINE("odbc19",15,odbc_dispatch19,"_odbc_dispatch19")
	PI_PDEFINE("odbc20",4,odbc_dispatch20,"_odbc_dispatch20")
	PI_PDEFINE("odbc21",8,odbc_dispatch21,"_odbc_dispatch21")
	PI_PDEFINE("odbc22",8,odbc_dispatch22,"_odbc_dispatch22")
PI_END
