...
PI_BEGIN
	...
	PI_PDEFINE("acc1",7,acc_dispatch1,"_acc_dispatch1")
	PI_PDEFINE("acc2",4,acc_dispatch2,"_acc_dispatch2")
	PI_PDEFINE("acc3",4,acc_dispatch3,"_acc_dispatch3")
	PI_PDEFINE("acc4",4,acc_dispatch4,"_acc_dispatch4")
	...
	PI_PDEFINE("acc8",3,acc_dispatch8,"_acc_dispatch8")
	PI_PDEFINE("acc9",5,acc_dispatch9,"_acc_dispatch9")
	PI_PDEFINE("acc10",6,acc_dispatch10,"_acc_dispatch10")
	PI_PDEFINE("acc11",6,acc_dispatch11,"_acc_dispatch11")
	PI_PDEFINE("acc12",6,acc_dispatch12,"_acc_dispatch12")
	PI_PDEFINE("acc13",6,acc_dispatch13,"_acc_dispatch13")
	PI_PDEFINE("acc14",5,acc_dispatch14,"_acc_dispatch14")
	PI_PDEFINE("acc15",4,acc_dispatch15,"_acc_dispatch15")
	PI_PDEFINE("acc16",4,acc_dispatch16,"_acc_dispatch16")
	PI_PDEFINE("acc17",4,acc_dispatch17,"_acc_dispatch17")
	PI_PDEFINE("acc18",4,acc_dispatch18,"_acc_dispatch18")
	PI_PDEFINE("acc19",5,acc_dispatch19,"_acc_dispatch19")
PI_END

void acsyd3i_compact_init(void)
{
	PI_INIT;
}
