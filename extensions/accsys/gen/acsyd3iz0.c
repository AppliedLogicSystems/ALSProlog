...
PI_BEGIN
	...
	PI_PDEFINE("acc3",7,acc_dispatch3,"_acc_dispatch3")
	...
	PI_PDEFINE("acc8",5,acc_dispatch8,"_acc_dispatch8")
	PI_PDEFINE("acc9",5,acc_dispatch9,"_acc_dispatch9")
	PI_PDEFINE("acc10",4,acc_dispatch10,"_acc_dispatch10")
	...
	PI_PDEFINE("acc16",6,acc_dispatch16,"_acc_dispatch16")
	...
	PI_PDEFINE("acc20",5,acc_dispatch20,"_acc_dispatch20")
	PI_PDEFINE("acc21",6,acc_dispatch21,"_acc_dispatch21")
PI_END

void acsyd3iz_compact_init(void)
{
	PI_INIT;
}
