...
overview_frame(ModuleNames, DocTitle, KeyWords, DateTime, OS)
	...
	'<B>%t</B></FONT></TD>'					+ ['Predicates'],
	'</TR>',
	'</TABLE>',
	'<TABLE BORDER="0" WIDTH="100%" SUMMARY="">',
	'<TR>',
	'<TD NOWRAP><FONT CLASS="FrameItemFont"><A HREF="predicateslist-frame.html" target="predicatesListFrame">From All Modules</A></FONT>',
	'<P>',
	'<FONT size="+1" CLASS="FrameHeadingFont">Predicates by Module</FONT>',
	'<BR>'
	  ], OS),
