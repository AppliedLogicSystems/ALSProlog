...
module cref.
	...
	/*
 	 * cref_shell/0	--	a shell for exploring the analyzed program
 	 *
 	 */
...
export start_cref_shell/2.
	%% Start the cref_shell, with possible options:
