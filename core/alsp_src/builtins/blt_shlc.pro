...
show_help
	...
	write('    [options]'),nl,
	write('    Prolog expressions and goals may need to be in single quotes to defeat the os shell'),nl,
	...
	write('    -nwd        Debugger should only use system console for display (Only meaningful in alsdev).'),nl,
	...
	write('    -P          Start application portion of command line (left to right), pushing on image name.'),nl,
	nl,nl,
	halt.
