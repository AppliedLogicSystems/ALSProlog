...
if test $TEST_C_OUT != "app_image0_saved"
then
...
if test $TEST_C_OUT != "app_image0_running"
then
...
if test $TEST_C_OUT != "app_image1_saved"
then
...
if test $TEST_C_OUT != "app_image1_making_app_image2"
then
...
if test $TEST_C_OUT != "app_image2_running"
then
