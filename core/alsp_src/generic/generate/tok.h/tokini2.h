...
{(unsigned char *)"\2=>"+1,0,9600},
{(unsigned char *)"\2|="+1,0,11520},
{(unsigned char *)"\2=|"+1,0,11520},
{(unsigned char *)"\1~"+1,2404,0},
...
{(unsigned char *)"\4real"+1,0,0},
{(unsigned char *)"\7integer"+1,0,0},
{(unsigned char *)"\7boolean"+1,0,0},
...
{(unsigned char *)"\7unequal"+1,0,0},
{(unsigned char *)"\5equal"+1,0,0},
{(unsigned char *)"\11greatereq"+1,0,0},
{(unsigned char *)"\6higher"+1,0,0},
{(unsigned char *)"\3add"+1,0,0},
{(unsigned char *)"\11begin_tog"+1,0,0},
{(unsigned char *)"\12finish_tog"+1,0,0},
{(unsigned char *)"\3inf"+1,0,0},
{(unsigned char *)"\6j_less"+1,0,0},
{(unsigned char *)"\7k_equal"+1,0,0},
{(unsigned char *)"\3lub"+1,0,0},
{(unsigned char *)"\3mul"+1,0,0},
{(unsigned char *)"\10narrower"+1,0,0},
{(unsigned char *)"\2or"+1,0,0},
{(unsigned char *)"\7pow_odd"+1,0,0},
{(unsigned char *)"\11qpow_even"+1,0,0},
{(unsigned char *)"\12rootsquare"+1,0,0},
{(unsigned char *)"\4vabs"+1,0,0},
{(unsigned char *)"\4wrap"+1,0,0},
{(unsigned char *)"\2xp"+1,0,0},
{(unsigned char *)"\2pi"+1,0,0},
{(unsigned char *)"\14cnst_pi_half"+1,0,0},
{(unsigned char *)"\1e"+1,0,0},
{(unsigned char *)"\11cnst_pi_4"+1,0,0},
{(unsigned char *)"\11cnst_1_pi"+1,0,0},
{(unsigned char *)"\11cnst_2_pi"+1,0,0},
{(unsigned char *)"\14cnst_2sqrtpi"+1,0,0},
{(unsigned char *)"\12cnst_log2e"+1,0,0},
{(unsigned char *)"\13cnst_log10e"+1,0,0},
{(unsigned char *)"\10cnst_ln2"+1,0,0},
{(unsigned char *)"\11cnst_ln10"+1,0,0},
{(unsigned char *)"\12cnst_sqrt2"+1,0,0},
{(unsigned char *)"\14cnst_sqrt1_2"+1,0,0},
