...
/*	BLT("$iter_link_net",  5, ilinknet, "_ilinknet"),  */
	...
	BLT("sio_set_console_prompt", 1, sio_set_console_prompt, "_sio_set_console_prompt"),
	BLT("sio_set_history_file", 1, sio_set_history_file, "_sio_set_history_file"),
	BLT("sio_set_load_prev_history", 0, sio_set_load_prev_history, "_sio_set_load_prev_history"),
