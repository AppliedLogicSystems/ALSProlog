...
/****************************************************************************/
/*                                                                          */
/*  WIN386.H -  Replacement for "windows.h".  				    */
/*                                                                          */
/****************************************************************************/

#ifndef __WINDOW386_H__
#define __WINDOW386_H__
...
/*--------------------------------------------------------------------------*/
/* Include 16/32 communication header                                       */
/*--------------------------------------------------------------------------*/
#ifndef _COM_H 		
#   include "com.h"
#endif
...
/* Define keywords                                                          */
/*--------------------------------------------------------------------------*/
/* Special Rules for generating interfaces 	-- Ilyas 8/17/92 */
#define pascal
/*
#define pascal \
    _DCC((_DEFAULT_CALLING_CONVENTION|_CALLEE_POPS_STACK) & \
...
/*--------------------------------------------------------------------------*/
/* Define how far pointers are to be treated                                */
/*--------------------------------------------------------------------------*/
#define LP_IS_FAR	1
#ifdef  LP_IS_FAR
#   define lpFAR	_Dfar
...
/*--------------------------------------------------------------------------*/
/* Start of Microsoft's windows.h                                           */
/*--------------------------------------------------------------------------*/
...
#ifndef max
#define max(a,b)            _max(a,b) 	// (((a) > (b)) ? (a) : (b))
#endif

#ifndef min
#define min(a,b)            _min(a,b)    // (((a) < (b)) ? (a) : (b))
#endif
...
typedef int lpFAR             *LPINT; typedef int _Dfar *LP48INT;
...
typedef char		    *LP32STR;
typedef char lpFAR            *LPSTR; typedef char _Dfar *LP48STR;
typedef BYTE near           *PBYTE;
typedef BYTE lpFAR            *LPBYTE; typedef BYTE _Dfar *LP48BYTE;
typedef WORD near           *PWORD;
typedef WORD lpFAR            *LPWORD; typedef WORD _Dfar *LP48WORD;
typedef long near           *PLONG;
typedef long lpFAR            *LPLONG; typedef long _Dfar *LP48LONG;
typedef DWORD near          *PDWORD;
typedef DWORD lpFAR           *LPDWORD; typedef DWORD _Dfar *LP48DWORD;
typedef void lpFAR            *LPVOID; typedef void _Dfar *LP48VOID;
typedef void lpFAR	    *LPBOOL; typedef void _Dfar *LP48BOOL;
typedef int (lpFAR PASCAL *LPFARPROC)();
typedef int (_Dfar PASCAL *LP48FARPROC)();

#ifndef WIN_INTERNAL
typedef WORD                HANDLE;
typedef HANDLE              HWND;  // unsigned int
#endif

typedef HANDLE              *PHANDLE;
typedef HANDLE NEAR         *SPHANDLE;
typedef HANDLE lpFAR          *LPHANDLE; typedef HANDLE _Dfar *LP48HANDLE;
...
typedef RECT lpFAR            *LPRECT; typedef RECT _Dfar *LP48RECT;
...
typedef POINT lpFAR           *LPPOINT; typedef POINT _Dfar *LP48POINT;
...
void    FAR PASCAL GetCodeInfo(FARPROC lpProc, LP48VOID lpSegInfo);
HANDLE  FAR PASCAL GetModuleHandle(LP48STR);
int     FAR PASCAL GetModuleUsage(HANDLE);
int     FAR PASCAL GetModuleFileName(HANDLE, LP48STR, int);
int     FAR PASCAL GetInstanceData(HANDLE, DWORD, int);
LPFARPROC FAR PASCAL GetProcAddress(HANDLE, LP48STR);
FARPROC FAR PASCAL MakeProcInstance(FARPROC, HANDLE);
void    FAR PASCAL FreeProcInstance(FARPROC);
HANDLE  FAR PASCAL LoadLibrary(LP48STR);
HANDLE  FAR PASCAL LoadModule(LP48STR, LP48VOID);
BOOL    FAR PASCAL FreeModule(HANDLE);
void    FAR PASCAL FreeLibrary(HANDLE);
DWORD   FAR PASCAL GetFreeSpace(WORD);
WORD    FAR PASCAL WinExec(LP48STR, WORD);
void    FAR PASCAL DebugBreak();
void    FAR PASCAL OutputDebugString(LP48STR);
...
typedef OFSTRUCT lpFAR        *LPOFSTRUCT; typedef OFSTRUCT _Dfar *LP48OFSTRUCT;
...
int  FAR PASCAL OpenFile(LP48STR, LP48OFSTRUCT, WORD);

/* GetTempFileName() Flags */
#define TF_FORCEDRIVE       (BYTE)0x80

BYTE FAR PASCAL GetTempDrive(BYTE);
int  FAR PASCAL GetTempFileName(BYTE, LP48STR, WORD, LP48STR);
...
LP48VOID  FAR PASCAL GlobalLock(HANDLE);
...
LP48STR  FAR PASCAL GlobalWire(HANDLE);
...
HANDLE FAR PASCAL FindResource(HANDLE, LP48STR, LP48STR);
HANDLE FAR PASCAL LoadResource(HANDLE, HANDLE);
BOOL   FAR PASCAL FreeResource(HANDLE);
LP48STR  FAR PASCAL LockResource(HANDLE);
FARPROC FAR PASCAL SetResourceHandler(HANDLE, LP48STR, FARPROC);
...
#define MAKEINTRESOURCE(i)  (LP48STR)((DWORD)((WORD)(i)))
...
ATOM   FAR PASCAL AddAtom(LP48STR);
ATOM   FAR PASCAL DeleteAtom(ATOM);
ATOM   FAR PASCAL FindAtom(LP48STR);
WORD   FAR PASCAL GetAtomName(ATOM, LP48STR, int);
ATOM   FAR PASCAL GlobalAddAtom(LP48STR);
ATOM   FAR PASCAL GlobalDeleteAtom(ATOM);
ATOM   FAR PASCAL GlobalFindAtom(LP48STR);
WORD   FAR PASCAL GlobalGetAtomName(ATOM, LP48STR, int);
HANDLE FAR PASCAL GetAtomHandle(ATOM);

#endif /* NOATOM */

/* User Profile Routines */
WORD FAR PASCAL GetProfileInt(LP48STR, LP48STR, int);
int  FAR PASCAL GetProfileString(LP48STR, LP48STR, LP48STR, LP48STR, int);
BOOL FAR PASCAL WriteProfileString(LP48STR, LP48STR, LP48STR);
WORD FAR PASCAL GetPrivateProfileInt(LP48STR, LP48STR, int, LP48STR);
int  FAR PASCAL GetPrivateProfileString(LP48STR, LP48STR, LP48STR, LP48STR, int, LP48STR);
BOOL FAR PASCAL WritePrivateProfileString(LP48STR, LP48STR, LP48STR, LP48STR);

WORD FAR PASCAL GetWindowsDirectory(LP48STR,WORD);
WORD FAR PASCAL GetSystemDirectory(LP48STR,WORD);

/* Catch() and Throw() */
typedef int                 CATCHBUF[9];
typedef int lpFAR             *LPCATCHBUF; typedef int _Dfar *LP48CATCHBUF;

int  FAR PASCAL Catch(LP48CATCHBUF);
void FAR PASCAL Throw(LP48CATCHBUF, int);
...
int   FAR PASCAL AnsiToOem(LP48STR, LP48STR);
BOOL  FAR PASCAL OemToAnsi(LP48STR, LP48STR);
void  FAR PASCAL AnsiToOemBuff(LP48STR, LP48STR, int);
void  FAR PASCAL OemToAnsiBuff(LP48STR, LP48STR, int);
LP48STR FAR PASCAL AnsiUpper(LP48STR);
WORD  FAR PASCAL AnsiUpperBuff(LP48STR, WORD);
LP48STR FAR PASCAL AnsiLower(LP48STR);
WORD  FAR PASCAL AnsiLowerBuff(LP48STR, WORD);
LP48STR FAR PASCAL AnsiNext(LP48STR);
LP48STR FAR PASCAL AnsiPrev(LP48STR, LP48STR);
...
int   FAR PASCAL GetKeyNameText(LONG, LP48STR, int);
int   FAR PASCAL ToAscii(WORD wVirtKey, WORD wScanCode, LP48STR lpKeyState, LP48VOID lpChar, WORD wFlags);
#endif
...
typedef BITMAP lpFAR          *LPBITMAP; typedef BITMAP _Dfar *LP48BITMAP;
...
typedef BITMAPCOREHEADER lpFAR *LPBITMAPCOREHEADER; typedef BITMAPCOREHEADER _Dfar *LP48BITMAPCOREHEADER;
...
typedef BITMAPINFOHEADER lpFAR *LPBITMAPINFOHEADER; typedef BITMAPINFOHEADER _Dfar *LP48BITMAPINFOHEADER;
...
typedef BITMAPINFO lpFAR *LPBITMAPINFO; typedef BITMAPINFO _Dfar *LP48BITMAPINFO;
...
typedef BITMAPCOREINFO lpFAR *LPBITMAPCOREINFO; typedef BITMAPCOREINFO _Dfar *LP48BITMAPCOREINFO;
...
typedef BITMAPFILEHEADER lpFAR *LPBITMAPFILEHEADER; typedef BITMAPFILEHEADER _Dfar *LP48BITMAPFILEHEADER;
...
typedef HANDLETABLE lpFAR     *LPHANDLETABLE; typedef HANDLETABLE _Dfar *LP48HANDLETABLE;
...
typedef METARECORD lpFAR      *LPMETARECORD; typedef METARECORD _Dfar *LP48METARECORD;
...
typedef METAFILEPICT lpFAR    *LPMETAFILEPICT; typedef METAFILEPICT _Dfar *LP48METAFILEPICT;
...
typedef TEXTMETRIC lpFAR      *LPTEXTMETRIC; typedef TEXTMETRIC _Dfar *LP48TEXTMETRIC;
...
typedef PELARRAY lpFAR        *LPPELARRAY; typedef PELARRAY _Dfar *LP48PELARRAY;
...
typedef LOGBRUSH lpFAR        *LPLOGBRUSH; typedef LOGBRUSH _Dfar *LP48LOGBRUSH;

typedef LOGBRUSH            PATTERN;
typedef PATTERN             *PPATTERN;
typedef PATTERN NEAR        *NPPATTERN;
typedef PATTERN lpFAR         *LPPATTERN; typedef PATTERN _Dfar *LP48PATTERN;
...
typedef LOGPEN lpFAR          *LPLOGPEN; typedef LOGPEN _Dfar *LP48LOGPEN;
...
typedef PALETTEENTRY lpFAR  *LPPALETTEENTRY; typedef PALETTEENTRY _Dfar *LP48PALETTEENTRY;
...
typedef LOGPALETTE lpFAR      *LPLOGPALETTE; typedef LOGPALETTE _Dfar *LP48LOGPALETTE;
...
typedef LOGFONT lpFAR         *LPLOGFONT; typedef LOGFONT _Dfar *LP48LOGFONT;
...
int  FAR PASCAL DrawText(HDC, LP48STR, int, LP48RECT, WORD);
...
HDC   FAR PASCAL CreateDC(LP48STR, LP48STR, LP48STR, LP48STR);
HDC   FAR PASCAL CreateIC(LP48STR, LP48STR, LP48STR, LP48STR);
...
BOOL FAR PASCAL ExtTextOut(HDC, int, int, WORD, LP48RECT, LP48STR, WORD, LP48INT);

BOOL FAR PASCAL Polyline(HDC, LP48POINT, int);
BOOL FAR PASCAL Polygon(HDC, LP48POINT, int);
BOOL FAR PASCAL PolyPolygon(HDC, LP48POINT, LP48INT, int);
...
BOOL  FAR PASCAL TextOut(HDC, int, int, LP48STR, int);
LONG  FAR PASCAL TabbedTextOut(HDC, int, int, LP48STR, int, int, LP48INT, int);
BOOL  FAR PASCAL GetCharWidth(HDC, WORD, WORD, LP48INT);
...
void  FAR PASCAL LineDDA(int, int, int, int, FARPROC, LP48STR);

HANDLE FAR PASCAL GetStockObject(int);

HPEN FAR PASCAL CreatePen(int, int, DWORD);
HPEN FAR PASCAL CreatePenIndirect(LP48LOGPEN);
...
HBRUSH FAR PASCAL CreateBrushIndirect(LP48LOGBRUSH);

HBITMAP FAR PASCAL CreateBitmap(int, int, BYTE, BYTE, LP48STR);
HBITMAP FAR PASCAL CreateBitmapIndirect(LP48BITMAP);
HBITMAP FAR PASCAL CreateCompatibleBitmap(HDC, int, int);
HBITMAP FAR PASCAL CreateDiscardableBitmap(HDC, int, int);

LONG  FAR PASCAL SetBitmapBits(HBITMAP, DWORD, LP48STR);
LONG  FAR PASCAL GetBitmapBits(HBITMAP, LONG, LP48STR);
DWORD FAR PASCAL SetBitmapDimension(HBITMAP, int, int);
DWORD FAR PASCAL GetBitmapDimension(HBITMAP);

HFONT FAR PASCAL CreateFont(int, int, int, int, int, BYTE, BYTE, BYTE, BYTE, BYTE, BYTE, BYTE, BYTE, LP48STR);
HFONT FAR PASCAL CreateFontIndirect(LP48LOGFONT);
...
HRGN FAR PASCAL CreateRectRgnIndirect(LP48RECT);
HRGN FAR PASCAL CreateEllipticRgnIndirect(LP48RECT);
HRGN FAR PASCAL CreateEllipticRgn(int, int, int, int);
HRGN FAR PASCAL CreatePolygonRgn(LP48POINT, int, int);
HRGN FAR PASCAL CreatePolyPolygonRgn(LP48POINT, LP48INT, int, int);
HRGN FAR PASCAL CreateRoundRectRgn(int, int, int, int, int, int);

int    FAR PASCAL GetObject(HANDLE, int, LP48STR);
...
int  FAR PASCAL GetClipBox(HDC, LP48RECT);
...
int  FAR PASCAL GetRgnBox(HRGN, LP48RECT);

int   FAR PASCAL SetTextJustification(HDC, int, int);
DWORD FAR PASCAL GetTextExtent(HDC, LP48STR, int);
DWORD FAR PASCAL GetTabbedTextExtent(HDC, LP48STR, int, int, LP48INT);
int   FAR PASCAL SetTextCharacterExtra(HDC, int);
int   FAR PASCAL GetTextCharacterExtra(HDC);

HANDLE FAR PASCAL GetMetaFile(LP48STR);
BOOL   FAR PASCAL DeleteMetaFile(HANDLE);
HANDLE FAR PASCAL CopyMetaFile(HANDLE, LP48STR);

#ifndef NOMETAFILE
void FAR PASCAL PlayMetaFileRecord(HDC, LP48HANDLETABLE, LP48METARECORD, WORD);
BOOL FAR PASCAL EnumMetaFile(HDC, LOCALHANDLE, FARPROC, LP48BYTE);
#endif

BOOL FAR PASCAL PlayMetaFile(HDC, HANDLE);
int FAR PASCAL Escape(HDC, int, int, LP48STR, LP48STR);
int FAR PASCAL EnumFonts(HDC, LP48STR, FARPROC, LP48STR);
int FAR PASCAL EnumObjects(HDC, int, FARPROC, LP48STR);
int FAR PASCAL GetTextFace(HDC, int, LP48STR);

#ifndef NOTEXTMETRIC
BOOL FAR PASCAL GetTextMetrics(HDC, LP48TEXTMETRIC );
#endif

int FAR PASCAL GetDeviceCaps(HDC, int);

int FAR PASCAL SetEnvironment(LP48STR, LP48STR, WORD);
int FAR PASCAL GetEnvironment(LP48STR, LP48STR, WORD);

BOOL FAR PASCAL DPtoLP(HDC, LP48POINT, int);
BOOL FAR PASCAL LPtoDP(HDC, LP48POINT, int);

HANDLE FAR PASCAL CreateMetaFile(LP48STR);
HANDLE FAR PASCAL CloseMetaFile(HANDLE);
HANDLE FAR PASCAL GetMetaFileBits(HANDLE);
HANDLE FAR PASCAL SetMetaFileBits(HANDLE);

int FAR PASCAL SetDIBits(HDC,HANDLE,WORD,WORD,LP48STR,LP48BITMAPINFO,WORD);
int FAR PASCAL GetDIBits(HDC,HANDLE,WORD,WORD,LP48STR,LP48BITMAPINFO,WORD);
int FAR PASCAL SetDIBitsToDevice(HDC,WORD,WORD,WORD,WORD,
                                        WORD,WORD,WORD,WORD,
                                        LP48STR,LP48BITMAPINFO,WORD);
HBITMAP FAR PASCAL CreateDIBitmap(HDC,LP48BITMAPINFOHEADER,DWORD,LP48STR,
                                                LP48BITMAPINFO,WORD);
HBRUSH FAR PASCAL CreateDIBPatternBrush(HANDLE,WORD);
int FAR PASCAL StretchDIBits(HDC, WORD, WORD, WORD, WORD, WORD,
                        WORD, WORD, WORD, LP48STR, LP48BITMAPINFO, WORD, DWORD);

HPALETTE FAR PASCAL CreatePalette (LP48LOGPALETTE);
HPALETTE  FAR PASCAL SelectPalette (HDC,HPALETTE, BOOL) ;
WORD FAR PASCAL RealizePalette (HDC) ;
int  FAR PASCAL UpdateColors (HDC) ;
void FAR PASCAL AnimatePalette(HPALETTE, WORD, WORD, LP48PALETTEENTRY);
WORD FAR PASCAL SetPaletteEntries(HPALETTE,WORD,WORD,LP48PALETTEENTRY);
WORD FAR PASCAL GetPaletteEntries(HPALETTE,WORD,WORD,LP48PALETTEENTRY);
WORD FAR PASCAL GetNearestPaletteIndex(HPALETTE, DWORD);
BOOL FAR PASCAL ResizePalette(HPALETTE, WORD);

WORD FAR PASCAL GetSystemPaletteEntries(HDC,WORD,WORD,LP48PALETTEENTRY);
...
typedef EVENTMSG lpFAR        *LPEVENTMSGMSG; typedef EVENTMSG _Dfar *LP48EVENTMSGMSG;
...
typedef struct tagWNDCLASS
  {
    ...
    LP48STR     lpszMenuName;
    LP48STR     lpszClassName;
  } WNDCLASS;
typedef WNDCLASS            *PWNDCLASS;
typedef WNDCLASS NEAR       *NPWNDCLASS;
typedef WNDCLASS lpFAR        *LPWNDCLASS; typedef WNDCLASS _Dfar *LP48WNDCLASS;
...
typedef MSG lpFAR             *LPMSG; typedef MSG _Dfar *LP48MSG;
...
WORD FAR PASCAL RegisterWindowMessage(LP48STR);
...
typedef PAINTSTRUCT lpFAR     *LPPAINTSTRUCT; typedef PAINTSTRUCT _Dfar *LP48PAINTSTRUCT;

typedef struct tagCREATESTRUCT
  {
    LP48STR       lpCreateParams;
    HANDLE      hInstance;
    HANDLE      hMenu;
    HWND        hwndParent;
    int         cy;
...
typedef MEASUREITEMSTRUCT lpFAR  *LPMEASUREITEMSTRUCT; typedef MEASUREITEMSTRUCT _Dfar *LP48MEASUREITEMSTRUCT;
...
typedef DRAWITEMSTRUCT lpFAR  *LPDRAWITEMSTRUCT; typedef DRAWITEMSTRUCT _Dfar *LP48DRAWITEMSTRUCT;
...
typedef DELETEITEMSTRUCT lpFAR  *LPDELETEITEMSTRUCT; typedef DELETEITEMSTRUCT _Dfar *LP48DELETEITEMSTRUCT;
...
typedef COMPAREITEMSTRUCT lpFAR  *LPCOMPAREITEMSTRUCT; typedef COMPAREITEMSTRUCT _Dfar *LP48COMPAREITEMSTRUCT;

#ifndef NOMSG

/* Message Function Templates */
BOOL FAR PASCAL GetMessage(LP48MSG, HWND, WORD, WORD);
BOOL FAR PASCAL TranslateMessage(LP48MSG);
LONG FAR PASCAL DispatchMessage(LP48MSG);
BOOL FAR PASCAL PeekMessage(LP48MSG, HWND, WORD, WORD, WORD);
...
#ifndef NOLSTRING
int         FAR PASCAL lstrcmp( LP48STR, LP48STR );
int         FAR PASCAL lstrcmpi( LP48STR, LP48STR );
LP48STR       FAR PASCAL lstrcpy( LP48STR, LP48STR );
LP48STR       FAR PASCAL lstrcat( LP48STR, LP48STR );
int         FAR PASCAL lstrlen( LP48STR );
#endif  /* NOLSTRING */

#ifndef NOLFILEIO
int         FAR PASCAL _lopen( LP48STR, int );
int         FAR PASCAL _lclose( int );
int         FAR PASCAL _lcreat( LP48STR, int );
LONG        FAR PASCAL _llseek( int, long, int );
WORD        FAR PASCAL _lread( int, LP48STR, int );
WORD        FAR PASCAL _lwrite( int, LP48STR, int );
...
BOOL  FAR PASCAL RegisterClass(LP48WNDCLASS);
BOOL  FAR PASCAL UnregisterClass(LP48STR, HANDLE);
BOOL  FAR PASCAL GetClassInfo(HANDLE, LP48STR, LP48WNDCLASS);
...
HWND FAR PASCAL CreateDialog(HANDLE, LP48STR, HWND, FARPROC);
HWND FAR PASCAL CreateDialogIndirect(HANDLE, LP48STR, HWND, FARPROC);
HWND FAR PASCAL CreateDialogParam(HANDLE, LP48STR, HWND, FARPROC, LONG);
HWND FAR PASCAL CreateDialogIndirectParam(HANDLE, LP48STR, HWND, FARPROC, LONG);
int  FAR PASCAL DialogBox(HANDLE, LP48STR, HWND, FARPROC);
int  FAR PASCAL DialogBoxIndirect(HANDLE, HANDLE, HWND, FARPROC);
int  FAR PASCAL DialogBoxParam(HANDLE, LP48STR, HWND, FARPROC, LONG);
...
WORD FAR PASCAL GetDlgItemInt(HWND, int, LP48BOOL, BOOL);
void FAR PASCAL SetDlgItemText(HWND, int, LP48STR);
int  FAR PASCAL GetDlgItemText(HWND, int, LP48STR, int);
...
#ifndef NOMSG
BOOL FAR PASCAL CallMsgFilter(LP48MSG, int);
#endif
...
void FAR PASCAL GetKeyboardState(LP48BYTE);
void FAR PASCAL SetKeyboardState(LP48BYTE);
...
HANDLE FAR PASCAL LoadAccelerators(HANDLE, LP48STR);

#ifndef NOMSG
int  FAR PASCAL TranslateAccelerator(HWND, HANDLE, LP48MSG);
#endif
...
HMENU FAR PASCAL LoadMenu(HANDLE, LP48STR);
HMENU FAR PASCAL LoadMenuIndirect(LP48STR);
HMENU FAR PASCAL GetMenu(HWND);
BOOL  FAR PASCAL SetMenu(HWND, HMENU);
BOOL  FAR PASCAL ChangeMenu(HMENU, WORD, LP48STR, WORD, WORD);
BOOL  FAR PASCAL HiliteMenuItem(HWND, HMENU, WORD, WORD);
int   FAR PASCAL GetMenuString(HMENU, WORD, LP48STR, int, WORD);
...
BOOL  FAR PASCAL InsertMenu(HMENU, WORD, WORD, WORD, LP48STR);
BOOL  FAR PASCAL AppendMenu(HMENU, WORD, WORD, LP48STR);
BOOL  FAR PASCAL ModifyMenu(HMENU, WORD, WORD, WORD, LP48STR);
...
BOOL  FAR PASCAL TrackPopupMenu(HMENU, WORD, int, int, int, HWND, LP48RECT);
...
HDC  FAR PASCAL BeginPaint(HWND, LP48PAINTSTRUCT);
void FAR PASCAL EndPaint(HWND, LP48PAINTSTRUCT);
BOOL FAR PASCAL GetUpdateRect(HWND, LP48RECT, BOOL);
int  FAR PASCAL GetUpdateRgn(HWND, HRGN, BOOL);

int  FAR PASCAL ExcludeUpdateRgn(HDC, HWND);

void FAR PASCAL InvalidateRect(HWND, LP48RECT, BOOL);
void FAR PASCAL ValidateRect(HWND, LP48RECT);

void FAR PASCAL InvalidateRgn(HWND, HRGN, BOOL);
void FAR PASCAL ValidateRgn(HWND, HRGN);

void FAR PASCAL ScrollWindow(HWND, int, int, LP48RECT, LP48RECT);
BOOL FAR PASCAL ScrollDC(HDC, int, int, LP48RECT, LP48RECT, HRGN, LP48RECT);
...
void FAR PASCAL GetScrollRange(HWND, int, LP48INT, LP48INT);
void FAR PASCAL ShowScrollBar(HWND, WORD, BOOL);
#endif

BOOL   FAR PASCAL SetProp(HWND, LP48STR, HANDLE);
HANDLE FAR PASCAL GetProp(HWND, LP48STR);
HANDLE FAR PASCAL RemoveProp(HWND, LP48STR);
int    FAR PASCAL EnumProps(HWND, FARPROC);
void   FAR PASCAL SetWindowText(HWND, LP48STR);
int    FAR PASCAL GetWindowText(HWND, LP48STR, int);
int    FAR PASCAL GetWindowTextLength(HWND);

void FAR PASCAL GetClientRect(HWND, LP48RECT);
void FAR PASCAL GetWindowRect(HWND, LP48RECT);
void FAR PASCAL AdjustWindowRect(LP48RECT, LONG, BOOL);
void FAR PASCAL AdjustWindowRectEx(LP48RECT, LONG, BOOL, DWORD);
...
int  FAR PASCAL MessageBox(HWND, LP48STR, LP48STR, WORD);
...
void    FAR PASCAL GetCursorPos(LP48POINT);
void    FAR PASCAL ClipCursor(LP48RECT);
...
void FAR PASCAL GetCaretPos(LP48POINT);

void FAR PASCAL ClientToScreen(HWND, LP48POINT);
void FAR PASCAL ScreenToClient(HWND, LP48POINT);
...
void  FAR PASCAL SetSysColors(int, LP48INT, LP48LONG);
...
void FAR PASCAL DrawFocusRect(HDC, LP48RECT);
int  FAR PASCAL FillRect(HDC, LP48RECT, HBRUSH);
int  FAR PASCAL FrameRect(HDC, LP48RECT, HBRUSH);
void FAR PASCAL InvertRect(HDC, LP48RECT);
void FAR PASCAL SetRect(LP48RECT, int, int, int, int);
void FAR PASCAL SetRectEmpty(LP48RECT);
int  FAR PASCAL CopyRect(LP48RECT, LP48RECT);
void FAR PASCAL InflateRect(LP48RECT, int, int);
int  FAR PASCAL IntersectRect(LP48RECT, LP48RECT, LP48RECT);
int  FAR PASCAL UnionRect(LP48RECT, LP48RECT, LP48RECT);
void FAR PASCAL OffsetRect(LP48RECT, int, int);
BOOL FAR PASCAL IsRectEmpty(LP48RECT);
BOOL FAR PASCAL EqualRect(LP48RECT, LP48RECT);
BOOL FAR PASCAL PtInRect(LP48RECT, POINT);
BOOL FAR PASCAL RectVisible(HDC, LP48RECT);
BOOL FAR PASCAL RectInRegion(HRGN, LP48RECT);
...
DWORD   FAR PASCAL DefHookProc(int, WORD, DWORD, LP48FARPROC);
#endif
...
HBITMAP FAR PASCAL LoadBitmap(HANDLE, LP48STR);
HCURSOR FAR PASCAL LoadCursor(HANDLE, LP48STR);
HCURSOR FAR PASCAL CreateCursor(HANDLE, int, int, int, int, LP48STR, LP48STR);
...
HICON FAR PASCAL LoadIcon(HANDLE, LP48STR);
HICON FAR PASCAL CreateIcon(HANDLE, int, int, BYTE, BYTE, LP48STR, LP48STR);
...
int  FAR PASCAL LoadString(HANDLE, WORD, LP48STR, int);

int  FAR PASCAL AddFontResource(LP48STR);
BOOL FAR PASCAL RemoveFontResource(LP48STR);
...
typedef struct
  {
    ...
    LP48STR       lpReserved1;
    LP48STR       lpReserved2;
  } KANJISTRUCT, lpFAR *LPKANJISTRUCT, _Dfar *LP48KANJISTRUCT;

int  FAR PASCAL ConvertRequest(HWND, LP48KANJISTRUCT);
...
#define EM_X			0
#define EM_GETSEL          (EM_X+WM_USER+0)
#define EM_SETSEL          (EM_X+WM_USER+1)
#define EM_GETRECT         (EM_X+WM_USER+2)
#define EM_SETRECT         (EM_X+WM_USER+3)
#define EM_SETRECTNP       (EM_X+WM_USER+4)
#define EM_SCROLL          (EM_X+WM_USER+5)
#define EM_LINESCROLL      (EM_X+WM_USER+6)
#define EM_GETMODIFY       (EM_X+WM_USER+8)
#define EM_SETMODIFY       (EM_X+WM_USER+9)
#define EM_GETLINECOUNT    (EM_X+WM_USER+10)
#define EM_LINEINDEX       (EM_X+WM_USER+11)
#define EM_SETHANDLE       (EM_X+WM_USER+12)
#define EM_GETHANDLE       (EM_X+WM_USER+13)
#define EM_GETTHUMB        (EM_X+WM_USER+14)
#define EM_LINELENGTH      (EM_X+WM_USER+17)
#define EM_REPLACESEL      (EM_X+WM_USER+18)
#define EM_SETFONT         (EM_X+WM_USER+19)
#define EM_GETLINE         (EM_X+WM_USER+20)
#define EM_LIMITTEXT       (EM_X+WM_USER+21)
#define EM_CANUNDO         (EM_X+WM_USER+22)
#define EM_UNDO            (EM_X+WM_USER+23)
#define EM_FMTLINES        (EM_X+WM_USER+24)
#define EM_LINEFROMCHAR    (EM_X+WM_USER+25)
#define EM_SETWORDBREAK    (EM_X+WM_USER+26)
#define EM_SETTABSTOPS     (EM_X+WM_USER+27)
#define EM_SETPASSWORDCHAR (EM_X+WM_USER+28)
#define EM_EMPTYUNDOBUFFER (EM_X+WM_USER+29)
#define EM_MSGMAX          (EM_X+WM_USER+30)
...
#define BM_X			32
#define BM_GETCHECK        (BM_X+WM_USER+0)
#define BM_SETCHECK        (BM_X+WM_USER+1)
#define BM_GETSTATE        (BM_X+WM_USER+2)
#define BM_SETSTATE        (BM_X+WM_USER+3)
#define BM_SETSTYLE        (BM_X+WM_USER+4)
...
#ifndef NOMSG
BOOL FAR PASCAL IsDialogMessage(HWND, LP48MSG);
#endif

void FAR PASCAL MapDialogRect(HWND, LP48RECT);

int  FAR PASCAL DlgDirList(HWND, LP48STR, int, int, WORD);
BOOL FAR PASCAL DlgDirSelect(HWND, LP48STR, int);
int  FAR PASCAL DlgDirListComboBox(HWND, LP48STR, int, int, WORD);
BOOL FAR PASCAL DlgDirSelectComboBox(HWND, LP48STR, int);
...
#define DM_X		    64
#define DM_GETDEFID         (DM_X+WM_USER+0)
#define DM_SETDEFID         (DM_X+WM_USER+1)
...
/* Listbox messages */
#define LB_X			96
#define LB_ADDSTRING           (LB_X+WM_USER+1)
#define LB_INSERTSTRING        (LB_X+WM_USER+2)
#define LB_DELETESTRING        (LB_X+WM_USER+3)
#define LB_RESETCONTENT        (LB_X+WM_USER+5)
#define LB_SETSEL              (LB_X+WM_USER+6)
#define LB_SETCURSEL           (LB_X+WM_USER+7)
#define LB_GETSEL              (LB_X+WM_USER+8)
#define LB_GETCURSEL           (LB_X+WM_USER+9)
#define LB_GETTEXT             (LB_X+WM_USER+10)
#define LB_GETTEXTLEN          (LB_X+WM_USER+11)
#define LB_GETCOUNT            (LB_X+WM_USER+12)
#define LB_SELECTSTRING        (LB_X+WM_USER+13)
#define LB_DIR                 (LB_X+WM_USER+14)
#define LB_GETTOPINDEX         (LB_X+WM_USER+15)
#define LB_FINDSTRING          (LB_X+WM_USER+16)
#define LB_GETSELCOUNT         (LB_X+WM_USER+17)
#define LB_GETSELITEMS         (LB_X+WM_USER+18)
#define LB_SETTABSTOPS         (LB_X+WM_USER+19)
#define LB_GETHORIZONTALEXTENT (LB_X+WM_USER+20)
#define LB_SETHORIZONTALEXTENT (LB_X+WM_USER+21)
#define LB_SETCOLUMNWIDTH      (LB_X+WM_USER+22)
#define LB_SETTOPINDEX         (LB_X+WM_USER+24)
#define LB_GETITEMRECT         (LB_X+WM_USER+25)
#define LB_GETITEMDATA         (LB_X+WM_USER+26)
#define LB_SETITEMDATA         (LB_X+WM_USER+27)
#define LB_SELITEMRANGE        (LB_X+WM_USER+28)
#define LB_ADDSTRINGD          (LB_X+WM_USER+29)
#define LB_ADDSTRINGP          (LB_X+WM_USER+30)
#define LB_MSGMAX              (LB_X+WM_USER+33)
...
#ifndef NOWINMESSAGES
#define CB_X			128
#define CB_GETEDITSEL            (CB_X+WM_USER+0)
#define CB_LIMITTEXT             (CB_X+WM_USER+1)
#define CB_SETEDITSEL            (CB_X+WM_USER+2)
#define CB_ADDSTRING             (CB_X+WM_USER+3)
#define CB_DELETESTRING          (CB_X+WM_USER+4)
#define CB_DIR                   (CB_X+WM_USER+5)
#define CB_GETCOUNT              (CB_X+WM_USER+6)
#define CB_GETCURSEL             (CB_X+WM_USER+7)
#define CB_GETLBTEXT             (CB_X+WM_USER+8)
#define CB_GETLBTEXTLEN          (CB_X+WM_USER+9)
#define CB_INSERTSTRING          (CB_X+WM_USER+10)
#define CB_RESETCONTENT          (CB_X+WM_USER+11)
#define CB_FINDSTRING            (CB_X+WM_USER+12)
#define CB_SELECTSTRING          (CB_X+WM_USER+13)
#define CB_SETCURSEL             (CB_X+WM_USER+14)
#define CB_SHOWDROPDOWN          (CB_X+WM_USER+15)
#define CB_GETITEMDATA           (CB_X+WM_USER+16)
#define CB_SETITEMDATA           (CB_X+WM_USER+17)
#define CB_GETDROPPEDCONTROLRECT (CB_X+WM_USER+18)
#define CB_ADDSTRINGD            (CB_X+WM_USER+19)
#define CB_ADDSTRINGP            (CB_X+WM_USER+20)
#define CB_MSGMAX                (CB_X+WM_USER+21)
#endif  /* NOWINMESSAGES */
...
LP48INT FAR PASCAL GetThresholdEvent(void);
...
typedef DCB lpFAR * LPDCB; typedef DCB _Dfar *LP48DCB;
typedef COMSTAT lpFAR * LPCOMSTAT; typedef COMSTAT _Dfar *LP48COMSTAT;

int  FAR PASCAL OpenComm(LP48STR, WORD, WORD);
int  FAR PASCAL SetCommState(LP48DCB);
int  FAR PASCAL GetCommState(int, LP48DCB);
int  FAR PASCAL ReadComm(int, LP48STR, int);
int  FAR PASCAL UngetCommChar(int, char);
int  FAR PASCAL WriteComm(int, LP48STR, int);
int  FAR PASCAL CloseComm(int);
int  FAR PASCAL GetCommError(int, LP48COMSTAT);
int  FAR PASCAL BuildCommDCB(LP48STR, LP48DCB);
int  FAR PASCAL TransmitCommChar(int, char);
LP48WORD  FAR PASCAL SetCommEventMask(int, WORD);
...
typedef MDICREATESTRUCT FAR * LPMDICREATESTRUCT; typedef MDICREATESTRUCT _Dfar *LP48MDICREATESTRUCT;
...
typedef CLIENTCREATESTRUCT lpFAR * LPCLIENTCREATESTRUCT; typedef CLIENTCREATESTRUCT _Dfar *LP48CLIENTCREATESTRUCT;

LONG FAR PASCAL DefFrameProc(HWND,HWND,WORD,WORD,LONG);
LONG FAR PASCAL DefMDIChildProc(HWND,WORD,WORD,LONG);

#ifndef NOMSG
BOOL FAR PASCAL TranslateMDISysAccel(HWND,LP48MSG);
#endif
...
BOOL FAR PASCAL WinHelp(HWND hwndMain, LP48STR lpszHelp, WORD usCommand, DWORD ulData);
...
/*--------------------------------------------------------------------------*/
/* End of Microsoft's windows.h                                             */
/*--------------------------------------------------------------------------*/

/*--------------------------------------------------------------------------*/
/* Additional High C specifics                                              */
/*--------------------------------------------------------------------------*/
#ifdef __HIGHC__
...
int FAR PASCAL wvsprintf(LP48STR,LP48STR,va_list);
...
extern struct com_t _mw_myc; /* 16/32 communication structure */

extern LONG (PASCAL *GetCallBack(void *lpCallback))();
extern ReleaseCallBack(LONG (PASCAL *pFunc)() );

extern BOOL FAR PASCAL PostAppMessageStr(HANDLE, WORD, WORD, LP48STR);
extern BOOL FAR PASCAL PostAppMessageStr(HANDLE, WORD, WORD, LP48STR);
extern long FAR PASCAL SendDlgItemMessageStr(HWND, int16, WORD, WORD, LP48STR);
extern long FAR PASCAL SendMessageStr(HWND, WORD, WORD, long);

extern void _Dfar *_mwLocalLock(HANDLE xx);
extern void PASCAL Set_Id_ArgCnt(unsigned long offset, unsigned long link, int id, int cnt);

extern LPSTR Call16(LPFARPROC proc, LP48STR fmt, ...);

extern DWORD PASCAL Alloc1616Alias(LPSTR);
extern void  PASCAL Free1616Alias(DWORD);

extern LP48STR _mwdwordtolpstr(DWORD l);

#define DWORDTOLPSTR(i)     (LP48STR)((DWORD)(i))
#define WORDTOLPSTR(i)      (LP48STR)((DWORD)((WORD)(i)))

#define GetCallBack(a)        		GetCallBack((void *)a)
#define GetInstanceData(a, b, c)        GetInstanceData(a, (DWORD)b, c)
#define MakeProcInstance(a, b)    	MakeProcInstance((FARPROC)a, b)
#define SendMessageStr(a, b, c, d)	SendMessageStr(a, b, c, (LP48STR)d)

typedef LONG (PASCAL *MWFARPROC)();

extern void _far *BRK_FP(void *pp);

#define BRK_FP(ptr)     BRK_FP((void *)ptr)
#define LocalLock       _mwLocalLock
#define _WinFlags       _mw_myc.mw_WinFlags

/* Routines to convert the structure pointed to by a DWORD callback
 * parameter into a 32-bit structure.  This is necessary for structures
 * that contain far pointers.
 */
extern void ConvertBITMAP (DWORD s, BITMAP *bitmap);
extern void ConvertWNDCLASS (DWORD s, WNDCLASS *wndclass);
extern void ConvertCREATESTRUCT (DWORD s, CREATESTRUCT *cstruct);
extern void ConvertKANJI (DWORD s, KANJISTRUCT *kanji);
extern void ConvertMDICREATESTRUCT (DWORD s, MDICREATESTRUCT *mdistr);
