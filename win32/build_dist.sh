...
cp -p "$ALS_BUILD_SUPPORT"/bin/libunistring-2.dll "$DISTDIR"
cp -p "$ALS_BUILD_SUPPORT"/bin/libcrypto-1_1.dll "$DISTDIR"
cp -p "$ALS_BUILD_SUPPORT"/bin/libidn2-0.dll "$DISTDIR"
...
cp -p "$ALS_BUILD_SUPPORT"/bin/libssl-1_1.dll "$DISTDIR"
cp -p "$ALS_BUILD_SUPPORT"/bin/zlib1.dll "$DISTDIR"
